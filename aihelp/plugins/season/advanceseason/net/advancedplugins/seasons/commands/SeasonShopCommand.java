...
extends SimpleCommand<CommandSender> {
    public SeasonShopCommand(JavaPlugin javaPlugin) {
        super(javaPlugin, "seasonshop", "advancedseasons.seasonshop", true);
    }

    @Override
    public void onExecute(CommandSender commandSender, String[] stringArray) {
        Player player = (Player)commandSender;
        SeasonShopMenu.open(player, Core.getLocaleHandler().getString("messages.notAllowedWorld"));
    }
}
