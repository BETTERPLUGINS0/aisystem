...
public class VictimNameVariable
implements VariableType {
    @Override
    public String parse(String string, LivingEntity livingEntity, ExecutionTask executionTask) {
        return string.replace(this.getVariable(), executionTask.getBuilder().getVictim() != null ? executionTask.getBuilder().getVictim().getName() : "");
    }
