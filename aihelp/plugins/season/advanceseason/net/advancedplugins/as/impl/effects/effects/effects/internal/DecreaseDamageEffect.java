...
public class DecreaseDamageEffect
extends AdvancedEffect {
    public DecreaseDamageEffect(JavaPlugin javaPlugin) {
        super(javaPlugin, "DECREASE_DAMAGE", "Decrease damage by percentage", "%e:<AMOUNT>");
