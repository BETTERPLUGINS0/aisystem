...
import net.advancedplugins.as.impl.utils.nbt.utils.NbtApiException;
...
public class MojangToMapping {
    ...
    public static Map<String, String> getMapping() {
        ...
        throw new NbtApiException("No fitting mapping found for version " + String.valueOf((Object)MinecraftVersion.getVersion()) + ". This is a bug!");
    }
}
