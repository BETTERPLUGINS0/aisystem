...
public class ElytraFlyDamageTrigger
extends AdvancedTrigger {
    public ElytraFlyDamageTrigger() {
        super("ELYTRA_FLY_DAMAGE");
        this.setDescription("Activates when entity takes damage while flying with elytra");
    }
