...
public class CactusEffect
extends AdvancedEffect {
    public CactusEffect(JavaPlugin javaPlugin) {
        super(javaPlugin, "CACTUS", "Display cactus effect", "%e");
    }
    ...
    public boolean executeEffect(ExecutionTask executionTask, Location location, String[] stringArray) {
        ...
        location.getWorld().playEffect(location.clone().add(0.0, 0.8, 0.0), Effect.STEP_SOUND, (Object)Material.CACTUS);
        return true;
    }
}
