...
public class AddMoneyEffect
extends AdvancedEffect {
    public AddMoneyEffect(JavaPlugin javaPlugin) {
        super(javaPlugin, "ADD_MONEY", "Add vault money to the player", "%e:<AMOUNT>");
    ...
    public boolean executeEffect(ExecutionTask executionTask, LivingEntity livingEntity, String[] stringArray) {
        ...
        advancedEconomy.giveUser(player, d);
        return true;
    }
}
