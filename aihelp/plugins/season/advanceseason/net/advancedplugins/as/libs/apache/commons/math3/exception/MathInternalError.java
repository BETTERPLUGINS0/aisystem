...
extends MathIllegalStateException {
    ...
    public MathInternalError(Throwable throwable) {
        super(throwable, LocalizedFormats.INTERNAL_ERROR, REPORT_URL);
    }

    public MathInternalError(Localizable localizable, Object ... objectArray) {
        super(localizable, objectArray);
    }
}
