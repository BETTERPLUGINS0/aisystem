...
public class Validate {
    ...
    public static <T> void exclusiveBetween(T t, T t2, Comparable<T> comparable, String string, Object ... objectArray) {
        if (comparable.compareTo(t) <= 0 || comparable.compareTo(t2) >= 0) {
            throw new IllegalArgumentException(Validate.getMessage(string, objectArray));
        }
    }
    ...
    private static String getMessage(String string, Object ... objectArray) {
        return ArrayUtils.isEmpty(objectArray) ? string : String.format(string, objectArray);
    }
    ...
    public static void isAssignableFrom(Class<?> clazz, Class<?> clazz2) {
        if (clazz2 == null || clazz == null || !clazz.isAssignableFrom(clazz2)) {
            throw new IllegalArgumentException(String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, ClassUtils.getName(clazz2, "null type"), ClassUtils.getName(clazz, "null type")));
        }
    }
    ...
    public static void isInstanceOf(Class<?> clazz, Object object) {
        if (!clazz.isInstance(object)) {
            throw new IllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, clazz.getName(), ClassUtils.getName(object, "null")));
        }
    }
    ...
    public static void matchesPattern(CharSequence charSequence, String string, String string2, Object ... objectArray) {
        if (!Pattern.matches(string, charSequence)) {
            throw new IllegalArgumentException(Validate.getMessage(string2, objectArray));
        }
    }
    ...
    public static <T extends Iterable<?>> T noNullElements(T t, String string, Object ... objectArray) {
        ...
        while (iterator.hasNext()) {
            if (iterator.next() == null) {
                ...
                throw new IllegalArgumentException(Validate.getMessage(string, objectArray2));
            }
            ++n;
        }
        return t;
    ...
    public static <T> T[] noNullElements(T[] TArray, String string, Object ... objectArray) {
        Objects.requireNonNull(TArray, "array");
    ...
    public static <T extends CharSequence> T notBlank(T t, String string, Object ... objectArray) {
        Objects.requireNonNull(t, Validate.toSupplier(string, objectArray));
    ...
    public static <T> T[] notEmpty(T[] TArray, String string, Object ... objectArray) {
        Objects.requireNonNull(TArray, Validate.toSupplier(string, objectArray));
        if (TArray.length == 0) {
            throw new IllegalArgumentException(Validate.getMessage(string, objectArray));
        }
        return TArray;
    ...
    public static <T> T notNull(T t, String string, Object ... objectArray) {
        return Objects.requireNonNull(t, Validate.toSupplier(string, objectArray));
    }

    private static Supplier<String> toSupplier(String string, Object ... objectArray) {
        return () -> Validate.getMessage(string, objectArray);
    }
    ...
    public static <T extends Collection<?>> T validIndex(T t, int n, String string, Object ... objectArray) {
        ...
        if (n < 0 || n >= t.size()) {
            throw new IndexOutOfBoundsException(Validate.getMessage(string, objectArray));
        }
        return t;
    }
    ...
    public static <T> T[] validIndex(T[] TArray, int n) {
        return Validate.validIndex(TArray, n, DEFAULT_VALID_INDEX_ARRAY_EX_MESSAGE, n);
    }
    ...
    public static void validState(boolean bl, String string, Object ... objectArray) {
        if (!bl) {
            throw new IllegalStateException(Validate.getMessage(string, objectArray));
        }
    }
}
