...
public abstract class CharSequenceTranslator {
    ...
    public final void translate(CharSequence charSequence, Writer writer) {
        ...
        while (n < n2) {
            ...
            if (n4 == 0) {
                ...
                writer.write(n3);
                if (!Character.isHighSurrogate((char)n3) || ++n >= n2 || !Character.isLowSurrogate(c2 = charSequence.charAt(n))) continue;
                writer.write(c2);
                ++n;
                continue;
            }
    ...
    public final CharSequenceTranslator with(CharSequenceTranslator ... charSequenceTranslatorArray) {
        ...
        return new AggregateTranslator(ArrayUtils.arraycopy(charSequenceTranslatorArray, 0, charSequenceTranslatorArray2, 1, charSequenceTranslatorArray.length));
    }
}
