...
public class ProtocolLibUtils1_20_R1 implements ProtocolLibUtils {
   DedicatedServer dedicatedserver;
   HashMap<Block, ProtocolLibUtils1_20_R1.Replacement> replacements;
   int winterBiomeID;
   int fallBiomeID;

   public ProtocolLibUtils1_20_R1() {
      Server var1 = Bukkit.getServer();
      CraftServer var2 = (CraftServer)var1;
      this.dedicatedserver = var2.getServer();
      this.winterBiomeID = this.getBiomeRegistry().a((BiomeBase)CraftBlock.biomeToBiomeBase(this.getBiomeRegistry(), Biome.SNOWY_PLAINS).a());
      this.fallBiomeID = this.getBiomeRegistry().a((BiomeBase)CraftBlock.biomeToBiomeBase(this.getBiomeRegistry(), Biome.SAVANNA).a());
   }
   ...
   public void readPacket(PacketContainer var1, int var2, boolean var3, int var4, int var5, HeightAccessor var6, boolean var7, int var8, boolean var9) {
      if (this.replacements == null) {
         ...
         while(var10.hasNext()) {
            ...
            ProtocolLibUtils1_20_R1.Replacement var12 = new ProtocolLibUtils1_20_R1.Replacement();
               ...
               for(var17 = 0; var17 < 16; ++var17) {
                  for(var18 = 0; var18 < 16; ++var18) {
                     if (this.replacements.containsKey(var15.a(var16, var17, var18).b())) {
                        ProtocolLibUtils1_20_R1.Replacement var24 = (ProtocolLibUtils1_20_R1.Replacement)this.replacements.get(var15.a(var16, var17, var18).b());
