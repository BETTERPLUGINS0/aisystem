...
public class NmsCode_20_R1 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_20_R1() {
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.ap, new MinecraftKey(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.ap, new MinecraftKey(var1.toLowerCase()));
      }
   ...
   public void refreshChunk(Player var1, Chunk var2) {
      try {
         ...
         ClientboundLevelChunkWithLightPacket var6 = new ClientboundLevelChunkWithLightPacket(var4, var5.s_(), (BitSet)null, (BitSet)null);
         EntityPlayer var7 = ((CraftPlayer)var1).getHandle();
         Field var8 = var7.getClass().getDeclaredField("c");
   ...
   public static void sendPacket(Player var0, Packet<?> var1) {
      if (!var0.hasMetadata("NPC")) {
         ...
         try {
            Field var3 = var2.getClass().getDeclaredField("c");
            var3.setAccessible(true);
   ...
   private IRegistry<BiomeBase> getBiomeRegistry() {
      return this.dedicatedserver.aV().d(Registries.ap);
   }
