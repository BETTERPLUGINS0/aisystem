...
public class FakeArmorStand_1_20_R3 implements FakeArmorStand {
   private int ID;
   ...
   public FakeArmorStand_1_20_R3(World var1, double var2, double var4, double var6, double var8, boolean var10, boolean var11, boolean var12, boolean var13) {
      this.armorstand = new EntityArmorStand(((CraftWorld)var1).getHandle(), var2, var4, var6);
      this.ID = this.armorstand.aj();
      this.dataWatcher = this.armorstand.an();
   ...
   public void move(Location var1, List<Player> var2) {
      ...
      while(var13.hasNext()) {
         ...
         NmsCode_20_R3.sendPacket(var14, var12);
      }
   ...
   public void sendSpawnPacket(List<Player> var1) {
      ...
      while(var6.hasNext()) {
         ...
         NmsCode_20_R3.sendPacket(var7, var2);
         NmsCode_20_R3.sendPacket(var7, var3);
         NmsCode_20_R3.sendPacket(var7, var8);
      }
   ...
   public void updateMetaData(Player var1) {
      ...
      NmsCode_20_R3.sendPacket(var1, var2);
   }
   ...
   public void destroy(List<Player> var1) {
      ...
      while(var3.hasNext()) {
         ...
         NmsCode_20_R3.sendPacket(var4, var2);
      }
