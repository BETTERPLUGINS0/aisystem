...
public class CustomBiome1_20_R3 implements CustomBiome {
   ...
   public CustomBiome1_20_R3(String var1, String var2, String var3) {
      ...
      this.newKey = ResourceKey.a(Registries.at, new MinecraftKey(var2, var1));
      ResourceKey var6;
      if (var3.contains(":")) {
         String[] var7 = var3.split(":");
         var6 = ResourceKey.a(Registries.at, new MinecraftKey(var7[0].toLowerCase(), var7[1].toLowerCase()));
      } else {
         var6 = ResourceKey.a(Registries.at, new MinecraftKey(var3.toLowerCase()));
      }

      this.biome = (BiomeBase)this.getBiomeRegistry().a(var6);
      if (this.biome == null) {
