...
import net.minecraft.server.v1_16_R2.PacketPlayOutGameStateChange.a;
...
public class NmsCode_16_R2 implements NmsCode {
   ...
   public Biome[] getAssociatedBiomes(String var1) {
      ...
      if (var1.equals("BADLANDS")) {
         ...
         var2 = new Biome[]{Biome.OCEAN, Biome.COLD_OCEAN, Biome.DEEP_COLD_OCEAN, Biome.DEEP_FROZEN_OCEAN, Biome.DEEP_LUKEWARM_OCEAN, Biome.DEEP_OCEAN, Biome.FROZEN_OCEAN, Biome.LUKEWARM_OCEAN, Biome.WARM_OCEAN, Biome.DEEP_WARM_OCEAN};
         return var2;
         ...
         var2 = new Biome[]{Biome.SNOWY_BEACH, Biome.SNOWY_MOUNTAINS, Biome.SNOWY_TAIGA, Biome.SNOWY_TAIGA_HILLS, Biome.SNOWY_TAIGA_MOUNTAINS, Biome.SNOWY_TUNDRA, Biome.FROZEN_RIVER, Biome.ICE_SPIKES};
         return var2;
