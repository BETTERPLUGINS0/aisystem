...
public class NmsCode_21_R1 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_21_R1() {
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.aF, MinecraftKey.a(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.aF, MinecraftKey.b(var1.toLowerCase()));
      }
   ...
   public List<String> getCustomBiomes(String var1) {
      ...
      Iterator var3 = this.getBiomeRegistry().h().iterator();
   ...
   public List<String> getAllBiomes() {
      ...
      Iterator var2 = this.getBiomeRegistry().h().iterator();
