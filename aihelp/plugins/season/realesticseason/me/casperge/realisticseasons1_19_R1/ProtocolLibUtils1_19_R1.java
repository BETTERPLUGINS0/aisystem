...
public class ProtocolLibUtils1_19_R1 {
   ...
   public ProtocolLibUtils1_19_R1() {
   ...
   public void readPacket(PacketContainer var1, World var2, int var3, boolean var4, int var5) {
      if (this.hasGlitched) {
         ...
         try {
            ProtocolLibUtils1_19_R1.CustomChunkSection[] var9 = this.extractData(var6, var2);
            int[] var10 = new int[var9.length * 64];
            int var11 = 0;
            ProtocolLibUtils1_19_R1.CustomChunkSection[] var12 = var9;
            int var13 = var9.length;

            int var14;
            ProtocolLibUtils1_19_R1.CustomChunkSection var15;
            int var16;
            int var17;
            int var18;
               ...
               for(var16 = 0; var16 < 4; ++var16) {
                  for(var17 = 0; var17 < 4; ++var17) {
                     for(var18 = 0; var18 < 4; ++var18) {
                        int var19 = this.dedicatedserver.aX().d(IRegistry.aR).a((BiomeBase)((Holder)var15.getDataPaletteBiome().a(var16, var17, var18)).a());
                        var10[var11] = var19;
                        ++var11;
                     }
                  }
            ...
            for(var14 = 0; var14 < var13; ++var14) {
               ...
               for(var16 = 0; var16 < 4; ++var16) {
                  for(var17 = 0; var17 < 4; ++var17) {
                     for(var18 = 0; var18 < 4; ++var18) {
                        var15.getDataPaletteBiome().c(var16, var17, var18, Holder.a((BiomeBase)this.dedicatedserver.aX().d(IRegistry.aR).a(var10[var11])));
                        ++var11;
                     }
                  }
               }
   ...
   public ProtocolLibUtils1_19_R1.CustomChunkSection[] extractData(ClientboundLevelChunkPacketData var1, World var2) {
      PacketDataSerializer var3 = var1.a();
      WorldServer var4 = ((CraftWorld)var2).getHandle();
      ProtocolLibUtils1_19_R1.CustomChunkSection[] var5 = new ProtocolLibUtils1_19_R1.CustomChunkSection[var4.ai()];

      int var6;
      for(var6 = 0; var6 < var5.length; ++var6) {
         var5[var6] = new ProtocolLibUtils1_19_R1.CustomChunkSection(this.dedicatedserver.aX().d(IRegistry.aR));
      }

      var6 = var5.length;

      for(int var7 = 0; var7 < var6; ++var7) {
         ProtocolLibUtils1_19_R1.CustomChunkSection var8 = var5[var7];
         ...
         try {
            ...
            if (var10 == 0) {
               ...
               DataPaletteBlock var20 = new DataPaletteBlock(Block.o, Blocks.a.m(), d.d);
   ...
   public byte[] toByteArray(ProtocolLibUtils1_19_R1.CustomChunkSection[] var1) {
      int var2 = 0;
      int var3 = var1.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         ProtocolLibUtils1_19_R1.CustomChunkSection var5 = var1[var4];
      ...
      for(int var7 = 0; var7 < var3; ++var7) {
         ProtocolLibUtils1_19_R1.CustomChunkSection var8 = var1[var7];
         var8.write(var6);
      }
   ...
   public void readPacketOld(PacketContainer var1, World var2, int var3, boolean var4, int var5) {
      ...
      for(var14 = 0; var14 < var13; ++var14) {
         ...
         for(var16 = 0; var16 < 4; ++var16) {
            for(var17 = 0; var17 < 4; ++var17) {
               for(var18 = 0; var18 < 4; ++var18) {
                  int var19 = this.dedicatedserver.aX().d(IRegistry.aR).a((BiomeBase)var15.c(var16, var17, var18).a());
                  var10[var11] = var19;
                  ++var11;
               }
            }
      ...
      for(var14 = 0; var14 < var13; ++var14) {
         ...
         for(var16 = 0; var16 < 4; ++var16) {
            for(var17 = 0; var17 < 4; ++var17) {
               for(var18 = 0; var18 < 4; ++var18) {
                  var15.setBiome(var16, var17, var18, Holder.a((BiomeBase)this.dedicatedserver.aX().d(IRegistry.aR).a(var10[var11])));
                  ++var11;
               }
            }
         }
   ...
   public ChunkSection[] extractDataSafe(ClientboundLevelChunkPacketData var1, World var2) {
      PacketDataSerializer var3 = var1.a();
      WorldServer var4 = ((CraftWorld)var2).getHandle();
      ChunkSection[] var5 = new ChunkSection[var4.ai()];

      int var6;
      for(var6 = 0; var6 < var5.length; ++var6) {
         var5[var6] = new ChunkSection(var4.g(var6), this.dedicatedserver.aX().d(IRegistry.aR));
      }
   ...
   class CustomChunkSection {
      ...
      public CustomChunkSection(IRegistry<BiomeBase> param2) {
         this.dataPaletteBiome = new DataPaletteBlock(var2.s(), var2.h(Biomes.b), d.e);
      }
