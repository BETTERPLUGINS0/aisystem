...
public class NmsCode_19_R1 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_19_R1() {
   ...
   public int getBiomeID(Biome var1) {
      BiomeBase var2 = (BiomeBase)CraftBlock.biomeToBiomeBase(this.dedicatedserver.aX().b(IRegistry.aR), var1).a();
      return this.dedicatedserver.aX().d(IRegistry.aR).a(var2);
   }
   ...
   public int getBiomeID(String var1) {
      ...
      IRegistry var5 = this.dedicatedserver.aX().b(IRegistry.aR);
      BiomeBase var4 = (BiomeBase)var5.a(var2);
      return this.dedicatedserver.aX().d(IRegistry.aR).a(var4);
   }
   ...
   public String getBiome(int var1) {
      if (var1 == 5555) {
         ...
         IRegistry var2 = this.dedicatedserver.aX().b(IRegistry.aR);
   ...
   public int[] getBiomeColors(String var1) {
      ...
      IRegistry var10 = this.dedicatedserver.aX().b(IRegistry.aR);
      BiomeBase var4 = (BiomeBase)var10.a(var2);
      BiomeFog var5 = null;

      try {
         Field var6 = BiomeBase.class.getDeclaredField("l");
   ...
   public List<String> getAllBiomes() {
      IRegistry var1 = this.dedicatedserver.aX().b(IRegistry.aR);
   ...
   public String getBiomeName(Biome var1) {
      BiomeBase var2 = (BiomeBase)CraftBlock.biomeToBiomeBase(this.dedicatedserver.aX().d(IRegistry.aR), var1).a();
      MinecraftKey var3 = this.dedicatedserver.aX().d(IRegistry.aR).b(var2);
      return var3.a();
   }
   ...
   public Biome[] getAssociatedBiomes(String var1) {
      ...
      if (var1.equals("BADLANDS")) {
         ...
         var2 = new Biome[]{Biome.SNOWY_BEACH, Biome.SNOWY_TAIGA, Biome.SNOWY_PLAINS, Biome.FROZEN_RIVER, Biome.ICE_SPIKES, Biome.FROZEN_OCEAN, Biome.DEEP_FROZEN_OCEAN};
         return var2;
   ...
   public void changeRegistryLock(boolean var1) {
      try {
         ...
         Field var3;
         if (var1) {
            var2 = (RegistryMaterials)this.dedicatedserver.aX().b(IRegistry.aR);
            var3 = var2.getClass().getDeclaredField("ca");
            var3.setAccessible(true);
            var3.set(var2, true);
         } else {
            var2 = (RegistryMaterials)this.dedicatedserver.aX().b(IRegistry.aR);
   ...
   public String getBiomeName(int var1, int var2, int var3, World var4) {
      ...
      if (var6 == null) {
         ...
         MinecraftKey var7 = this.dedicatedserver.aX().d(IRegistry.aR).b(var6);
