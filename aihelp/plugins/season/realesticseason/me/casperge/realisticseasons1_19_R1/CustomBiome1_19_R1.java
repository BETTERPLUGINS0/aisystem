...
public class CustomBiome1_19_R1 implements CustomBiome {
   ...
   public CustomBiome1_19_R1(String var1, String var2, String var3) {
      ...
      this.newKey = ResourceKey.a(IRegistry.aR, new MinecraftKey(var2, var1));
      ResourceKey var6;
      if (var3.contains(":")) {
         String[] var7 = var3.split(":");
         var6 = ResourceKey.a(IRegistry.aR, new MinecraftKey(var7[0].toLowerCase(), var7[1].toLowerCase()));
      } else {
         var6 = ResourceKey.a(IRegistry.aR, new MinecraftKey(var3.toLowerCase()));
      }

      IRegistry var13 = this.dedicatedserver.aX().b(IRegistry.aR);
      ...
      if (this.biome == null) {
         ...
         try {
            Field var8 = BiomeBase.class.getDeclaredField("l");
   ...
   public void register() {
      if (!this.isRegistered) {
         ...
         BiomeBase var1 = (BiomeBase)((IRegistryWritable)this.dedicatedserver.aX().b(IRegistry.aR)).a(this.newKey, this.newBiome.a(), Lifecycle.stable()).a();
         this.isRegistered = true;
         this.biomeID = this.dedicatedserver.aX().d(IRegistry.aR).a(var1);
      }
   }
   ...
   public void setFrozen(Boolean var1) {
      if (var1) {
         ...
         this.newBiome.a(Precipitation.c).a(0.0F).b(0.5F).a(var2.a());
         this.isFrozen = true;
      } else {
         this.newBiome.a(TemperatureModifier.a);
         this.isFrozen = false;
