...
public class NmsCode_19_R3 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_19_R3() {
   ...
   public int getBiomeID(Biome var1) {
      BiomeBase var2 = (BiomeBase)CraftBlock.biomeToBiomeBase(this.getBiomeRegistry(), var1).a();
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.an, new MinecraftKey(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.an, new MinecraftKey(var1.toLowerCase()));
      }

      BiomeBase var4 = (BiomeBase)this.getBiomeRegistry().a(var2);
   ...
   public HashMap<Integer, Integer> generateHeightAccessor(World var1) {
      WorldServer var2 = ((CraftWorld)var1).getHandle();
      HashMap var3 = new HashMap();

      for(int var4 = 0; var4 < this.getSectionCount(var1); ++var4) {
         var3.put(var4, var2.g(var4));
      }
   ...
   public int[] getBiomeColors(String var1) {
      ...
      BiomeBase var9 = (BiomeBase)this.getBiomeRegistry().a(var2);
      BiomeFog var4 = null;
   ...
   public List<String> getCustomBiomes(String var1) {
      ...
      Iterator var3 = this.getBiomeRegistry().g().iterator();
   ...
   public List<String> getAllBiomes() {
      ...
      Iterator var2 = this.getBiomeRegistry().g().iterator();
   ...
   public void refreshChunk(Player var1, Chunk var2) {
      try {
         ...
         net.minecraft.world.level.chunk.Chunk var4 = (net.minecraft.world.level.chunk.Chunk)var3.getHandle(ChunkStatus.o);
   ...
   public void resendChunks(List<Chunk> var1) {
      ...
      while(var4.hasNext()) {
         ...
         net.minecraft.world.level.chunk.Chunk var6 = (net.minecraft.world.level.chunk.Chunk)((CraftChunk)var5).getHandle(ChunkStatus.o);
         var3.add(var6);
      }
