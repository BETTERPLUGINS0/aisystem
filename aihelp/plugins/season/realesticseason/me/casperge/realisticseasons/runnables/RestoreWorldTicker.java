...
public class RestoreWorldTicker extends BukkitRunnable {
   ...
   public RestoreWorldTicker(RealisticSeasons var1, World var2) {
      this.main = var1;
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         var1.getSeasonManager().getQueue(var2, Season.RESTORE).add(new SeasonChunk(var6.getWorld().getName(), var6.getX(), var6.getZ(), System.currentTimeMillis()));
      }
         ...
         if (var4 != null) {
            if (!var1.getChunkUtils().affectFlora(var3)) {
               ...
               if (var1.hasBlockChanges(var3.getX(), var3.getZ(), var3.getWorld())) {
                  ...
                  var1.getChunkUtils().checkPopulation(var3, 4.0F, 0.1F, 1, 1, Season.RESTORE, var2);
               }
            }
   ...
   public void run() {
      if (this.wr.get() == null) {
         ...
         if (this.main.getSeasonManager().getSeason(var1) == Season.RESTORE && var1.getEnvironment() != Environment.NETHER && var1.getEnvironment() != Environment.THE_END) {
            if (!this.main.getSeasonManager().getQueue(var1, Season.RESTORE).isEmpty()) {
               if (this.main.getNMSUtils().getTPS() < this.main.getSettings().minTPS && this.main.getSettings().prioritiseTPS) {
                  return;
               }

               Iterator var2 = this.main.getSeasonManager().getQueue(var1, Season.RESTORE).iterator();
               ...
               while(true) {
                  while(true) {
                     ...
                     if (var4.getWorld() != var1) {
                        ...
                        var3.add(var4);
                     } else if (!this.main.getSeasonManager().getCheckedList(var1, Season.RESTORE).contains(var4) && var1.isChunkLoaded(var4.getX(), var4.getZ())) {
                        if (!var1.isChunkLoaded(var4.getX(), var4.getZ())) {
                           ...
                           if (!this.main.getChunkUtils().affectFlora(var5)) {
                              ...
                              var2.remove();
                              this.main.getSeasonManager().getCheckedList(var1, Season.RESTORE).add(var4);
                              break label87;
                           }
                           ...
                           if (this.main.hasSeasons(var5.getX(), var5.getZ(), var5.getWorld())) {
                              if (this.main.hasBlockChanges(var5.getX(), var5.getZ(), var5.getWorld())) {
                                 ...
                                 this.main.getChunkUtils().checkPopulation(var5, 4.0F, 0.1F, 1, 1, Season.RESTORE, this.hasChangedBlocks);
                              }
               ...
               while(var6.hasNext()) {
                  ...
                  JavaUtils.moveToBack(this.main.getSeasonManager().getQueue(var1, Season.RESTORE), var7);
               }
            }
         } else {
            this.main.getSeasonManager().clearChunkCheckedList(var1, Season.RESTORE);
            this.main.getSeasonManager().clearChunkQueue(var1, Season.RESTORE);
            this.cancel();
         }
