...
public class ChunkPacketEventProtocolLib1_19_R1 {
   ...
   public ChunkPacketEventProtocolLib1_19_R1(final RealisticSeasons var1) {
            ...
            if (var1.getSettings().affectBiomes) {
               ...
               if (var6 == Season.WINTER) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R1.this.protutils.readPacket(var2, var3.getWorld(), Season.WINTER.intValue(), false, var7.getPhase());
                     return;
                  }

                  ChunkPacketEventProtocolLib1_19_R1.this.protutils.readPacket(var2, var3.getWorld(), Season.WINTER.intValue(), true, var7.getPhase());
                  return;
               }

               if (var6 == Season.FALL) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R1.this.protutils.readPacket(var2, var3.getWorld(), Season.FALL.intValue(), false, var7.getPhase());
                     return;
                  }

                  ChunkPacketEventProtocolLib1_19_R1.this.protutils.readPacket(var2, var3.getWorld(), Season.FALL.intValue(), true, var7.getPhase());
                  return;
               }

               if (var6 == Season.SPRING) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R1.this.protutils.readPacket(var2, var3.getWorld(), Season.SPRING.intValue(), false, var7.getPhase());
                     return;
                  }
               ...
               if (var6 == Season.SUMMER) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R1.this.protutils.readPacket(var2, var3.getWorld(), Season.SUMMER.intValue(), false, var7.getPhase());
                     return;
                  }
