...
import me.casperge.realisticseasons1_19_R2.ProtocolLibUtils1_19_R2;
import org.bukkit.entity.Player;
import world.ofunny.bpm.Floodgate.FloodgateAPI;

public class ChunkPacketEventProtocolLib1_19_R2 {
   private ProtocolLibUtils1_19_R2 protutils = new ProtocolLibUtils1_19_R2();

   public ChunkPacketEventProtocolLib1_19_R2(final RealisticSeasons var1) {
            ...
            if (var1.getSettings().affectBiomes) {
               ...
               if (var6 == Season.WINTER) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R2.this.protutils.readPacket(var2, var3.getWorld(), Season.WINTER.intValue(), false, var7.getPhase());
                     return;
                  }

                  ChunkPacketEventProtocolLib1_19_R2.this.protutils.readPacket(var2, var3.getWorld(), Season.WINTER.intValue(), true, var7.getPhase());
                  return;
               }

               if (var6 == Season.FALL) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R2.this.protutils.readPacket(var2, var3.getWorld(), Season.FALL.intValue(), false, var7.getPhase());
                     return;
                  }

                  ChunkPacketEventProtocolLib1_19_R2.this.protutils.readPacket(var2, var3.getWorld(), Season.FALL.intValue(), true, var7.getPhase());
                  return;
               }

               if (var6 == Season.SPRING) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R2.this.protutils.readPacket(var2, var3.getWorld(), Season.SPRING.intValue(), false, var7.getPhase());
                     return;
                  }
               ...
               if (var6 == Season.SUMMER) {
                  if (!FloodgateAPI.get().isBedrockPlayer(var3) && var1.supportsCustomBiomes(var3)) {
                     ChunkPacketEventProtocolLib1_19_R2.this.protutils.readPacket(var2, var3.getWorld(), Season.SUMMER.intValue(), false, var7.getPhase());
                     return;
                  }
