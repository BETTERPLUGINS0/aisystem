...
public class ProtocolLibUtils1_20_R4 implements ProtocolLibUtils {
   DedicatedServer dedicatedserver;
   HashMap<Block, ProtocolLibUtils1_20_R4.Replacement> replacements;
   int winterBiomeID;
   int fallBiomeID;
   Random r;

   public ProtocolLibUtils1_20_R4() {
   ...
   public void readPacket(PacketContainer var1, int var2, boolean var3, int var4, int var5, HeightAccessor var6, boolean var7, int var8, boolean var9) {
      if (this.replacements == null) {
         ...
         while(var10.hasNext()) {
            ...
            ProtocolLibUtils1_20_R4.Replacement var12 = new ProtocolLibUtils1_20_R4.Replacement(this);
   ...
   public void readPacketOld(PacketContainer var1, int var2, boolean var3, int var4, int var5, boolean var6) {
               ...
               for(var19 = 0; var19 < 16; ++var19) {
                  for(var20 = 0; var20 < 16; ++var20) {
                     if (this.replacements.containsKey(var16.a(var18, var19, var20).b())) {
                        ProtocolLibUtils1_20_R4.Replacement var21 = (ProtocolLibUtils1_20_R4.Replacement)this.replacements.get(var16.a(var18, var19, var20).b());
                        if (var21.seasons.contains(var2) && var21.phases.contains(var4)) {
                           var16.h().c(var18, var19, var20, var21.replacement.o());
                        }
                     }
                     ...
                     if (var6 && var16.a(var18, var19, var20).b().equals(CraftMagicNumbers.getBlock(Material.SPRUCE_LEAVES))) {
                        ...
                        if (var31 < 0.2D) {
                           ...
                           while(var24.hasNext()) {
                              ProtocolLibUtils1_20_R4.Vector3D var25 = (ProtocolLibUtils1_20_R4.Vector3D)var24.next();
                           ...
                           if (var22 > 1 && var22 < 4 && !var23) {
                              if (var31 < 0.05D) {
                                 var16.h().c(var18, var19, var20, CraftMagicNumbers.getBlock(Material.RED_TERRACOTTA).o());
                              } else if (var31 < 0.1D) {
                                 var16.h().c(var18, var19, var20, CraftMagicNumbers.getBlock(Material.YELLOW_TERRACOTTA).o());
                              } else if (var31 < 0.15D) {
                                 var16.h().c(var18, var19, var20, CraftMagicNumbers.getBlock(Material.LIGHT_BLUE_TERRACOTTA).o());
                              } else {
                                 var16.h().c(var18, var19, var20, CraftMagicNumbers.getBlock(Material.LIME_TERRACOTTA).o());
                              }

                              var30.add(new ProtocolLibUtils1_20_R4.Vector3D(this, var18, var19, var20));
                           }
                        }
                     }
                  }
      ...
      try {
         Field var29 = var7.getClass().getDeclaredField("c");
   ...
   public ChunkSection[] extractDataSafe(ClientboundLevelChunkPacketData var1, int var2) {
      ...
      for(int var7 = 0; var7 < var6; ++var7) {
         ...
         try {
            ...
            var10000.println("Exception occured on section number " + var10001 + "/" + String.valueOf(var6) + " dimension: " + var5);
   ...
   private IRegistry<BiomeBase> getBiomeRegistry() {
      return this.dedicatedserver.bc().d(Registries.az);
   }
   ...
   private class Replacement {
      ...
      private Replacement(final ProtocolLibUtils1_20_R4 param1) {
      }
   }
   ...
   private class Vector3D {
      ...
      public Vector3D(final ProtocolLibUtils1_20_R4 param1, int param2, int param3, int param4) {
         this.x = var2;
         this.y = var3;
         this.z = var4;
      }
