...
public class NmsCode_21_R4 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_21_R4() {
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.aG, MinecraftKey.a(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.aG, MinecraftKey.b(var1.toLowerCase()));
      }
   ...
   public void refreshChunk(Player var1, Chunk var2) {
      try {
         ...
         ClientboundLevelChunkWithLightPacket var6 = new ClientboundLevelChunkWithLightPacket(var4, var5.B_(), (BitSet)null, (BitSet)null);
   ...
   private IRegistry<BiomeBase> getBiomeRegistry() {
      return this.dedicatedserver.ba().f(Registries.aG);
   }
