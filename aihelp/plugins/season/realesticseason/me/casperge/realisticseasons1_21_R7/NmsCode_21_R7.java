...
public class NmsCode_21_R7 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_21_R7() {
   ...
   public int getBiomeID(Biome var1) {
      BiomeBase var2 = (BiomeBase)CraftRegistry.bukkitToMinecraft(var1);
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.aS, MinecraftKey.a(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.aS, MinecraftKey.b(var1.toLowerCase()));
      }
   ...
   public static boolean isLeafLitter(Material var0) {
      return var0 == Material.LEAF_LITTER;
   }

   public static void setLeafLitterCount(Block var0, int var1) {
      if (var0.getBlockData() instanceof LeafLitter) {
         LeafLitter var2 = (LeafLitter)var0.getBlockData();
         var2.setSegmentAmount(var1);
         var0.setBlockData(var2);
      }

   }

   public static Material getLeafLitter() {
   ...
   public int[] getBiomeColors(String var1) {
      ...
      try {
         Field var5 = BiomeBase.class.getDeclaredField("m");
      ...
      int[] var10 = new int[]{this.readAttributeForBiomeColors(EnvironmentAttributes.a, var9.g()), this.getFieldInBiomea(var4, "b"), this.readAttributeForBiomeColors(EnvironmentAttributes.f, var9.g()), this.readAttributeForBiomeColors(EnvironmentAttributes.i, var9.g()), -9999999, -9999999};
      Optional var6 = this.getOptionalFieldInBiomea(var4, "e");
      if (var6.isPresent()) {
         var10[4] = (Integer)var6.get();
      }

      Optional var7 = this.getOptionalFieldInBiomea(var4, "c");
      if (var7.isPresent()) {
   ...
   private Integer readAttributeForBiomeColors(EnvironmentAttribute<Integer> var1, EnvironmentAttributeMap var2) {
      Optional var3 = this.readColor(var1, var2);
      return var3.isPresent() ? (Integer)var3.get() : -9999999;
   }
   ...
   public double getTPS() {
      ...
      try {
         var1 = this.dedicatedserver.recentTps[0];
         return var1;
   ...
   public Biome[] getAssociatedBiomes(String var1) {
      ...
      if (var1.equals("BADLANDS")) {
         ...
         return var2;
      } else if (var1.equals("PALE_GARDEN")) {
         var2 = new Biome[]{Biome.PALE_GARDEN};
         return var2;
      } else {
   ...
   public void refreshChunk(Player var1, Chunk var2) {
      try {
         ...
         Field var8 = var7.getClass().getDeclaredField("g");
   ...
   public static void sendPacket(Player var0, Packet<?> var1) {
      if (!var0.hasMetadata("NPC")) {
         ...
         try {
            Field var3 = var2.getClass().getDeclaredField("g");
            var3.setAccessible(true);
   ...
   public void setBlockInNMSChunk(World var1, int var2, int var3, int var4, int var5, byte var6, boolean var7) {
      ...
      IBlockData var10 = net.minecraft.world.level.block.Block.a(var5 + (var6 << 12));
