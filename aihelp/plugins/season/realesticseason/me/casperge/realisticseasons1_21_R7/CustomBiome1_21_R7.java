...
public class CustomBiome1_21_R7 implements CustomBiome {
   ...
   public CustomBiome1_21_R7(String var1, String var2, String var3) {
      ...
      this.newKey = ResourceKey.a(Registries.aS, MinecraftKey.a(var2, var1));
      ResourceKey var6;
      if (var3.contains(":")) {
         String[] var7 = var3.split(":");
         var6 = ResourceKey.a(Registries.aS, MinecraftKey.a(var7[0].toLowerCase(), var7[1].toLowerCase()));
      } else {
         var6 = ResourceKey.a(Registries.aS, MinecraftKey.b(var3.toLowerCase()));
      }
      ...
      if (this.biome == null) {
         ...
         this.newBiome.a(this.biome.g());
         this.fogColor = "c0d8ff";

         try {
            Field var12 = BiomeBase.class.getDeclaredField("m");
            var12.setAccessible(true);
            this.oldFog = (BiomeFog)var12.get(this.biome);
            this.convertBiomeFog(this.oldFog);
            if (this.waterFogColor == "") {
               this.waterFogColor = this.waterColor;
            }
   ...
   public void setFogColor(String var1) {
      this.newBiome.a(EnvironmentAttributes.a, this.hexToDecimal(var1));
      this.fogColor = var1;
   }
   ...
   public void setWaterFogColor(String var1) {
      this.newBiome.a(EnvironmentAttributes.f, this.hexToDecimal(var1));
      this.waterFogColor = var1;
   }

   public void setSkyColor(String var1) {
      this.newBiome.a(EnvironmentAttributes.i, this.hexToDecimal(var1));
      this.skyColor = var1;
   }
   ...
   public void setGrassColor(String var1) {
      if (var1.equals("CUSTOM")) {
         Optional var2 = this.getOptionalFieldInBiomea(this.oldFog, "e");
         if (var2.isPresent()) {
            this.newFog.d((Integer)var2.get());
   ...
   private Optional<Integer> readColor(EnvironmentAttribute<Integer> var1, EnvironmentAttributeMap var2) {
      Optional var3 = Optional.empty();
      Integer var4 = 100004;
      Integer var5 = (Integer)var2.a(var1, var4);
      if (var4 != var5) {
   ...
   private void convertBiomeFog(BiomeFog var1) {
      Optional var2 = this.readColor(EnvironmentAttributes.a, this.biome.g());
      if (var2.isPresent()) {
         this.fogColor = Integer.toHexString((Integer)var2.get());
      } else {
         this.fogColor = "";
      }

      this.waterColor = Integer.toHexString(this.getFieldInBiomea(var1, "b"));
      Optional var3 = this.readColor(EnvironmentAttributes.f, this.biome.g());
      if (var3.isPresent()) {
         this.waterFogColor = Integer.toHexString((Integer)var3.get());
      } else {
         this.waterFogColor = "";
      }

      Optional var4 = this.readColor(EnvironmentAttributes.i, this.biome.g());
      if (var4.isPresent()) {
         this.skyColor = Integer.toHexString((Integer)var4.get());
      } else {
         this.skyColor = "";
      }

      Optional var5 = this.getOptionalFieldInBiomea(var1, "c");
      if (var5.isPresent()) {
         this.foliageColor = Integer.toHexString((Integer)var5.get());
         this.newFog.b((Integer)var5.get());
      }

      Optional var6 = this.getOptionalFieldInBiomea(var1, "d");
      if (var6.isPresent()) {
         this.foliageColor = Integer.toHexString((Integer)var6.get());
         this.newFog.c((Integer)var6.get());
      }
   ...
   private IRegistry<BiomeBase> getBiomeRegistry() {
      return this.dedicatedserver.bc().f(Registries.aS);
   }
}
