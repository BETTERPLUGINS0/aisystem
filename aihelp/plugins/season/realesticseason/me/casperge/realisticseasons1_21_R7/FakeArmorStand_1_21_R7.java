...
public class FakeArmorStand_1_21_R7 implements FakeArmorStand {
   private int ID;
   ...
   public FakeArmorStand_1_21_R7(World var1, double var2, double var4, double var6, double var8, boolean var10, boolean var11, boolean var12, boolean var13) {
      this.armorstand = new EntityArmorStand(((CraftWorld)var1).getHandle(), var2, var4, var6);
      this.ID = this.armorstand.aA();
      this.dataWatcher = this.armorstand.aD();
   ...
   public void move(Location var1, List<Player> var2) {
      ...
      while(var13.hasNext()) {
         ...
         NmsCode_21_R7.sendPacket(var14, var12);
      }
   ...
   public void sendSpawnPacket(List<Player> var1) {
      PacketPlayOutSpawnEntity var2 = new PacketPlayOutSpawnEntity(this.armorstand.aA(), this.armorstand.cY(), this.armorstand.dP(), this.armorstand.dR(), this.armorstand.dV(), this.armorstand.ee(), this.armorstand.ec(), this.armorstand.ay(), 0, this.armorstand.dN(), (double)this.armorstand.cS());
      ...
      while(var6.hasNext()) {
         ...
         NmsCode_21_R7.sendPacket(var7, var2);
         NmsCode_21_R7.sendPacket(var7, var3);
         NmsCode_21_R7.sendPacket(var7, var8);
      }
   ...
   public void updateMetaData(Player var1) {
      ...
      NmsCode_21_R7.sendPacket(var1, var2);
   }
   ...
   public void destroy(List<Player> var1) {
      ...
      while(var3.hasNext()) {
         ...
         NmsCode_21_R7.sendPacket(var4, var2);
      }
