...
public class NmsCode_21_R5 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_21_R5() {
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.aK, MinecraftKey.a(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.aK, MinecraftKey.b(var1.toLowerCase()));
      }
