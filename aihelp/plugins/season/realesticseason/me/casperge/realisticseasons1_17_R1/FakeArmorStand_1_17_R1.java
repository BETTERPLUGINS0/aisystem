...
public class FakeArmorStand_1_17_R1 implements FakeArmorStand {
   private int ID;
   ...
   public FakeArmorStand_1_17_R1(World var1, double var2, double var4, double var6, double var8, boolean var10, boolean var11, boolean var12, boolean var13) {
   ...
   public void move(Location var1, List<Player> var2) {
      ...
      while(var13.hasNext()) {
         ...
         NmsCode_17_R1.sendPacket(var14, var12);
      }
   ...
   public void sendSpawnPacket(List<Player> var1) {
      ...
      while(var6.hasNext()) {
         ...
         NmsCode_17_R1.sendPacket(var7, var2);
         NmsCode_17_R1.sendPacket(var7, var3);
         NmsCode_17_R1.sendPacket(var7, var8);
      }
   ...
   public void updateMetaData(Player var1) {
      ...
      NmsCode_17_R1.sendPacket(var1, var2);
   }
   ...
   public void destroy(List<Player> var1) {
      PacketPlayOutEntityDestroy var2 = null;

      try {
         Constructor[] var3 = PacketPlayOutEntityDestroy.class.getDeclaredConstructors();
         boolean var4 = false;
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            ...
            if (var8.getParameters().length == 1 && var8.getParameters()[0].getType().equals(Integer.TYPE)) {
               var4 = true;
               var2 = (PacketPlayOutEntityDestroy)var8.newInstance(this.ID);
            }
         }

         if (!var4) {
            var2 = new PacketPlayOutEntityDestroy(new int[]{this.ID});
         }
      } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException | InstantiationException var9) {
      ...
      while(var10.hasNext()) {
         ...
         NmsCode_17_R1.sendPacket(var11, var2);
      }
