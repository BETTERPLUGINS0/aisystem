...
public class ProtocolLibUtils1_21_R2 implements ProtocolLibUtils {
   DedicatedServer dedicatedserver;
   HashMap<Block, ProtocolLibUtils1_21_R2.Replacement> replacements;
   int winterBiomeID;
   int fallBiomeID;
   Random r;

   public ProtocolLibUtils1_21_R2() {
   ...
   public void readPacket(PacketContainer var1, int var2, boolean var3, int var4, int var5, HeightAccessor var6, boolean var7, int var8, boolean var9) {
      if (this.replacements == null) {
         ...
         while(var10.hasNext()) {
            ...
            ProtocolLibUtils1_21_R2.Replacement var12 = new ProtocolLibUtils1_21_R2.Replacement();
               ...
               for(var19 = 0; var19 < 16; ++var19) {
                  for(var20 = 0; var20 < 16; ++var20) {
                     if (this.replacements.containsKey(var16.a(var18, var19, var20).b())) {
                        ProtocolLibUtils1_21_R2.Replacement var21 = (ProtocolLibUtils1_21_R2.Replacement)this.replacements.get(var16.a(var18, var19, var20).b());
                     ...
                     if (var6 && var16.a(var18, var19, var20).b().equals(CraftMagicNumbers.getBlock(Material.SPRUCE_LEAVES))) {
                        ...
                        if (var31 < 0.2D) {
                           ...
                           while(var24.hasNext()) {
                              ProtocolLibUtils1_21_R2.Vector3D var25 = (ProtocolLibUtils1_21_R2.Vector3D)var24.next();
                           ...
                           if (var22 > 1 && var22 < 4 && !var23) {
                              ...
                              var30.add(new ProtocolLibUtils1_21_R2.Vector3D(var18, var19, var20));
                           }
                        }
                     }
                  }
