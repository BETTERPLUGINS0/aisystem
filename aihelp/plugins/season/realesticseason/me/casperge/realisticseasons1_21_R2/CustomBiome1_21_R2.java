...
public class CustomBiome1_21_R2 implements CustomBiome {
   ...
   public CustomBiome1_21_R2(String var1, String var2, String var3) {
      ...
      this.newKey = ResourceKey.a(Registries.aI, MinecraftKey.a(var2, var1));
      ResourceKey var6;
      if (var3.contains(":")) {
         String[] var7 = var3.split(":");
         var6 = ResourceKey.a(Registries.aI, MinecraftKey.a(var7[0].toLowerCase(), var7[1].toLowerCase()));
      } else {
         var6 = ResourceKey.a(Registries.aI, MinecraftKey.b(var3.toLowerCase()));
      }
