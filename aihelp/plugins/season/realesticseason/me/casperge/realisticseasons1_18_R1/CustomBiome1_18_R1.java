...
public class CustomBiome1_18_R1 implements CustomBiome {
   ...
   public CustomBiome1_18_R1(String var1, String var2, String var3) {
      ...
      if (this.biome == null) {
         ...
         try {
            ...
            Field var10 = BiomeBase.class.getDeclaredField("l");
   ...
   public void register() {
      if (!this.isRegistered) {
         ...
         BiomeBase var1 = (BiomeBase)this.dedicatedserver.aV().b(IRegistry.aR).a(this.newKey, this.newBiome.a(), Lifecycle.stable());
         this.isRegistered = true;
         this.biomeID = this.dedicatedserver.aV().d(IRegistry.aR).a(var1);
      }
   }
