...
public class NmsCode_18_R1 implements NmsCode {
   ...
   public int getBiomeID(Biome var1) {
      BiomeBase var2 = CraftBlock.biomeToBiomeBase(this.dedicatedserver.aV().b(IRegistry.aR), var1);
      return this.dedicatedserver.aV().d(IRegistry.aR).a(var2);
   }
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(IRegistry.aR, new MinecraftKey(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(IRegistry.aR, new MinecraftKey(var1.toLowerCase()));
      }

      IRegistryWritable var5 = this.dedicatedserver.aV().b(IRegistry.aR);
      BiomeBase var4 = (BiomeBase)var5.a(var2);
      return this.dedicatedserver.aV().d(IRegistry.aR).a(var4);
   }
   ...
   public String getBiome(int var1) {
      if (var1 == 5555) {
         ...
         IRegistryWritable var2 = this.dedicatedserver.aV().b(IRegistry.aR);
   ...
   public int[] getBiomeColors(String var1) {
      ...
      IRegistryWritable var10 = this.dedicatedserver.aV().b(IRegistry.aR);
      BiomeBase var4 = (BiomeBase)var10.a(var2);
      BiomeFog var5 = null;

      try {
         Field var6 = BiomeBase.class.getDeclaredField("n");
   ...
   public List<String> getAllBiomes() {
      IRegistryWritable var1 = this.dedicatedserver.aV().b(IRegistry.aR);
   ...
   public String getBiomeName(Biome var1) {
      BiomeBase var2 = CraftBlock.biomeToBiomeBase(this.dedicatedserver.aV().d(IRegistry.aR), var1);
      MinecraftKey var3 = this.dedicatedserver.aV().d(IRegistry.aR).b(var2);
      return var3.a();
   }
   ...
   public Biome[] getAssociatedBiomes(String var1) {
      ...
      if (var1.equals("BADLANDS")) {
         ...
         var2 = new Biome[]{Biome.OCEAN, Biome.COLD_OCEAN, Biome.DEEP_LUKEWARM_OCEAN, Biome.DEEP_COLD_OCEAN, Biome.DEEP_OCEAN, Biome.LUKEWARM_OCEAN, Biome.WARM_OCEAN};
         return var2;
         ...
         var2 = new Biome[]{Biome.SNOWY_BEACH, Biome.FROZEN_OCEAN, Biome.DEEP_FROZEN_OCEAN, Biome.SNOWY_TAIGA, Biome.SNOWY_PLAINS, Biome.FROZEN_RIVER, Biome.ICE_SPIKES};
         return var2;
   ...
   public String getBiomeName(int var1, int var2, int var3, World var4) {
      ...
      BiomeBase var6 = var5.getNoiseBiome(var1 >> 2, var2 >> 2, var3 >> 2);
      if (var6 == null) {
         return "void";
      } else {
         MinecraftKey var7 = this.dedicatedserver.aV().d(IRegistry.aR).b(var6);
