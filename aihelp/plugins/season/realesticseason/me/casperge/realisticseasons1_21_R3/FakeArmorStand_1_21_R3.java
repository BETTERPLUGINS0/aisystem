...
public class FakeArmorStand_1_21_R3 implements FakeArmorStand {
   private int ID;
   ...
   public FakeArmorStand_1_21_R3(World var1, double var2, double var4, double var6, double var8, boolean var10, boolean var11, boolean var12, boolean var13) {
   ...
   public void move(Location var1, List<Player> var2) {
      ...
      while(var13.hasNext()) {
         ...
         NmsCode_21_R3.sendPacket(var14, var12);
      }
   ...
   public void sendSpawnPacket(List<Player> var1) {
      PacketPlayOutSpawnEntity var2 = new PacketPlayOutSpawnEntity(this.armorstand.ar(), this.armorstand.cG(), this.armorstand.dA(), this.armorstand.dC(), this.armorstand.dG(), this.armorstand.dN(), this.armorstand.dL(), this.armorstand.aq(), 0, this.armorstand.dy(), (double)this.armorstand.cA());
      ...
      while(var6.hasNext()) {
         ...
         NmsCode_21_R3.sendPacket(var7, var2);
         NmsCode_21_R3.sendPacket(var7, var3);
         NmsCode_21_R3.sendPacket(var7, var8);
      }
   ...
   public void updateMetaData(Player var1) {
      ...
      NmsCode_21_R3.sendPacket(var1, var2);
   }
   ...
   public void destroy(List<Player> var1) {
      ...
      while(var3.hasNext()) {
         ...
         NmsCode_21_R3.sendPacket(var4, var2);
      }
