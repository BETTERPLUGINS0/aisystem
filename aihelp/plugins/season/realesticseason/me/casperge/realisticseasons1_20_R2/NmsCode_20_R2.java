...
public class NmsCode_20_R2 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_20_R2() {
   ...
   public void refreshChunk(Player var1, Chunk var2) {
      try {
         ...
         ClientboundLevelChunkWithLightPacket var6 = new ClientboundLevelChunkWithLightPacket(var4, var5.x_(), (BitSet)null, (BitSet)null);
