...
public class FakeArmorStand_1_19_R2 implements FakeArmorStand {
   private int ID;
   private int test = 2;
   ...
   public FakeArmorStand_1_19_R2(World var1, double var2, double var4, double var6, double var8, boolean var10, boolean var11, boolean var12, boolean var13) {
      this.armorstand = new EntityArmorStand(((CraftWorld)var1).getHandle(), var2, var4, var6);
      this.ID = this.armorstand.ah();
      this.dataWatcher = this.armorstand.al();
      this.armorstand.j(var10);
      this.armorstand.t(var11);
      this.armorstand.a(var12);
      this.armorstand.r(var13);
      this.armorstand.a(var2, var4, var6, (float)var8, 0.0F);
   ...
   public void move(Location var1, List<Player> var2) {
      ...
      this.armorstand.e(var3, var5, var7);
      this.armorstand.a((double)var1.getYaw(), (double)var1.getPitch());
      ...
      while(var13.hasNext()) {
         ...
         NmsCode_19_R2.sendPacket(var14, var12);
      }
   ...
   public void sendSpawnPacket(List<Player> var1) {
      ...
      while(var6.hasNext()) {
         ...
         NmsCode_19_R2.sendPacket(var7, var2);
         NmsCode_19_R2.sendPacket(var7, var3);
         NmsCode_19_R2.sendPacket(var7, var8);
      }
   ...
   public void updateMetaData(Player var1) {
      ...
      NmsCode_19_R2.sendPacket(var1, var2);
   }
   ...
   public void destroy(List<Player> var1) {
      ...
      while(var3.hasNext()) {
         ...
         NmsCode_19_R2.sendPacket(var4, var2);
      }
