...
public class CustomBiome1_19_R2 implements CustomBiome {
   ...
   public CustomBiome1_19_R2(String var1, String var2, String var3) {
      ...
      this.newKey = ResourceKey.a(Registries.al, new MinecraftKey(var2, var1));
      ResourceKey var6;
      if (var3.contains(":")) {
         String[] var7 = var3.split(":");
         var6 = ResourceKey.a(Registries.al, new MinecraftKey(var7[0].toLowerCase(), var7[1].toLowerCase()));
      } else {
         var6 = ResourceKey.a(Registries.al, new MinecraftKey(var3.toLowerCase()));
      }

      IRegistry var13 = this.dedicatedserver.aW().d(Registries.al);
   ...
   public void register() {
      try {
         ...
         IRegistryWritable var2 = (IRegistryWritable)this.dedicatedserver.aW().d(Registries.al);
         Field var3 = RegistryMaterials.class.getDeclaredField("m");
         var3.setAccessible(true);
         var3.set(var2, new IdentityHashMap());
         var2.f(var1);
         var2.a(this.newKey, var1, Lifecycle.stable());
         var3.set(var2, (Object)null);
         this.isRegistered = true;
         this.biomeID = this.dedicatedserver.aW().d(Registries.al).a(var1);
