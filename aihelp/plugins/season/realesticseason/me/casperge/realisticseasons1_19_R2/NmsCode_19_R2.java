...
public class NmsCode_19_R2 implements NmsCode {
   private DedicatedServer dedicatedserver;
   int test = 0;

   public NmsCode_19_R2() {
   ...
   public int getBiomeID(Biome var1) {
      BiomeBase var2 = (BiomeBase)CraftBlock.biomeToBiomeBase(this.dedicatedserver.aW().d(Registries.al), var1).a();
      return this.dedicatedserver.aW().d(Registries.al).a(var2);
   }
   ...
   public int getBiomeID(String var1) {
      ...
      if (var1.contains(":")) {
         ...
         var2 = ResourceKey.a(Registries.al, new MinecraftKey(var3[0].toLowerCase(), var3[1].toLowerCase()));
      } else {
         var2 = ResourceKey.a(Registries.al, new MinecraftKey(var1.toLowerCase()));
      }

      IRegistry var5 = this.dedicatedserver.aW().d(Registries.al);
      BiomeBase var4 = (BiomeBase)var5.a(var2);
      return this.dedicatedserver.aW().d(Registries.al).a(var4);
   }
   ...
   public String getBiome(int var1) {
      if (var1 == 5555) {
         ...
         IRegistry var2 = this.dedicatedserver.aW().d(Registries.al);
   ...
   public int[] getBiomeColors(String var1) {
      ...
      IRegistry var10 = this.dedicatedserver.aW().d(Registries.al);
   ...
   public List<String> getAllBiomes() {
      IRegistry var1 = this.dedicatedserver.aW().d(Registries.al);
   ...
   public String getBiomeName(Biome var1) {
      BiomeBase var2 = (BiomeBase)CraftBlock.biomeToBiomeBase(this.dedicatedserver.aW().d(Registries.al), var1).a();
      MinecraftKey var3 = this.dedicatedserver.aW().d(Registries.al).b(var2);
      return var3.a();
   }
   ...
   public void changeRegistryLock(boolean var1) {
      try {
         IRegistryWritable var2;
         Field var3;
         if (var1) {
            var2 = (IRegistryWritable)this.dedicatedserver.aW().d(Registries.al);
            var3 = RegistryMaterials.class.getDeclaredField("l");
            var3.setAccessible(true);
            var3.set(var2, false);
         } else {
            var2 = (IRegistryWritable)this.dedicatedserver.aW().d(Registries.al);
   ...
   public void refreshChunk(Player var1, Chunk var2) {
      try {
         ...
         ClientboundLevelChunkWithLightPacket var6 = new ClientboundLevelChunkWithLightPacket(var4, var5.m_(), (BitSet)null, (BitSet)null, true);
   ...
   public String getBiomeName(int var1, int var2, int var3, World var4) {
      ...
      if (var6 == null) {
         ...
         MinecraftKey var7 = this.dedicatedserver.aW().d(Registries.al).b(var6);
