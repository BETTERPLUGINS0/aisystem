...
public class CustomBiome1_18_R2 implements CustomBiome {
   ...
   public CustomBiome1_18_R2(String var1, String var2, String var3) {
      ...
      this.newKey = ResourceKey.a(IRegistry.aP, new MinecraftKey(var2, var1));
      ResourceKey var6;
      if (var3.contains(":")) {
         String[] var7 = var3.split(":");
         var6 = ResourceKey.a(IRegistry.aP, new MinecraftKey(var7[0].toLowerCase(), var7[1].toLowerCase()));
      } else {
         var6 = ResourceKey.a(IRegistry.aP, new MinecraftKey(var3.toLowerCase()));
      }

      IRegistry var15 = this.dedicatedserver.aU().b(IRegistry.aP);
      this.biome = (BiomeBase)var15.a(var6);
      if (this.biome == null) {
         ...
         try {
            ...
            Geography var13 = (Geography)var12.get(this.biome);
            this.newBiome.a(var13);
   ...
   public void register() {
      if (!this.isRegistered) {
         ...
         BiomeBase var1 = (BiomeBase)((IRegistryWritable)this.dedicatedserver.aU().b(IRegistry.aP)).a(this.newKey, this.newBiome.a(), Lifecycle.stable()).a();
         this.isRegistered = true;
         this.biomeID = this.dedicatedserver.aU().d(IRegistry.aP).a(var1);
      }
   }
   ...
   public void setFrozen(Boolean var1) {
      if (var1) {
         ...
         this.newBiome.a(Precipitation.c).a(Geography.h).a(0.0F).b(0.5F).a(var2.a());
         this.isFrozen = true;
      } else {
         this.newBiome.a(TemperatureModifier.a);
         this.isFrozen = false;
