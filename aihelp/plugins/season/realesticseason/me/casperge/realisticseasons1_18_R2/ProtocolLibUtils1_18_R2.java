...
public class ProtocolLibUtils1_18_R2 {
   ...
   public ProtocolLibUtils1_18_R2() {
   ...
   public void readPacket(PacketContainer var1, World var2, int var3, boolean var4, int var5) {
         ...
         for(var16 = 0; var16 < 4; ++var16) {
            for(var17 = 0; var17 < 4; ++var17) {
               for(var18 = 0; var18 < 4; ++var18) {
                  int var19 = this.dedicatedserver.aU().d(IRegistry.aP).a((BiomeBase)var15.c(var16, var17, var18).a());
                  var10[var11] = var19;
                  ++var11;
               }
            }
      ...
      for(var14 = 0; var14 < var13; ++var14) {
         ...
         for(var16 = 0; var16 < 4; ++var16) {
            for(var17 = 0; var17 < 4; ++var17) {
               for(var18 = 0; var18 < 4; ++var18) {
                  var15.setBiome(var16, var17, var18, Holder.a((BiomeBase)this.dedicatedserver.aU().d(IRegistry.aP).a(var10[var11])));
                  ++var11;
               }
            }
         }
   ...
   public ChunkSection[] extractData(ClientboundLevelChunkPacketData var1, World var2) {
      ...
      for(var6 = 0; var6 < var5.length; ++var6) {
         var5[var6] = new ChunkSection(var4.g(var6), this.dedicatedserver.aU().d(IRegistry.aP));
      }
