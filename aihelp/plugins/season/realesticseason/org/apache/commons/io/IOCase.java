...
public enum IOCase {
   ...
   public static boolean isCaseSensitive(IOCase var0) {
      return var0 != null && !var0.isCaseSensitive();
   }
   ...
   private IOCase(final String param3, final boolean param4) {
      this.name = var3;
      this.sensitive = var4;
   }
   ...
   public int checkCompareTo(String var1, String var2) {
      Objects.requireNonNull(var1, "str1");
      Objects.requireNonNull(var2, "str2");
   ...
   public boolean checkStartsWith(String var1, String var2) {
      return var1 != null && var2 != null && var1.regionMatches(!this.sensitive, 0, var2, 0, var2.length());
   }
