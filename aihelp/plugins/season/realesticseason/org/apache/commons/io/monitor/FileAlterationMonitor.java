...
public final class FileAlterationMonitor implements Runnable {
   ...
   public FileAlterationMonitor(long var1, Collection<FileAlterationObserver> var3) {
      this(var1, (FileAlterationObserver[])((Collection)Optional.ofNullable(var3).orElse(Collections.emptyList())).toArray(EMPTY_ARRAY));
   }
   ...
   public synchronized void stop(long var1) {
      if (!this.running) {
