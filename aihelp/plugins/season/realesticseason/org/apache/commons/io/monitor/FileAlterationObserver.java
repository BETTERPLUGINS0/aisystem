...
public class FileAlterationObserver implements Serializable {
   ...
   private void checkAndNotify(FileEntry var1, FileEntry[] var2, File[] var3) {
      int var4 = 0;
      FileEntry[] var5 = var3.length > 0 ? new FileEntry[var3.length] : FileEntry.EMPTY_FILE_ENTRY_ARRAY;
      FileEntry[] var6 = var2;
   ...
   private FileEntry[] doListFiles(File var1, FileEntry var2) {
      ...
      FileEntry[] var4 = var3.length > 0 ? new FileEntry[var3.length] : FileEntry.EMPTY_FILE_ENTRY_ARRAY;
