...
public class EndianUtils {
   ...
   public static void writeSwappedShort(OutputStream var0, short var1) {
      var0.write((byte)(var1 >> 0 & 255));
      var0.write((byte)(var1 >> 8 & 255));
   }

   public static short readSwappedShort(InputStream var0) {
      return (short)(((read(var0) & 255) << 0) + ((read(var0) & 255) << 8));
   }

   public static int readSwappedUnsignedShort(InputStream var0) {
      int var1 = read(var0);
      int var2 = read(var0);
      return ((var1 & 255) << 0) + ((var2 & 255) << 8);
   }

   public static void writeSwappedInteger(OutputStream var0, int var1) {
      var0.write((byte)(var1 >> 0 & 255));
      var0.write((byte)(var1 >> 8 & 255));
   ...
   public static int readSwappedInteger(InputStream var0) {
      int var1 = read(var0);
      int var2 = read(var0);
      int var3 = read(var0);
      int var4 = read(var0);
   ...
   public static long readSwappedUnsignedInteger(InputStream var0) {
      int var1 = read(var0);
      int var2 = read(var0);
      int var3 = read(var0);
      int var4 = read(var0);
   ...
   public static void writeSwappedLong(OutputStream var0, long var1) {
   ...
   public static long readSwappedLong(InputStream var0) {
   ...
   public static void writeSwappedFloat(OutputStream var0, float var1) {
      writeSwappedInteger(var0, Float.floatToIntBits(var1));
   }

   public static float readSwappedFloat(InputStream var0) {
      return Float.intBitsToFloat(readSwappedInteger(var0));
   }

   public static void writeSwappedDouble(OutputStream var0, double var1) {
      writeSwappedLong(var0, Double.doubleToLongBits(var1));
   }

   public static double readSwappedDouble(InputStream var0) {
