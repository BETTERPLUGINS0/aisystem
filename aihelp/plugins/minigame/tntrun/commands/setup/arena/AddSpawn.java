   ...
   public boolean handleCommand(Player player, String[] args) {
      ...
      if (arena != null) {
         ...
         if (arena.getStructureManager().addSpawnPoint(player.getLocation())) {
            ...
            Messages.sendMessage(player, "&7 Arena &6" + args[0] + "&7 spawn point (" + point + ") set to &6X: &7" + Math.round(player.getLocation().getX()) + " &6Y: &7" + Math.round(player.getLocation().getY()) + " &6Z: &7" + Math.round(player.getLocation().getZ()));
         } else {
