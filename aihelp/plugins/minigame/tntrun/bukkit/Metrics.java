...
import tntrun.MetricsBase;
import tntrun.charts.CustomChart;
import tntrun.json.JsonObjectBuilder;
...
public class Metrics {
   ...
   public Metrics(Plugin plugin, int serviceId) {
      ...
      Consumer var10009 = isFolia ? null : (submitDataTask) -> {
