...
extends FilterInputStream {
    ...
    @Override
    public int read(byte[] b2) throws UncheckedIOException {
        return Uncheck.apply(x$0 -> super.read((byte[])x$0), b2);
    }

    @Override
    public int read(byte[] b2, int off, int len) throws UncheckedIOException {
        return Uncheck.apply((x$0, x$1, x$2) -> super.read((byte[])x$0, (int)x$1, (int)x$2), b2, off, len);
    }
