...
public class ConfigPath {
    ...
    @GameMainOverridable
    public static final String GENERAL_GAME_END_CHAT_TOP_STATISTIC = "game-end.chat-top.order-by";
    @GameMainOverridable
    public static final String GENERAL_GAME_END_CHAT_TOP_HIDE_MISSING = "game-end.chat-top.hide-missing";
    @GameMainOverridable
    public static final String GENERAL_GAME_END_SB_TOP_STATISTIC = "game-end.sb-top.order-by";
    @GameMainOverridable
    public static final String GENERAL_GAME_END_SB_TOP_HIDE_MISSING = "game-end.sb-top.hide-missing";
    ...
    public static final String GENERAL_CHAT_FORMATTING = "chat-settings.format";
    public static final String GENERAL_CHAT_GLOBAL = "chat-settings.global";
    ...
    public static final String GENERAL_ENABLE_PARTY_CMD = "party-settings.enable-party-cmd";
    public static final String GENERAL_CONFIGURATION_ALLOW_PARTIES = "party-settings.allow-parties";
    public static final String GENERAL_ALESSIODP_PARTIES_RANK = "party-settings.alessioDP-choose-arena-rank";
    private static final String GENERAL_TNT_JUMP_PATH = "tnt-jump-settings";
    public static final String GENERAL_TNT_JUMP_BARYCENTER_IN_Y = "tnt-jump-settings.barycenter-alteration-in-y";
    public static final String GENERAL_TNT_JUMP_STRENGTH_REDUCTION = "tnt-jump-settings.strength-reduction-constant";
    public static final String GENERAL_TNT_JUMP_Y_REDUCTION = "tnt-jump-settings.y-axis-reduction-constant";
    public static final String GENERAL_TNT_JUMP_DAMAGE_SELF = "tnt-jump-settings.damage-self";
    public static final String GENERAL_TNT_JUMP_DAMAGE_TEAMMATES = "tnt-jump-settings.damage-teammates";
    public static final String GENERAL_TNT_JUMP_DAMAGE_OTHERS = "tnt-jump-settings.damage-others";
    public static final String GENERAL_TNT_BLAST_PROTECTION = "blast-protection";
    public static final String GENERAL_TNT_PROTECTION_END_STONE_BLAST = "blast-protection.end-stone";
    public static final String GENERAL_TNT_PROTECTION_GLASS_BLAST = "blast-protection.glass";
    public static final String GENERAL_TNT_RAY_BLOCKED_BY_GLASS = "blast-protection.ray-blocked-by-glass";
    public static final String GENERAL_TNT_PRIME = "tnt-prime-settings";
    public static final String GENERAL_TNT_AUTO_IGNITE = "tnt-prime-settings.auto-ignite";
    public static final String GENERAL_TNT_FUSE_TICKS = "tnt-prime-settings.fuse-ticks";
    private static final String GENERAL_FIREBALL_PATH = "fireball";
    public static final String GENERAL_FIREBALL_EXPLOSION_SIZE = "fireball.explosion-size";
    public static final String GENERAL_FIREBALL_SPEED_MULTIPLIER = "fireball.speed-multiplier";
    public static final String GENERAL_FIREBALL_MAKE_FIRE = "fireball.make-fire";
    private static final String GENERAL_FIREBALL_KNOCKBACK_PATH = "fireball.knockback";
    public static final String GENERAL_FIREBALL_KNOCKBACK_VERTICAL = "fireball.knockback.vertical";
    public static final String GENERAL_FIREBALL_KNOCKBACK_HORIZONTAL = "fireball.knockback.horizontal";
    public static final String GENERAL_FIREBALL_COOLDOWN = "fireball.cooldown";
    private static final String GENERAL_FIREBALL_DAMAGE_PATH = "fireball.damage";
    public static final String GENERAL_FIREBALL_DAMAGE_SELF = "fireball.damage.self";
    public static final String GENERAL_FIREBALL_DAMAGE_ENEMY = "fireball.damage.enemy";
    public static final String GENERAL_FIREBALL_DAMAGE_TEAMMATES = "fireball.damage.teammates";
    ...
    public static final String GENERAL_CONFIGURATION_PERFORMANCE_SPOIL_TNT_PLAYERS = "performance-settings.spoil-tnt-players";
    public static final String GENERAL_CONFIGURATION_PERFORMANCE_PAPER_FEATURES = "performance-settings.paper-features";
    private static final String GENERAL_CONFIGURATION_HEAL_POOL = "performance-settings.heal-pool";
    public static final String GENERAL_CONFIGURATION_HEAL_POOL_ENABLE = "performance-settings.heal-pool.enable";
    public static final String GENERAL_CONFIGURATION_HEAL_POOL_SEEN_TEAM_ONLY = "performance-settings.heal-pool.seen-by-team-only";
    ...
    public static final String SHOP_SPECIAL_TOWER_ENABLE = "shop-specials.tower.enable";
    public static final String SHOP_SPECIAL_TOWER_MATERIAL = "shop-specials.tower.material";
