...
implements AutoCloseable {
    ...
    private boolean useWeakThreadLocals() {
        try {
            if (System.getProperty("com.andrei1058.bedwars.libs.hikari.useWeakReferences") != null) {
                return Boolean.getBoolean("com.andrei1058.bedwars.libs.hikari.useWeakReferences");
            }
