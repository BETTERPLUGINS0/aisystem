...
implements VersionedTabGroup {
    ...
    public void add(@NotNull Player player) {
        ...
        this.sidebar.getReceivers().forEach(r -> ((CraftPlayer)r).getHandle().c.a((Packet)packetPlayOutScoreboardTeam));
    }
    ...
    public void sendCreateToPlayer(Player player) {
        ...
        ((CraftPlayer)player).getHandle().c.a((Packet)packetPlayOutScoreboardTeam);
    }
