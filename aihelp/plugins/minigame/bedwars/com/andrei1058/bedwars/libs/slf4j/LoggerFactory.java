...
import com.andrei1058.bedwars.libs.slf4j.helpers.NOP_FallbackServiceProvider;
import com.andrei1058.bedwars.libs.slf4j.helpers.SubstituteLogger;
import com.andrei1058.bedwars.libs.slf4j.helpers.SubstituteServiceProvider;
...
public final class LoggerFactory {
    ...
    private static final String STATIC_LOGGER_BINDER_PATH = "com/andrei1058/bedwars/libs/slf4j/impl/StaticLoggerBinder.class";
    ...
    static SLF4JServiceProvider getProvider() {
        if (INITIALIZATION_STATE == 0) {
            ...
            // MONITORENTER : com.andrei1058.bedwars.libs.slf4j.LoggerFactory.class
            if (INITIALIZATION_STATE == 0) {
