...
implements VersionedTabGroup {
    ...
    public PlayerListImpl(@NotNull WrappedSidebar sidebar, String identifier, SidebarLine prefix, SidebarLine suffix, PlayerTab.PushingRule pushingRule, PlayerTab.NameTagVisibility nameTagVisibility, @javax.annotation.Nullable Collection<PlaceholderProvider> placeholders) {
    ...
    public void add(@NotNull Player player) {
        ...
        this.sidebar.getReceivers().forEach(r -> ((CraftPlayer)r).getHandle().c.b((Packet)packetPlayOutScoreboardTeam));
    }
    ...
    public void sendCreateToPlayer(Player player) {
        ...
        ((CraftPlayer)player).getHandle().c.b((Packet)packetPlayOutScoreboardTeam);
    }
    ...
    public boolean refreshContent() {
        String newPrefix = this.prefix.getTrimReplacePlaceholders(this.getSubject(), 256, this.placeholders);
        String newSuffix = this.suffix.getTrimReplacePlaceholders(this.getSubject(), 256, this.placeholders);
