...
import com.andrei1058.bedwars.libs.sidebar.v1_20_R3.PlayerListImpl;
import com.andrei1058.bedwars.libs.sidebar.v1_20_R3.SidebarImpl;
...
extends SidebarProvider {
    ...
    public void sendScore(@NotNull WrappedSidebar sidebar, String playerName, int score) {
        ...
        PacketPlayOutScoreboardScore packetPlayOutScoreboardScore = new PacketPlayOutScoreboardScore(sidebar.getHealthObjective().getName(), playerName, score, null, null);
