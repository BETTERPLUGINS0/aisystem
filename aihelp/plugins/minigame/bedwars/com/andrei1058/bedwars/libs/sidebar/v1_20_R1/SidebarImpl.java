...
extends WrappedSidebar {
    ...
    Comparable<ScoreLine> {
        ...
        public void sendCreateToAllReceivers() {
            ...
            SidebarImpl.this.getReceivers().forEach(p -> ((CraftPlayer)p).getHandle().c.a((Packet)packetPlayOutScoreboardTeam));
            ...
            SidebarImpl.this.getReceivers().forEach(p -> ((CraftPlayer)p).getHandle().c.a((Packet)packetPlayOutScoreboardScore));
        }
        ...
        public void sendUpdate(Player player) {
            ...
            ((CraftPlayer)player).getHandle().c.a((Packet)packetTeamUpdate);
        }
        ...
        public void sendUpdateToAllReceivers() {
            PacketPlayOutScoreboardTeam packetTeamUpdate = PacketPlayOutScoreboardTeam.a((ScoreboardTeam)this.team, (boolean)false);
            SidebarImpl.this.getReceivers().forEach(r -> ((CraftPlayer)r).getHandle().c.a((Packet)packetTeamUpdate));
        }
        ...
        public void b(int score) {
            ...
            SidebarImpl.this.getReceivers().forEach(r -> ((CraftPlayer)r).getHandle().c.a((Packet)packetPlayOutScoreboardScore));
        }
    ...
    implements SidebarObjective {
        ...
        public void sendUpdate() {
            ...
            SidebarImpl.this.getReceivers().forEach(player -> ((CraftPlayer)player).getHandle().c.a((Packet)packetPlayOutScoreboardObjective));
        }
