...
import com.andrei1058.bedwars.libs.hikari.SQLExceptionOverride;
...
import com.andrei1058.bedwars.libs.hikari.util.DriverDataSource;
import com.andrei1058.bedwars.libs.hikari.util.PropertyElf;
    ...
    void handleMBeans(HikariPool hikariPool, boolean register) {
        ...
        try {
            ...
            if ("true".equals(System.getProperty("hikaricp.jmx.register2.0"))) {
                beanConfigName = new ObjectName("com.andrei1058.bedwars.libs.hikari:type=PoolConfig,name=" + this.poolName);
                beanPoolName = new ObjectName("com.andrei1058.bedwars.libs.hikari:type=Pool,name=" + this.poolName);
            } else {
                beanConfigName = new ObjectName("com.andrei1058.bedwars.libs.hikari:type=PoolConfig (" + this.poolName + ")");
                beanPoolName = new ObjectName("com.andrei1058.bedwars.libs.hikari:type=Pool (" + this.poolName + ")");
            }
            if (register) {
