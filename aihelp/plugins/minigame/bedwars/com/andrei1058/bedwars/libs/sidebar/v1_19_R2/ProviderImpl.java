 ...
 */
package com.andrei1058.bedwars.libs.sidebar.v1_19_R2;
...
import com.andrei1058.bedwars.libs.sidebar.v1_19_R2.PlayerListImpl;
import com.andrei1058.bedwars.libs.sidebar.v1_19_R2.SidebarImpl;
...
extends SidebarProvider {
    ...
    public void sendScore(@NotNull WrappedSidebar sidebar, String playerName, int score) {
        ...
        for (Player player : sidebar.getReceivers()) {
            ...
            playerConnection.a((Packet)packetPlayOutScoreboardScore);
        }
    }
