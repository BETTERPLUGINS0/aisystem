...
extends VersionSupport {
    ...
    public void spawnShop(@NotNull Location loc, String name1, List<Player> players, IArena arena) {
        ...
        for (Player p : players) {
            ...
            if (nume.length == 1) {
                a = v1_18_R2.createArmorStand(nume[0], l.clone().add(0.0, 1.85, 0.0));
                new ShopHolo(Language.getPlayerLanguage(p).getIso(), a, null, l, arena);
                continue;
            }
            a = v1_18_R2.createArmorStand(nume[0], l.clone().add(0.0, 2.1, 0.0));
    ...
    public void registerTntWhitelist(float endStoneBlast, float glassBlast) {
        try {
            ...
            for (Block glass : new Block[]{Blocks.bQ, Blocks.dg, Blocks.dh, Blocks.di, Blocks.dj, Blocks.dk, Blocks.dl, Blocks.dm, Blocks.dn, Blocks.dp, Blocks.dq, Blocks.dr, Blocks.ds, Blocks.dt, Blocks.du, Blocks.dv}) {
