...
extends VersionSupport {
    ...
    public void spawnShop(@NotNull Location loc, String name1, List<Player> players, IArena arena) {
        ...
        for (Player p : players) {
            ...
            if (name.length == 1) {
                a = v1_20_R3.createArmorStand(name[0], l.clone().add(0.0, 1.85, 0.0));
                new ShopHolo(Language.getPlayerLanguage(p).getIso(), a, null, l, arena);
                continue;
            }
            a = v1_20_R3.createArmorStand(name[0], l.clone().add(0.0, 2.1, 0.0));
            ArmorStand b2 = v1_20_R3.createArmorStand(name[1], l.clone().add(0.0, 1.85, 0.0));
    ...
    public ItemStack createItemStack(String material, int amount, short data) {
        ...
        try {
            ...
            this.getPlugin().getLogger().log(Level.WARNING, material + " is not a valid " + v1_20_R3.getName() + " material!");
