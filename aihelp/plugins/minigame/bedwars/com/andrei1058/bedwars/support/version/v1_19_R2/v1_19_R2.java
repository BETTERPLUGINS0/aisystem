 ...
 *  org.bukkit.craftbukkit.v1_19_R2.entity.CraftFireball
 *  org.bukkit.craftbukkit.v1_19_R2.entity.CraftLivingEntity
 *  org.bukkit.craftbukkit.v1_19_R2.entity.CraftPlayer
 *  org.bukkit.craftbukkit.v1_19_R2.entity.CraftTNTPrimed
...
extends VersionSupport {
    ...
    public void spawnShop(@NotNull Location loc, String name1, List<Player> players, IArena arena) {
        ...
        for (Player p : players) {
            ...
            if (name.length == 1) {
                a = v1_19_R2.createArmorStand(name[0], l.clone().add(0.0, 1.85, 0.0));
                new ShopHolo(Language.getPlayerLanguage(p).getIso(), a, null, l, arena);
                continue;
            }
            a = v1_19_R2.createArmorStand(name[0], l.clone().add(0.0, 2.1, 0.0));
            ArmorStand b2 = v1_19_R2.createArmorStand(name[1], l.clone().add(0.0, 1.85, 0.0));
    ...
    public void voidKill(Player p) {
        this.getPlayer(p).a(DamageSource.m, 1000.0f);
    }
    ...
    public ItemStack createItemStack(String material, int amount, short data) {
        ...
        try {
            ...
            this.getPlugin().getLogger().log(Level.WARNING, material + " is not a valid " + v1_19_R2.getName() + " material!");
