 ...
 *  org.bukkit.craftbukkit.v1_20_R2.entity.CraftFireball
 *  org.bukkit.craftbukkit.v1_20_R2.entity.CraftLivingEntity
 *  org.bukkit.craftbukkit.v1_20_R2.entity.CraftPlayer
 *  org.bukkit.craftbukkit.v1_20_R2.entity.CraftTNTPrimed
...
extends VersionSupport {
    ...
    public void hideEntity(@NotNull Entity e, Player p) {
        ...
        this.sendPacket(p, (Packet<?>)packet);
    }
    ...
    public void spawnShop(@NotNull Location loc, String name1, List<Player> players, IArena arena) {
        ...
        for (Player p : players) {
            ...
            if (name.length == 1) {
                a = v1_20_R2.createArmorStand(name[0], l.clone().add(0.0, 1.85, 0.0));
                new ShopHolo(Language.getPlayerLanguage(p).getIso(), a, null, l, arena);
                continue;
            }
            a = v1_20_R2.createArmorStand(name[0], l.clone().add(0.0, 2.1, 0.0));
            ArmorStand b2 = v1_20_R2.createArmorStand(name[1], l.clone().add(0.0, 1.85, 0.0));
    ...
    public void hideArmor(@NotNull Player victim, Player receiver) {
        ...
        this.sendPacket(receiver, (Packet<?>)packet1);
    }
    ...
    public void registerTntWhitelist(float endStoneBlast, float glassBlast) {
        try {
            ...
            field.set(Blocks.fz, Float.valueOf(endStoneBlast));
            field.set(Blocks.aQ, Float.valueOf(glassBlast));
            Block[] coloredGlass = new Block[]{Blocks.ej, Blocks.ek, Blocks.el, Blocks.em, Blocks.en, Blocks.eo, Blocks.ep, Blocks.eq, Blocks.er, Blocks.es, Blocks.et, Blocks.eu, Blocks.ev, Blocks.ew, Blocks.ex, Blocks.ey, Blocks.qB};
    ...
    public ItemStack createItemStack(String material, int amount, short data) {
        ...
        try {
            ...
            this.getPlugin().getLogger().log(Level.WARNING, material + " is not a valid " + v1_20_R2.getName() + " material!");
    ...
    public void sendPlayerSpawnPackets(Player respawned, IArena arena) {
        ...
        PacketPlayOutSpawnEntity show = new PacketPlayOutSpawnEntity((net.minecraft.world.entity.Entity)entityPlayer);
        ...
        for (Player p : arena.getPlayers()) {
            ...
            this.sendPackets(p, new Packet[]{show, head, playerVelocity, new PacketPlayOutEntityEquipment(respawned.getEntityId(), list)});
            if (p.hasPotionEffect(PotionEffectType.INVISIBILITY)) {
                this.hideArmor(p, respawned);
                continue;
            }
            PacketPlayOutSpawnEntity show2 = new PacketPlayOutSpawnEntity((net.minecraft.world.entity.Entity)boundTo);
            ...
            this.sendPackets(respawned, new Packet[]{show2, playerVelocity2, head2});
        ...
        for (Player spectator : arena.getSpectators()) {
            ...
            this.sendPackets(spectator, new Packet[]{show, playerVelocity, new PacketPlayOutEntityEquipment(respawned.getEntityId(), list), new PacketPlayOutEntityHeadRotation((net.minecraft.world.entity.Entity)entityPlayer, this.getCompressedAngle(entityPlayer.getBukkitYaw()))});
        }
    }
    ...
    public void playRedStoneDot(@NotNull Player player) {
        ...
        for (Player inWorld : player.getWorld().getPlayers()) {
            ...
            this.sendPacket(inWorld, (Packet<?>)particlePacket);
        }
    }
