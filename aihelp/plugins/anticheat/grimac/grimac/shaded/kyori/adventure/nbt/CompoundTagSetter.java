...
public interface CompoundTagSetter<R> {
   ...
   @NotNull
   default R putByteArray(@NotNull final String key, @NotNull final byte[] value) {
   ...
   @NotNull
   default R putIntArray(@NotNull final String key, @NotNull final int[] value) {
      return this.put(key, IntArrayBinaryTag.intArrayBinaryTag(value));
   }

   @NotNull
   default R putLongArray(@NotNull final String key, @NotNull final long[] value) {
