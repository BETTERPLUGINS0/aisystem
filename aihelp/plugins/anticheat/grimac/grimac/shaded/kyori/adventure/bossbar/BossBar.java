...
public interface BossBar extends Examinable {
   ...
   public static enum Color {
      ...
      // $FF: synthetic method
      private static BossBar.Color[] $values() {
   ...
   public static enum Overlay {
      ...
      // $FF: synthetic method
      private static BossBar.Overlay[] $values() {
         return new BossBar.Overlay[]{PROGRESS, NOTCHED_6, NOTCHED_10, NOTCHED_12, NOTCHED_20};
      }
   }
   ...
   public static enum Flag {
      ...
      // $FF: synthetic method
      private static BossBar.Flag[] $values() {
         return new BossBar.Flag[]{DARKEN_SCREEN, PLAY_BOSS_MUSIC, CREATE_WORLD_FOG};
      }
   }
