...
class BukkitFacet<V extends CommandSender> extends FacetBase<V> {
   ...
   static final class PlayerPointers extends BukkitFacet<Player> implements Facet.Pointers<Player> {
      ...
      public void contributePointers(final Player viewer, final ac.grim.grimac.shaded.kyori.adventure.pointer.Pointers.Builder builder) {
      ...
      static {
         MethodHandle asLocale = MinecraftReflection.findMethod(Player.class, "getLocale", Locale.class);
         MethodHandle asString = MinecraftReflection.findMethod(Player.class, "getLocale", String.class);
   ...
   static final class ConsoleCommandSenderPointers extends BukkitFacet<ConsoleCommandSender> implements Facet.Pointers<ConsoleCommandSender> {
      ...
      public void contributePointers(final ConsoleCommandSender viewer, final ac.grim.grimac.shaded.kyori.adventure.pointer.Pointers.Builder builder) {
   ...
   static final class CommandSenderPointers extends BukkitFacet<CommandSender> implements Facet.Pointers<CommandSender> {
      ...
      public void contributePointers(final CommandSender viewer, final ac.grim.grimac.shaded.kyori.adventure.pointer.Pointers.Builder builder) {
   ...
   static class BossBar extends BukkitFacet.Message<Player> implements Facet.BossBar<Player> {
      ...
      public void bossBarProgressChanged(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar, final float oldPercent, final float newPercent) {
         this.bar.setProgress((double)newPercent);
      }

      public void bossBarColorChanged(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar, @NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color oldColor, @NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color newColor) {
      ...
      @Nullable
      private BarColor color(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color color) {
         if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.PINK) {
            return BarColor.PINK;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.BLUE) {
            return BarColor.BLUE;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.RED) {
            return BarColor.RED;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.GREEN) {
            return BarColor.GREEN;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.YELLOW) {
            return BarColor.YELLOW;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.PURPLE) {
            return BarColor.PURPLE;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.WHITE) {
      ...
      public void bossBarOverlayChanged(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar, @NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay oldOverlay, @NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay newOverlay) {
      ...
      @Nullable
      private BarStyle style(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay overlay) {
         if (overlay == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay.PROGRESS) {
            return BarStyle.SOLID;
         } else if (overlay == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay.NOTCHED_6) {
            return BarStyle.SEGMENTED_6;
         } else if (overlay == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay.NOTCHED_10) {
            return BarStyle.SEGMENTED_10;
         } else if (overlay == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay.NOTCHED_12) {
            return BarStyle.SEGMENTED_12;
         } else if (overlay == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay.NOTCHED_20) {
      ...
      public void bossBarFlagsChanged(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar, @NotNull final Set<ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag> flagsAdded, @NotNull final Set<ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag> flagsRemoved) {
         Iterator var4 = flagsRemoved.iterator();

         ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag addFlag;
         BarFlag flag;
         while(var4.hasNext()) {
            addFlag = (ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag)var4.next();
      ...
      @Nullable
      private BarFlag flag(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag flag) {
         if (flag == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag.DARKEN_SCREEN) {
            return BarFlag.DARKEN_SKY;
         } else if (flag == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag.PLAY_BOSS_MUSIC) {
            return BarFlag.PLAY_BOSS_MUSIC;
         } else if (flag == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag.CREATE_WORLD_FOG) {
   ...
   static class SoundWithCategory extends BukkitFacet.Sound {
      ...
      public void playSound(@NotNull final Player viewer, @NotNull final ac.grim.grimac.shaded.kyori.adventure.sound.Sound sound, @NotNull final Vector vector) {
      ...
      @Nullable
      private SoundCategory category(@Nullable final ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source source) {
         if (source == null) {
            return null;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.MASTER) {
            return SoundCategory.MASTER;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.MUSIC) {
            return SoundCategory.MUSIC;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.RECORD) {
            return SoundCategory.RECORDS;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.WEATHER) {
            return SoundCategory.WEATHER;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.BLOCK) {
            return SoundCategory.BLOCKS;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.HOSTILE) {
            return SoundCategory.HOSTILE;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.NEUTRAL) {
            return SoundCategory.NEUTRAL;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.PLAYER) {
            return SoundCategory.PLAYERS;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.AMBIENT) {
            return SoundCategory.AMBIENT;
         } else if (source == ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Source.VOICE) {
