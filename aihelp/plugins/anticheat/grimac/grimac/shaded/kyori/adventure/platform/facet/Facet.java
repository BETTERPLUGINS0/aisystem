...
public interface Facet<V> {
   ...
   public interface Pointers<V> extends Facet<V> {
      void contributePointers(final V viewer, final ac.grim.grimac.shaded.kyori.adventure.pointer.Pointers.Builder builder);
   }
   ...
   public interface BossBarEntity<V, P> extends Facet.BossBar<V>, Facet.FakeEntity<V, P> {
      ...
      default void bossBarProgressChanged(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar, final float oldProgress, final float newProgress) {
         this.health(newProgress);
      }

      default void bossBarNameChanged(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar, @NotNull final Component oldName, @NotNull final Component newName) {
         this.name(newName);
      }
   ...
   public interface BossBarPacket<V> extends Facet.BossBar<V> {
      ...
      default int createColor(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color color) {
         if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.PURPLE) {
            return 5;
         } else if (color == ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Color.PINK) {
            return 0;
      ...
      default int createOverlay(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Overlay overlay) {
      ...
      default byte createFlag(final byte flagBit, @NotNull final Set<ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag> flagsAdded, @NotNull final Set<ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag> flagsRemoved) {
         byte bit = flagBit;
         Iterator var5 = flagsAdded.iterator();

         ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag flag;
         while(var5.hasNext()) {
            flag = (ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Flag)var5.next();
   ...
   public interface BossBar<V> extends ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar.Listener, Closeable {
      int PROTOCOL_BOSS_BAR = 356;

      default void bossBarInitialized(@NotNull final ac.grim.grimac.shaded.kyori.adventure.bossbar.BossBar bar) {
   ...
   public interface EntitySound<V, M> extends Facet<V> {
      M createForSelf(final V viewer, @NotNull final ac.grim.grimac.shaded.kyori.adventure.sound.Sound sound);

      M createForEmitter(@NotNull final ac.grim.grimac.shaded.kyori.adventure.sound.Sound sound, @NotNull final ac.grim.grimac.shaded.kyori.adventure.sound.Sound.Emitter emitter);

      void playSound(@NotNull final V viewer, final M message);
   }

   public interface Sound<V, P> extends Facet.Position<V, P> {
      void playSound(@NotNull final V viewer, @NotNull final ac.grim.grimac.shaded.kyori.adventure.sound.Sound sound, @NotNull final P position);
