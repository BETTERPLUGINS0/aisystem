...
final class MiniMessageSerializer {
   ...
   static final class Collector implements TokenEmitter, ClaimConsumer {
      ...
      @Nullable
      Component flushClaims(final Component component) {
         Component ret = null;
         if (this.componentClaim != null) {
      ...
      static enum TagState {
         ...
         // $FF: synthetic method
         private static MiniMessageSerializer.Collector.TagState[] $values() {
            return new MiniMessageSerializer.Collector.TagState[]{TEXT, MID, MID_SELF_CLOSING};
         }
      }
   }
}
