...
public interface Component extends ComponentBuilderApplicable, ComponentLike, Examinable, HoverEventSource<Component>, StyleGetter, StyleSetter<Component> {
   ...
   @NotNull
   static Component join(@NotNull final JoinConfiguration.Builder configBuilder, @NotNull final ComponentLike... components) {
   ...
   @NotNull
   static Component join(@NotNull final JoinConfiguration.Builder configBuilder, @NotNull final Iterable<? extends ComponentLike> components) {
   ...
   @Contract("_ -> new")
   @NotNull
   static ObjectComponent object(@NotNull final Consumer<? super ObjectComponent.Builder> consumer) {
      return (ObjectComponent)AbstractBuilder.configureAndBuild(object(), consumer);
   }
   ...
   @NotNull
   static ObjectComponent object(@NotNull final ObjectContents objectContents) {
   ...
   @NotNull
   static <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer) {
   ...
   @NotNull
   static <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer, @NotNull final Style style) {
      Objects.requireNonNull(contextType, "context type");
      Objects.requireNonNull(renderer, "renderer");
   ...
   @NotNull
   static <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer, @NotNull final StyleBuilderApplicable... style) {
      Objects.requireNonNull(contextType, "context type");
      Objects.requireNonNull(renderer, "renderer");
   ...
   @NotNull
   static <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer, @NotNull final Iterable<StyleBuilderApplicable> style) {
      Objects.requireNonNull(contextType, "context type");
      Objects.requireNonNull(renderer, "renderer");
      return VirtualComponentImpl.createVirtual(contextType, renderer, Collections.emptyList(), Style.style(style));
   }
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final Style style) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final StyleBuilderApplicable... style) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Iterable<StyleBuilderApplicable> style) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final ComponentLike... args) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final ComponentLike... args) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final Style style, @NotNull final ComponentLike... args) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style, @NotNull final ComponentLike... args) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args) {
      return translatable(((Translatable)Objects.requireNonNull(translatable, "translatable")).translationKey(), fallback, style, args);
   }
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final Iterable<StyleBuilderApplicable> style) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final Iterable<StyleBuilderApplicable> style) {
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final StyleBuilderApplicable... style) {
      return TranslatableComponentImpl.create(Collections.emptyList(), Style.style(style), key, fallback, (List)Objects.requireNonNull(args, "args"));
   }
   ...
   @NotNull
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final StyleBuilderApplicable... style) {
      return translatable(((Translatable)Objects.requireNonNull(translatable, "translatable")).translationKey(), fallback, args, style);
   }
   ...
   default Component append(@NotNull final ComponentLike... components) {
      if (components.length == 0) {
         ...
         List<ComponentLike> newChildren = new ArrayList(components.length + this.children().size());
   ...
   default Component append(@NotNull final List<? extends ComponentLike> components) {
      if (components.isEmpty()) {
         ...
         List<ComponentLike> newChildren = new ArrayList(components.size() + this.children().size());
         newChildren.addAll(this.children());
   ...
   default Component shadowColorIfAbsent(@Nullable final ARGBLike argb) {
      return this.shadowColor() == null ? this.shadowColor(argb) : this;
   }
   ...
   default Component compact() {
      return this.compact((Style)null);
   }

   @ScopedComponentOverrideNotRequired
   @NotNull
   default Component compact(@Nullable final Style parentStyle) {
