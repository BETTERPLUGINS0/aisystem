...
final class BinaryTagWriterImpl implements BinaryTagIO.Writer {
   ...
   public void writeNameless(@NotNull final CompoundBinaryTag tag, @NotNull final Path path, @NotNull final BinaryTagIO.Compression compression) throws IOException {
      OutputStream os = Files.newOutputStream(path);
   ...
   public void writeNameless(@NotNull final CompoundBinaryTag tag, @NotNull final OutputStream output, @NotNull final BinaryTagIO.Compression compression) throws IOException {
      DataOutputStream dos = new DataOutputStream(new BufferedOutputStream(compression.compress(IOStreamUtil.closeShield(output))));
