...
public final class TokenParser {
   ...
   static enum FirstPassState {
      ...
      // $FF: synthetic method
      private static TokenParser.FirstPassState[] $values() {
         return new TokenParser.FirstPassState[]{NORMAL, TAG, STRING};
      }
   }
   ...
   static enum SecondPassState {
      ...
      // $FF: synthetic method
      private static TokenParser.SecondPassState[] $values() {
         return new TokenParser.SecondPassState[]{NORMAL, STRING};
      }
   }
}
