...
import ac.grim.grimac.shaded.fastutil.objects.AbstractObjectCollection;
import ac.grim.grimac.shaded.fastutil.objects.AbstractObjectSet;
import ac.grim.grimac.shaded.fastutil.objects.ObjectCollection;
...
public class Long2ObjectOpenHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public void forEach(Consumer<? super V> consumer) {
               ...
               V[] value = Long2ObjectOpenHashMap.this.value;
               if (Long2ObjectOpenHashMap.this.containsNullKey) {
                  consumer.accept(value[Long2ObjectOpenHashMap.this.n]);
               }
   ...
   public int hashCode() {
      ...
      for(boolean var6 = false; j-- != 0; ++i) {
         ...
         int t = HashCommon.long2int(key[i]);
         if (this != value[i]) {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public void forEach(java.util.function.LongConsumer consumer) {
         long[] key = Long2ObjectOpenHashMap.this.key;
         if (Long2ObjectOpenHashMap.this.containsNullKey) {
            consumer.accept(key[Long2ObjectOpenHashMap.this.n]);
         }
   ...
   private final class ValueSpliterator extends Long2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Long2ObjectOpenHashMap<V>.ValueSpliterator> implements ObjectSpliterator<V> {
   ...
   private final class KeySpliterator extends Long2ObjectOpenHashMap<V>.MapSpliterator<java.util.function.LongConsumer, Long2ObjectOpenHashMap<V>.KeySpliterator> implements LongSpliterator {
   ...
   private final class EntrySpliterator extends Long2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Long2ObjectMap.Entry<V>>, Long2ObjectOpenHashMap<V>.EntrySpliterator> implements ObjectSpliterator<Long2ObjectMap.Entry<V>> {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      private void shiftKeys(int pos) {
         long[] key = Long2ObjectOpenHashMap.this.key;
         Object[] value = Long2ObjectOpenHashMap.this.value;
   ...
   final class MapEntry implements Long2ObjectMap.Entry<V>, java.util.Map.Entry<Long, V>, LongObjectPair<V> {
      int index;
