...
import ac.grim.grimac.shaded.fastutil.bytes.ByteSpliterator;
import ac.grim.grimac.shaded.fastutil.chars.CharSpliterator;
import ac.grim.grimac.shaded.fastutil.floats.FloatSpliterator;
import ac.grim.grimac.shaded.fastutil.ints.IntSpliterator;
import ac.grim.grimac.shaded.fastutil.shorts.ShortSpliterator;
...
public final class DoubleSpliterators {
   ...
   public static DoubleSpliterator asDoubleSpliterator(Spliterator i) {
      if (i instanceof DoubleSpliterator) {
         ...
         return (DoubleSpliterator)(i instanceof OfDouble ? new DoubleSpliterators.PrimitiveSpliteratorWrapper((OfDouble)i) : new DoubleSpliterators.SpliteratorWrapper(i));
      }
   }
   ...
   public static DoubleSpliterator asDoubleSpliterator(Spliterator i, DoubleComparator comparatorOverride) {
      if (i instanceof DoubleSpliterator) {
         ...
         return (DoubleSpliterator)(i instanceof OfDouble ? new DoubleSpliterators.PrimitiveSpliteratorWrapperWithComparator((OfDouble)i, comparatorOverride) : new DoubleSpliterators.SpliteratorWrapperWithComparator(i, comparatorOverride));
      }
   }
   ...
   private static class ArraySpliterator implements DoubleSpliterator {
      ...
      public void forEachRemaining(java.util.function.DoubleConsumer action) {
         ...
         for(double[] array = this.array; this.curr < this.length; ++this.curr) {
      ...
      public long skip(long n) {
         if (n < 0L) {
            ...
            if (this.iter instanceof DoubleBigListIterator) {
               skippedSoFar = ((DoubleBigListIterator)this.iter).skip(n);
