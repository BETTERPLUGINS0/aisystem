...
public abstract class AbstractFloatList extends AbstractFloatCollection implements FloatList, FloatStack {
   ...
   public int indexOf(float k) {
      ...
      do {
         ...
         e = i.nextFloat();
      } while(Float.floatToIntBits(k) != Float.floatToIntBits(e));
   ...
   public FloatList subList(int from, int to) {
      ...
      if (from > to) {
         ...
         return (FloatList)(this instanceof RandomAccess ? new AbstractFloatList.FloatRandomAccessSubList(this, from, to) : new AbstractFloatList.FloatSubList(this, from, to));
      }
   }
   ...
   public void getElements(int from, float[] a, int offset, int length) {
      ...
      if (from + length > this.size()) {
         ...
         if (this instanceof RandomAccess) {
            for(int var5 = from; length-- != 0; a[offset++] = this.getFloat(var5++)) {
            }
         } else {
   ...
   public int hashCode() {
      ...
      float k;
      for(int var3 = this.size(); var3-- != 0; h = 31 * h + HashCommon.float2int(k)) {
         k = i.nextFloat();
      }
      ...
      if (o == this) {
         ...
         if (s != l.size()) {
            ...
            if (l instanceof FloatList) {
               ...
               } while(i1.nextFloat() == i2.nextFloat());
   ...
   public static class FloatSubList extends AbstractFloatList implements Serializable {
      ...
      public FloatListIterator listIterator(int index) {
         this.ensureIndex(index);
         return (FloatListIterator)(this.l instanceof RandomAccess ? new AbstractFloatList.FloatSubList.RandomAccessIter(index) : new AbstractFloatList.FloatSubList.ParentWrappingIter(this.l.listIterator(index + this.from)));
      }

      public FloatSpliterator spliterator() {
         return (FloatSpliterator)(this.l instanceof RandomAccess ? new AbstractFloatList.IndexBasedSpliterator(this.l, this.from, this.to) : super.spliterator());
      }
      ...
      private class ParentWrappingIter implements FloatListIterator {
         ...
         ParentWrappingIter(FloatListIterator param2) {
            this.parent = parent;
         }
