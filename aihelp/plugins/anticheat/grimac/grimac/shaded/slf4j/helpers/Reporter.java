...
public class Reporter {
   ...
   private static enum TargetChoice {
      ...
      // $FF: synthetic method
      private static Reporter.TargetChoice[] $values() {
         return new Reporter.TargetChoice[]{Stderr, Stdout};
      }
   }
   ...
   private static enum Level {
      ...
      // $FF: synthetic method
      private static Reporter.Level[] $values() {
         return new Reporter.Level[]{DEBUG, INFO, WARN, ERROR};
      }
   }
}
