...
public final class EntityPositionData {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof EntityPositionData)) {
         return false;
      } else {
         ...
         if (Float.compare(that.yaw, this.yaw) != 0) {
            ...
            return !this.position.equals(that.position) ? false : this.deltaMovement.equals(that.deltaMovement);
         }
      }
   }

   public int hashCode() {
      return Objects.hash(new Object[]{this.position, this.deltaMovement, this.yaw, this.pitch});
   }
