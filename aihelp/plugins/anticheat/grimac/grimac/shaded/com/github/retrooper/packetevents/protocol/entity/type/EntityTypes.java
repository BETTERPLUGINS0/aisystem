...
public final class EntityTypes {
   ...
   public static final EntityType ENTITY = define("entity", (EntityType)null);
   ...
   public static final EntityType ABSTRACT_WIND_CHARGE;
   ...
   @ApiStatus.Obsolete
   public static final EntityType CREAKING_TRANSIENT;
   ...
   public static final EntityType ABSTRACT_NAUTILUS;
   ...
   public static EntityType define(String name, @Nullable EntityType parent) {
      StaticEntityType type = (StaticEntityType)REGISTRY.define(name, (data) -> {
         return new StaticEntityType(data, parent);
      });
      VersionedRegistry var10000 = LEGACY_SPAWN_REGISTRY;
      Objects.requireNonNull(type);
      return (EntityType)var10000.define(name, type::setLegacyData);
   }
   ...
   public static EntityType getByName(String name) {
      return (EntityType)REGISTRY.getByName(name);
   }

   public static EntityType getById(ClientVersion version, int id) {
      return (EntityType)REGISTRY.getById(version, id);
   }

   @ApiStatus.Obsolete
   public static EntityType getByLegacyId(ClientVersion version, int id) {
      return version.isNewerThanOrEquals(ClientVersion.V_1_14) ? null : (EntityType)LEGACY_SPAWN_REGISTRY.getById(version, id);
   }
   ...
   static {
      ...
      AVATAR = define("avatar", LIVINGENTITY);
      ...
      ABSTRACT_WIND_CHARGE = define("abstract_wind_charge", PROJECTILE_ABSTRACT);
      WIND_CHARGE = define("wind_charge", ABSTRACT_WIND_CHARGE);
      ARMADILLO = define("armadillo", ABSTRACT_ANIMAL);
      BOGGED = define("bogged", ABSTRACT_SKELETON);
      BREEZE_WIND_CHARGE = define("breeze_wind_charge", ABSTRACT_WIND_CHARGE);
      OMINOUS_ITEM_SPAWNER = define("ominous_item_spawner", ENTITY);
      ACACIA_BOAT = define("acacia_boat", BOAT);
      ACACIA_CHEST_BOAT = define("acacia_chest_boat", CHEST_BOAT);
      BAMBOO_CHEST_RAFT = define("bamboo_chest_raft", CHEST_BOAT);
      BAMBOO_RAFT = define("bamboo_raft", BOAT);
      BIRCH_BOAT = define("birch_boat", BOAT);
      BIRCH_CHEST_BOAT = define("birch_chest_boat", CHEST_BOAT);
      CHERRY_BOAT = define("cherry_boat", BOAT);
      CHERRY_CHEST_BOAT = define("cherry_chest_boat", CHEST_BOAT);
      CREAKING = define("creaking", ABSTRACT_MONSTER);
      CREAKING_TRANSIENT = define("creaking_transient", CREAKING);
      DARK_OAK_BOAT = define("dark_oak_boat", BOAT);
      DARK_OAK_CHEST_BOAT = define("dark_oak_chest_boat", CHEST_BOAT);
      JUNGLE_BOAT = define("jungle_boat", BOAT);
      JUNGLE_CHEST_BOAT = define("jungle_chest_boat", CHEST_BOAT);
      MANGROVE_BOAT = define("mangrove_boat", BOAT);
      MANGROVE_CHEST_BOAT = define("mangrove_chest_boat", CHEST_BOAT);
      OAK_BOAT = define("oak_boat", BOAT);
      OAK_CHEST_BOAT = define("oak_chest_boat", CHEST_BOAT);
      PALE_OAK_BOAT = define("pale_oak_boat", BOAT);
      PALE_OAK_CHEST_BOAT = define("pale_oak_chest_boat", CHEST_BOAT);
      SPRUCE_BOAT = define("spruce_boat", BOAT);
      SPRUCE_CHEST_BOAT = define("spruce_chest_boat", CHEST_BOAT);
      SPLASH_POTION = define("splash_potion", POTION);
      LINGERING_POTION = define("lingering_potion", POTION);
      HAPPY_GHAST = define("happy_ghast", ABSTRACT_ANIMAL);
      COPPER_GOLEM = define("copper_golem", ABSTRACT_GOLEM);
      MANNEQUIN = define("mannequin", AVATAR);
      CAMEL_HUSK = define("camel_husk", CAMEL);
      ABSTRACT_NAUTILUS = define("abstract_nautilus", ABSTRACT_TAMEABLE_ANIMAL);
      NAUTILUS = define("nautilus", ABSTRACT_NAUTILUS);
      PARCHED = define("parched", ABSTRACT_SKELETON);
      ZOMBIE_NAUTILUS = define("zombie_nautilus", ABSTRACT_NAUTILUS);
