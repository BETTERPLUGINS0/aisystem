...
public final class Sounds {
   ...
   public static Sound define(String name) {
      return define(name, new ResourceLocation(name), (Float)null);
   }

   @ApiStatus.Internal
   public static Sound define(String name, ResourceLocation soundId, @Nullable Float range) {
      return (Sound)REGISTRY.define(name, (data) -> {
         return new StaticSound(data, soundId, range);
      });
   }

   public static Sound getByNameOrCreate(String name) {
      Sound builtinSound = getByName(name);
      return (Sound)(builtinSound == null ? new StaticSound(new ResourceLocation(name), (Float)null) : builtinSound);
   }

   @Nullable
   public static Sound getByName(String name) {
      return (Sound)REGISTRY.getByName(name);
   }

   @Nullable
   public static Sound getById(ClientVersion version, int id) {
      return (Sound)REGISTRY.getById(version, id);
   }
