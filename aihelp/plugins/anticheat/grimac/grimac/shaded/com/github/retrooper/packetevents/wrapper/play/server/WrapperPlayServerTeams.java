...
public class WrapperPlayServerTeams extends PacketWrapper<WrapperPlayServerTeams> {
      ...
      if (this.teamMode == WrapperPlayServerTeams.TeamMode.CREATE || this.teamMode == WrapperPlayServerTeams.TeamMode.UPDATE) {
         ...
         if (this.serverVersion.isOlderThanOrEquals(ServerVersion.V_1_12_2)) {
            ...
            if (this.serverVersion.isNewerThanOrEquals(ServerVersion.V_1_21_5)) {
               nameTagVisibility = (WrapperPlayServerTeams.NameTagVisibility)this.readEnum(WrapperPlayServerTeams.NameTagVisibility.class);
               collisionRule = (WrapperPlayServerTeams.CollisionRule)this.readEnum(WrapperPlayServerTeams.CollisionRule.class);
            } else {
         ...
         info = new WrapperPlayServerTeams.ScoreBoardTeamInfo((Component)displayName, (Component)prefix, (Component)suffix, nameTagVisibility, collisionRule == null ? WrapperPlayServerTeams.CollisionRule.ALWAYS : collisionRule, color, optionData);
      }
   ...
   public static enum OptionData {
      ...
      public static WrapperPlayServerTeams.OptionData fromValue(byte value) {
         WrapperPlayServerTeams.OptionData[] var1 = VALUES;
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            WrapperPlayServerTeams.OptionData data = var1[var3];
   ...
   public static enum NameTagVisibility {
      ...
      public static WrapperPlayServerTeams.NameTagVisibility fromID(String id) {
         WrapperPlayServerTeams.NameTagVisibility[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            WrapperPlayServerTeams.NameTagVisibility value = var1[var3];
   ...
   public static enum CollisionRule {
      ...
      public static WrapperPlayServerTeams.CollisionRule fromID(String id) {
         WrapperPlayServerTeams.CollisionRule[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            WrapperPlayServerTeams.CollisionRule value = var1[var3];
            if (value.id.equalsIgnoreCase(id)) {
               return value;
            }
         }
