...
public final class Serializer {
   ...
   private void anchorNode(Node node) {
      ...
      if (this.anchors.containsKey(node)) {
         ...
         case mapping:
            ...
            while(var6.hasNext()) {
               NodeTuple object = (NodeTuple)var6.next();
      ...
      if (this.serializedNodes.contains(node)) {
         ...
         default:
            ...
            if (mnode.getTag() != Tag.COMMENT) {
               ...
               while(var16.hasNext()) {
                  NodeTuple row = (NodeTuple)var16.next();
   ...
   private void serializeComments(List<CommentLine> comments) throws IOException {
      if (comments != null) {
         ...
         while(var2.hasNext()) {
            CommentLine line = (CommentLine)var2.next();
