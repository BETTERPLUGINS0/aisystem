...
import ac.grim.grimac.shaded.snakeyaml.events.CollectionEndEvent;
...
public final class Emitter implements Emitable {
   ...
   static String prepareAnchor(String anchor) {
      if (anchor.length() == 0) {
         ...
         Iterator var1 = INVALID_ANCHOR.iterator();
   ...
   private boolean writeCommentLines(List<CommentLine> commentLines) throws IOException {
      ...
      if (this.emitComments) {
         ...
         for(Iterator var5 = commentLines.iterator(); var5.hasNext(); wroteComment = true) {
            CommentLine commentLine = (CommentLine)var5.next();
