      ...
      if (className == null) {
         ...
         try {
            ...
            if (loaded == null) {
               ...
               LOGGER.debug((String)"Class {} loaded from classloader {}", (Object)className, (Object)UtilityElf.class.getClassLoader());
            }
   ...
   private static Class<?> attemptFromContextLoader(String className) {
      ...
      if (threadContextClassLoader != null) {
         try {
            ...
            LOGGER.debug((String)"Class {} found in Thread context class loader {}", (Object)className, (Object)threadContextClassLoader);
            return clazz;
         } catch (ClassNotFoundException var3) {
            LOGGER.debug("Class {} not found in Thread context class loader {}, trying classloader {}", className, threadContextClassLoader, UtilityElf.class.getClassLoader());
         }
      }
