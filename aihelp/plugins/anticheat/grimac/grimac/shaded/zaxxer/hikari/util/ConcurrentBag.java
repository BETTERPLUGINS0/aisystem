...
public class ConcurrentBag<T extends ConcurrentBag.IConcurrentBagEntry> implements AutoCloseable {
   ...
   private boolean useWeakThreadLocals() {
      try {
         if (System.getProperty("ac.grim.grimac.shaded.zaxxer.hikari.useWeakReferences") != null) {
            return Boolean.getBoolean("ac.grim.grimac.shaded.zaxxer.hikari.useWeakReferences");
         } else {
