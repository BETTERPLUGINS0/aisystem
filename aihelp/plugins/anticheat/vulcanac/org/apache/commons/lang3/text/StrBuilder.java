...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
   ...
   public int readFrom(Readable var1) {
      int var2 = this.size;
      int var4;
   ...
   public StrBuilder appendWithSeparators(Object[] var1, String var2) {
      if (var1 != null && var1.length > 0) {
         String var3 = Objects.toString(var2, "");
         this.append(var1[0]);
   ...
   private StrBuilder replaceImpl(StrMatcher var1, String var2, int var3, int var4, int var5) {
      if (var1 != null && this.size != 0) {
         ...
         for(int var7 = var3; var7 < var4 && var5 != 0; ++var7) {
            char[] var8 = this.buffer;
            int var9 = var1.isMatch(var8, var7, var3, var4);
            if (var9 > 0) {
               this.replaceImpl(var7, var7 + var9, var9, var2, var6);
               var4 = var4 - var9 + var6;
               var7 = var7 + var6 - 1;
               if (var5 > 0) {
                  --var5;
