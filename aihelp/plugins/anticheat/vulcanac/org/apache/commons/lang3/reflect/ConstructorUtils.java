...
public class ConstructorUtils {
   public static <T> T invokeConstructor(Class<T> var0, Object... var1) {
      var1 = ArrayUtils.nullToEmpty(var1);
      Class[] var2 = ClassUtils.toClass(var1);
      return invokeConstructor(var0, var1, var2);
   }

   public static <T> T invokeConstructor(Class<T> var0, Object[] var1, Class<?>[] var2) {
      var1 = ArrayUtils.nullToEmpty(var1);
   ...
   public static <T> T invokeExactConstructor(Class<T> var0, Object... var1) {
      var1 = ArrayUtils.nullToEmpty(var1);
      Class[] var2 = ClassUtils.toClass(var1);
      return invokeExactConstructor(var0, var1, var2);
   }

   public static <T> T invokeExactConstructor(Class<T> var0, Object[] var1, Class<?>[] var2) {
      var1 = ArrayUtils.nullToEmpty(var1);
      var2 = ArrayUtils.nullToEmpty(var2);
