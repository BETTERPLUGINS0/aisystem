...
public class EnumUtils {
   ...
   public static <E extends Enum<E>> long generateBitVector(Class<E> var0, Iterable<? extends E> var1) {
      ...
      for(Iterator var4 = var1.iterator(); var4.hasNext(); var2 |= 1L << var5.ordinal()) {
         var5 = (Enum)var4.next();
         Validate.notNull(var5, "null elements not permitted");
      }
   ...
   public static <E extends Enum<E>> long[] generateBitVectors(Class<E> var0, Iterable<? extends E> var1) {
      ...
      while(var3.hasNext()) {
         ...
         Validate.notNull(var4, "null elements not permitted");
         var2.add(var4);
      }
   ...
   public static <E extends Enum<E>> E getEnum(Class<E> var0, String var1) {
      return getEnum(var0, var1, (Enum)null);
   }

   public static <E extends Enum<E>> E getEnum(Class<E> var0, String var1, E var2) {
      if (var1 == null) {
         return var2;
      } else {
         try {
   ...
   public static <E extends Enum<E>> E getEnumIgnoreCase(Class<E> var0, String var1) {
      return getEnumIgnoreCase(var0, var1, (Enum)null);
   }

   public static <E extends Enum<E>> E getEnumIgnoreCase(Class<E> var0, String var1, E var2) {
      if (var1 != null && var0.isEnum()) {
         Enum[] var3 = (Enum[])var0.getEnumConstants();
         int var4 = var3.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            Enum var6 = var3[var5];
            if (var6.name().equalsIgnoreCase(var1)) {
               return var6;
            }
         }
   ...
   public static <E extends Enum<E>> boolean isValidEnumIgnoreCase(Class<E> var0, String var1) {
