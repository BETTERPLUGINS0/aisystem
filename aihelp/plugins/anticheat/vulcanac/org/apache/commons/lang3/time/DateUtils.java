...
public class DateUtils {
   ...
   public static Date parseDate(String var0, Locale var1, String... var2) {
      return parseDateWithLeniency(var0, var1, var2, true);
   }

   public static Date parseDateStrictly(String var0, String... var1) {
      return parseDateStrictly(var0, (Locale)null, var1);
   }

   public static Date parseDateStrictly(String var0, Locale var1, String... var2) {
      return parseDateWithLeniency(var0, var1, var2, false);
   }

   private static Date parseDateWithLeniency(String var0, Locale var1, String[] var2, boolean var3) {
      if (var0 != null && var2 != null) {
         TimeZone var4 = TimeZone.getDefault();
         Locale var5 = LocaleUtils.toLocale(var1);
