...
public class FastDatePrinter implements DatePrinter, Serializable {
   ...
   protected FastDatePrinter(String var1, TimeZone var2, Locale var3) {
      this.mPattern = var1;
      this.mTimeZone = var2;
      this.mLocale = LocaleUtils.toLocale(var3);
      this.init();
   }

   private void init() {
      List var1 = this.parsePattern();
      this.mRules = (FastDatePrinter.Rule[])var1.toArray(EMPTY_RULE_ARRAY);
      int var2 = 0;
      ...
      for(int var11 = 0; var11 < var9; ++var11) {
         ...
         case 'y':
            if (var13 == 2) {
               ...
               var14 = this.selectNumberRule(1, Math.max(var13, 4));
            }
   ...
   private static void appendDigits(Appendable var0, int var1) {
      var0.append((char)(var1 / 10 + 48));
      var0.append((char)(var1 % 10 + 48));
   }

   private static void appendFullDigits(Appendable var0, int var1, int var2) {
      int var4;
      if (var1 < 10000) {
         int var3 = 4;
         if (var1 < 1000) {
   ...
   private static class TimeZoneDisplayKey {
      ...
      TimeZoneDisplayKey(TimeZone var1, boolean var2, int var3, Locale var4) {
         ...
         this.mLocale = LocaleUtils.toLocale(var4);
      }
   ...
   private static class TimeZoneNameRule implements FastDatePrinter.Rule {
      ...
      TimeZoneNameRule(TimeZone var1, Locale var2, int var3) {
         this.mLocale = LocaleUtils.toLocale(var2);
         this.mStyle = var3;
   ...
   private static class DayInWeekField implements FastDatePrinter.NumberRule {
      ...
      public void appendTo(Appendable var1, Calendar var2) {
         int var3 = var2.get(7);
         this.mRule.appendTo(var1, var3 == 1 ? 7 : var3 - 1);
      }
   ...
   private static class TwoDigitMonthField implements FastDatePrinter.NumberRule {
      ...
      public final void appendTo(Appendable var1, int var2) {
   ...
   private static class TwoDigitYearField implements FastDatePrinter.NumberRule {
      ...
      public final void appendTo(Appendable var1, int var2) {
         FastDatePrinter.appendDigits(var1, var2 % 100);
      }
   }
