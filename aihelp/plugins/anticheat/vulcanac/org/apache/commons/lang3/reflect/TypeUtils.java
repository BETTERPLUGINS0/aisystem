...
public class TypeUtils {
   ...
   private static <T> StringBuilder appendAllTo(StringBuilder var0, String var1, T... var2) {
   ...
   private static void appendRecursiveTypes(StringBuilder var0, int[] var1, Type[] var2) {
      for(int var3 = 0; var3 < var1.length; ++var3) {
         appendAllTo(var0.append('<'), ", ", var2[var3].toString()).append('>');
      }

      Type[] var4 = (Type[])ArrayUtils.removeAll((Object[])var2, (int[])var1);
      if (var4.length > 0) {
         appendAllTo(var0.append('<'), ", ", var4).append('>');
      }
   ...
   private static String classToString(Class<?> var0) {
      if (var0.isArray()) {
         return toString((Type)var0.getComponentType()) + "[]";
      } else {
   ...
   public static boolean containsTypeVariables(Type var0) {
      if (var0 instanceof TypeVariable) {
         ...
         return var0 instanceof GenericArrayType ? containsTypeVariables(((GenericArrayType)var0).getGenericComponentType()) : false;
      } else {
   ...
   public static Map<TypeVariable<?>, Type> determineTypeArguments(Class<?> var0, ParameterizedType var1) {
      ...
      Validate.notNull(var1, "superParameterizedType");
   ...
   private static Type[] extractTypeArgumentsFrom(Map<TypeVariable<?>, Type> var0, TypeVariable<?>[] var1) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         Validate.isTrue(var0.containsKey(var7), "missing argument mapping for %s", toString((Type)var7));
   ...
   private static int[] findRecursiveTypes(ParameterizedType var0) {
      Type[] var1 = (Type[])Arrays.copyOf(var0.getActualTypeArguments(), var0.getActualTypeArguments().length);
      int[] var2 = new int[0];

      for(int var3 = 0; var3 < var1.length; ++var3) {
         if (var1[var3] instanceof TypeVariable && containsVariableTypeSameParametrizedTypeBound((TypeVariable)var1[var3], var0)) {
   ...
   public static GenericArrayType genericArrayType(Type var0) {
      return new TypeUtils.GenericArrayTypeImpl((Type)Validate.notNull(var0, "componentType"));
   }
   ...
   public static Type[] getImplicitBounds(TypeVariable<?> var0) {
      Validate.notNull(var0, "typeVariable");
   ...
   public static Type[] getImplicitLowerBounds(WildcardType var0) {
      Validate.notNull(var0, "wildcardType");
   ...
   private static Map<TypeVariable<?>, Type> getTypeArguments(ParameterizedType var0, Class<?> var1, Map<TypeVariable<?>, Type> var2) {
      ...
      if (!isAssignable(var3, (Class)var1)) {
         ...
         for(int var8 = 0; var8 < var7.length; ++var8) {
            ...
            ((Map)var5).put(var7[var8], ((Map)var5).getOrDefault(var9, var9));
         }

         return (Map)(var1.equals(var3) ? var5 : getTypeArguments((Type)getClosestParentType(var3, var1), var1, (Map)var5));
      }
   }
   ...
   public static Type[] normalizeUpperBounds(Type[] var0) {
      ...
      if (var0.length < 2) {
         ...
         return (Type[])var1.toArray(ArrayUtils.EMPTY_TYPE_ARRAY);
      }
   }

   public static final ParameterizedType parameterize(Class<?> var0, Map<TypeVariable<?>, Type> var1) {
      Validate.notNull(var0, "rawClass");
      Validate.notNull(var1, "typeVariableMap");
   ...
   private static String parameterizedTypeToString(ParameterizedType var0) {
      ...
      if (var4.length > 0) {
         ...
         appendAllTo(var1.append('<'), ", ", var0.getActualTypeArguments()).append('>');
      }
   ...
   public static final ParameterizedType parameterizeWithOwner(Type var0, Class<?> var1, Map<TypeVariable<?>, Type> var2) {
      Validate.notNull(var1, "rawClass");
      Validate.notNull(var2, "typeVariableMap");
   ...
   private static <T> String toString(T var0) {
   ...
   public static boolean typesSatisfyVariables(Map<TypeVariable<?>, Type> var0) {
      Validate.notNull(var0, "typeVariableMap");
   ...
   public static <T> Typed<T> wrap(Type var0) {
      return () -> {
         return var0;
      };
   }
   ...
   private static final class WildcardTypeImpl implements WildcardType {
      ...
      private WildcardTypeImpl(Type[] var1, Type[] var2) {
         this.upperBounds = (Type[])ObjectUtils.defaultIfNull(var1, ArrayUtils.EMPTY_TYPE_ARRAY);
         this.lowerBounds = (Type[])ObjectUtils.defaultIfNull(var2, ArrayUtils.EMPTY_TYPE_ARRAY);
      }
   ...
   private static final class ParameterizedTypeImpl implements ParameterizedType {
      ...
      public int hashCode() {
         ...
         var2 <<= 4;
         var2 |= Objects.hashCode(this.useOwner);
         var2 <<= 8;
