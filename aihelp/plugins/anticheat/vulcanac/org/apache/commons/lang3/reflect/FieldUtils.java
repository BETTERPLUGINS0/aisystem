...
public class FieldUtils {
   ...
   public static Field[] getAllFields(Class<?> var0) {
      ...
      return (Field[])var1.toArray(ArrayUtils.EMPTY_FIELD_ARRAY);
   }
   ...
   public static Field[] getFieldsWithAnnotation(Class<?> var0, Class<? extends Annotation> var1) {
      ...
      return (Field[])var2.toArray(ArrayUtils.EMPTY_FIELD_ARRAY);
   }
   ...
   public static Object readStaticField(Field var0) {
      return readStaticField(var0, false);
   }

   public static Object readStaticField(Field var0, boolean var1) {
      Validate.notNull(var0, "field");
   ...
   public static Object readStaticField(Class<?> var0, String var1) {
      return readStaticField(var0, var1, false);
   }

   public static Object readStaticField(Class<?> var0, String var1, boolean var2) {
      Field var3 = getField(var0, var1, var2);
      Validate.notNull(var3, "Cannot locate field '%s' on %s", var1, var0);
      return readStaticField(var3, false);
   }

   public static Object readDeclaredStaticField(Class<?> var0, String var1) {
      return readDeclaredStaticField(var0, var1, false);
   }

   public static Object readDeclaredStaticField(Class<?> var0, String var1, boolean var2) {
      Field var3 = getDeclaredField(var0, var1, var2);
      Validate.notNull(var3, "Cannot locate declared field %s.%s", var0.getName(), var1);
      return readStaticField(var3, false);
   }

   public static Object readField(Field var0, Object var1) {
      return readField(var0, var1, false);
   }

   public static Object readField(Field var0, Object var1, boolean var2) {
      Validate.notNull(var0, "field");
   ...
   public static Object readField(Object var0, String var1) {
      return readField(var0, var1, false);
   }

   public static Object readField(Object var0, String var1, boolean var2) {
      Validate.notNull(var0, "target");
   ...
   public static Object readDeclaredField(Object var0, String var1) {
      return readDeclaredField(var0, var1, false);
   }

   public static Object readDeclaredField(Object var0, String var1, boolean var2) {
      Validate.notNull(var0, "target");
      Class var3 = var0.getClass();
   ...
   public static void writeStaticField(Field var0, Object var1) {
      writeStaticField(var0, var1, false);
   }

   public static void writeStaticField(Field var0, Object var1, boolean var2) {
      Validate.notNull(var0, "field");
   ...
   public static void writeStaticField(Class<?> var0, String var1, Object var2) {
      writeStaticField(var0, var1, var2, false);
   }

   public static void writeStaticField(Class<?> var0, String var1, Object var2, boolean var3) {
      Field var4 = getField(var0, var1, var3);
      Validate.notNull(var4, "Cannot locate field %s on %s", var1, var0);
      writeStaticField(var4, var2, false);
   }

   public static void writeDeclaredStaticField(Class<?> var0, String var1, Object var2) {
      writeDeclaredStaticField(var0, var1, var2, false);
   }

   public static void writeDeclaredStaticField(Class<?> var0, String var1, Object var2, boolean var3) {
      Field var4 = getDeclaredField(var0, var1, var3);
      Validate.notNull(var4, "Cannot locate declared field %s.%s", var0.getName(), var1);
      writeField((Field)var4, (Object)null, var2, false);
   }

   public static void writeField(Field var0, Object var1, Object var2) {
      writeField(var0, var1, var2, false);
   }

   public static void writeField(Field var0, Object var1, Object var2, boolean var3) {
      Validate.notNull(var0, "field");
   ...
   public static void writeField(Object var0, String var1, Object var2) {
      writeField(var0, var1, var2, false);
   }

   public static void writeField(Object var0, String var1, Object var2, boolean var3) {
      Validate.notNull(var0, "target");
   ...
   public static void writeDeclaredField(Object var0, String var1, Object var2) {
      writeDeclaredField(var0, var1, var2, false);
   }

   public static void writeDeclaredField(Object var0, String var1, Object var2, boolean var3) {
      Validate.notNull(var0, "target");
      Class var4 = var0.getClass();
