...
public class ExtendedMessageFormat extends MessageFormat {
   ...
   public ExtendedMessageFormat(String var1, Locale var2, Map<String, ? extends FormatFactory> var3) {
      super("");
      this.setLocale(LocaleUtils.toLocale(var2));
      this.registry = var3;
   ...
   public int hashCode() {
      ...
      var1 = 31 * var1 + Objects.hashCode(this.registry);
      var1 = 31 * var1 + Objects.hashCode(this.toPattern);
      return var1;
   }
   ...
   private StringBuilder appendQuotedString(String var1, ParsePosition var2, StringBuilder var3) {
      ...
      for(int var7 = var2.getIndex(); var7 < var1.length(); ++var7) {
         if (var5[var2.getIndex()] == '\'') {
            this.next(var2);
