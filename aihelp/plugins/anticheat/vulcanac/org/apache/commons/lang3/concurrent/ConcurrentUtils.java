...
public class ConcurrentUtils {
   ...
   public static void handleCause(ExecutionException var0) {
   ...
   public static <T> T initialize(ConcurrentInitializer<T> var0) {
   ...
   public static <K, V> V createIfAbsent(ConcurrentMap<K, V> var0, K var1, ConcurrentInitializer<V> var2) {
