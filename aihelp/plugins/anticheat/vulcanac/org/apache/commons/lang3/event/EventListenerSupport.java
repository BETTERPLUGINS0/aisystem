...
public class EventListenerSupport<L> implements Serializable {
   ...
   public EventListenerSupport(Class<L> var1, ClassLoader var2) {
      this();
      Validate.notNull(var1, "listenerInterface");
      Validate.notNull(var2, "classLoader");
      Validate.isTrue(var1.isInterface(), "Class %s is not an interface", var1.getName());
   ...
   public void addListener(L var1, boolean var2) {
      Validate.notNull(var1, "listener");
      if (var2 || !this.listeners.contains(var1)) {
