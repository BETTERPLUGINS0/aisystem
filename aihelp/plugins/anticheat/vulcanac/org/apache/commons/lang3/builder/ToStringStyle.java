...
public abstract class ToStringStyle implements Serializable {
   ...
   protected void removeLastFieldSeparator(StringBuffer var1) {
      if (StringUtils.endsWith(var1, this.fieldSeparator)) {
         var1.setLength(var1.length() - this.fieldSeparator.length());
      }
   ...
   protected void appendDetail(StringBuffer var1, String var2, Object[] var3) {
      ...
      for(int var4 = 0; var4 < var3.length; ++var4) {
         ...
         this.appendDetail(var1, var2, var4, var5);
      }

      var1.append(this.arrayEnd);
   }

   protected void appendDetail(StringBuffer var1, String var2, int var3, Object var4) {
      if (var3 > 0) {
      ...
      if (var4 == null) {
         ...
         this.appendInternal(var1, var2, var4, this.arrayContentDetail);
      }
   ...
   protected void reflectionAppendArrayDetail(StringBuffer var1, String var2, Object var3) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         this.appendDetail(var1, var2, var5, var6);
      }
   ...
   private static final class JsonToStringStyle extends ToStringStyle {
         ...
         if (var3 == null) {
            ...
            if (!(var3 instanceof Number) && !(var3 instanceof Boolean)) {
               ...
               if (!this.isJsonObject(var4) && !this.isJsonArray(var4)) {
                  this.appendDetail(var1, var2, (Object)var4);
               } else {
                  var1.append(var3);
               }
            } else {
      ...
      protected void appendDetail(StringBuffer var1, String var2, Collection<?> var3) {
         if (var3 != null && !var3.isEmpty()) {
            var1.append(this.getArrayStart());
            int var4 = 0;
            Iterator var5 = var3.iterator();

            while(var5.hasNext()) {
               Object var6 = var5.next();
               this.appendDetail(var1, var2, var4++, var6);
            }

            var1.append(this.getArrayEnd());
         } else {
            var1.append(var3);
         }
      }
      ...
      protected void appendDetail(StringBuffer var1, String var2, Map<?, ?> var3) {
         if (var3 != null && !var3.isEmpty()) {
            var1.append(this.getContentStart());
            boolean var4 = true;
            Iterator var5 = var3.entrySet().iterator();

            while(var5.hasNext()) {
               Entry var6 = (Entry)var5.next();
               String var7 = Objects.toString(var6.getKey(), (String)null);
               if (var7 != null) {
                  if (var4) {
                     var4 = false;
                  } else {
                     this.appendFieldEnd(var1, var7);
                  }

                  this.appendFieldStart(var1, var7);
                  Object var8 = var6.getValue();
                  if (var8 == null) {
                     this.appendNullText(var1, var7);
                  } else {
                     this.appendInternal(var1, var7, var8, true);
                  }
               }
            }

            var1.append(this.getContentEnd());
         } else {
            var1.append(var3);
         }
      }
      ...
      private void appendValueAsString(StringBuffer var1, String var2) {
         var1.append('"').append(StringEscapeUtils.escapeJson(var2)).append('"');
      }
      ...
      protected void appendFieldStart(StringBuffer var1, String var2) {
         if (var2 == null) {
            ...
            super.appendFieldStart(var1, "\"" + StringEscapeUtils.escapeJson(var2) + "\"");
         }
      }
