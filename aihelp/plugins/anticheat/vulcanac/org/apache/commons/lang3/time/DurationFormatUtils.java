...
public class DurationFormatUtils {
   ...
   static DurationFormatUtils.Token[] lexx(String var0) {
      ...
      if (var2) {
         ...
         return (DurationFormatUtils.Token[])var1.toArray(DurationFormatUtils.Token.EMPTY_ARRAY);
      }
   }

   static class Token {
      private static final DurationFormatUtils.Token[] EMPTY_ARRAY = new DurationFormatUtils.Token[0];
