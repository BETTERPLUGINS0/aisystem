...
public class StringUtils {
   ...
   public static String abbreviate(String var0, String var1, int var2, int var3) {
      if (isNotEmpty(var0) && "".equals(var1) && var3 > 0) {
         return substring(var0, 0, var3);
      } else if (isAnyEmpty(var0, var1)) {
         return var0;
      } else {
         ...
         if (var3 < var5) {
            throw new IllegalArgumentException(String.format("Minimum abbreviation width is %d", var5));
         } else {
            ...
            if (var7 <= var3) {
               ...
               if (var2 <= var4 + 1) {
                  return var0.substring(0, var3 - var4) + var1;
               } else if (var3 < var6) {
                  throw new IllegalArgumentException(String.format("Minimum abbreviation width with offset is %d", var6));
               } else {
                  return var2 + var3 - var4 < var7 ? var1 + abbreviate(var0.substring(var2), var1, var3 - var4) : var1 + var0.substring(var7 - (var3 - var4));
               }
            }
         }
      }
   ...
   public static String abbreviateMiddle(String var0, String var1, int var2) {
      if (!isAnyEmpty(var0, var1) && var2 < var0.length() && var2 >= var1.length() + 2) {
   ...
   private static String appendIfMissing(String var0, CharSequence var1, boolean var2, CharSequence... var3) {
      if (var0 != null && !isEmpty(var1) && !endsWith(var0, var1, var2)) {
         if (ArrayUtils.isNotEmpty((Object[])var3)) {
   ...
   public static String capitalize(String var0) {
      int var1 = length(var0);
      if (var1 == 0) {
         return var0;
      } else {
         int var2 = var0.codePointAt(0);
         int var3 = Character.toTitleCase(var2);
         if (var2 == var3) {
            return var0;
         } else {
            ...
            int var7;
            for(int var6 = Character.charCount(var2); var6 < var1; var6 += Character.charCount(var7)) {
               var7 = var0.codePointAt(var6);
               var4[var8++] = var7;
            }
   ...
   public static boolean containsAny(CharSequence var0, CharSequence... var1) {
      return containsAny(StringUtils::contains, var0, var1);
   }

   private static boolean containsAny(ToBooleanBiFunction<CharSequence, CharSequence> var0, CharSequence var1, CharSequence... var2) {
      if (!isEmpty(var1) && !ArrayUtils.isEmpty((Object[])var2)) {
         CharSequence[] var3 = var2;
         int var4 = var2.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            CharSequence var6 = var3[var5];
            if (var0.applyAsBoolean(var1, var6)) {
               return true;
            }
         }
   ...
   public static boolean containsAnyIgnoreCase(CharSequence var0, CharSequence... var1) {
      return containsAny(StringUtils::containsIgnoreCase, var0, var1);
   }
   ...
   public static boolean containsNone(CharSequence var0, String var1) {
      return var1 == null ? true : containsNone(var0, var1.toCharArray());
   }
   ...
   @SafeVarargs
   public static <T extends CharSequence> T firstNonBlank(T... var0) {
      if (var0 != null) {
   ...
   @SafeVarargs
   public static <T extends CharSequence> T firstNonEmpty(T... var0) {
      if (var0 != null) {
         CharSequence[] var1 = var0;
         int var2 = var0.length;
   ...
   public static byte[] getBytes(String var0, Charset var1) {
      return var0 == null ? ArrayUtils.EMPTY_BYTE_ARRAY : var0.getBytes(Charsets.toCharset(var1));
   }

   public static byte[] getBytes(String var0, String var1) {
      return var0 == null ? ArrayUtils.EMPTY_BYTE_ARRAY : var0.getBytes(Charsets.toCharsetName(var1));
   }
   ...
   public static <T extends CharSequence> T getIfBlank(T var0, Supplier<T> var1) {
      return isBlank(var0) ? (var1 == null ? null : (CharSequence)var1.get()) : var0;
   }

   public static <T extends CharSequence> T getIfEmpty(T var0, Supplier<T> var1) {
      return isEmpty(var0) ? (var1 == null ? null : (CharSequence)var1.get()) : var0;
   }
   ...
   public static int getLevenshteinDistance(CharSequence var0, CharSequence var1) {
      if (var0 != null && var1 != null) {
         ...
         if (var2 == 0) {
            ...
            int var5;
            for(var5 = 0; var5 <= var2; var11[var5] = var5++) {
            }
            ...
            for(int var6 = 1; var6 <= var3; ++var6) {
               ...
               for(var5 = 1; var5 <= var2; ++var5) {
                  int var8 = var11[var5];
                  int var10 = var0.charAt(var5 - 1) == var9 ? 0 : 1;
                  var11[var5] = Math.min(Math.min(var11[var5 - 1] + 1, var11[var5] + 1), var7 + var10);
                  var7 = var8;
               }
            }
      ...
      if (var0 != null && var1 != null) {
         if (var2 < 0) {
            ...
            if (var3 == 0) {
               ...
               Arrays.fill(var14, var8, var14.length, Integer.MAX_VALUE);
               ...
               for(var9 = 1; var9 <= var4; ++var9) {
                  ...
                  int var12 = var9 > Integer.MAX_VALUE - var2 ? var3 : Math.min(var3, var9 + var2);
                  if (var11 > var12) {
                     return -1;
                  }

                  if (var11 > 1) {
                     var6[var11 - 1] = Integer.MAX_VALUE;
                  }
   ...
   public static int indexOfAny(CharSequence var0, CharSequence... var1) {
      if (var0 != null && var1 != null) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            CharSequence var7 = var4[var6];
            if (var7 != null) {
               int var8 = CharSequenceUtils.indexOf(var0, var7, 0);
               if (var8 != -1 && var8 < var2) {
                  var2 = var8;
               }
            }
   ...
   public static int indexOfDifference(CharSequence... var0) {
      if (ArrayUtils.getLength(var0) <= 1) {
         return -1;
      } else {
         boolean var1 = false;
         boolean var2 = true;
         ...
         for(int var8 = 0; var8 < var7; ++var8) {
            CharSequence var9 = var6[var8];
            if (var9 == null) {
               var1 = true;
               var4 = 0;
            } else {
               var2 = false;
               var4 = Math.min(var9.length(), var4);
               var5 = Math.max(var9.length(), var5);
            }
         }
         ...
         if (var2 || var5 == 0 && !var1) {
            ...
            for(var7 = 0; var7 < var4; ++var7) {
               char var11 = var0[0].charAt(var7);

               for(int var12 = 1; var12 < var3; ++var12) {
                  if (var0[var12].charAt(var7) != var11) {
                     var10 = var7;
                     break;
                  }
               }
            ...
            return var10 == -1 && var4 != var5 ? var4 : var10;
         }
      }
   }
   ...
   public static boolean isAlphanumericSpace(CharSequence var0) {
      if (var0 == null) {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            ...
            if (var3 != ' ' && !Character.isLetterOrDigit(var3)) {
               return false;
            }
         }
   ...
   public static boolean isAlphaSpace(CharSequence var0) {
      if (var0 == null) {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            char var3 = var0.charAt(var2);
            if (var3 != ' ' && !Character.isLetter(var3)) {
               return false;
            }
         }
      ...
      if (!isEmpty(var0) && var0.length() != 1) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            if (Character.isUpperCase(var0.charAt(var4))) {
               var1 = true;
            } else if (Character.isLowerCase(var0.charAt(var4))) {
               var2 = true;
            }
         }
   ...
   public static boolean isNumericSpace(CharSequence var0) {
      if (var0 == null) {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            char var3 = var0.charAt(var2);
            if (var3 != ' ' && !Character.isDigit(var3)) {
               return false;
            }
         }
   ...
   public static String join(boolean[] var0, char var1) {
      return var0 == null ? null : join((boolean[])var0, var1, 0, var0.length);
   }

   public static String join(boolean[] var0, char var1, int var2, int var3) {
      if (var0 == null) {
         return null;
      } else if (var3 - var2 <= 0) {
         return "";
      } else {
         StringJoiner var4 = newStringJoiner(var1);

         for(int var5 = var2; var5 < var3; ++var5) {
            var4.add(String.valueOf(var0[var5]));
         }
   ...
   public static String join(List<?> var0, char var1, int var2, int var3) {
      if (var0 == null) {
         ...
         if (var4 <= 0) {
            ...
            List var5 = var0.subList(var2, var3);
            return join(var5.iterator(), var1);
         }
      }
   }
   ...
   public static String join(Object[] var0, char var1, int var2, int var3) {
      if (var0 == null) {
         ...
         for(int var5 = var2; var5 < var3; ++var5) {
            var4.add(toStringOrEmpty(var0[var5]));
         }
   ...
   public static String join(Object[] var0, String var1, int var2, int var3) {
      if (var0 == null) {
         ...
         StringJoiner var4 = new StringJoiner(toStringOrEmpty(var1));
   ...
   public static String joinWith(String var0, Object... var1) {
      if (var1 == null) {
         ...
         return join(var1, var0);
      }
   }

   public static int lastIndexOf(CharSequence var0, CharSequence var1) {
      return var0 == null ? -1 : CharSequenceUtils.lastIndexOf(var0, var1, var0.length());
   }

   public static int lastIndexOf(CharSequence var0, CharSequence var1, int var2) {
      return CharSequenceUtils.lastIndexOf(var0, var1, var2);
   }
   ...
   public static int lastIndexOfAny(CharSequence var0, CharSequence... var1) {
      if (var0 != null && var1 != null) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            CharSequence var7 = var4[var6];
            if (var7 != null) {
               int var8 = CharSequenceUtils.lastIndexOf(var0, var7, var0.length());
               if (var8 > var2) {
                  var2 = var8;
               }
            }
      ...
      if (var0 != null && var1 != null) {
         ...
         if (var2 < 0) {
            ...
            for(int var5 = var2; var5 >= 0; --var5) {
               if (CharSequenceUtils.regionMatches(var0, true, var5, var1, 0, var3)) {
                  return var5;
               }
            }
   ...
   public static String lowerCase(String var0, Locale var1) {
      return var0 == null ? null : var0.toLowerCase(LocaleUtils.toLocale(var1));
   }
   ...
   private static StringJoiner newStringJoiner(char var0) {
      return new StringJoiner(String.valueOf(var0));
   }
   ...
   public static String overlay(String var0, String var1, int var2, int var3) {
      if (var0 == null) {
         ...
         return var0.substring(0, var2) + var1 + var0.substring(var3);
      }
   }
   ...
   public static String removeIgnoreCase(String var0, String var1) {
      return replaceIgnoreCase(var0, var1, "", -1);
   }
   ...
   public static String removeStartIgnoreCase(String var0, String var1) {
      return var0 != null && startsWithIgnoreCase(var0, var1) ? var0.substring(length(var1)) : var0;
   }
   ...
   private static String replace(String var0, String var1, String var2, int var3, boolean var4) {
      if (!isEmpty(var0) && !isEmpty(var1) && var2 != null && var3 != 0) {
         ...
         int var5 = 0;
         int var6 = var4 ? indexOfIgnoreCase(var0, var1, var5) : indexOf(var0, var1, var5);
         if (var6 == -1) {
            return var0;
         } else {
            int var7 = var1.length();
            int var8 = Math.max(var2.length() - var7, 0);
            var8 *= var3 < 0 ? 16 : Math.min(var3, 64);

            StringBuilder var9;
            for(var9 = new StringBuilder(var0.length() + var8); var6 != -1; var6 = var4 ? indexOfIgnoreCase(var0, var1, var5) : indexOf(var0, var1, var5)) {
               var9.append(var0, var5, var6).append(var2);
               var5 = var6 + var7;
               --var3;
               if (var3 == 0) {
                  break;
            ...
            var9.append(var0, var5, var0.length());
            return var9.toString();
         }
      } else {
         return var0;
   ...
   private static String replaceEach(String var0, String[] var1, String[] var2, boolean var3, int var4) {
      if (var4 < 0) {
         ...
         HashSet var6 = new HashSet(Arrays.asList(var2));
         var5.retainAll(var6);
         if (!var5.isEmpty()) {
      ...
      if (isEmpty(var0) || ArrayUtils.isEmpty((Object[])var1) || ArrayUtils.isEmpty((Object[])var2) || ArrayUtils.isNotEmpty((Object[])var1) && var4 == -1) {
         return var0;
      } else {
         int var16 = var1.length;
         int var17 = var2.length;
         if (var16 != var17) {
            throw new IllegalArgumentException("Search and Replace array lengths don't match: " + var16 + " vs " + var17);
         } else {
            boolean[] var7 = new boolean[var16];
            int var8 = -1;
            int var9 = -1;
            boolean var10 = true;
            ...
            for(var11 = 0; var11 < var16; ++var11) {
               if (!var7[var11] && !isEmpty(var1[var11]) && var2[var11] != null) {
                  var18 = var0.indexOf(var1[var11]);
                  if (var18 == -1) {
                     var7[var11] = true;
                  } else if (var8 == -1 || var18 < var8) {
                     var8 = var18;
                     var9 = var11;
                  }
               }
            ...
            if (var8 == -1) {
               ...
               StringBuilder var19 = new StringBuilder(var0.length() + var12);

               while(var8 != -1) {
                  for(var14 = var11; var14 < var8; ++var14) {
                     var19.append(var0.charAt(var14));
                  }

                  var19.append(var2[var9]);
                  ...
                  for(var14 = 0; var14 < var16; ++var14) {
                     if (!var7[var14] && var1[var14] != null && !var1[var14].isEmpty() && var2[var14] != null) {
                        var18 = var0.indexOf(var1[var14], var11);
                        if (var18 == -1) {
                           var7[var14] = true;
                        } else if (var8 == -1 || var18 < var8) {
                           var8 = var18;
               ...
               for(int var15 = var11; var15 < var14; ++var15) {
                  var19.append(var0.charAt(var15));
               }
               ...
               if (!var3) {
                  ...
                  return replaceEach(var20, var1, var2, var3, var4 - 1);
               }
            }
         }
      }
   ...
   private static String[] splitByWholeSeparatorWorker(String var0, String var1, int var2, boolean var3) {
      if (var0 == null) {
         ...
         if (var4 == 0) {
            ...
            return (String[])var6.toArray(ArrayUtils.EMPTY_STRING_ARRAY);
         } else {
      ...
      if (var0 == null) {
         ...
         if (var3 == 0) {
            ...
            while(true) {
               ...
               return (String[])var4.toArray(ArrayUtils.EMPTY_STRING_ARRAY);
            }
         }
      }
   }
   ...
   private static String[] splitWorker(String var0, String var1, int var2, boolean var3) {
      if (var0 == null) {
         ...
         if (var4 == 0) {
            ...
            return (String[])var5.toArray(ArrayUtils.EMPTY_STRING_ARRAY);
         }
      }
   }
   ...
   private static boolean startsWith(CharSequence var0, CharSequence var1, boolean var2) {
      if (var0 != null && var1 != null) {
         int var3 = var1.length();
         return var3 > var0.length() ? false : CharSequenceUtils.regionMatches(var0, var2, 0, var1, 0, var3);
      } else {
         return var0 == var1;
      }
   }
   ...
   public static String stripAccents(String var0) {
      if (var0 == null) {
         ...
         StringBuilder var1 = new StringBuilder(Normalizer.normalize(var0, Form.NFD));
         convertRemainingAccentCharacters(var1);
         return STRIP_ACCENTS_PATTERN.matcher(var1).replaceAll("");
      }
   }
   ...
   public static String[] stripAll(String[] var0, String var1) {
      int var2 = ArrayUtils.getLength(var0);
      if (var2 == 0) {
         return var0;
      } else {
   ...
   public static String substringAfter(String var0, int var1) {
      if (isEmpty(var0)) {
         return var0;
      } else {
         int var2 = var0.indexOf(var1);
         return var2 == -1 ? "" : var0.substring(var2 + 1);
      }
   }
   ...
   public static String substringAfterLast(String var0, int var1) {
      if (isEmpty(var0)) {
         return var0;
      } else {
         int var2 = var0.lastIndexOf(var1);
         return var2 != -1 && var2 != var0.length() - 1 ? var0.substring(var2 + 1) : "";
      }
   }
   ...
   public static String substringBefore(String var0, int var1) {
      if (isEmpty(var0)) {
         return var0;
      } else {
         int var2 = var0.indexOf(var1);
   ...
   public static String substringBetween(String var0, String var1, String var2) {
      if (!ObjectUtils.allNotNull(var0, var1, var2)) {
         return null;
      } else {
   ...
   public static String[] substringsBetween(String var0, String var1, String var2) {
      if (var0 != null && !isEmpty(var1) && !isEmpty(var2)) {
         ...
         if (var3 == 0) {
            ...
            return var6.isEmpty() ? null : (String[])var6.toArray(ArrayUtils.EMPTY_STRING_ARRAY);
         }
      } else {
         return null;
      }
   ...
   public static String swapCase(String var0) {
      if (isEmpty(var0)) {
         ...
         int var6;
         for(int var4 = 0; var4 < var1; var4 += Character.charCount(var6)) {
            int var5 = var0.codePointAt(var4);
            if (!Character.isUpperCase(var5) && !Character.isTitleCase(var5)) {
               if (Character.isLowerCase(var5)) {
                  var6 = Character.toUpperCase(var5);
               } else {
                  var6 = var5;
               }
            } else {
               var6 = Character.toLowerCase(var5);
            }
   ...
   public static int[] toCodePoints(CharSequence var0) {
      if (var0 == null) {
         ...
         int[] var2 = new int[var1.codePointCount(0, var1.length())];
         int var3 = 0;

         for(int var4 = 0; var4 < var2.length; ++var4) {
            var2[var4] = var1.codePointAt(var3);
            var3 += Character.charCount(var2[var4]);
         }
   ...
   public static String toRootLowerCase(String var0) {
      return var0 == null ? null : var0.toLowerCase(Locale.ROOT);
   }

   public static String toRootUpperCase(String var0) {
      return var0 == null ? null : var0.toUpperCase(Locale.ROOT);
   }
   ...
   private static String toStringOrEmpty(Object var0) {
      return Objects.toString(var0, "");
   }
   ...
   public static String truncate(String var0, int var1, int var2) {
      if (var1 < 0) {
         ...
         int var3 = Math.min(var1 + var2, var0.length());
   ...
   public static String uncapitalize(String var0) {
      ...
      if (var1 == 0) {
         ...
         int var2 = var0.codePointAt(0);
         int var3 = Character.toLowerCase(var2);
         if (var2 == var3) {
            return var0;
         } else {
            int[] var4 = new int[var1];
   ...
   public static String unwrap(String var0, char var1) {
      if (!isEmpty(var0) && var1 != 0 && var0.length() != 1) {
   ...
   public static String unwrap(String var0, String var1) {
      if (!isEmpty(var0) && !isEmpty(var1) && var0.length() >= 2 * var1.length()) {
   ...
   public static String upperCase(String var0, Locale var1) {
      return var0 == null ? null : var0.toUpperCase(LocaleUtils.toLocale(var1));
   }
   ...
   public static String wrapIfMissing(String var0, char var1) {
      if (!isEmpty(var0) && var1 != 0) {
         boolean var2 = var0.charAt(0) != var1;
         boolean var3 = var0.charAt(var0.length() - 1) != var1;
         if (!var2 && !var3) {
            return var0;
         } else {
   ...
   public static String wrapIfMissing(String var0, String var1) {
      if (!isEmpty(var0) && !isEmpty(var1)) {
         boolean var2 = !var0.startsWith(var1);
         boolean var3 = !var0.endsWith(var1);
         if (!var2 && !var3) {
            return var0;
         } else {
            StringBuilder var4 = new StringBuilder(var0.length() + var1.length() + var1.length());
            if (var2) {
               var4.append(var1);
            }
