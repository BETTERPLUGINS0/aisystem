...
@CheckInfo(
   name = "Bad Packets",
   type = 'A',
   complexType = "Abilities",
   description = "Spoofed abilities packets."
)
public class BadPacketsA extends AbstractCheck {
   private static final String[] b;

   public BadPacketsA(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = "w\t42`e2}\t2\"muN\u0007w\t$<fvN";
      int var4 = "w\t42`e2}\t2\"muN\u0007w\t$<fvN".length();
      char var1 = 14;
      int var0 = -1;
