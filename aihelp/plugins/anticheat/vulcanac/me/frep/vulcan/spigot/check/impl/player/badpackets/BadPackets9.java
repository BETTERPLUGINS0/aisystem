...
@CheckInfo(
   name = "Bad Packets",
   type = '9',
   complexType = "No Swing",
   description = "Hitting without swinging."
)
public class BadPackets9 extends AbstractCheck {
   private boolean Vulcan_P = false;
   private boolean Vulcan_X = false;
   private static final String[] b;

   public BadPackets9(Vulcan_iE var1) {
      super(var1);
   }
