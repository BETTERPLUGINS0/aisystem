...
@CheckInfo(
   name = "Scaffold",
   type = 'J',
   complexType = "Acceleration [2]",
   experimental = false,
   description = "Invalid pitch change."
)
public class ScaffoldJ extends AbstractCheck {
   private static final String[] b;

   public ScaffoldJ(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = "\u0014(s\\QtW]8uX\u0018\rU/uUIpuU8\u007f_K(";
      int var4 = "\u0014(s\\QtW]8uX\u0018\rU/uUIpuU8\u007f_K(".length();
      char var1 = '\f';
      int var0 = -1;
