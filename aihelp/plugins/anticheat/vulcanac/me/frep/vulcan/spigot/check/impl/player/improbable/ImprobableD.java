...
@CheckInfo(
   name = "Improbable",
   type = 'D',
   complexType = "Auto Clicker",
   description = "Too many combined autoclicker violations."
)
public class ImprobableD extends AbstractCheck {
   private long Vulcan_f;
   private static final String b;

   public ImprobableD(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      char[] var10003 = "\u0004g\fI,6\r\u0006y\u001dT93\u000b\ts\fO\u00004\u0017X".toCharArray();
