...
@CheckInfo(
   ...
   type = 'A',
   complexType = "Spider",
   description = "Climbing up a wall."
)
public class WallClimbA extends AbstractCheck {
   ...
   public WallClimbA(Vulcan_iE var1) {
      super(var1);
   }
   ...
   public static void Vulcan__(int var0) {
      Vulcan_h = var0;
   }
   ...
   static {
      ...
      int var3 = 0;
      Vulcan__(0);
      String var2 = "@Lh,R\"E\u0007\u0004]m;X\bE";
      int var4 = "@Lh,R\"E\u0007\u0004]m;X\bE".length();
      char var1 = 7;
      int var0 = -1;
