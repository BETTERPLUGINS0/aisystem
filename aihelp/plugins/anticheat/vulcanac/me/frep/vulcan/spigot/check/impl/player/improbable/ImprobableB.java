...
@CheckInfo(
   name = "Improbable",
   type = 'B',
   complexType = "Movement",
   experimental = false,
   description = "Too many combined movement violations."
)
public class ImprobableB extends AbstractCheck {
   private long Vulcan_U;
   private static final String b;

   public ImprobableB(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      char[] var10003 = "\u000b\"p\u000e\u00157J\u0012\u001bo\u0004\u00143P\u000f\"h\u0018E".toCharArray();
