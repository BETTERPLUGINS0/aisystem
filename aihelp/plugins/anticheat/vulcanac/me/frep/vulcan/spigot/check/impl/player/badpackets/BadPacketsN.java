...
@CheckInfo(
   name = "Bad Packets",
   type = 'N',
   complexType = "Post BlockDig",
   description = "Post BlockDig packets."
)
public class BadPacketsN extends AbstractCheck {
   private long Vulcan_O = 0L;
   private boolean Vulcan_d = false;
   private static final String b;

   public BadPacketsN(Vulcan_iE var1) {
      super(var1);
   }
