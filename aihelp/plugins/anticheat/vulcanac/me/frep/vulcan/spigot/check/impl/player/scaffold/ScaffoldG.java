...
@CheckInfo(
   ...
   complexType = "Speed",
   experimental = false,
   description = "Bridging too quickly."
)
public class ScaffoldG extends AbstractCheck {
   private long Vulcan_j;
   private static final String[] b;

   public ScaffoldG(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = "\u007foYGYi\u0007>e[G]-$\u000e>`]HY8|l`JBS:$";
      int var4 = "\u007foYGYi\u0007>e[G]-$\u000e>`]HY8|l`JBS:$".length();
      char var1 = 6;
      int var0 = -1;
