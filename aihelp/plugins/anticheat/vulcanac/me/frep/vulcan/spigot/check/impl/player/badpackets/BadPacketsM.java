...
@CheckInfo(
   name = "Bad Packets",
   type = 'M',
   complexType = "Post BlockPlace",
   description = "Post BlockPlace packets."
)
public class BadPacketsM extends AbstractCheck {
   private long Vulcan_y = 0L;
   private boolean Vulcan_L = false;
   private static final String[] b;

   public BadPacketsM(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = "rZ\u001b 9f\u0006rZ\u001b 9f\u0006Tj4\n\u0005\u000f";
      int var4 = "rZ\u001b 9f\u0006rZ\u001b 9f\u0006Tj4\n\u0005\u000f".length();
      char var1 = 6;
      int var0 = -1;
