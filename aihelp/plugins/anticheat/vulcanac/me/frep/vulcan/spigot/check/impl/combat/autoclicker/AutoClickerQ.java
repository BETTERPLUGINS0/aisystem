...
@CheckInfo(
   ...
   description = "Too low average deviation."
)
public class AutoClickerQ extends AbstractCheck {
   private final Vulcan_c Vulcan_X = new Vulcan_c(40);
   private double Vulcan_U;
   private static final String[] b;

   public AutoClickerQ(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = ",]\u0016z6\u001f|&W\u0015!\thU\u0006y!\f~-\t";
      int var4 = ",]\u0016z6\u001f|&W\u0015!\thU\u0006y!\f~-\t".length();
      char var1 = 11;
      int var0 = -1;
