...
@CheckInfo(
   name = "Bad Packets",
   type = 'T',
   complexType = "Keep Alive",
   experimental = false,
   description = "Invalid KeepAlive packets."
)
public class BadPacketsT extends AbstractCheck {
   private long Vulcan_r = -1L;
   private static final String[] b;

   public BadPacketsT(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = "R&Ju\u00164\u0014O\u0003\u001b.\u0016";
      int var4 = "R&Ju\u00164\u0014O\u0003\u001b.\u0016".length();
      char var1 = '\b';
      int var0 = -1;
