...
@CheckInfo(
   name = "Auto Clicker",
   type = 'M',
   complexType = "Variance Difference",
   description = "Similar variance values."
)
public class AutoClickerM extends AbstractCheck {
   private final Deque Vulcan_d = Lists.newLinkedList();
   private double Vulcan_z;
   private static final String b;

   public AutoClickerM(Vulcan_iE var1) {
      super(var1);
   }
