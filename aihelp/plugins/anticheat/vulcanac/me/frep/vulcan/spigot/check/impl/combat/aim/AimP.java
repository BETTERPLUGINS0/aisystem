...
@CheckInfo(
   name = "Aim",
   type = 'P',
   complexType = "Yaw Acceleration",
   experimental = false,
   description = "Large yaw acceleration."
)
public class AimP extends AbstractCheck {
   private static final String[] b;

   public AimP(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      ...
      int var3 = 0;
      String var2 = "Lufz[k`Y)\f\u0015dxO[`DVwtW\u0005";
      int var4 = "Lufz[k`Y)\f\u0015dxO[`DVwtW\u0005".length();
      char var1 = '\t';
      int var0 = -1;
