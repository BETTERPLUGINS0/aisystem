...
@CheckInfo(
   name = "Auto Clicker",
   type = 'D',
   complexType = "Skewness",
   description = "Too low skewness values."
)
public class AutoClickerD extends AbstractCheck {
   private final Deque Vulcan_V = Lists.newLinkedList();
   private static final String b;

   public AutoClickerD(Vulcan_iE var1) {
      super(var1);
   }
   ...
   static {
      char[] var10003 = "P+U(1\u0004OP".toCharArray();
