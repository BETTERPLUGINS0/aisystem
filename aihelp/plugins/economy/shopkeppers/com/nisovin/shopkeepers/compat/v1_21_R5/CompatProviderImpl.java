...
public final class CompatProviderImpl implements CompatProvider {
   ...
   public void overwriteLivingEntityAI(LivingEntity entity) {
      if (entity instanceof Mob) {
         try {
            ...
            PathfinderGoalSelector goalSelector = mcMob.bF;
            goalSelector.a((goal) -> {
               return true;
            });
            goalSelector.a(0, new PathfinderGoalLookAtPlayer(mcMob, EntityHuman.class, 6.0F, 1.0F));
            PathfinderGoalSelector targetSelector = mcMob.bG;
   ...
   private NBTTagCompound getItemStackTag(ItemStack nmsItem) {
      NBTTagCompound itemTag = (NBTTagCompound)nmsItem.a(CraftRegistry.getMinecraftRegistry());
   ...
   public void updateTrades(Player player) {
      ...
      if (openInventory instanceof MerchantInventory) {
         ...
         MerchantRecipeList merchantRecipeList = ((IMerchant)nmsMerchant).gw();
         if (merchantRecipeList == null) {
            merchantRecipeList = new MerchantRecipeList();
         }

         EntityPlayer nmsPlayer = ((CraftPlayer)player).getHandle();
         nmsPlayer.a(nmsPlayer.bR.l, merchantRecipeList, merchantLevel, merchantExperience, regularVillager, canRestock);
      }
   }
   ...
   public org.bukkit.inventory.ItemStack deserializeItemStack(int dataVersion, NamespacedKey id, int count, @Nullable ItemStackComponentsData componentsData) {
      ...
      NBTTagCompound convertedItemTag = (NBTTagCompound)DataConverterRegistry.a().update(DataConverterTypes.t, new Dynamic((DynamicOps)Unsafe.castNonNull(DynamicOpsNBT.a), itemTag), dataVersion, currentDataVersion).getValue();
      if (convertedItemTag.b("id", "minecraft:air").equals("minecraft:air")) {
         return new org.bukkit.inventory.ItemStack(Material.AIR);
      } else {
         ItemStack nmsItem = (ItemStack)ItemStack.a(CraftRegistry.getMinecraftRegistry(), convertedItemTag).orElseThrow();
