...
public final class CompatProviderImpl implements CompatProvider {
   ...
   public void overwriteLivingEntityAI(LivingEntity entity) {
      if (entity instanceof Mob) {
         try {
            ...
            PathfinderGoalSelector goalSelector = mcMob.cq;
            goalSelector.a((goal) -> {
               return true;
            });
            goalSelector.a(0, new PathfinderGoalLookAtPlayer(mcMob, EntityHuman.class, 6.0F, 1.0F));
            PathfinderGoalSelector targetSelector = mcMob.cr;
   ...
   public void updateTrades(Player player) {
      ...
      if (openInventory instanceof MerchantInventory) {
         ...
         MerchantRecipeList merchantRecipeList = ((IMerchant)nmsMerchant).gK();
         if (merchantRecipeList == null) {
            merchantRecipeList = new MerchantRecipeList();
         }

         EntityPlayer nmsPlayer = ((CraftPlayer)player).getHandle();
         nmsPlayer.a(nmsPlayer.cl.l, merchantRecipeList, merchantLevel, merchantExperience, regularVillager, canRestock);
      }
   }
   ...
   public org.bukkit.inventory.ItemStack deserializeItemStack(int dataVersion, NamespacedKey id, int count, @Nullable ItemStackComponentsData componentsData) {
      ...
      NBTTagCompound convertedItemTag = (NBTTagCompound)DataConverterRegistry.a().update(DataConverterTypes.v, new Dynamic((DynamicOps)Unsafe.castNonNull(DynamicOpsNBT.a), itemTag), dataVersion, currentDataVersion).getValue();
