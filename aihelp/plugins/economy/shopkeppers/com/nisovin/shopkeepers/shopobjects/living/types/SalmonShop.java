...
public class SalmonShop extends SKLivingShopObject<Salmon> {
   ...
   public SalmonShop(BaseEntityShopObjectCreationContext context, BaseEntityShopObjectType<SalmonShop> shopObjectType, AbstractShopkeeper shopkeeper, @Nullable ShopCreationData creationData) {
      super(context, shopObjectType, shopkeeper, creationData);
      PropertyValue var10001 = new PropertyValue(VARIANT);
      SalmonShop var10002 = (SalmonShop)Unsafe.initialized(this);
   ...
   private void applyVariant() {
      Salmon entity = (Salmon)this.getEntity();
      if (entity != null) {
   ...
   private ItemStack getVariantEditorItem() {
      ...
      ItemUtils.setDisplayNameAndLore(iconItem, Messages.buttonSalmonVariant, Messages.buttonSalmonVariantLore);
      return iconItem;
   }
   ...
   private Button getVariantEditorButton() {
      return new ShopkeeperActionButton() {
         ...
         public ItemStack getIcon(EditorView editorView) {
            return SalmonShop.this.getVariantEditorItem();
         }

         protected boolean runAction(EditorView editorView, InventoryClickEvent clickEvent) {
            boolean backwards = clickEvent.isRightClick();
            SalmonShop.this.cycleVariant(backwards);
            return true;
         }
      };
   }
   ...
   static {
      VARIANT = (new BasicProperty()).dataKeyAccessor("variant", EnumSerializers.lenient(Variant.class)).useDefaultIfMissing().defaultValue(Variant.MEDIUM).build();
   }
}
