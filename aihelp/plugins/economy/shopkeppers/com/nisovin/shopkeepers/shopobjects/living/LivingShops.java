...
public class LivingShops {
   ...
   public LivingShops(SKShopkeepersPlugin plugin, BaseEntityShops baseEntityShops) {
      this.livingShopObjectTypes = new SKLivingShopObjectTypes(baseEntityShops, this);
      this.livingEntityShopListener = new LivingEntityShopListener(plugin);
   }
      ...
      ShopkeeperDataMigrator.registerMigration(new Migration("living-shop-object-types", MigrationPhase.EARLY) {
         public boolean migrate(ShopkeeperData shopkeeperData, String logPrefix) throws InvalidDataException {
            ...
            if (shopObjectData == null) {
               ...
               String objectTypeId = (String)shopObjectData.getOrNullIfMissing(AbstractShopObject.SHOP_OBJECT_TYPE_ID);
