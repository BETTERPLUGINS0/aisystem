...
@WithDefaultValueType(
   fieldType = String.class,
   valueType = ColoredStringValue.class
)
...
public class Messages extends Config {
   ...
   public static List<String> buttonShopOpenLore = c(Arrays.asList("Temporarily closes the shop.", "Currently: &2Open", "&2Players can trade."));
   public static String buttonShopClosed = c("&aOpen shop");
   public static List<String> buttonShopClosedLore = c(Arrays.asList("Re-opens the shop.", "Currently: &4Closed", "&4Players cannot trade."));
   ...
   public static List<String> buttonEquipmentLore = c(Arrays.asList("Assign equipment.", "Note: Not all mobs support", "the same equipment slots."));
   public static String buttonMove = c("&aMove shopkeeper");
   public static List<String> buttonMoveLore = c(Arrays.asList("Lets you move", "your shopkeeper"));
   ...
   public static List<String> buttonCowVariantLore = c(Arrays.asList("Changes the cow's look"));
   ...
   public static List<String> buttonPigVariantLore = c(Arrays.asList("Changes the pig's look"));
   public static String buttonChickenVariant = c("&aChoose chicken variant");
   public static List<String> buttonChickenVariantLore = c(Arrays.asList("Changes the chicken's look"));
   ...
   public static List<String> buttonGoatLeftHornLore = c(Arrays.asList("Toggles the goat's", "left horn"));
   public static String buttonGoatRightHorn = c("&aToggle right horn");
   public static List<String> buttonGoatRightHornLore = c(Arrays.asList("Toggles the goat's", "right horn"));
   ...
   public static List<String> buttonSalmonVariantLore = c(Arrays.asList("Changes the size", "of the salmon."));
   public static String buttonFrogVariant = c("&aChoose frog variant");
   public static List<String> buttonFrogVariantLore = c(Arrays.asList("Changes the frog's look"));
   public static String buttonWolfVariant = c("&aChoose wolf variant");
   public static List<String> buttonWolfVariantLore = c(Arrays.asList("Changes the wolf's look"));
   public static String buttonSaddle = c("&aToggle saddle");
   public static List<String> buttonSaddleLore = c(Arrays.asList("Toggles the mob's saddle"));
   public static String buttonCopperGolemWeatherState = c("&aChoose oxidation level");
   public static List<String> buttonCopperGolemWeatherStateLore = c(Arrays.asList("Changes the copper golem's", "oxidation level"));
   public static String buttonArmorStandBasePlate = c("&aToggle base plate");
   public static List<String> buttonArmorStandBasePlateLore = c(Arrays.asList("Toggles the base plate", "of the armor stand"));
   public static String buttonArmorStandShowArms = c("&aToggle arms");
   public static List<String> buttonArmorStandShowArmsLore = c(Arrays.asList("Toggles the arms", "of the armor stand"));
   public static String buttonArmorStandSmall = c("&aToggle size");
   public static List<String> buttonArmorStandSmallLore = c(Arrays.asList("Toggles the size", "of the armor stand"));
   public static String buttonMannequinMainHand = c("&aToggle main hand");
   public static List<String> buttonMannequinMainHandLore = c(Arrays.asList("Toggles the main hand", "of the mannequin"));
   public static String buttonMannequinPose = c("&aToggle pose");
   public static List<String> buttonMannequinPoseLore = c(Arrays.asList("Toggles the pose", "of the mannequin"));
   public static String buttonMannequinProfile = c("&aChange skin");
   public static List<String> buttonMannequinProfileLore = c(Arrays.asList("Changes the skin", "of the mannequin"));
   public static String buttonNautilusArmor = c("&aChoose armor");
   public static List<String> buttonNautilusArmorLore = c(Arrays.asList("Changes the armor", "of the nautilus"));
   public static String buttonZombieNautilusVariant = c("&aChoose variant");
   public static List<String> buttonZombieNautilusVariantLore = c(Arrays.asList("Changes the look of", "the zombie nautilus."));
   public static String buttonEndCrystalBottomSlab = c("&aToggle bottom slab");
   public static List<String> buttonEndCrystalBottomSlabLore = c(Arrays.asList("Toggles the bottom slab", "of the end crystal"));
   public static Text mannequinEnterProfile = Text.parse("&aPlease enter in chat the name or id of the player whose profile you want to apply to the mannequin.\n&a  Enter a dash (-) to clear the current profile.\n&a  Enter an exclamation mark (!) to keep the current profile.");
   ...
   public static List<String> equipmentSlotLore = c(Arrays.asList("Place an item to equip it.", "Right-click to clear", "the equipment slot."));
   ...
   public static List<String> sellingShop_emptyTrade_resultItemLore = c(Arrays.asList("The item you want to sell.", "Add items to the shop container.", "Left/Right click to adjust the amount."));
   public static String sellingShop_emptyTrade_item1 = c("&dBuy Item");
   public static List<String> sellingShop_emptyTrade_item1Lore = c(Arrays.asList("The item you want to buy.", "Left/Right click to adjust the amount."));
   public static String sellingShop_emptyTrade_item2 = c("&dBuy Item 2");
   public static List<String> sellingShop_emptyTrade_item2Lore = c(Arrays.asList("The second item you want to buy.", "Left/Right click to adjust the amount."));
   public static String sellingShop_emptyItem1 = c("&dBuy Item");
   public static List<String> sellingShop_emptyItem1Lore = c(Arrays.asList("The item you want to buy.", "Left/Right click to adjust the amount."));
   public static String sellingShop_emptyItem2 = c("&dBuy Item 2");
   public static List<String> sellingShop_emptyItem2Lore = c(Arrays.asList("The second item you want to buy.", "Left/Right click to adjust the amount."));
   public static String buyingShop_emptyTrade_resultItem = c("&dSell Item");
   public static List<String> buyingShop_emptyTrade_resultItemLore = c(Arrays.asList("The item you want to sell.", "Left/Right click to adjust the amount."));
   public static String buyingShop_emptyTrade_item1 = c("&dBuy Item");
   public static List<String> buyingShop_emptyTrade_item1Lore = c(Arrays.asList("The item you want to buy.", "Add items to the shop container.", "Left/Right click to adjust the amount."));
   public static String buyingShop_emptyResultItem = c("&dSell Item");
   public static List<String> buyingShop_emptyResultItemLore = c(Arrays.asList("The item you want to sell.", "Left/Right click to adjust the amount."));
   public static String tradingShop_emptyTrade_resultItem = c("&dSell Item");
   public static List<String> tradingShop_emptyTrade_resultItemLore = c(Arrays.asList("The item you want to sell.", "Add items to the shop container,", "or place an item from your inventory.", "Left/Right click to adjust the amount."));
   public static String tradingShop_emptyTrade_item1 = c("&dBuy Item");
   public static List<String> tradingShop_emptyTrade_item1Lore = c(Arrays.asList("The item you want to buy.", "Place an item from your inventory.", "Left/Right click to adjust the amount."));
   public static String tradingShop_emptyTrade_item2 = c("&dBuy Item 2");
   public static List<String> tradingShop_emptyTrade_item2Lore = c(Arrays.asList("The second item you want to buy.", "Place an item from your inventory.", "Left/Right click to adjust the amount."));
   public static String tradingShop_emptyResultItem = c("&dSell Item");
   public static List<String> tradingShop_emptyResultItemLore = c(Arrays.asList("The item you want to sell.", "Place an item from your inventory.", "Left/Right click to adjust the amount."));
   public static String tradingShop_emptyItem1 = c("&dBuy Item");
   public static List<String> tradingShop_emptyItem1Lore = c(Arrays.asList("The item you want to buy.", "Place an item from your inventory.", "Left/Right click to adjust the amount."));
   public static String tradingShop_emptyItem2 = c("&dBuy Item 2");
   public static List<String> tradingShop_emptyItem2Lore = c(Arrays.asList("The second item you want to buy.", "Place an item from your inventory.", "Left/Right click to adjust the amount."));
   public static String bookShop_emptyTrade_resultItem = c("&dSell Item");
   public static List<String> bookShop_emptyTrade_resultItemLore = c(Arrays.asList("The item you want to sell.", "Add written books to the shop container."));
   public static String bookShop_emptyTrade_item1 = c("&dBuy Item");
   public static List<String> bookShop_emptyTrade_item1Lore = c(Arrays.asList("The item you want to buy.", "Left/Right click to adjust the amount."));
   public static String bookShop_emptyTrade_item2 = c("&dBuy Item 2");
   public static List<String> bookShop_emptyTrade_item2Lore = c(Arrays.asList("The second item you want to buy.", "Left/Right click to adjust the amount."));
   public static String bookShop_emptyItem1 = c("&dBuy Item");
   public static List<String> bookShop_emptyItem1Lore = c(Arrays.asList("The item you want to buy.", "Left/Right click to adjust the amount."));
   public static String bookShop_emptyItem2 = c("&dBuy Item 2");
   public static List<String> bookShop_emptyItem2Lore = c(Arrays.asList("The second item you want to buy.", "Left/Right click to adjust the amount."));
   public static String shopInformationHeader = c("&6Details");
   public static List<String> shopInformation = c(Arrays.asList("Id: &e{shop_id}", "Unique id: &e{shop_uuid}", "Name: &e{shop_name}", "Type: &e{shop_type}", "Object: &e{shop_object_type}", "Location: &e{shop_location}"));
   public static List<String> playerShopInformation = c(Arrays.asList("Owner: &e{shop_owner_name} &8({shop_owner_uuid})"));
   ...
   public static List<String> villagerEditorDescription = c(Arrays.asList("Top row: Result items", "Bottom rows: Cost items", "Edited trades have infinite", "uses and no XP rewards."));
   public static String villagerEditorInformationHeader = c("&6Details");
   public static List<String> villagerEditorInformation = c(Arrays.asList("Id: &e{entity_id}", "Unique id: &e{entity_uuid}", "Name: &e{entity_name}", "Location: &e{entity_location}"));
   ...
   public static List<String> buttonVillagerInventoryLore = c(Arrays.asList("Lets you view a copy of", "the villager's inventory"));
   ...
   public static Text confirmReplaceAllShopsWithVanillaVillagers = Text.parse("&cYou are about to irrevocably delete all shops (&6{shopsCount}&c) and replace them with vanilla villagers without AI!\nConsider creating a backup of your world and shopkeeper data before you proceed.");
   public static Text allShopsReplacedWithVanillaVillagers = Text.parse("&e{adminShopsCount}&a admin shops and &e{playerShopsCount}&a player shops have been replaced with vanilla villagers!\n&e{skippedShopsCount}&a shops have been skipped.");
   ...
   public static File getLangFolder() {
      return new File(SKShopkeepersPlugin.getInstance().getDataFolder(), "lang");
   }
   ...
   public static String getLanguageFilePath(String language) {
      return "lang/" + getLanguageFileName(language);
   }

   public static String getDefaultLanguageFilePath() {
      return getLanguageFilePath("en-default");
   }
   ...
   @Nullable
   private static ConfigData loadLanguageFile(String language) {
      SKShopkeepersPlugin plugin = SKShopkeepersPlugin.getInstance();
      String languageFilePath = getLanguageFilePath(language);
      ...
      if (!languageFile.exists()) {
         ...
         try {
            ...
            return ConfigData.of((DataContainer)languageConfig);
         } catch (Exception var5) {
            Log.warning((String)("Could not load language file '" + languageFile.getName() + "'!"), (Throwable)var5);
            return null;
         }
      }
   }
   ...
   @Nullable
   private static ConfigData loadDefaultLanguageFile() {
      return loadLanguageFile("en-default");
   }

   public static void loadLanguageFile() {
      saveDefaultLanguageFile();
      ConfigData defaultLanguageConfigData = loadDefaultLanguageFile();
      if (defaultLanguageConfigData != null) {
         String language = Settings.language;
         ConfigData languageConfigData = defaultLanguageConfigData;
         if (!language.equals("en-default")) {
         ...
         try {
            ...
            Log.warning((String)("Could not load language file for language '" + language + "'!"), (Throwable)var4);
         }
   ...
   protected String msgMissingValue(String configKey) {
      ...
      return var10000 + "Missing message: " + configKey;
   }

   protected String msgUsingDefaultForMissingValue(String configKey, Object defaultValue) {
      String var10000 = this.getLogPrefix();
      return var10000 + "Using default value for missing message: " + configKey;
   }
   ...
   protected String msgInsertingDefault(String configKey) {
      String var10000 = this.getLogPrefix();
      return var10000 + "Inserting default value for missing message: " + configKey;
   }

   protected String msgMissingDefault(String configKey) {
      String var10000 = this.getLogPrefix();
      return var10000 + "Missing default value for message: " + configKey;
   }
   ...
   public void load(ConfigData configData) throws ConfigLoadException {
      ...
      Iterator var3 = configKeys.iterator();

      while(var3.hasNext()) {
         String configKey = (String)var3.next();
         if (this.getSetting(configKey) == null) {
            String var10000 = this.getLogPrefix();
            Log.warning(var10000 + "Unknown message: " + configKey);
         }
      }
