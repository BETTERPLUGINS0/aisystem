...
public class Economy_XPBank extends AbstractEconomy {
   ...
   public Economy_XPBank(Plugin plugin) {
      ...
      Bukkit.getServer().getPluginManager().registerEvents(new Economy_XPBank.EconomyServerListener(this), plugin);
      if (this.XPB == null) {
         Plugin economy = plugin.getServer().getPluginManager().getPlugin("XPBank");
         if (economy != null && economy.isEnabled()) {
            this.XPB = (XPBank)economy;
            this.api = this.XPB.getAPI();
            this.log.info(String.format("[Economy] %s hooked.", "XPBank"));
         }
      }
   ...
   public EconomyResponse withdrawPlayer(String playerName, double amount) {
      ...
      if (account == null) {
         ...
         if (value < 1) {
            return new EconomyResponse(0.0D, (double)balance, EconomyResponse.ResponseType.FAILURE, this.api.getMsg("LessThanZero"));
         } else if (value > balance) {
            return new EconomyResponse(0.0D, (double)balance, EconomyResponse.ResponseType.FAILURE, String.format(this.api.getMsg("InsufficientXP"), this.api.currencyName(value)));
         } else {
   ...
   public EconomyResponse createBank(String name, String player) {
      ...
      if (groupBank != null) {
         return new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.FAILURE, String.format(this.api.getMsg("GroupBankExists"), name));
      } else {
         Account account = this.api.getAccount(player);
         groupBank = this.api.createGroupBank(name, account);
         return new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.SUCCESS, (String)null);
      }
   }
   ...
   public EconomyResponse bankBalance(String name) {
      GroupBank groupBank = this.api.getGroupBank(name);
      return groupBank == null ? new EconomyResponse(0.0D, 0.0D, EconomyResponse.ResponseType.FAILURE, this.api.getMsg("GroupBankNotExists")) : new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.SUCCESS, (String)null);
   }
   ...
   public EconomyResponse bankHas(String name, double amount) {
      ...
      if (groupBank == null) {
         ...
         return balance >= value ? new EconomyResponse(0.0D, (double)balance, EconomyResponse.ResponseType.SUCCESS, (String)null) : new EconomyResponse(0.0D, (double)balance, EconomyResponse.ResponseType.FAILURE, String.format(this.api.getMsg("InsufficientXP"), this.api.currencyName(value)));
      }
   }
   ...
   public EconomyResponse isBankOwner(String name, String playerName) {
      ...
      if (groupBank == null) {
         ...
         if (account == null) {
            return new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.FAILURE, this.api.getMsg("PlayerNotExist"));
         } else {
            return groupBank.getOwner().equalsIgnoreCase(name) ? new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.SUCCESS, (String)null) : new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.FAILURE, String.format(this.api.getMsg("PlayerNotOwner"), account.getName(), groupBank.getName()));
         }
      }
   }
   ...
   public EconomyResponse isBankMember(String name, String playerName) {
      ...
      if (groupBank == null) {
         ...
         if (account == null) {
            ...
            return groupBank.groupMembers.getMembers().containsKey(playerName) ? new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.SUCCESS, (String)null) : new EconomyResponse(0.0D, (double)groupBank.getBalance(), EconomyResponse.ResponseType.FAILURE, String.format(this.api.getMsg("NotAMemberOf"), groupBank.getName(), account.getName()));
         }
      }
   }
   ...
   public class EconomyServerListener implements Listener {
      ...
      public void onPluginEnable(PluginEnableEvent event) {
         if (this.economy.XPB == null) {
            ...
            if (eco.getDescription().getName().equals("XPBank")) {
               ...
               Economy_XPBank.this.log.info(String.format("[Economy] %s hooked.", "XPBank"));
            }
         }
      ...
      public void onPluginDisable(PluginDisableEvent event) {
         if (this.economy.XPB != null && event.getPlugin().getDescription().getName().equals("XPBank")) {
            ...
            Economy_XPBank.this.log.info(String.format("[Economy] %s unhooked.", "XPBank"));
         }
