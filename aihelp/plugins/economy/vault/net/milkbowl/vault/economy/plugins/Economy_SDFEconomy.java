...
public class Economy_SDFEconomy extends AbstractEconomy {
   ...
   public Economy_SDFEconomy(Plugin plugin) {
      ...
      plugin.getServer().getPluginManager().registerEvents(new Economy_SDFEconomy.EconomyServerListener(this), plugin);
      this.load_api();
   }
   ...
   public void load_api() {
      ...
      if (!this.isEnabled() && pluginSDF != null) {
         ...
         this.log.info(String.format("[Economy] %s hooked.", "SDFEconomy"));
      }
   ...
   public void unload_api() {
      ...
      if (this.isEnabled() && pluginSDF != null) {
         this.api = null;
         this.log.info(String.format("[Economy] %s unhooked.", "SDFEconomy"));
      }
