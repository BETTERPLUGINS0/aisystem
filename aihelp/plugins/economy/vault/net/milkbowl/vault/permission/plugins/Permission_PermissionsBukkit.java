...
public class Permission_PermissionsBukkit extends Permission {
   ...
   public Permission_PermissionsBukkit(Plugin plugin) {
      this.plugin = plugin;
      Bukkit.getServer().getPluginManager().registerEvents(new Permission_PermissionsBukkit.PermissionServerListener(this), plugin);
      if (this.perms == null) {
   ...
   public boolean playerInGroup(String world, String player, String group) {
      if (world != null) {
         Iterator var6 = this.perms.getPlayerInfo(player).getGroups().iterator();
   ...
   public String[] getPlayerGroups(String world, String player) {
      ...
      if (world != null && info != null) {
         var5 = this.perms.getPlayerInfo(player).getGroups().iterator();

         while(var5.hasNext()) {
            group = (Group)var5.next();
   ...
   public String[] getGroups() {
      ...
      Iterator var2 = this.perms.getAllGroups().iterator();
