...
public class Permission_Starburst extends Permission {
   ...
   public Permission_Starburst(Plugin plugin) {
      this.plugin = plugin;
      Bukkit.getServer().getPluginManager().registerEvents(new Permission_Starburst.PermissionServerListener(), plugin);
      if (this.perms == null) {
   ...
   public String[] getGroups() {
      ...
      for(Iterator var3 = this.perms.getGroupManager().getDefaultGroupSet().getGroups().iterator(); var3.hasNext(); ++i) {
         Group g = (Group)var3.next();
         s[i] = g.getName();
      }
   ...
   public boolean groupAdd(String world, String group, String permission) {
      ...
      if (!set.hasGroup(group)) {
         ...
         Iterator var8 = gm.getAffectedUsers(g).iterator();
