...
public class Permission_SimplyPerms extends Permission {
   ...
   public Permission_SimplyPerms(Plugin plugin) {
      this.plugin = plugin;
      Bukkit.getServer().getPluginManager().registerEvents(new Permission_SimplyPerms.PermissionServerListener(this), plugin);
      if (this.perms == null) {
   ...
   public boolean playerInGroup(String world, String player, String group) {
      if (world != null) {
         Iterator var4 = this.perms.getPlayerGroups(player).iterator();
   ...
   public String[] getPlayerGroups(String world, String player) {
      ...
      if (world != null && this.perms.isPlayerInDB(player)) {
         var4 = this.perms.getPlayerGroups(player).iterator();
