...
public final class HikariProxyConnection extends ProxyConnection implements Wrapper, AutoCloseable, Connection {
   ...
   public boolean setShardingKeyIfValid(ShardingKey var1, ShardingKey var2, int var3) throws SQLException {
      try {
         return super.delegate.setShardingKeyIfValid(var1, var2, var3);
      } catch (SQLException var5) {
         throw this.checkException(var5);
      }
   }

   public boolean setShardingKeyIfValid(ShardingKey var1, int var2) throws SQLException {
      try {
         return super.delegate.setShardingKeyIfValid(var1, var2);
      } catch (SQLException var4) {
         throw this.checkException(var4);
      }
   }

   public void setShardingKey(ShardingKey var1, ShardingKey var2) throws SQLException {
      try {
         super.delegate.setShardingKey(var1, var2);
      } catch (SQLException var4) {
         throw this.checkException(var4);
      }
   }

   public void setShardingKey(ShardingKey var1) throws SQLException {
      try {
         super.delegate.setShardingKey(var1);
      } catch (SQLException var3) {
         throw this.checkException(var3);
      }
   }

   protected HikariProxyConnection(PoolEntry var1, Connection var2, FastList var3, ProxyLeakTask var4, boolean var5, boolean var6) {
