...
public class DurationCodec implements Codec<Duration> {
   ...
   public Duration decodeText(ReadableByteBuf buf, MutableInt length, ColumnDecoder column, Calendar cal, Context context) throws SQLDataException {
      int[] parts;
   ...
   public Duration decodeBinary(ReadableByteBuf buf, MutableInt length, ColumnDecoder column, Calendar cal, Context context) throws SQLDataException {
      long days = 0L;
      int hours = 0;
      int minutes = 0;
      int seconds = 0;
   ...
   public int getApproximateTextProtocolLength(Object value, Long length) {
      ...
      long microSecond = (long)(((Duration)value).getNano() / 1000);
      return microSecond != 0L ? String.valueOf(s / 3600L).length() + 13 : String.valueOf(s / 3600L).length() + 6;
   }

   public void encodeBinary(Writer encoder, Context context, Object val, Calendar cal, Long maxLength) throws IOException {
