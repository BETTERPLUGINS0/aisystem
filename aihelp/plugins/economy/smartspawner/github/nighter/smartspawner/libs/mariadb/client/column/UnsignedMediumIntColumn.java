...
public class UnsignedMediumIntColumn extends ColumnDefinitionPacket implements ColumnDecoder {
   ...
   public int getPrecision() {
      return Math.min(8, (int)this.columnLength);
   }
   ...
   public byte decodeByteBinary(ReadableByteBuf buf, MutableInt length) throws SQLDataException {
      long result = (long)buf.readUnsignedMedium();
      buf.skip();
   ...
   public long decodeLongBinary(ReadableByteBuf buf, MutableInt length) throws SQLDataException {
      long l = (long)buf.readUnsignedMedium();
      buf.skip();
      return l;
   }
   ...
   public float decodeFloatBinary(ReadableByteBuf buf, MutableInt length) throws SQLDataException {
      float f = (float)buf.readUnsignedMedium();
      buf.skip();
      return f;
   }
   ...
   public double decodeDoubleBinary(ReadableByteBuf buf, MutableInt length) throws SQLDataException {
      double f = (double)buf.readUnsignedMedium();
      buf.skip();
      return f;
   }
