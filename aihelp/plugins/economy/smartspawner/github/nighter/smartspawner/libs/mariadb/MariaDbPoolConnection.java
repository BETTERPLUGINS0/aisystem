   ...
   private class MariaDbXAResource implements XAResource {
      ...
      private void execute(String command) throws XAException {
         try {
            ...
            throw MariaDbPoolConnection.mapXaException(var3);
         }
      }
      ...
      public void end(Xid xid, int flags) throws XAException {
         if (flags != 67108864 && flags != 33554432 && flags != 536870912) {
            ...
            this.execute("XA END " + MariaDbPoolConnection.xidToString(xid) + " " + MariaDbPoolConnection.flagsToString(flags));
         }
      }
      ...
      public void start(Xid xid, int flags) throws XAException {
         if (flags != 2097152 && flags != 134217728 && flags != 0) {
            ...
            this.execute("XA START " + MariaDbPoolConnection.xidToString(xid) + " " + MariaDbPoolConnection.flagsToString(flags));
         }
      }
