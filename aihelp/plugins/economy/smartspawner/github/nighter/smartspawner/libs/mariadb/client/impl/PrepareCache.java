...
public final class PrepareCache extends LinkedHashMap<String, CachedPrepareResultPacket> implements github.nighter.smartspawner.libs.mariadb.client.PrepareCache {
   ...
   public synchronized Prepare put(String key, Prepare result, BasePreparedStatement preparedStatement) {
