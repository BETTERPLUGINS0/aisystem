...
final class PoolEntry implements ConcurrentBag.IConcurrentBagEntry {
   ...
   public String toString() {
      ...
      return var10000 + ", accessed " + ClockSource.elapsedDisplayString(this.lastAccessed, now) + " ago, " + this.stateToString();
   }
   ...
   Connection close() {
      ...
      if (ka != null && !ka.isDone() && !ka.cancel(false)) {
         LOGGER.warn("{} - keepalive task cancellation unexpectedly returned false for connection {}", this.getPoolName(), this.connection);
      }
