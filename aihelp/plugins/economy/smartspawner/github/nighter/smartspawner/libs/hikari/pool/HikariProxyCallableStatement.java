...
public final class HikariProxyCallableStatement extends ProxyCallableStatement implements Wrapper, AutoCloseable, Statement, PreparedStatement, CallableStatement {
   ...
   public String enquoteLiteral(String var1) throws SQLException {
      try {
         return ((CallableStatement)super.delegate).enquoteLiteral(var1);
      } catch (SQLException var3) {
         throw this.checkException(var3);
      }
   }
   ...
   public String enquoteIdentifier(String var1, boolean var2) throws SQLException {
      try {
         return ((CallableStatement)super.delegate).enquoteIdentifier(var1, var2);
      } catch (SQLException var4) {
         throw this.checkException(var4);
      }
   }
   ...
   public boolean isSimpleIdentifier(String var1) throws SQLException {
      try {
         return ((CallableStatement)super.delegate).isSimpleIdentifier(var1);
      } catch (SQLException var3) {
         throw this.checkException(var3);
      }
   }

   public String enquoteNCharLiteral(String var1) throws SQLException {
      try {
         return ((CallableStatement)super.delegate).enquoteNCharLiteral(var1);
      } catch (SQLException var3) {
         throw this.checkException(var3);
      }
   }
