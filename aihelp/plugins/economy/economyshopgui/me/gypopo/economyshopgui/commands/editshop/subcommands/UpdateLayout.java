...
public class UpdateLayout extends SubCommad {
   public String getName() {
      return "updateLayout";
   }

   public String getDescription() {
      return "§aUpdate a existing shop layout from https://layouts.gpplugins.com/";
   }

   public String getSyntax() {
      return "§a/editshop updateLayout <layoutID>";
   }
   ...
   public void perform(Object logger, String[] args) {
      if (logger instanceof Player) {
         if (args.length > 1) {
            ...
            (new MarketplaceIntegration()).startUpdate((Player)logger, uuid.toString());
         } else {
