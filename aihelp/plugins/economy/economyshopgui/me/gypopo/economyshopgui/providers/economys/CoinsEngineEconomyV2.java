...
public class CoinsEngineEconomyV2 implements EconomyProvider {
   ...
   public CoinsEngineEconomyV2(String currency) {
      if (!currency.isEmpty()) {
   ...
   public double getBalance(OfflinePlayer p) {
      return CoinsEngineAPI.getBalance((Player)p, this.cur);
   }
