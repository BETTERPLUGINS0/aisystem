...
public class HeaderTokenizer {
   ...
   public HeaderTokenizer.Token next(char endOfAtom, boolean keepEscapes) throws ParseException {
      ...
      HeaderTokenizer.Token tk = this.getNext(endOfAtom, keepEscapes);
   ...
   public HeaderTokenizer.Token peek() throws ParseException {
      ...
      HeaderTokenizer.Token tk = this.getNext('\u0000', false);
      this.peekPos = this.currentPos;
      return tk;
   }

   public String getRemainder() {
      return this.nextPos >= this.string.length() ? null : this.string.substring(this.nextPos);
   }
