...
public interface Part {
   ...
   Enumeration<Header> getMatchingHeaders(String[] var1) throws MessagingException;

   Enumeration<Header> getNonMatchingHeaders(String[] var1) throws MessagingException;
}
