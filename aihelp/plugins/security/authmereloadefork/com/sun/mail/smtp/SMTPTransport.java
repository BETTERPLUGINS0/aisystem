...
public class SMTPTransport extends Transport {
   ...
   private Map<String, SMTPTransport.Authenticator> authenticators;
   ...
   protected SMTPTransport(Session session, URLName urlname, String name, boolean isSSL) {
      ...
      SMTPTransport.Authenticator[] a = new SMTPTransport.Authenticator[]{new SMTPTransport.LoginAuthenticator(), new SMTPTransport.PlainAuthenticator(), new SMTPTransport.DigestMD5Authenticator(), new SMTPTransport.NtlmAuthenticator(), new SMTPTransport.OAuth2Authenticator()};
   ...
   private boolean authenticate(String user, String passwd) throws MessagingException {
      ...
      if (this.enableSASL) {
         ...
         try {
            ...
            this.logger.log(Level.FINE, "SASL support failed", (Throwable)var10);
         }
      }
      ...
      while(true) {
         while(true) {
            while(st.hasMoreTokens()) {
               ...
               a = (SMTPTransport.Authenticator)this.authenticators.get(m);
               if (a != null) {
      ...
      if (!(message instanceof MimeMessage)) {
         ...
         if (addresses.length == 0) {
            ...
            try {
               ...
               this.logger.log(Level.FINE, "MessagingException while sending", (Throwable)var16);
               ...
               this.logger.log(Level.FINE, "IOException while sending, closing", (Throwable)var17);
      ...
      if (sendFailed) {
         ...
         try {
            ...
            try {
               ...
               this.logger.log(Level.FINE, "close failed", (Throwable)var20);
            }
         } finally {
   ...
   protected OutputStream bdat() throws MessagingException {
      ...
      this.dataStream = new SMTPTransport.BDATOutputStream(this.serverOutput, this.chunkSize);
      return this.dataStream;
   }
   ...
   private void openServer(String host, int port) throws MessagingException {
      ...
      } catch (SocketConnectException var6) {
         throw new MailConnectException(var6);
      } catch (IOException var7) {
         throw new MessagingException("Could not connect to SMTP host: " + host + ", port: " + port, var7);
      }
   }
   ...
   private class OAuth2Authenticator extends SMTPTransport.Authenticator {
      OAuth2Authenticator() {
         super("XOAUTH2", false);
      }
   ...
   private abstract class Authenticator {
      ...
      boolean authenticate(String host, String authzid, String user, String passwd) throws MessagingException {
         ...
         try {
            ...
            SMTPTransport.this.logger.log(Level.FINE, "AUTH " + this.mech + " failed", (Throwable)var11);
