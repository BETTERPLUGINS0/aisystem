...
public class DigestMD5 {
   ...
   public byte[] authClient(String host, String user, String passwd, String realm, String serverChallenge) throws IOException {
      ...
      try {
         ...
         this.logger.log(Level.FINE, "NoSuchAlgorithmException", (Throwable)var20);
   ...
   private static String toHex(byte[] bytes) {
      ...
      for(int var3 = 0; index < bytes.length; ++index) {
         int temp = bytes[index] & 255;
         result[var3++] = digits[temp >> 4];
         result[var3++] = digits[temp & 15];
      }
