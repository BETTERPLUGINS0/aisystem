...
public class IMAPFolder extends Folder implements UIDFolder, ResponseHandler {
   ...
   private synchronized Folder[] doList(final String pattern, final boolean subscribed) throws MessagingException {
      ...
      if (this.attributes != null && !this.isDirectory()) {
         ...
         ListInfo[] li = (ListInfo[])((ListInfo[])this.doCommandIgnoreFailure(new IMAPFolder.ProtocolCommand() {
            public Object doCommand(IMAPProtocol p) throws ProtocolException {
   ...
   public synchronized boolean isSubscribed() {
      ...
      try {
         li = (ListInfo[])((ListInfo[])this.doProtocolCommand(new IMAPFolder.ProtocolCommand() {
            public Object doCommand(IMAPProtocol p) throws ProtocolException {
               return p.lsub("", lname);
            }
         }));
   ...
   public synchronized boolean hasNewMessages() throws MessagingException {
      ...
      li = (ListInfo[])((ListInfo[])this.doCommandIgnoreFailure(new IMAPFolder.ProtocolCommand() {
         public Object doCommand(IMAPProtocol p) throws ProtocolException {
            return p.list("", lname);
         }
      }));
         ...
         if (folder.getStore() == this.store) {
            synchronized(this.messageCacheLock) {
               try {
                  ...
                  if (var8.getMessage().indexOf("TRYCREATE") != -1) {
      ...
      if (msgs.length == 0) {
         ...
         synchronized(this.messageCacheLock) {
            try {
               ...
               if (var16.getMessage().indexOf("TRYCREATE") != -1) {
                  throw new FolderNotFoundException(folder, folder.getFullName() + " does not exist");
               } else {
                  throw new MessagingException(var16.getMessage(), var16);
               }
   ...
   public synchronized Message[] getMessagesByUID(long start, long end) throws MessagingException {
      ...
      try {
         synchronized(this.messageCacheLock) {
            ...
            Message[] msgs = (Message[])ma.toArray(new Message[ma.size()]);
            return msgs;
         }
   ...
   public Quota[] getQuota() throws MessagingException {
      return (Quota[])((Quota[])this.doOptionalCommand("QUOTA not supported", new IMAPFolder.ProtocolCommand() {
         public Object doCommand(IMAPProtocol p) throws ProtocolException {
   ...
   public ACL[] getACL() throws MessagingException {
      return (ACL[])((ACL[])this.doOptionalCommand("ACL not supported", new IMAPFolder.ProtocolCommand() {
         public Object doCommand(IMAPProtocol p) throws ProtocolException {
   ...
   public Rights[] listRights(final String name) throws MessagingException {
      return (Rights[])((Rights[])this.doOptionalCommand("ACL not supported", new IMAPFolder.ProtocolCommand() {
         public Object doCommand(IMAPProtocol p) throws ProtocolException {
      ...
      synchronized(this.messageCacheLock) {
         if (this.idleState == 1 && this.protocol != null) {
            ...
            try {
               ...
               this.logger.log(Level.FINEST, "Exception in idleAbortWait", (Throwable)var4);
            }
   ...
   public Map<String, String> id(final Map<String, String> clientParams) throws MessagingException {
      this.checkOpened();
      return (Map)this.doOptionalCommand("ID not supported", new IMAPFolder.ProtocolCommand() {
         public Object doCommand(IMAPProtocol p) throws ProtocolException {
   ...
   protected IMAPMessage[] getMessagesBySeqNumbers(int[] seqnums) {
      ...
      if (nulls > 0) {
         ...
         for(int var6 = 0; i < msgs.length; ++i) {
            if (msgs[i] != null) {
               nmsgs[var6++] = msgs[i];
            }
         }
   ...
   public static class FetchProfileItem extends FetchProfile.Item {
      ...
      public static final IMAPFolder.FetchProfileItem INTERNALDATE = new IMAPFolder.FetchProfileItem("INTERNALDATE");
