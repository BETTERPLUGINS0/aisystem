   ...
   public boolean authenticate(String[] mechs, final String realm, String authzid, final String u, final String p) throws ProtocolException {
      synchronized(this.pr) {
         ...
         try {
            ...
            this.logger.log(Level.FINE, "Failed to create SASL client", (Throwable)var20);
         ...
         if (sc == null) {
            ...
            try {
               ...
               if (this.pr.hasCapability("SASL-IR") && sc.hasInitialResponse()) {
                  ...
                  String irs;
                  if (CRLF.length > 0) {
                     CRLF = BASE64EncoderStream.encode(CRLF);
               ...
               this.logger.log(Level.FINE, "SASL AUTHENTICATE Exception", (Throwable)var22);
               return false;
            }
            ...
            while(!done) {
               try {
                  ...
                  this.logger.log(Level.FINE, "SASL Exception", (Throwable)var21);
