...
public class IMAPProtocol extends Protocol {
   ...
   public synchronized void authplain(String authzid, String u, String p) throws ProtocolException {
      ...
      try {
         ...
         for(BASE64EncoderStream b64os = new BASE64EncoderStream(bos, Integer.MAX_VALUE); !done; v.add(r)) {
            try {
               r = this.readResponse();
               if (r.isContinuation()) {
                  String nullByte = "\u0000";
      ...
      try {
         ...
         try {
            ...
            if (this.hasCapability("SASL-IR")) {
               ...
               b = BASE64EncoderStream.encode(resp.getBytes(StandardCharsets.UTF_8));
   ...
   public void sasllogin(String[] allowed, String realm, String authzid, String u, String p) throws ProtocolException {
      ...
      String[] mechs = (String[])((List)v).toArray(new String[((List)v).size()]);
   ...
   public void compress() throws ProtocolException {
      try {
         ...
         this.logger.log(Level.FINE, "COMPRESS ProtocolException", (Throwable)var3);
         throw var3;
      } catch (Exception var4) {
         this.logger.log(Level.FINE, "COMPRESS Exception", (Throwable)var4);
         Response[] r = new Response[]{Response.byeResponse(var4)};
         this.notifyResponseHandlers(r);
         this.disconnect();
   ...
   public int[] uidfetchChangedSince(long start, long end, long modseq) throws ProtocolException {
      ...
      Response[] r = this.command("UID FETCH " + msgSequence + " (FLAGS) (CHANGEDSINCE " + modseq + ")", (Argument)null);
