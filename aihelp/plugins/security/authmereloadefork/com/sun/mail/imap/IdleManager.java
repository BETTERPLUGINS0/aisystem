...
public class IdleManager {
   ...
   private void select() {
      ...
      try {
         ...
         this.logger.log(Level.FINEST, "IdleManager interrupted", (Throwable)var14);
      } catch (IOException var15) {
         this.logger.log(Level.FINEST, "IdleManager got I/O exception", (Throwable)var15);
      } catch (Exception var16) {
         this.logger.log(Level.FINEST, "IdleManager got exception", (Throwable)var16);
      } finally {
         this.die = true;
         ...
         try {
            ...
            this.logger.log(Level.FINEST, "IdleManager unwatch exception", (Throwable)var13);
         }
   ...
   private void watchAll() {
      ...
      while((folder = (IMAPFolder)this.toWatch.poll()) != null) {
         ...
         try {
            ...
            this.logger.log(Level.FINEST, "IdleManager can't register folder", (Throwable)var3);
   ...
   private void processKeys() throws IOException {
      ...
      while(it.hasNext()) {
         ...
         try {
            ...
            this.logger.log(Level.FINEST, "IdleManager got exception for folder: " + folderName(folder), (Throwable)var8);
         }
      }
      ...
      while(true) {
         while(true) {
            ...
            do {
               ...
               if (this.logger.isLoggable(Level.FINEST)) {
                  this.logger.log(Level.FINEST, "IdleManager aborting IDLE for folder: {0}", (Object)folderName(folder));
               }
   ...
   private void unwatchAll() {
      ...
      while(var3.hasNext()) {
         ...
         try {
            ...
            this.logger.log(Level.FINEST, "IdleManager exception while aborting idle for folder: " + folderName(folder), (Throwable)var8);
         }
      }

      while((folder = (IMAPFolder)this.toWatch.poll()) != null) {
         if (this.logger.isLoggable(Level.FINEST)) {
            this.logger.log(Level.FINEST, "IdleManager aborting IDLE for unwatched folder: {0}", (Object)folderName(folder));
         }
         ...
         if (sc != null) {
            try {
               ...
               this.logger.log(Level.FINEST, "IdleManager exception while aborting idle for folder: " + folderName(folder), (Throwable)var7);
            }
         }
      }
