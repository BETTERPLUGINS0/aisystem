...
public class CompactFormatter extends Formatter {
   ...
   private static Class<?>[] loadDeclaredClasses() {
      return new Class[]{CompactFormatter.Alternate.class};
   }
   ...
   public String format(LogRecord record) {
      ...
      Object[] params = new Object[]{this.formatZonedDateTime(record), this.formatSource(record), this.formatLoggerName(record), this.formatLevel(record), msg, thrown, new CompactFormatter.Alternate(msg, thrown), new CompactFormatter.Alternate(thrown, msg), record.getSequenceNumber(), this.formatThreadID(record), err, new CompactFormatter.Alternate(msg, err), new CompactFormatter.Alternate(err, msg), this.formatBackTrace(record), record.getResourceBundleName(), record.getMessage()};
