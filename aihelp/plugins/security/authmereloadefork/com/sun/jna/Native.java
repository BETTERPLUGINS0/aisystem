...
public final class Native implements Version {
   ...
   private static void unregisterAll() {
      synchronized(registeredClasses) {
         ...
         while(var1.hasNext()) {
            Entry<Class<?>, long[]> e = (Entry)var1.next();
   ...
   public static void main(String[] args) {
      ...
      String version = pkg != null ? pkg.getSpecificationVersion() : "5.8.0";
      if (version == null) {
         version = "5.8.0";
      }
      ...
      version = pkg != null ? pkg.getImplementationVersion() : "5.8.0 (package information missing)";
      if (version == null) {
