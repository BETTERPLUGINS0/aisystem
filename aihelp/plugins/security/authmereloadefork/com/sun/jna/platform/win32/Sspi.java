...
public interface Sspi {
   int MAX_TOKEN_SIZE = VersionHelpers.IsWindows8OrGreater() ? '뮀' : 12000;
   ...
   public static class SecPkgContext_Flags extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgContext_Flags implements Structure.ByReference {
      }
   }
   ...
   public static class SecPkgContext_NegotiationInfo extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgContext_NegotiationInfo implements Structure.ByReference {
      }
   }
   ...
   public static class SecPkgContext_Lifespan extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgContext_Lifespan implements Structure.ByReference {
      }
   }
   ...
   public static class SecPkgContext_SessionKey extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgContext_SessionKey implements Structure.ByReference {
      }
   }
   ...
   public static class SecPkgContext_Sizes extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgContext_Sizes implements Structure.ByReference {
      }
   }
   ...
   public static class SecPkgCredentials_Names extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgCredentials_Names implements Structure.ByReference {
      }
   }
   ...
   public static class SecPkgContext_PackageInfo extends Structure {
      ...
      public static class ByReference extends Sspi.SecPkgContext_PackageInfo implements Structure.ByReference {
      }
   }
