...
public interface Crypt32 extends StdCallLibrary {
   ...
   WinCrypt.HCERTSTORE CertOpenStore(WinCrypt.CertStoreProviderName var1, int var2, WinCrypt.HCRYPTPROV_LEGACY var3, int var4, Pointer var5);

   WinCrypt.HCERTSTORE CertOpenStore(WinCrypt.CertStoreProviderName var1, int var2, WinCrypt.HCRYPTPROV_LEGACY var3, int var4, WTypes.LPWSTR var5);
   ...
   WinCrypt.CERT_CONTEXT.ByReference CertEnumCertificatesInStore(WinCrypt.HCERTSTORE var1, Pointer var2);

   WinCrypt.CTL_CONTEXT.ByReference CertEnumCTLsInStore(WinCrypt.HCERTSTORE var1, Pointer var2);

   WinCrypt.CRL_CONTEXT.ByReference CertEnumCRLsInStore(WinCrypt.HCERTSTORE var1, Pointer var2);

   boolean CryptQueryObject(int var1, Pointer var2, int var3, int var4, int var5, IntByReference var6, IntByReference var7, IntByReference var8, PointerByReference var9, PointerByReference var10, PointerByReference var11);
}
