...
public class TypeInfoUtil {
   ...
   public TypeInfoUtil.Invoke Invoke(WinDef.PVOID pvInstance, OaIdl.MEMBERID memid, WinDef.WORD wFlags, OleAuto.DISPPARAMS.ByReference pDispParams) {
      ...
      COMUtils.checkRC(hr);
      return new TypeInfoUtil.Invoke(pVarResult, pExcepInfo, puArgErr.getValue().intValue());
   }
   ...
   public TypeInfoUtil.TypeInfoDoc getDocumentation(OaIdl.MEMBERID memid) {
      ...
      COMUtils.checkRC(hr);
      TypeInfoUtil.TypeInfoDoc TypeInfoDoc = new TypeInfoUtil.TypeInfoDoc(pBstrName.getString(), pBstrDocString.getString(), pdwHelpContext.getValue().intValue(), pBstrHelpFile.getString());
   ...
   public TypeInfoUtil.DllEntry GetDllEntry(OaIdl.MEMBERID memid, OaIdl.INVOKEKIND invKind) {
      ...
      OLEAUTO.SysFreeString(pBstrName.getValue());
      return new TypeInfoUtil.DllEntry(pBstrDllName.getString(), pBstrName.getString(), pwOrdinal.getValue().intValue());
   }
   ...
   public TypeInfoUtil.ContainingTypeLib GetContainingTypeLib() {
      ...
      COMUtils.checkRC(hr);
      return new TypeInfoUtil.ContainingTypeLib(new TypeLib(ppTLib.getValue()), pIndex.getValue().intValue());
   }
