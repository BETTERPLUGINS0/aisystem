...
public interface OleAuto extends StdCallLibrary {
   ...
   int VariantTimeToSystemTime(double var1, WinBase.SYSTEMTIME var3);
   ...
   public static class DISPPARAMS extends Structure {
      ...
      public static class ByReference extends OleAuto.DISPPARAMS implements Structure.ByReference {
      }
   }
}
