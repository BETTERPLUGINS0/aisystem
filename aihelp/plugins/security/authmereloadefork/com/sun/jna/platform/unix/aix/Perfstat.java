...
public interface Perfstat extends Library {
   ...
   int perfstat_cpu_total(Perfstat.perfstat_id_t var1, Perfstat.perfstat_cpu_total_t var2, int var3, int var4);

   int perfstat_cpu(Perfstat.perfstat_id_t var1, Perfstat.perfstat_cpu_t[] var2, int var3, int var4);

   int perfstat_memory_total(Perfstat.perfstat_id_t var1, Perfstat.perfstat_memory_total_t var2, int var3, int var4);

   int perfstat_process(Perfstat.perfstat_id_t var1, Perfstat.perfstat_process_t[] var2, int var3, int var4);

   int perfstat_disk(Perfstat.perfstat_id_t var1, Perfstat.perfstat_disk_t[] var2, int var3, int var4);

   int perfstat_partition_config(Perfstat.perfstat_id_t var1, Perfstat.perfstat_partition_config_t var2, int var3, int var4);

   int perfstat_netinterface(Perfstat.perfstat_id_t var1, Perfstat.perfstat_netinterface_t[] var2, int var3, int var4);

   int perfstat_protocol(Perfstat.perfstat_id_t var1, Perfstat.perfstat_protocol_t[] var2, int var3, int var4);

   @Structure.FieldOrder({"name", "u", "version"})
   public static class perfstat_protocol_t extends Structure {
      public byte[] name = new byte[64];
      public Perfstat.perfstat_protocol_t.AnonymousUnionPayload u;
      public long version;
   ...
   @Structure.FieldOrder({"name", "description", "vgname", "size", "free", "bsize", "xrate", "xfers", "wblks", "rblks", "qdepth", "time", "adapter", "paths_count", "q_full", "rserv", "rtimeout", "rfailed", "min_rserv", "max_rserv", "wserv", "wtimeout", "wfailed", "min_wserv", "max_wserv", "wq_depth", "wq_sampled", "wq_time", "wq_min_time", "wq_max_time", "q_sampled", "wpar_id", "version", "dk_type"})
