...
public interface WinUser extends WinDef {
   ...
   public interface MONITORENUMPROC extends StdCallLibrary.StdCallCallback {
      int apply(WinUser.HMONITOR var1, WinDef.HDC var2, WinDef.RECT var3, WinDef.LPARAM var4);
   }
   ...
   public static class WNDCLASSEX extends Structure {
      ...
      public static class ByReference extends WinUser.WNDCLASSEX implements Structure.ByReference {
      }
   }
   ...
   public interface LowLevelMouseProc extends WinUser.HOOKPROC {
      WinDef.LRESULT callback(int var1, WinDef.WPARAM var2, WinUser.MSLLHOOKSTRUCT var3);
   }
