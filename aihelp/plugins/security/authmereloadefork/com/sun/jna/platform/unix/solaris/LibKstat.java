...
public interface LibKstat extends Library {
   ...
   int kstat_close(LibKstat.KstatCtl var1);

   int kstat_chain_update(LibKstat.KstatCtl var1);

   int kstat_read(LibKstat.KstatCtl var1, LibKstat.Kstat var2, Pointer var3);

   int kstat_write(LibKstat.KstatCtl var1, LibKstat.Kstat var2, Pointer var3);

   LibKstat.Kstat kstat_lookup(LibKstat.KstatCtl var1, String var2, int var3, String var4);

   Pointer kstat_data_lookup(LibKstat.Kstat var1, String var2);
   ...
   public static class KstatNamed extends Structure {
      ...
      public LibKstat.KstatNamed.UNION value;
      ...
      public void read() {
         ...
         default:
            break;
         case 9:
            this.value.setType(LibKstat.KstatNamed.UNION.STR.class);
         }
      ...
      public static class UNION extends Union {
         ...
         public long i64;
         public long ui64;
         public LibKstat.KstatNamed.UNION.STR str;
   ...
   public static class Kstat extends Structure {
      ...
      public LibKstat.Kstat next() {
         if (this.ks_next == null) {
            ...
            LibKstat.Kstat n = new LibKstat.Kstat();
