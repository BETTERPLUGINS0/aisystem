...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
   ...
   WinNT.HANDLE OpenFileMapping(int var1, boolean var2, String var3);
   ...
   WinNT.HRESULT RegisterApplicationRestart(char[] var1, int var2);

   WinNT.HRESULT UnregisterApplicationRestart();

   WinNT.HRESULT GetApplicationRestartSettings(WinNT.HANDLE var1, char[] var2, IntByReference var3, IntByReference var4);

   boolean VirtualLock(Pointer var1, BaseTSD.SIZE_T var2);

   boolean VirtualUnlock(Pointer var1, BaseTSD.SIZE_T var2);
}
