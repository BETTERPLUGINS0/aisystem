...
public abstract class Winnetwk {
   ...
   public static class REMOTE_NAME_INFO extends Structure {
      ...
      public static class ByReference extends Winnetwk.REMOTE_NAME_INFO implements Structure.ByReference {
         public ByReference() {
         }
   ...
   public static class NETRESOURCE extends Structure {
      ...
      public static class ByReference extends Winnetwk.NETRESOURCE implements Structure.ByReference {
         public ByReference() {
         }
