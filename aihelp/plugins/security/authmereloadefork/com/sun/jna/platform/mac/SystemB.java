...
public interface SystemB extends LibCAPI, Library {
   ...
   int gettimeofday(SystemB.Timeval var1, SystemB.Timezone var2);
   ...
   SystemB.Passwd getpwuid(int var1);

   SystemB.Group getgrgid(int var1);
   ...
   int proc_pid_rusage(int var1, int var2, SystemB.RUsageInfoV2 var3);

   int getfsstat64(SystemB.Statfs[] var1, int var2, int var3);
