...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
   ...
   int SECTION_ALL_ACCESS = 983071;
   int SECTION_MAP_EXECUTE_EXPLICIT = 32;
   ...
   int REG_NOTIFY_THREAD_AGNOSTIC = 268435456;
   int REG_LEGAL_CHANGE_FILTER = 268435471;
   int REG_NONE = 0;
   int REG_SZ = 1;
   int REG_EXPAND_SZ = 2;
   int REG_BINARY = 3;
   ...
   public static class SYSTEM_POWER_CAPABILITIES extends Structure {
      ...
      public WinNT.BATTERY_REPORTING_SCALE[] BatteryScale = new WinNT.BATTERY_REPORTING_SCALE[3];
   ...
   public static class SYSTEM_POWER_POLICY extends Structure {
      ...
      public WinNT.SYSTEM_POWER_LEVEL[] DischargePolicy = new WinNT.SYSTEM_POWER_LEVEL[4];
   ...
   public static class UNKNOWN_RELATIONSHIP extends WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
   ...
   public static class GROUP_RELATIONSHIP extends WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
      public short maximumGroupCount;
      public short activeGroupCount;
      public byte[] reserved = new byte[20];
      public WinNT.PROCESSOR_GROUP_INFO[] groupInfo = new WinNT.PROCESSOR_GROUP_INFO[1];
      ...
      public void read() {
         ...
         if (this.activeGroupCount != this.groupInfo.length) {
            this.groupInfo = new WinNT.PROCESSOR_GROUP_INFO[this.activeGroupCount];
         }
   ...
   public static class CACHE_RELATIONSHIP extends WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
      public byte level;
   ...
   public static class NUMA_NODE_RELATIONSHIP extends WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
      public int nodeNumber;
      public byte[] reserved = new byte[18];
      public short groupCount;
      public WinNT.GROUP_AFFINITY groupMask;
      public WinNT.GROUP_AFFINITY[] groupMasks = new WinNT.GROUP_AFFINITY[1];
      ...
      public void read() {
         ...
         if (actualGroupCount != this.groupMasks.length) {
            this.groupMasks = new WinNT.GROUP_AFFINITY[actualGroupCount];
         }
   ...
   public static class PROCESSOR_RELATIONSHIP extends WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
      public byte flags;
      public byte efficiencyClass;
      public byte[] reserved = new byte[20];
      public short groupCount;
      public WinNT.GROUP_AFFINITY[] groupMask = new WinNT.GROUP_AFFINITY[1];
      ...
      public void read() {
         ...
         if (this.groupCount != this.groupMask.length) {
            this.groupMask = new WinNT.GROUP_AFFINITY[this.groupCount];
         }
   ...
   public abstract static class SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX extends Structure {
      ...
      public static WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX fromPointer(Pointer memory) {
         ...
         case 5:
         case 7:
            result = new WinNT.PROCESSOR_RELATIONSHIP(memory);
            break;
         case 1:
         case 6:
            result = new WinNT.NUMA_NODE_RELATIONSHIP(memory);
            break;
         case 2:
            result = new WinNT.CACHE_RELATIONSHIP(memory);
            break;
         case 4:
            result = new WinNT.GROUP_RELATIONSHIP(memory);
            break;
         default:
            result = new WinNT.UNKNOWN_RELATIONSHIP(memory);
         }

         ((WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX)result).read();
         return (WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX)result;
      }
   }
   ...
   public static class GENERIC_MAPPING extends Structure {
      ...
      public static class ByReference extends WinNT.GENERIC_MAPPING implements Structure.ByReference {
      }
   }
   ...
   public abstract static class ACCESS_ACEStructure extends WinNT.ACE_HEADER {
      public int Mask;
      ...
      public void read() {
         ...
         int sizeOfSID = super.AceSize - super.fieldOffset("SidStart");
         if (sizeOfSID > 0) {
            this.psid = new WinNT.PSID(this.getPointer().getByteArray((long)offsetOfSID, sizeOfSID));
         } else {
            this.psid = new WinNT.PSID();
         }
   ...
   public static class SECURITY_DESCRIPTOR_RELATIVE extends Structure {
      ...
      private final void setMembers() {
         ...
         if (this.Sacl != 0) {
            this.SACL = new WinNT.ACL(this.getPointer().share((long)this.Sacl));
         }

         if (this.Group != 0) {
            this.GROUP = new WinNT.PSID(this.getPointer().share((long)this.Group));
         }

         if (this.Owner != 0) {
            this.OWNER = new WinNT.PSID(this.getPointer().share((long)this.Owner));
         }
   ...
   public static class PACLByReference extends com.sun.jna.ptr.ByReference {
      ...
      public WinNT.ACL getValue() {
         ...
         return p == null ? null : new WinNT.ACL(p);
      }
   }
   ...
   public static class ACL extends Structure {
      ...
      public WinNT.ACE_HEADER[] getACEs() {
         WinNT.ACE_HEADER[] ACEs = new WinNT.ACE_HEADER[this.AceCount];
         ...
         for(int i = 0; i < this.AceCount; ++i) {
            ...
            switch(aceType) {
            case 0:
               ACEs[i] = new WinNT.ACCESS_ALLOWED_ACE(share);
               break;
            case 1:
               ACEs[i] = new WinNT.ACCESS_DENIED_ACE(share);
               break;
            default:
               ACEs[i] = new WinNT.ACE_HEADER(share);
            }
   ...
   public static class LARGE_INTEGER extends Structure implements Comparable<WinNT.LARGE_INTEGER> {
      ...
      public LARGE_INTEGER(long value) {
         this.u = new WinNT.LARGE_INTEGER.UNION(value);
      }
   ...
   public static class TOKEN_PRIVILEGES extends Structure {
      ...
      public TOKEN_PRIVILEGES(Pointer p) {
         ...
         this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[count];
         this.read();
      }
   }
