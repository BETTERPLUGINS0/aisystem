...
public interface User32 extends StdCallLibrary, WinUser, WinNT {
   ...
   boolean BringWindowToTop(WinDef.HWND var1);
   ...
   WinDef.LRESULT CallWindowProc(Pointer var1, WinDef.HWND var2, int var3, WinDef.WPARAM var4, WinDef.LPARAM var5);
   ...
   WinDef.HWND GetParent(WinDef.HWND var1);
