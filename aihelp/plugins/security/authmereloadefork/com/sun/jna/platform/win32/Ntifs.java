...
public interface Ntifs extends WinDef, BaseTSD {
   ...
   public static class REPARSE_DATA_BUFFER extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(Ntifs.REPARSE_DATA_BUFFER.class, (Object)null);
      }
      ...
      public static class REPARSE_UNION extends Union {
         ...
         public static class ByReference extends Ntifs.REPARSE_DATA_BUFFER.REPARSE_UNION implements Structure.ByReference {
         }
      }

      public static class ByReference extends Ntifs.REPARSE_DATA_BUFFER implements Structure.ByReference {
         public ByReference() {
         }
   ...
   public static class GenericReparseBuffer extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(Ntifs.GenericReparseBuffer.class, (Object)null);
      }
      ...
      public static class ByReference extends Ntifs.GenericReparseBuffer implements Structure.ByReference {
         public ByReference() {
         }
   ...
   public static class MountPointReparseBuffer extends Structure {
      ...
      public static int sizeOf() {
         return Native.getNativeSize(Ntifs.MountPointReparseBuffer.class, (Object)null);
      }
      ...
      public static class ByReference extends Ntifs.MountPointReparseBuffer implements Structure.ByReference {
         public ByReference() {
         }
   ...
   public static class SymbolicLinkReparseBuffer extends Structure {
      ...
      public static class ByReference extends Ntifs.SymbolicLinkReparseBuffer implements Structure.ByReference {
         public ByReference() {
         }
