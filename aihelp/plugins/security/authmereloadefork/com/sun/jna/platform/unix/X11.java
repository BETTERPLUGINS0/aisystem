...
public interface X11 extends Library {
   ...
   boolean XQueryExtension(X11.Display var1, String var2, IntByReference var3, IntByReference var4, IntByReference var5);
   ...
   int XSetWMProtocols(X11.Display var1, X11.Window var2, X11.Atom[] var3, int var4);

   int XGetWMProtocols(X11.Display var1, X11.Window var2, PointerByReference var3, IntByReference var4);
   ...
   boolean XGetEventData(X11.Display var1, X11.XGenericEventCookie var2);

   void XFreeEventData(X11.Display var1, X11.XGenericEventCookie var2);
   ...
   int XGrabKeyboard(X11.Display var1, X11.Window var2, int var3, int var4, int var5, NativeLong var6);

   int XUngrabKeyboard(X11.Display var1, NativeLong var2);

   int XFetchName(X11.Display var1, X11.Window var2, PointerByReference var3);
   ...
   @Structure.FieldOrder({"type", "serial", "send_event", "display", "extension", "evtype", "cookie", "data"})
   ...
   @Structure.FieldOrder({"type", "serial", "send_event", "display", "extension", "evtype"})
   ...
   public static class XEvent extends Union {
      ...
      public X11.XGenericEvent xgeneric;
      public X11.XGenericEventCookie xcookie;
   ...
   public interface XTest extends Library {
      X11.XTest INSTANCE = (X11.XTest)Native.load("Xtst", X11.XTest.class);
   ...
   public interface Xevie extends Library {
      X11.Xevie INSTANCE = (X11.Xevie)Native.load("Xevie", X11.Xevie.class);
   ...
   public interface Xrender extends Library {
      X11.Xrender INSTANCE = (X11.Xrender)Native.load("Xrender", X11.Xrender.class);
      ...
      public static class PictFormat extends X11.XID {
         ...
         public Object fromNative(Object nativeValue, FromNativeContext context) {
            return this.isNone(nativeValue) ? None : new X11.Xrender.PictFormat(((Number)nativeValue).longValue());
         }
      }
   ...
   public interface Xext extends Library {
      X11.Xext INSTANCE = (X11.Xext)Native.load("Xext", X11.Xext.class);
      int ShapeBounding = 0;
      int ShapeClip = 1;
      int ShapeInput = 2;
      int ShapeSet = 0;
   ...
   public static class Visual extends PointerType {
      public X11.VisualID getVisualID() {
         if (this.getPointer() != null) {
            return new X11.VisualID(this.getPointer().getNativeLong((long)Native.POINTER_SIZE).longValue());
         } else {
   ...
   public static class VisualID extends NativeLong {
      private static final long serialVersionUID = 1L;
      public static final X11.VisualID None = null;
      ...
      public Object fromNative(Object nativeValue, FromNativeContext context) {
         return this.isNone(nativeValue) ? None : new X11.VisualID(((Number)nativeValue).longValue());
      }
   }
}
