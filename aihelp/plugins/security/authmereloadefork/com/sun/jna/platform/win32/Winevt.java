...
public interface Winevt {
   ...
   public static class EVT_RPC_LOGIN extends Structure {
      ...
      public static class ByValue extends Winevt.EVT_RPC_LOGIN implements Structure.ByValue {
      }

      public static class ByReference extends Winevt.EVT_RPC_LOGIN implements Structure.ByReference {
      }
   }
   ...
   public static class EVT_VARIANT extends Structure {
      ...
      public Object getValue() {
         Winevt.EVT_VARIANT_TYPE type = this.getVariantType();
         int i;
         switch(type) {
         case EvtVarTypeAnsiString:
      ...
      public static class ByValue extends Winevt.EVT_VARIANT implements Structure.ByValue {
      ...
      public static class ByReference extends Winevt.EVT_VARIANT implements Structure.ByReference {
