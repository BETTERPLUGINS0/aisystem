      ...
      public String getProcessFilePath(WinDef.HWND hwnd) {
         ...
         try {
            ...
            if (processImagePath.startsWith("\\Device\\Mup\\")) {
               String var21 = "\\" + processImagePath.substring(11);
               return var21;
            } else {
               ...
               if (h != null && !h.equals(WinBase.INVALID_HANDLE_VALUE)) {
                  ...
                  try {
                     label241:
                     do {
                        volumePath = Native.toString(volumeUUID);
                        Iterator var8 = Kernel32Util.getVolumePathNamesForVolumeName(volumePath).iterator();
                        ...
                        while(true) {
                           ...
                           Iterator var10 = Kernel32Util.queryDosDevice(s.substring(0, 2), 1024).iterator();

                           while(var10.hasNext()) {
                              String path = (String)var10.next();
                              if (processImagePath.startsWith(path)) {
                                 String var12 = s + processImagePath.substring(path.length() + 1);
                                 return var12;
                              }
                           }
                        }
