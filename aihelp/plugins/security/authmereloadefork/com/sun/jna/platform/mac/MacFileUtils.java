...
public class MacFileUtils extends FileUtils {
   ...
   public void moveToTrash(File... files) throws IOException {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if (status != 0) {
            ...
            status = MacFileUtils.FileManager.INSTANCE.FSMoveObjectToTrashSync(fsref, (MacFileUtils.FileManager.FSRef)null, 0);
            if (status != 0) {
   ...
   public interface FileManager extends Library {
      MacFileUtils.FileManager INSTANCE = (MacFileUtils.FileManager)Native.load("CoreServices", MacFileUtils.FileManager.class);
      ...
      int FSRefMakePath(MacFileUtils.FileManager.FSRef var1, byte[] var2, int var3);

      int FSPathMakeRef(String var1, int var2, ByteByReference var3);

      int FSPathMakeRefWithOptions(String var1, int var2, MacFileUtils.FileManager.FSRef var3, ByteByReference var4);

      int FSPathMoveObjectToTrashSync(String var1, PointerByReference var2, int var3);

      int FSMoveObjectToTrashSync(MacFileUtils.FileManager.FSRef var1, MacFileUtils.FileManager.FSRef var2, int var3);
