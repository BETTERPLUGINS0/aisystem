      ...
      public <V> Future<V> runAsync(Callable<V> command) {
         while(this.nativeThreadId == 0) {
            try {
               ...
               Logger.getLogger(User32Util.MessageLoopThread.class.getName()).log(Level.SEVERE, (String)null, var3);
            }
         }
      ...
      public <V> V runOnThread(Callable<V> callable) throws Exception {
         while(this.javaThreadId == 0L) {
            try {
               ...
               Logger.getLogger(User32Util.MessageLoopThread.class.getName()).log(Level.SEVERE, (String)null, var5);
            }
         }
         ...
         if (this.javaThreadId == Thread.currentThread().getId()) {
            ...
            Future ft = this.runAsync(callable);
