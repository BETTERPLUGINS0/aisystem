...
public interface Variant {
   ...
   public static class VariantArg extends Structure {
      public Variant.VARIANT[] variantArg;

      public VariantArg() {
         this.variantArg = new Variant.VARIANT[1];
      }
      ...
      public void setArraySize(int size) {
         this.variantArg = new Variant.VARIANT[size];
         this.read();
      }
      ...
      public static class ByReference extends Variant.VariantArg implements Structure.ByReference {
         ...
         public ByReference(Variant.VARIANT[] variantArg) {
            super(variantArg);
         }
      }
   }
   ...
   public static class VARIANT extends Union {
      public static final Variant.VARIANT VARIANT_MISSING = new Variant.VARIANT();
      ...
      public static class _VARIANT extends Structure {
         ...
         public Variant.VARIANT._VARIANT.__VARIANT __variant;
      ...
      public static class ByValue extends Variant.VARIANT implements Structure.ByValue {
