...
public interface SetupApi extends StdCallLibrary {
   ...
   boolean SetupDiEnumDeviceInterfaces(WinNT.HANDLE var1, Pointer var2, Guid.GUID var3, int var4, SetupApi.SP_DEVICE_INTERFACE_DATA var5);

   boolean SetupDiGetDeviceInterfaceDetail(WinNT.HANDLE var1, SetupApi.SP_DEVICE_INTERFACE_DATA var2, Pointer var3, int var4, IntByReference var5, SetupApi.SP_DEVINFO_DATA var6);

   boolean SetupDiGetDeviceRegistryProperty(WinNT.HANDLE var1, SetupApi.SP_DEVINFO_DATA var2, int var3, IntByReference var4, Pointer var5, int var6, IntByReference var7);

   WinReg.HKEY SetupDiOpenDevRegKey(WinNT.HANDLE var1, SetupApi.SP_DEVINFO_DATA var2, int var3, int var4, int var5, int var6);

   boolean SetupDiEnumDeviceInfo(WinNT.HANDLE var1, int var2, SetupApi.SP_DEVINFO_DATA var3);
