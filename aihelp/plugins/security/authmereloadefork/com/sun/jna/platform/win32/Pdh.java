...
public interface Pdh extends StdCallLibrary {
   ...
   int PdhMakeCounterPath(Pdh.PDH_COUNTER_PATH_ELEMENTS var1, char[] var2, WinDef.DWORDByReference var3, int var4);
   ...
   int PdhGetRawCounterValue(WinNT.HANDLE var1, WinDef.DWORDByReference var2, Pdh.PDH_RAW_COUNTER var3);
   ...
   int PdhSetQueryTimeRange(WinNT.HANDLE var1, Pdh.PDH_TIME_INFO var2);
