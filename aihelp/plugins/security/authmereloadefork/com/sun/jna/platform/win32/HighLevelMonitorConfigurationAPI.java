   ...
   public static enum MC_COLOR_TEMPERATURE {
      ...
      public static class ByReference extends com.sun.jna.ptr.ByReference {
         ...
         public HighLevelMonitorConfigurationAPI.MC_COLOR_TEMPERATURE getValue() {
            return (HighLevelMonitorConfigurationAPI.MC_COLOR_TEMPERATURE)EnumUtils.fromInteger(this.getPointer().getInt(0L), HighLevelMonitorConfigurationAPI.MC_COLOR_TEMPERATURE.class);
         }
      }
   }
   ...
   public static enum MC_DISPLAY_TECHNOLOGY_TYPE {
      ...
      public static class ByReference extends com.sun.jna.ptr.ByReference {
         ...
         public HighLevelMonitorConfigurationAPI.MC_DISPLAY_TECHNOLOGY_TYPE getValue() {
            return (HighLevelMonitorConfigurationAPI.MC_DISPLAY_TECHNOLOGY_TYPE)EnumUtils.fromInteger(this.getPointer().getInt(0L), HighLevelMonitorConfigurationAPI.MC_DISPLAY_TECHNOLOGY_TYPE.class);
         }
      }
   }
