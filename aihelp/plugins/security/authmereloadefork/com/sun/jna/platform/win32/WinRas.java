...
public interface WinRas {
   ...
   public static class RASENTRY extends Structure {
      ...
      public static class ByReference extends WinRas.RASENTRY implements Structure.ByReference {
      }
   }
   ...
   public static class RASTUNNELENDPOINT extends Structure {
      public int dwType;
      public WinRas.RASTUNNELENDPOINT.UNION u;
      ...
      public void read() {
         ...
         switch(this.dwType) {
         case 1:
            this.u.setType(WinRas.RASIPV4ADDR.class);
            break;
         case 2:
            this.u.setType(WinRas.RASIPV6ADDR.class);
            break;
         default:
            this.u.setType(WinRas.RASIPV4ADDR.class);
         }
      ...
      public static class UNION extends Union {
         ...
         public static class ByReference extends WinRas.RASTUNNELENDPOINT.UNION implements Structure.ByReference {
         }
      }
   }
   ...
   public static class RASCONN extends Structure {
      ...
      public static class ByReference extends WinRas.RASCONN implements Structure.ByReference {
      }
   }
