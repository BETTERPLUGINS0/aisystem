...
public class TypeLibUtil {
   ...
   private void initTypeLibInfo() {
      TypeLibUtil.TypeLibDoc documentation = this.getDocumentation(-1);
   ...
   public TypeLibUtil.TypeLibDoc getDocumentation(int index) {
      ...
      COMUtils.checkRC(hr);
      TypeLibUtil.TypeLibDoc typeLibDoc = new TypeLibUtil.TypeLibDoc(pBstrName.getString(), pBstrDocString.getString(), pdwHelpContext.getValue().intValue(), pBstrHelpFile.getString());
   ...
   public TypeLibUtil.IsName IsName(String nameBuf, int hashVal) {
      ...
      COMUtils.checkRC(hr);
      return new TypeLibUtil.IsName(szNameBuf.getValue(), pfName.getValue().booleanValue());
   }
   ...
   public TypeLibUtil.FindName FindName(String name, int hashVal, short maxResult) {
      ...
      COMUtils.checkRC(hr);
      TypeLibUtil.FindName findName = new TypeLibUtil.FindName(olestr.getValue(), ppTInfo, rgMemId, pcFound.getValue().shortValue());
