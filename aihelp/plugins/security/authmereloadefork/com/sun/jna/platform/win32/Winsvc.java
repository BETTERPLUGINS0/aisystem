...
public interface Winsvc {
   ...
   public static class SERVICE_FAILURE_ACTIONS_FLAG extends Winsvc.ChangeServiceConfig2Info {
   ...
   public static class SC_ACTION extends Structure {
      ...
      public static class ByReference extends Winsvc.SC_ACTION implements Structure.ByReference {
      }
   }

   @Structure.FieldOrder({"dwResetPeriod", "lpRebootMsg", "lpCommand", "cActions", "lpsaActions"})
   public static class SERVICE_FAILURE_ACTIONS extends Winsvc.ChangeServiceConfig2Info {
      ...
      public static class ByReference extends Winsvc.SERVICE_FAILURE_ACTIONS implements Structure.ByReference {
      }
   }
