...
public interface Guid {
   Guid.IID IID_NULL = new Guid.IID();

   public static class IID extends Guid.GUID {
      public IID() {
      }
   ...
   public static class REFIID extends PointerType {
      ...
      public Guid.IID getValue() {
         return new Guid.IID(this.getPointer());
      }
      ...
      public boolean equals(Object o) {
         if (o == null) {
            ...
            Guid.REFIID other = (Guid.REFIID)o;
   ...
   public static class CLSID extends Guid.GUID {
      public CLSID() {
      }
   ...
   public static class GUID extends Structure {
      ...
      public static Guid.GUID fromBinary(byte[] data) {
         if (data.length != 16) {
            ...
            Guid.GUID newGuid = new Guid.GUID();
      ...
      public static Guid.GUID newGuid() {
         ...
         return new Guid.GUID(randomBytes);
      }
      ...
      public static class ByValue extends Guid.GUID implements Structure.ByValue {
         public ByValue() {
         }
