...
public abstract class Structure {
   ...
   private final Map<String, Structure.NativeStringTracking> nativeStrings;
      ...
      if (this.memory != PLACEHOLDER_MEMORY) {
         ...
         if (busy().add(this)) {
            ...
            try {
               ...
               busy().remove(this);
               if (this instanceof Structure.ByReference && reading().get(this.getPointer()) == this) {
   ...
   protected Object readField(Structure.StructField structField) {
      ...
      if (fieldType.equals(String.class) || fieldType.equals(WString.class)) {
         if (result != null) {
            Structure.NativeStringTracking current = new Structure.NativeStringTracking(result);
            Structure.NativeStringTracking previous = (Structure.NativeStringTracking)this.nativeStrings.put(structField.name, current);
            if (previous != null) {
   ...
   private void writeField(Structure.StructField structField, Object value) {
      int offset = structField.offset;
      Class<?> fieldType = structField.type;
      ...
      if (String.class == fieldType || WString.class == fieldType) {
         if (value != null) {
            Structure.NativeStringTracking current = new Structure.NativeStringTracking(value);
            Structure.NativeStringTracking previous = (Structure.NativeStringTracking)this.nativeStrings.put(structField.name, current);
      ...
      try {
         ...
         throw new IllegalArgumentException(msg, var10);
      }
   }
   ...
   protected List<String> getFieldOrder() {
      ...
      for(Class clazz = this.getClass(); clazz != Structure.class; clazz = clazz.getSuperclass()) {
         Structure.FieldOrder order = (Structure.FieldOrder)clazz.getAnnotation(Structure.FieldOrder.class);
         if (order != null) {
   ...
   static class FFIType extends Structure {
      private static final Map<Class, Structure.FFIType> typeInfoMap = new WeakHashMap();
      private static final Map<Class, Structure.FFIType> unionHelper = new WeakHashMap();
      private static final Map<Pointer, Structure.FFIType> ffiTypeInfo = new HashMap();
      ...
      private static boolean isIntegerType(Structure.FFIType type) {
      ...
      private static boolean isFloatType(Structure.FFIType type) {
         Pointer typePointer = type.getPointer();
      ...
      public FFIType(Structure ref) {
         ...
         if (ref instanceof Union) {
            Structure.FFIType unionType = null;
            int size = 0;
               ...
               do {
                  if (!var6.hasNext()) {
                     if ((Platform.isIntel() && Platform.is64Bit() && !Platform.isWindows() || Platform.isARM()) && hasInteger && isFloatType(unionType)) {
                        unionType = new Structure.FFIType(unionType);
                        if (unionType.size.intValue() == 4) {
                           unionType.type = ((Structure.FFIType)ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint32)).type;
                        } else if (unionType.size.intValue() == 8) {
                           unionType.type = ((Structure.FFIType)ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint64)).type;
                        }
                  ...
                  sf = (Structure.StructField)var6.next();
            ...
            for(Iterator var10 = ref.fields().values().iterator(); var10.hasNext(); els[idx++] = ref.getFieldTypeInfo(sf).getPointer()) {
               sf = (Structure.StructField)var10.next();
            }
         }
      ...
      static Structure.FFIType get(Object obj) {
         if (obj == null) {
            return (Structure.FFIType)typeInfoMap.get(Pointer.class);
         } else {
            return obj instanceof Class ? get((Object)null, (Class)obj) : get(obj, obj.getClass());
         }
      }

      private static Structure.FFIType get(Object obj, Class<?> cls) {
         ...
         synchronized(typeInfoMap) {
            Structure.FFIType o = (Structure.FFIType)typeInfoMap.get(cls);
            if (o != null) {
               return o;
      ...
      static {
         if (Native.POINTER_SIZE == 0) {
            ...
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_void, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_void));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_float, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_float));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_double, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_double));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_longdouble, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_longdouble));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_uint8, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint8));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_sint8, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint8));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_uint16, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint16));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_sint16, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint16));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_uint32, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint32));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_sint32, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint32));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_uint64, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_uint64));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_sint64, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_sint64));
            ffiTypeInfo.put(Structure.FFIType.FFITypes.ffi_type_pointer, Structure.newInstance(Structure.FFIType.class, Structure.FFIType.FFITypes.ffi_type_pointer));
            Iterator var0 = ffiTypeInfo.values().iterator();

            while(var0.hasNext()) {
               Structure.FFIType f = (Structure.FFIType)var0.next();
               f.read();
            }
            ...
            Structure.FFIType ctype = Native.WCHAR_SIZE == 2 ? (Structure.FFIType)ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint16) : (Structure.FFIType)ffiTypeInfo.get(Structure.FFIType.FFITypes.ffi_type_uint32);
