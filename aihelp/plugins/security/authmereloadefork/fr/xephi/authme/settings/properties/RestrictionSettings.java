...
public final class RestrictionSettings implements SettingsHolder {
   ...
   public static final Property<Set<String>> ALLOW_COMMANDS = PropertyInitializer.newLowercaseStringSetProperty("settings.restrictions.allowCommands", "/login", "/log", "/l", "/register", "/reg", "/email", "/captcha", "/2fa", "/totp");
   @Comment({"Max number of allowed registrations per IP", "The value 0 means an unlimited number of registrations!"})
   public static final Property<Integer> MAX_REGISTRATION_PER_IP = PropertyInitializer.newProperty("settings.restrictions.maxRegPerIp", (int)3);
   @Comment({"Minimum allowed username length"})
   public static final Property<Integer> MIN_NICKNAME_LENGTH = PropertyInitializer.newProperty("settings.restrictions.minNicknameLength", (int)3);
   @Comment({"Maximum allowed username length"})
   public static final Property<Integer> MAX_NICKNAME_LENGTH = PropertyInitializer.newProperty("settings.restrictions.maxNicknameLength", (int)16);
   ...
   public static final Property<List<String>> FORCE_SPAWN_ON_WORLDS = PropertyInitializer.newListProperty("settings.restrictions.ForceSpawnLocOnJoin.worlds", "world", "world_nether", "world_the_end");
   ...
   public static final Property<Boolean> ENABLE_RESTRICTED_USERS = PropertyInitializer.newProperty("settings.restrictions.AllowRestrictedUser", true);
   ...
   public static final Property<Set<String>> RESTRICTED_USERS = PropertyInitializer.newLowercaseStringSetProperty("settings.restrictions.AllowedRestrictedUser", "server_land;127.0.0.1", "server;127.0.0.1", "bukkit;127.0.0.1", "purpur;127.0.0.1", "system;127.0.0.1", "admin;127.0.0.1", "md_5;127.0.0.1", "administrator;127.0.0.1", "notch;127.0.0.1", "spigot;127.0.0.1", "bukkit;127.0.0.1", "bukkitcraft;127.0.0.1", "paperclip;127.0.0.1", "papermc;127.0.0.1", "spigotmc;127.0.0.1", "root;127.0.0.1", "console;127.0.0.1", "purpur;127.0.0.1", "authme;127.0.0.1", "owner;127.0.0.1");
   ...
   public static final Property<Boolean> KICK_ON_WRONG_PASSWORD = PropertyInitializer.newProperty("settings.restrictions.kickOnWrongPassword", false);
   ...
   public static final Property<Integer> TIMEOUT = PropertyInitializer.newProperty("settings.restrictions.timeout", (int)120);
   ...
   public static final Property<Integer> ALLOWED_MOVEMENT_RADIUS = PropertyInitializer.newProperty("settings.restrictions.allowedMovementRadius", (int)0);
   @Comment({"Should we protect the player inventory before logging in? Requires ProtocolLib."})
   public static final Property<Boolean> PROTECT_INVENTORY_BEFORE_LOGIN = PropertyInitializer.newProperty("settings.restrictions.ProtectInventoryBeforeLogIn", false);
   ...
   public static final Property<Boolean> DISPLAY_OTHER_ACCOUNTS = PropertyInitializer.newProperty("settings.restrictions.displayOtherAccounts", false);
   @Comment({"Spawn priority; values: authme, essentials, cmi, multiverse, default"})
   public static final Property<String> SPAWN_PRIORITY = PropertyInitializer.newProperty("settings.restrictions.spawnPriority", "authme,essentials,cmi,multiverse,default");
   @Comment({"Maximum Login authorized by IP"})
   public static final Property<Integer> MAX_LOGIN_PER_IP = PropertyInitializer.newProperty("settings.restrictions.maxLoginPerIp", (int)3);
   @Comment({"Maximum Join authorized by IP"})
   public static final Property<Integer> MAX_JOIN_PER_IP = PropertyInitializer.newProperty("settings.restrictions.maxJoinPerIp", (int)3);
   ...
   public static final Property<String> ALLOWED_EMAIL_REGEX = PropertyInitializer.newProperty("settings.restrictions.allowedEmailCharacters", "^([a-zA-Z0-9_.+-]+)@([a-zA-Z0-9-]+)\\.([a-zA-Z]{2,})$");
   ...
   public static final Property<Set<String>> UNRESTRICTED_NAMES = PropertyInitializer.newLowercaseStringSetProperty("settings.unrestrictions.UnrestrictedName");
   @Comment({"Below you can list all inventories names that AuthMe will ignore", "for registration or login. Configure it at your own risk!!", "This option adds compatibility with some mods.", "It is case-insensitive! Example:", "UnrestrictedInventories:", "- 'myCustomInventory1'", "- 'myCustomInventory2'"})
   public static final Property<Set<String>> UNRESTRICTED_INVENTORIES = PropertyInitializer.newLowercaseStringSetProperty("settings.unrestrictions.UnrestrictedInventories");
   @Comment({"Should we check unrestricted inventories strictly? (Original behavior)"})
   public static final Property<Boolean> STRICT_UNRESTRICTED_INVENTORIES_CHECK = PropertyInitializer.newProperty("settings.unrestrictions.StrictUnrestrictedInventoriesCheck", true);
