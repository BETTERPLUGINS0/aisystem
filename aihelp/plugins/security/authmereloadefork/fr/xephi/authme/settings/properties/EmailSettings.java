...
public final class EmailSettings implements SettingsHolder {
   ...
   public static final Property<String> SMTP_HOST = PropertyInitializer.newProperty("Email.mailSMTP", "smtp.163.com");
   @Comment({"Email SMTP server port"})
   public static final Property<Integer> SMTP_PORT = PropertyInitializer.newProperty("Email.mailPort", (int)465);
   ...
   public static final Property<Integer> RECOVERY_PASSWORD_LENGTH = PropertyInitializer.newProperty("Email.RecoveryPasswordLength", (int)12);
   ...
   public static final Property<Integer> MAX_REG_PER_EMAIL = PropertyInitializer.newProperty("Email.maxRegPerEmail", (int)1);
   ...
   public static final Property<Integer> DELAY_RECALL = PropertyInitializer.newProperty("Email.delayRecall", (int)5);
   ...
   public static final Property<Boolean> SHUTDOWN_MAIL = PropertyInitializer.newProperty("Email.shutDownEmail", false);
   @Comment({"Email notification address when the server is shut down"})
   public static final Property<String> SHUTDOWN_MAIL_ADDRESS = PropertyInitializer.newProperty("Email.shutDownEmailAddress", "your@mail.com");
