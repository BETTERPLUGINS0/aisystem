...
public class messages_nl extends ResourceBundle {
   ...
   public Object handleGetObject(String msgid) throws MissingResourceException {
      ...
      return found != null && msgid.equals(found) ? table[idx + 1] : null;
   }
   ...
   public Enumeration getKeys() {
      return new Enumeration() {
         ...
         {
            for(this.idx = 0; this.idx < 36 && messages_nl.table[this.idx] == null; this.idx += 2) {
            }
         ...
         public Object nextElement() {
            String key = messages_nl.table[this.idx];
