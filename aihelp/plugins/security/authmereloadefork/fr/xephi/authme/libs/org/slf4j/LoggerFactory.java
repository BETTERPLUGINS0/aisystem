...
import fr.xephi.authme.libs.org.slf4j.event.SubstituteLoggingEvent;
import fr.xephi.authme.libs.org.slf4j.helpers.NOPLoggerFactory;
import fr.xephi.authme.libs.org.slf4j.helpers.SubstituteLogger;
import fr.xephi.authme.libs.org.slf4j.helpers.SubstituteLoggerFactory;
import fr.xephi.authme.libs.org.slf4j.helpers.Util;
import fr.xephi.authme.libs.org.slf4j.impl.StaticLoggerBinder;
...
public final class LoggerFactory {
   ...
   private static String STATIC_LOGGER_BINDER_PATH = "fr/xephi/authme/libs/org/slf4j/impl/StaticLoggerBinder.class";
   ...
   private static boolean messageContainsOrgSlf4jImplStaticLoggerBinder(String msg) {
      if (msg == null) {
         return false;
      } else if (msg.contains("fr/xephi/authme/libs/org/slf4j/impl/StaticLoggerBinder")) {
         return true;
      } else {
         return msg.contains("fr.xephi.authme.libs.org.slf4j.impl.StaticLoggerBinder");
      }
   }
   ...
   private static final void bind() {
      try {
         ...
         try {
            ...
            msg = var8.getMessage();
            if (msg != null && msg.contains("fr.xephi.authme.libs.org.slf4j.impl.StaticLoggerBinder.getSingleton()")) {
