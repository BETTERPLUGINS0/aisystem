...
public final class Booleans {
   ...
   private static enum LexicographicalComparator implements Comparator<boolean[]> {
      ...
      // $FF: synthetic method
      private static Booleans.LexicographicalComparator[] $values() {
         return new Booleans.LexicographicalComparator[]{INSTANCE};
      }
   }
   ...
   private static enum BooleanComparator implements Comparator<Boolean> {
      ...
      // $FF: synthetic method
      private static Booleans.BooleanComparator[] $values() {
         return new Booleans.BooleanComparator[]{TRUE_FIRST, FALSE_FIRST};
      }
   }
}
