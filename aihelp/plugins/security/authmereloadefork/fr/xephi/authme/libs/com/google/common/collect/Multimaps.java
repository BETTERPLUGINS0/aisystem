...
public final class Multimaps {
   ...
   public static <K, V> Multimap<K, V> newMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends Collection<V>> factory) {
      return new Multimaps.CustomMultimap(map, factory);
   }

   public static <K, V> ListMultimap<K, V> newListMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends List<V>> factory) {
      return new Multimaps.CustomListMultimap(map, factory);
   }

   public static <K, V> SetMultimap<K, V> newSetMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends Set<V>> factory) {
      return new Multimaps.CustomSetMultimap(map, factory);
   }

   public static <K, V> SortedSetMultimap<K, V> newSortedSetMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends SortedSet<V>> factory) {
   ...
   public static <K, V, M extends Multimap<K, V>> M invertFrom(Multimap<? extends V, ? extends K> source, M dest) {
      ...
      while(var2.hasNext()) {
         Entry<? extends V, ? extends K> entry = (Entry)var2.next();
   ...
   public static <K, V1, V2> Multimap<K, V2> transformValues(Multimap<K, V1> fromMultimap, fr.xephi.authme.libs.com.google.common.base.Function<? super V1, V2> function) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   }

   public static <K, V1, V2> ListMultimap<K, V2> transformValues(ListMultimap<K, V1> fromMultimap, fr.xephi.authme.libs.com.google.common.base.Function<? super V1, V2> function) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   }
   ...
   public static <K, V> ImmutableListMultimap<K, V> index(Iterable<V> values, fr.xephi.authme.libs.com.google.common.base.Function<? super V, K> keyFunction) {
      return index(values.iterator(), keyFunction);
   }

   public static <K, V> ImmutableListMultimap<K, V> index(Iterator<V> values, fr.xephi.authme.libs.com.google.common.base.Function<? super V, K> keyFunction) {
   ...
   static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
      ...
      class EntrySet extends Maps.EntrySet<K, Collection<V>> {
         ...
         public Iterator<Entry<K, Collection<V>>> iterator() {
            return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new fr.xephi.authme.libs.com.google.common.base.Function<K, Collection<V>>() {
   ...
   static class Keys<K, V> extends AbstractMultiset<K> {
      ...
      Iterator<Multiset.Entry<K>> entryIterator() {
         return new TransformedIterator<Entry<K, Collection<V>>, Multiset.Entry<K>>(this, this.multimap.asMap().entrySet().iterator()) {
   ...
   private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
      ...
      Collection<V2> transform(@ParametricNullness K key, Collection<V1> values) {
         fr.xephi.authme.libs.com.google.common.base.Function<? super V1, V2> function = Maps.asValueToValueFunction(this.transformer, key);
   ...
   private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
      ...
      public Map<K, Collection<V>> asMap() {
         ...
         if (result == null) {
            result = this.map = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new fr.xephi.authme.libs.com.google.common.base.Function<Collection<V>, Collection<V>>(this) {
   ...
   private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
      transient fr.xephi.authme.libs.com.google.common.base.Supplier<? extends SortedSet<V>> factory;
      @CheckForNull
      transient Comparator<? super V> valueComparator;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomSortedSetMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends SortedSet<V>> factory) {
         super(map);
         this.factory = (fr.xephi.authme.libs.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         ...
         this.factory = (fr.xephi.authme.libs.com.google.common.base.Supplier)stream.readObject();
   ...
   private static class CustomSetMultimap<K, V> extends AbstractSetMultimap<K, V> {
      transient fr.xephi.authme.libs.com.google.common.base.Supplier<? extends Set<V>> factory;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomSetMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends Set<V>> factory) {
         super(map);
         this.factory = (fr.xephi.authme.libs.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      }
   ...
   private static class CustomListMultimap<K, V> extends AbstractListMultimap<K, V> {
      transient fr.xephi.authme.libs.com.google.common.base.Supplier<? extends List<V>> factory;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomListMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends List<V>> factory) {
         super(map);
         this.factory = (fr.xephi.authme.libs.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      }
   ...
   private static class CustomMultimap<K, V> extends AbstractMapBasedMultimap<K, V> {
      transient fr.xephi.authme.libs.com.google.common.base.Supplier<? extends Collection<V>> factory;
      @GwtIncompatible
      private static final long serialVersionUID = 0L;

      CustomMultimap(Map<K, Collection<V>> map, fr.xephi.authme.libs.com.google.common.base.Supplier<? extends Collection<V>> factory) {
         super(map);
         this.factory = (fr.xephi.authme.libs.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      }
