package fr.xephi.authme.libs.com.zaxxer.hikari.metrics.prometheus;
...
class PrometheusHistogramMetricsTracker implements IMetricsTracker {
   ...
   private static Histogram registerHistogram(String name, String help, double bucketStart) {
      return ((io.prometheus.client.Histogram.Builder)((io.prometheus.client.Histogram.Builder)((io.prometheus.client.Histogram.Builder)Histogram.build().name(name)).labelNames(new String[]{"pool"})).help(help)).exponentialBuckets(bucketStart, 2.0D, 11).create();
   }
