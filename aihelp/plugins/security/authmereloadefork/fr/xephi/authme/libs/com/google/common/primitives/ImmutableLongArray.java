...
public final class ImmutableLongArray implements Serializable {
   ...
   public static ImmutableLongArray.Builder builder(int initialCapacity) {
      ...
      return new ImmutableLongArray.Builder(initialCapacity);
   }
   ...
   static class AsList extends AbstractList<Long> implements RandomAccess, Serializable {
      ...
      public boolean equals(@CheckForNull Object object) {
         if (object instanceof ImmutableLongArray.AsList) {
            ImmutableLongArray.AsList that = (ImmutableLongArray.AsList)object;
   ...
   public static final class Builder {
      ...
      public ImmutableLongArray.Builder addAll(Iterable<Long> values) {
      ...
      public ImmutableLongArray.Builder addAll(Collection<Long> values) {
      ...
      public ImmutableLongArray.Builder addAll(LongStream stream) {
         OfLong spliterator = stream.spliterator();
