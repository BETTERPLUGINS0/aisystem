...
import fr.xephi.authme.libs.com.mysql.cj.conf.AbstractRuntimeProperty;
...
public class MysqlDataSource extends JdbcPropertySetImpl implements DataSource, Referenceable, Serializable, JdbcPropertySet {
   ...
   public String getUrl() {
      if (!this.explicitUrl) {
         ...
         sbUrl.append("//").append(StringUtils.urlEncode(this.getServerName()));
         ...
         sbUrl.append("/").append(StringUtils.urlEncode(this.getDatabaseName()));
   ...
   public int getMaxByteArrayAsHex() throws SQLException {
      return this.getIntegerRuntimeProperty("maxByteArrayAsHex");
   }

   public void setMaxByteArrayAsHex(int var1) throws SQLException {
      this.setIntegerRuntimeProperty("maxByteArrayAsHex", var1);
   }
   ...
   public String getAuthenticationFidoCallbackHandler() throws SQLException {
      return this.getStringRuntimeProperty("authenticationFidoCallbackHandler");
   }

   public void setAuthenticationFidoCallbackHandler(String var1) throws SQLException {
      this.setStringRuntimeProperty("authenticationFidoCallbackHandler", var1);
   }
   ...
   public String getOciConfigProfile() throws SQLException {
      return this.getStringRuntimeProperty("ociConfigProfile");
   }

   public void setOciConfigProfile(String var1) throws SQLException {
      this.setStringRuntimeProperty("ociConfigProfile", var1);
   }
   ...
   public boolean getSocksProxyRemoteDns() throws SQLException {
      return this.getBooleanRuntimeProperty("socksProxyRemoteDns");
   }

   public void setSocksProxyRemoteDns(boolean var1) throws SQLException {
      this.setBooleanRuntimeProperty("socksProxyRemoteDns", var1);
   }
