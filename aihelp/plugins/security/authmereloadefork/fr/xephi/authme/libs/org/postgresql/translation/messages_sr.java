...
public class messages_sr extends ResourceBundle {
   ...
   public Enumeration getKeys() {
      return new Enumeration() {
         ...
         {
            for(this.idx = 0; this.idx < 794 && messages_sr.table[this.idx] == null; this.idx += 2) {
            }
         ...
         public Object nextElement() {
            String key = messages_sr.table[this.idx];

            do {
               this.idx += 2;
            } while(this.idx < 794 && messages_sr.table[this.idx] == null);
