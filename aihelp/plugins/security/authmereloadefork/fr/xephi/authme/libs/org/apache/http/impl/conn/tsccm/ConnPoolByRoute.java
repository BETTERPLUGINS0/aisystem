...
import fr.xephi.authme.libs.org.apache.http.conn.params.ConnManagerParams;
import fr.xephi.authme.libs.org.apache.http.conn.params.ConnPerRoute;
...
public class ConnPoolByRoute extends AbstractConnPool {
   ...
   public void shutdown() {
      ...
      try {
         if (!this.shutdown) {
            this.shutdown = true;
            Iterator iter1 = this.leasedConnections.iterator();
            ...
            for(Iterator iter2 = this.freeConnections.iterator(); iter2.hasNext(); this.closeConnection(entry)) {
