...
import fr.xephi.authme.libs.com.mysql.cj.conf.url.LoadBalanceConnectionUrl;
...
import fr.xephi.authme.libs.com.mysql.cj.jdbc.ConnectionGroup;
import fr.xephi.authme.libs.com.mysql.cj.jdbc.ConnectionGroupManager;
import fr.xephi.authme.libs.com.mysql.cj.jdbc.ConnectionImpl;
   ...
   public LoadBalancedConnectionProxy(ConnectionUrl connectionUrl) throws SQLException {
      ...
      try {
         ...
         case -938285885:
            ...
            break;
         case 775801227:
            if (strategy.equals("serverAffinity")) {
               var13 = 2;
            }
         }
         ...
         case 2:
            ...
            break;
         default:
            this.balancer = (BalanceStrategy)Util.getInstance(BalanceStrategy.class, strategy, (Class[])null, (Object[])null, (ExceptionInterceptor)null);
         }
      ...
      try {
         ...
         this.exceptionChecker = (LoadBalanceExceptionChecker)Util.getInstance(LoadBalanceExceptionChecker.class, lbExceptionChecker, (Class[])null, (Object[])null, (ExceptionInterceptor)null);
