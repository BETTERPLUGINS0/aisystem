...
import fr.xephi.authme.libs.com.mysql.cj.protocol.Warning;
...
public class Notice implements ProtocolEntity {
   ...
   public static Notice getInstance(XMessage message) {
      ...
      case 1:
         return new Notice.XWarning(notice);
      case 2:
         return new Notice.XSessionVariableChanged(notice);
      case 3:
         return new Notice.XSessionStateChanged(notice);
      case 4:
      default:
