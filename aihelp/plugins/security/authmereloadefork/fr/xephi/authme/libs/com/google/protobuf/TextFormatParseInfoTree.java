...
public class TextFormatParseInfoTree {
   ...
   private TextFormatParseInfoTree(Map<Descriptors.FieldDescriptor, List<TextFormatParseLocation>> locationsFromField, Map<Descriptors.FieldDescriptor, List<TextFormatParseInfoTree.Builder>> subtreeBuildersFromField) {
      ...
      while(var4.hasNext()) {
         Entry<Descriptors.FieldDescriptor, List<TextFormatParseLocation>> kv = (Entry)var4.next();
      ...
      while(var11.hasNext()) {
         Entry<Descriptors.FieldDescriptor, List<TextFormatParseInfoTree.Builder>> kv = (Entry)var11.next();
   ...
   public static class Builder {
      private Map<Descriptors.FieldDescriptor, List<TextFormatParseLocation>> locationsFromField;
      private Map<Descriptors.FieldDescriptor, List<TextFormatParseInfoTree.Builder>> subtreeBuildersFromField;
