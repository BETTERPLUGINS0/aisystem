...
public class LocalTimeCodec implements Codec<LocalTime> {
   ...
   public LocalTime decodeText(ReadableByteBuf buf, MutableInt length, ColumnDecoder column, Calendar cal) throws SQLDataException {
      int[] parts;
   ...
   public LocalTime decodeBinary(ReadableByteBuf buf, MutableInt length, ColumnDecoder column, Calendar cal) throws SQLDataException {
      int hour = 0;
      int minutes = 0;
      int seconds = 0;
