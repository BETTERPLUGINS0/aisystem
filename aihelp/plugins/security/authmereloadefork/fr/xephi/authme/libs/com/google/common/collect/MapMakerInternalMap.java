...
class MapMakerInternalMap<K, V, E extends MapMakerInternalMap.InternalEntry<K, V, E>, S extends MapMakerInternalMap.Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
   ...
   static <K> MapMakerInternalMap<K, MapMaker.Dummy, ? extends MapMakerInternalMap.InternalEntry<K, MapMaker.Dummy, ?>, ?> createWithDummyValues(MapMaker builder) {
      if (builder.getKeyStrength() == MapMakerInternalMap.Strength.STRONG && builder.getValueStrength() == MapMakerInternalMap.Strength.STRONG) {
   ...
   public boolean containsValue(@Nullable Object value) {
      if (value == null) {
         ...
         for(int i = 0; i < 3; ++i) {
            long sum = 0L;
            MapMakerInternalMap.Segment[] var8 = segments;
            int var9 = segments.length;

            for(int var10 = 0; var10 < var9; ++var10) {
               MapMakerInternalMap.Segment<K, V, E, S> segment = var8[var10];
   ...
   public void clear() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         MapMakerInternalMap.Segment<K, V, E, S> segment = var1[var3];
         segment.clear();
      }
   ...
   final class EntrySet extends MapMakerInternalMap.SafeToArraySet<Entry<K, V>> {
      ...
      public Iterator<Entry<K, V>> iterator() {
         return MapMakerInternalMap.this.new EntryIterator(MapMakerInternalMap.this);
      }
   ...
   final class Values extends AbstractCollection<V> {
      public Iterator<V> iterator() {
         return MapMakerInternalMap.this.new ValueIterator(MapMakerInternalMap.this);
      }
   ...
   final class KeySet extends MapMakerInternalMap.SafeToArraySet<K> {
      ...
      public Iterator<K> iterator() {
         return MapMakerInternalMap.this.new KeyIterator(MapMakerInternalMap.this);
      }
   ...
   static final class CleanupMapTask implements Runnable {
      ...
      public void run() {
         ...
         if (map == null) {
            ...
            MapMakerInternalMap.Segment[] var2 = map.segments;
            int var3 = var2.length;

            for(int var4 = 0; var4 < var3; ++var4) {
               MapMakerInternalMap.Segment<?, ?, ?, ?> segment = var2[var4];
               segment.runCleanup();
            }
   ...
   static final class WeakKeyDummyValueEntry<K> extends MapMakerInternalMap.AbstractWeakKeyEntry<K, MapMaker.Dummy, MapMakerInternalMap.WeakKeyDummyValueEntry<K>> implements MapMakerInternalMap.StrongValueEntry<K, MapMaker.Dummy, MapMakerInternalMap.WeakKeyDummyValueEntry<K>> {
      WeakKeyDummyValueEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable MapMakerInternalMap.WeakKeyDummyValueEntry<K> next) {
         super(queue, key, hash, next);
      }
      ...
      static final class Helper<K> implements MapMakerInternalMap.InternalEntryHelper<K, MapMaker.Dummy, MapMakerInternalMap.WeakKeyDummyValueEntry<K>, MapMakerInternalMap.WeakKeyDummyValueSegment<K>> {
         ...
         public MapMakerInternalMap.WeakKeyDummyValueEntry<K> newEntry(MapMakerInternalMap.WeakKeyDummyValueSegment<K> segment, K key, int hash, @Nullable MapMakerInternalMap.WeakKeyDummyValueEntry<K> next) {
            return new MapMakerInternalMap.WeakKeyDummyValueEntry(segment.queueForKeys, key, hash, next);
         }
      }
   }
   ...
   static final class StrongKeyDummyValueEntry<K> extends MapMakerInternalMap.AbstractStrongKeyEntry<K, MapMaker.Dummy, MapMakerInternalMap.StrongKeyDummyValueEntry<K>> implements MapMakerInternalMap.StrongValueEntry<K, MapMaker.Dummy, MapMakerInternalMap.StrongKeyDummyValueEntry<K>> {
      StrongKeyDummyValueEntry(K key, int hash, @Nullable MapMakerInternalMap.StrongKeyDummyValueEntry<K> next) {
         super(key, hash, next);
      }
   ...
   static enum Strength {
      ...
      // $FF: synthetic method
      private static MapMakerInternalMap.Strength[] $values() {
         return new MapMakerInternalMap.Strength[]{STRONG, WEAK};
      }
