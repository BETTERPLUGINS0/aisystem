package fr.xephi.authme.libs.org.apache.commons.codec.language.bm;
...
public class Lang {
   ...
   private static final String LANGUAGE_RULES_RN = "fr/xephi/authme/libs/org/apache/commons/codec/language/bm/%s_lang.txt";
   ...
   public Languages.LanguageSet guessLanguages(String input) {
      ...
      while(var4.hasNext()) {
         Lang.LangRule rule = (Lang.LangRule)var4.next();
   ...
   static {
      ...
      for(int var2 = 0; var2 < var1; ++var2) {
         ...
         Langs.put(s, loadFromResource(String.format("fr/xephi/authme/libs/org/apache/commons/codec/language/bm/%s_lang.txt", s.getName()), Languages.getInstance(s)));
      }
