...
public class DoubleCodec implements Codec<Double> {
   ...
   public Double decodeText(ReadableByteBuf buf, MutableInt length, ColumnDecoder column, Calendar cal) throws SQLDataException {
      return column.decodeDoubleText(buf, length);
   }

   public Double decodeBinary(ReadableByteBuf buf, MutableInt length, ColumnDecoder column, Calendar cal) throws SQLDataException {
