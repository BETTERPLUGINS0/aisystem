...
public class ConcurrentBag<T extends ConcurrentBag.IConcurrentBagEntry> implements AutoCloseable {
   ...
   private boolean useWeakThreadLocals() {
      try {
         if (System.getProperty("fr.xephi.authme.libs.com.zaxxer.hikari.useWeakReferences") != null) {
            return Boolean.getBoolean("fr.xephi.authme.libs.com.zaxxer.hikari.useWeakReferences");
         } else {
