...
public final class Escapers {
   ...
   static UnicodeEscaper asUnicodeEscaper(Escaper escaper) {
      ...
      if (escaper instanceof UnicodeEscaper) {
         ...
         String var10003 = String.valueOf(escaper.getClass().getName());
         String var10002;
         if (var10003.length() != 0) {
            var10002 = "Cannot create a UnicodeEscaper from: ".concat(var10003);
         } else {
            String var10004 = new String;
            var10002 = var10004;
            var10004.<init>("Cannot create a UnicodeEscaper from: ");
         }
