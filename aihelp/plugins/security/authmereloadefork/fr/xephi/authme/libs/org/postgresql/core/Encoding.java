...
public class Encoding {
   ...
   public static Encoding getJVMEncoding(String jvmEncoding) {
      if ("UTF-8".equals(jvmEncoding)) {
         ...
         return Charset.isSupported(jvmEncoding) ? new Encoding(Charset.forName(jvmEncoding)) : DEFAULT_ENCODING;
      }
   }
   ...
   public byte[] encode(@PolyNull String s) throws IOException {
      return s == null ? null : s.getBytes(this.encoding);
   }
   ...
   static {
      UTF8_ENCODING = new Encoding(StandardCharsets.UTF_8, true);
