...
public interface AsyncCache<K, V> {
   ...
   @NonNull
   default CompletableFuture<Map<K, V>> getAll(@NonNull Iterable<? extends K> keys, @NonNull BiFunction<Iterable<? extends K>, Executor, CompletableFuture<Map<K, V>>> mappingFunction) {
      throw new UnsupportedOperationException();
   }
