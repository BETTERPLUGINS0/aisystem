...
import fr.xephi.authme.libs.org.apache.http.client.protocol.RequestExpectContinue;
...
import fr.xephi.authme.libs.org.apache.http.conn.socket.LayeredConnectionSocketFactory;
import fr.xephi.authme.libs.org.apache.http.conn.socket.PlainConnectionSocketFactory;
import fr.xephi.authme.libs.org.apache.http.conn.ssl.DefaultHostnameVerifier;
import fr.xephi.authme.libs.org.apache.http.conn.ssl.SSLConnectionSocketFactory;
import fr.xephi.authme.libs.org.apache.http.conn.ssl.X509HostnameVerifier;
...
import fr.xephi.authme.libs.org.apache.http.impl.conn.DefaultProxyRoutePlanner;
import fr.xephi.authme.libs.org.apache.http.impl.conn.DefaultRoutePlanner;
import fr.xephi.authme.libs.org.apache.http.impl.conn.DefaultSchemePortResolver;
import fr.xephi.authme.libs.org.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import fr.xephi.authme.libs.org.apache.http.impl.conn.SystemDefaultRoutePlanner;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.BackoffStrategyExec;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.ClientExecChain;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.MainClientExec;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.ProtocolExec;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.RedirectExec;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.RetryExec;
import fr.xephi.authme.libs.org.apache.http.impl.execchain.ServiceUnavailableRetryExec;
import fr.xephi.authme.libs.org.apache.http.protocol.HttpProcessor;
import fr.xephi.authme.libs.org.apache.http.protocol.HttpProcessorBuilder;
...
import fr.xephi.authme.libs.org.apache.http.ssl.SSLContexts;
   ...
   public CloseableHttpClient build() {
      ...
      if (userAgentCopy == null) {
         ...
         if (userAgentCopy == null && !this.defaultUserAgentDisabled) {
            userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient", "fr.xephi.authme.libs.org.apache.http.client", this.getClass());
         }
      }
      ...
      if (httpprocessorCopy == null) {
         ...
         if (!this.contentCompressionDisabled) {
            if (this.contentDecoderMap == null) {
               ...
               while(i$.hasNext()) {
                  Entry<String, InputStreamFactory> entry = (Entry)i$.next();
