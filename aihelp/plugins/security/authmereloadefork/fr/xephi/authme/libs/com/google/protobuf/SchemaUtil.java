...
final class SchemaUtil {
   ...
   private static Class<?> getGeneratedMessageClass() {
      try {
         return Class.forName("fr.xephi.authme.libs.com.google.protobuf.GeneratedMessageV3");
   ...
   private static Class<?> getUnknownFieldSetSchemaClass() {
      try {
         return Class.forName("fr.xephi.authme.libs.com.google.protobuf.UnknownFieldSetSchema");
      } catch (Throwable var1) {
         return null;
      }
   }
         ...
         if (enumList instanceof RandomAccess) {
            ...
            while(it.hasNext()) {
               ...
               if (enumMap.findValueByNumber(size) == null) {
                  unknownFields = storeUnknownEnum(containerMessage, number, size, unknownFields, unknownFieldSchema);
                  it.remove();
               }
            }
         }
