...
import fr.xephi.authme.libs.com.google.common.base.Ticker;
import fr.xephi.authme.libs.com.google.common.collect.AbstractSequentialIterator;
...
import fr.xephi.authme.libs.com.google.common.util.concurrent.ExecutionError;
import fr.xephi.authme.libs.com.google.common.util.concurrent.Futures;
...
import fr.xephi.authme.libs.com.google.common.util.concurrent.SettableFuture;
import fr.xephi.authme.libs.com.google.common.util.concurrent.UncheckedExecutionException;
import fr.xephi.authme.libs.com.google.common.util.concurrent.Uninterruptibles;
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
   ...
   public void cleanUp() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         LocalCache.Segment<?, ?> segment = var1[var3];
         segment.cleanUp();
      }
   ...
   ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException {
      ...
      try {
         ...
         var17 = ImmutableMap.copyOf((Map)result);
      } finally {
         this.globalStatsCounter.recordHits(hits);
         this.globalStatsCounter.recordMisses(misses);
      }
   ...
   Map<K, V> loadAll(Set<? extends K> keys, CacheLoader<? super K, V> loader) throws ExecutionException {
      ...
      if (result == null) {
         this.globalStatsCounter.recordLoadException(stopwatch.elapsed(TimeUnit.NANOSECONDS));
         String var24 = String.valueOf(loader);
         ...
         while(true) {
            ...
            if (nullsPresent) {
               this.globalStatsCounter.recordLoadException(stopwatch.elapsed(TimeUnit.NANOSECONDS));
               String var25 = String.valueOf(loader);
   ...
   public boolean containsValue(@Nullable Object value) {
      if (value == null) {
         ...
         for(int i = 0; i < 3; ++i) {
            long sum = 0L;
            LocalCache.Segment[] var10 = segments;
            int var11 = segments.length;

            for(int var12 = 0; var12 < var11; ++var12) {
               LocalCache.Segment<K, V> segment = var10[var12];
   ...
   public V computeIfAbsent(K key, Function<? super K, ? extends V> function) {
      Preconditions.checkNotNull(key);
      Preconditions.checkNotNull(function);
      return this.compute(key, (k, oldValue) -> {
   ...
   public V computeIfPresent(K key, BiFunction<? super K, ? super V, ? extends V> function) {
      ...
      Preconditions.checkNotNull(function);
      return this.compute(key, (k, oldValue) -> {
         return oldValue == null ? null : function.apply(k, oldValue);
      });
   }
   ...
   public void clear() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         LocalCache.Segment<K, V> segment = var1[var3];
         segment.clear();
      }
   ...
   static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
      ...
      public CacheStats stats() {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            LocalCache.Segment<K, V> segment = var2[var4];
   ...
   final class EntrySet extends LocalCache<K, V>.AbstractCacheSet<Entry<K, V>> {
      ...
      public Iterator<Entry<K, V>> iterator() {
         return LocalCache.this.new EntryIterator(LocalCache.this);
      }
   ...
   final class Values extends AbstractCollection<V> {
      ...
      public Iterator<V> iterator() {
         return LocalCache.this.new ValueIterator(LocalCache.this);
      }
   ...
   final class KeySet extends LocalCache<K, V>.AbstractCacheSet<K> {
      ...
      public Iterator<K> iterator() {
         return LocalCache.this.new KeyIterator(LocalCache.this);
      }
      ...
      public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
         ...
         try {
            ...
            if (previousValue == null) {
               ...
               return newValue == null ? Futures.immediateFuture((Object)null) : Futures.transform(newValue, new fr.xephi.authme.libs.com.google.common.base.Function<V, V>() {
   ...
   static class Segment<K, V> extends ReentrantLock {
      ...
      @GuardedBy("this")
      @Nullable
      ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> first, ReferenceEntry<K, V> entry, @Nullable K key, int hash, V value, LocalCache.ValueReference<K, V> valueReference, RemovalCause cause) {
   ...
   private static enum NullEntry implements ReferenceEntry<Object, Object> {
      ...
      // $FF: synthetic method
      private static LocalCache.NullEntry[] $values() {
         return new LocalCache.NullEntry[]{INSTANCE};
      }
   }
   ...
   static enum EntryFactory {
      ...
      abstract <K, V> ReferenceEntry<K, V> newEntry(LocalCache.Segment<K, V> var1, K var2, int var3, @Nullable ReferenceEntry<K, V> var4);
      ...
      // $FF: synthetic method
      private static LocalCache.EntryFactory[] $values() {
         return new LocalCache.EntryFactory[]{STRONG, STRONG_ACCESS, STRONG_WRITE, STRONG_ACCESS_WRITE, WEAK, WEAK_ACCESS, WEAK_WRITE, WEAK_ACCESS_WRITE};
      }
   ...
   static enum Strength {
      ...
      // $FF: synthetic method
      private static LocalCache.Strength[] $values() {
         return new LocalCache.Strength[]{STRONG, SOFT, WEAK};
      }
