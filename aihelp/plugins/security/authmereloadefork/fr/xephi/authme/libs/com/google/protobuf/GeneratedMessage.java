...
public abstract class GeneratedMessage extends AbstractMessage implements Serializable {
   ...
   public static <ContainingType extends Message, Type> GeneratedMessage.GeneratedExtension<ContainingType, Type> newMessageScopedGeneratedExtension(final Message scope, final int descriptorIndex, Class singularType, Message defaultInstance) {
   ...
   public static <ContainingType extends Message, Type> GeneratedMessage.GeneratedExtension<ContainingType, Type> newMessageScopedGeneratedExtension(final Message scope, final String name, Class singularType, Message defaultInstance) {
      return new GeneratedMessage.GeneratedExtension(new GeneratedMessage.CachedDescriptorRetriever() {
   ...
   public static <ContainingType extends Message, Type> GeneratedMessage.GeneratedExtension<ContainingType, Type> newFileScopedGeneratedExtension(final Class singularType, Message defaultInstance, final String descriptorOuterClass, final String extensionName) {
      return new GeneratedMessage.GeneratedExtension(new GeneratedMessage.CachedDescriptorRetriever() {
         protected Descriptors.FieldDescriptor loadDescriptor() {
            try {
   ...
   public abstract static class ExtendableBuilder<MessageType extends GeneratedMessage.ExtendableMessage, BuilderType extends GeneratedMessage.ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessage.Builder<BuilderType> implements GeneratedMessage.ExtendableMessageOrBuilder<MessageType> {
   ...
   public abstract static class ExtendableMessage<MessageType extends GeneratedMessage.ExtendableMessage> extends GeneratedMessage implements GeneratedMessage.ExtendableMessageOrBuilder<MessageType> {
      private static final long serialVersionUID = 1L;
   ...
   public abstract static class Builder<BuilderType extends GeneratedMessage.Builder<BuilderType>> extends AbstractMessage.Builder<BuilderType> {
      ...
      public BuilderType clone() {
         BuilderType builder = (GeneratedMessage.Builder)this.getDefaultInstanceForType().newBuilderForType();
