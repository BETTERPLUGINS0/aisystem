...
public class Oid {
   ...
   public static String toString(int oid) {
      String name = (String)OID_TO_NAME.get(oid);
      if (name == null) {
         name = "<unknown:" + oid + ">";
      }
   ...
   public static int valueOf(String oid) throws PSQLException {
      if (oid.length() > 0 && !Character.isDigit(oid.charAt(0))) {
         Integer id = (Integer)NAME_TO_OID.get(oid);
         if (id == null) {
            id = (Integer)NAME_TO_OID.get(oid.toUpperCase(Locale.ROOT));
         }
   ...
   static {
      java.lang.reflect.Field[] var0 = Oid.class.getFields();
      int var1 = var0.length;

      for(int var2 = 0; var2 < var1; ++var2) {
         java.lang.reflect.Field field = var0[var2];

         try {
            int oid = field.getInt((Object)null);
