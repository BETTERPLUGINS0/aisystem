package fr.xephi.authme.libs.com.mysql.cj.sasl;
...
public final class ScramShaSaslProvider extends Provider {
   ...
   public ScramShaSaslProvider() {
      super("MySQLScramShaSasl", 1.0D, "MySQL Connector/J SASL provider (implements client mechanisms for MYSQLCJ-SCRAM-SHA-1 and MYSQLCJ-SCRAM-SHA-256)");
      AccessController.doPrivileged(() -> {
         this.putService(new ScramShaSaslProvider.ProviderService(this, "SaslClientFactory", "MYSQLCJ-SCRAM-SHA-1", ScramShaSaslClientFactory.class.getName()));
         this.putService(new ScramShaSaslProvider.ProviderService(this, "SaslClientFactory", "MYSQLCJ-SCRAM-SHA-256", ScramShaSaslClientFactory.class.getName()));
         return null;
      });
   }
