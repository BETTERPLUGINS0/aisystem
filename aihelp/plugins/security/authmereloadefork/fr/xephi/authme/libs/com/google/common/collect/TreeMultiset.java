...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
   ...
   public void clear() {
      if (!this.range.hasLowerBound() && !this.range.hasUpperBound()) {
         TreeMultiset.AvlNode next;
         for(TreeMultiset.AvlNode current = this.header.succ(); current != this.header; current = next) {
            next = current.succ();
            current.elemCount = 0;
            current.left = null;
            current.right = null;
      ...
      return new Iterator<Multiset.Entry<E>>() {
         ...
         public Multiset.Entry<E> next() {
            if (!this.hasNext()) {
               ...
               Multiset.Entry<E> result = TreeMultiset.this.wrapEntry((TreeMultiset.AvlNode)Objects.requireNonNull(this.current));
   ...
   public void forEachEntry(ObjIntConsumer<? super E> action) {
      ...
      for(TreeMultiset.AvlNode node = this.firstNode(); node != this.header && node != null && !this.range.tooHigh(node.getElement()); node = node.succ()) {
   ...
   private static final class AvlNode<E> {
      ...
      private TreeMultiset.AvlNode<E> pred() {
         return (TreeMultiset.AvlNode)Objects.requireNonNull(this.pred);
      }

      private TreeMultiset.AvlNode<E> succ() {
         return (TreeMultiset.AvlNode)Objects.requireNonNull(this.succ);
      }
      ...
      @CheckForNull
      TreeMultiset.AvlNode<E> remove(Comparator<? super E> comparator, @ParametricNullness E e, int count, int[] result) {
         int cmp = comparator.compare(e, this.getElement());
         TreeMultiset.AvlNode initRight;
         if (cmp < 0) {
            initRight = this.left;
      ...
      @CheckForNull
      TreeMultiset.AvlNode<E> setCount(Comparator<? super E> comparator, @ParametricNullness E e, int count, int[] result) {
         int cmp = comparator.compare(e, this.getElement());
         TreeMultiset.AvlNode initRight;
         if (cmp < 0) {
            initRight = this.left;
      ...
      @CheckForNull
      TreeMultiset.AvlNode<E> setCount(Comparator<? super E> comparator, @ParametricNullness E e, int expectedCount, int newCount, int[] result) {
         int cmp = comparator.compare(e, this.getElement());
         TreeMultiset.AvlNode initRight;
         if (cmp < 0) {
            initRight = this.left;
      ...
      private static long totalCount(@CheckForNull TreeMultiset.AvlNode<?> node) {
         return node == null ? 0L : node.totalCount;
      }

      private static int height(@CheckForNull TreeMultiset.AvlNode<?> node) {
         return node == null ? 0 : node.height;
      }

      @CheckForNull
      private TreeMultiset.AvlNode<E> ceiling(Comparator<? super E> comparator, @ParametricNullness E e) {
         int cmp = comparator.compare(e, this.getElement());
         if (cmp < 0) {
      ...
      @CheckForNull
      private TreeMultiset.AvlNode<E> floor(Comparator<? super E> comparator, @ParametricNullness E e) {
         int cmp = comparator.compare(e, this.getElement());
         if (cmp > 0) {
   ...
   private static enum Aggregate {
      ...
      abstract long treeAggregate(@CheckForNull TreeMultiset.AvlNode<?> var1);

      // $FF: synthetic method
      private static TreeMultiset.Aggregate[] $values() {
         return new TreeMultiset.Aggregate[]{SIZE, DISTINCT};
      }
