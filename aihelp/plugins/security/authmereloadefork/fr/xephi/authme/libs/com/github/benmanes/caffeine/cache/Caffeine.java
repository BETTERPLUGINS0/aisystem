...
import fr.xephi.authme.libs.com.github.benmanes.caffeine.cache.stats.ConcurrentStatsCounter;
import fr.xephi.authme.libs.com.github.benmanes.caffeine.cache.stats.StatsCounter;
import fr.xephi.authme.libs.com.google.errorprone.annotations.FormatMethod;
...
public final class Caffeine<K, V> {
   ...
   <K1 extends K, V1 extends V> Weigher<K1, V1> getWeigher(boolean isAsync) {
      Weigher<K1, V1> delegate = this.weigher != null && this.weigher != Weigher.singletonWeigher() ? Weigher.boundedWeigher(this.weigher) : Weigher.singletonWeigher();
      return (Weigher)(isAsync ? new Async.AsyncWeigher(delegate) : delegate);
   }
   ...
   Expiry<K, V> getExpiry(boolean isAsync) {
      return (Expiry)(isAsync && this.expiry != null ? new Async.AsyncExpiry(this.expiry) : this.expiry);
   }
   ...
   @NonNull
   Ticker getTicker() {
      boolean useTicker = this.expiresVariable() || this.expiresAfterAccess() || this.expiresAfterWrite() || this.refreshAfterWrite() || this.isRecordingStats();
   ...
   <K1 extends K, V1 extends V> RemovalListener<K1, V1> getRemovalListener(boolean async) {
      ...
      return (RemovalListener)(async && castedListener != null ? new Async.AsyncRemovalListener(castedListener, this.getExecutor()) : castedListener);
   }
   ...
   <K1 extends K, V1 extends V> CacheWriter<K1, V1> getCacheWriter(boolean async) {
      ...
      return (CacheWriter)(castedWriter == null ? CacheWriter.disabledWriter() : castedWriter);
   }
   ...
   public <K1 extends K, V1 extends V> Cache<K1, V1> build() {
      ...
      return (Cache)(this.isBounded() ? new BoundedLocalCache.BoundedLocalManualCache(this) : new UnboundedLocalCache.UnboundedLocalManualCache(this));
   }

   @NonNull
   public <K1 extends K, V1 extends V> LoadingCache<K1, V1> build(@NonNull CacheLoader<? super K1, V1> loader) {
      this.requireWeightWithWeigher();
      return (LoadingCache)(!this.isBounded() && !this.refreshAfterWrite() ? new UnboundedLocalCache.UnboundedLocalLoadingCache(this, loader) : new BoundedLocalCache.BoundedLocalLoadingCache(this, loader));
   }
   ...
   public <K1 extends K, V1 extends V> AsyncCache<K1, V1> buildAsync() {
      ...
      this.requireWeightWithWeigher();
      this.requireNonLoadingCache();
      return (AsyncCache)(this.isBounded() ? new BoundedLocalCache.BoundedLocalAsyncCache(this) : new UnboundedLocalCache.UnboundedLocalAsyncCache(this));
   }

   @NonNull
   public <K1 extends K, V1 extends V> AsyncLoadingCache<K1, V1> buildAsync(@NonNull CacheLoader<? super K1, V1> loader) {
      return this.buildAsync((AsyncCacheLoader)loader);
   }
   ...
   public <K1 extends K, V1 extends V> AsyncLoadingCache<K1, V1> buildAsync(@NonNull AsyncCacheLoader<? super K1, V1> loader) {
      ...
      return (AsyncLoadingCache)(!this.isBounded() && !this.refreshAfterWrite() ? new UnboundedLocalCache.UnboundedLocalAsyncLoadingCache(this, loader) : new BoundedLocalCache.BoundedLocalAsyncLoadingCache(this, loader));
   }
