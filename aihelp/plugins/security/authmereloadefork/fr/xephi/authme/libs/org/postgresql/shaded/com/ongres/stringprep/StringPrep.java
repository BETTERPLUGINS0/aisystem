package fr.xephi.authme.libs.org.postgresql.shaded.com.ongres.stringprep;
...
public class StringPrep {
   ...
   public static boolean bidirectional(List<Integer> value) throws IllegalArgumentException {
      ...
      for(int i = 0; i < value.size(); ++i) {
         int character = (Integer)value.get(i);
      ...
      } else if (!containPropertyRorAL || firstCharacterPropertyRorAL && lastCharacterPropertyRorAL) {
         return true;
      } else {
