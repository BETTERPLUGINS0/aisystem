...
import fr.xephi.authme.libs.com.mysql.cj.util.SaslPrep;
...
public abstract class ScramShaSaslClient implements SaslClient {
   ...
   protected static enum ScramExchangeStage {
      TERMINATED((ScramShaSaslClient.ScramExchangeStage)null),
      ...
      private ScramExchangeStage(ScramShaSaslClient.ScramExchangeStage next) {
         this.next = next;
      }
