...
class ReseedingSecureRandom {
   ...
   private void buildSecureRandom() {
      try {
         ...
         throw new GoogleAuthenticatorException(String.format("Could not initialise SecureRandom with the specified algorithm: %s. Another provider can be chosen setting the %s system property.", this.algorithm, "fr.xephi.authme.libs.com.warrenstrange.googleauth.rng.algorithm"), var2);
      } catch (NoSuchProviderException var3) {
         throw new GoogleAuthenticatorException(String.format("Could not initialise SecureRandom with the specified provider: %s. Another provider can be chosen setting the %s system property.", this.provider, "fr.xephi.authme.libs.com.warrenstrange.googleauth.rng.algorithmProvider"), var3);
      }
   }
