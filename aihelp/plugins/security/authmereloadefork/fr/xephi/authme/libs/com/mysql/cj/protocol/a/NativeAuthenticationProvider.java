...
import fr.xephi.authme.libs.com.mysql.cj.protocol.AuthenticationProvider;
...
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.AuthenticationFidoClient;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.AuthenticationKerberosClient;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.AuthenticationLdapSaslClientPlugin;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.AuthenticationOciClient;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.CachingSha2PasswordPlugin;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.MysqlClearPasswordPlugin;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.MysqlNativePasswordPlugin;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.MysqlOldPasswordPlugin;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.authentication.Sha256PasswordPlugin;
      ...
      if (defaultAuthenticationPluginValue != null && !"".equals(defaultAuthenticationPluginValue.trim())) {
         ...
         if (authenticationPluginClasses != null && !"".equals(authenticationPluginClasses.trim())) {
            ...
            while(var8.hasNext()) {
               ...
               pluginsToInit.add(Util.getInstance(AuthenticationPlugin.class, className, (Class[])null, (Object[])null, this.getExceptionInterceptor()));
            }
         }
