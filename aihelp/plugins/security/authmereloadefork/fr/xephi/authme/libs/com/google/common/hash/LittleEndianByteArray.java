...
import fr.xephi.authme.libs.com.google.common.primitives.Longs;
...
final class LittleEndianByteArray {
   ...
   static {
      Object theGetter = LittleEndianByteArray.JavaLittleEndianBytes.INSTANCE;
      ...
      byteArray = (LittleEndianByteArray.LittleEndianBytes)theGetter;
   }
   ...
   private static enum JavaLittleEndianBytes implements LittleEndianByteArray.LittleEndianBytes {
      ...
      // $FF: synthetic method
      private static LittleEndianByteArray.JavaLittleEndianBytes[] $values() {
         return new LittleEndianByteArray.JavaLittleEndianBytes[]{INSTANCE};
      }
   ...
   private static enum UnsafeByteArray implements LittleEndianByteArray.LittleEndianBytes {
      ...
      // $FF: synthetic method
      private static LittleEndianByteArray.UnsafeByteArray[] $values() {
         return new LittleEndianByteArray.UnsafeByteArray[]{UNSAFE_LITTLE_ENDIAN, UNSAFE_BIG_ENDIAN};
      }
