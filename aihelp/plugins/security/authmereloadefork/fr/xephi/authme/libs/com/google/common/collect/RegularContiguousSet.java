...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
   ...
   public ContiguousSet<C> intersection(ContiguousSet<C> other) {
      ...
      if (other.isEmpty()) {
         ...
         C lowerEndpoint = (Comparable)Ordering.natural().max(this.first(), (Comparable)other.first());
         C upperEndpoint = (Comparable)Ordering.natural().min(this.last(), (Comparable)other.last());
