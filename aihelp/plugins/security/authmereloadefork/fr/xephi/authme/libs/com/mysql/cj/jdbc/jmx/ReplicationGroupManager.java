package fr.xephi.authme.libs.com.mysql.cj.jdbc.jmx;
...
import fr.xephi.authme.libs.com.mysql.cj.jdbc.ha.ReplicationConnectionGroup;
import fr.xephi.authme.libs.com.mysql.cj.jdbc.ha.ReplicationConnectionGroupManager;
...
public class ReplicationGroupManager implements ReplicationGroupManagerMBean {
   ...
   public synchronized void registerJmx() throws SQLException {
      if (!this.isJmxRegistered) {
         ...
         try {
            ObjectName name = new ObjectName("fr.xephi.authme.libs.com.mysql.cj.jdbc.jmx:type=ReplicationGroupManager");
