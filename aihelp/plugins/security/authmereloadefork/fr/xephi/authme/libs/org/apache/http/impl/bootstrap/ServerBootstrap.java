...
import fr.xephi.authme.libs.org.apache.http.impl.DefaultBHttpServerConnection;
import fr.xephi.authme.libs.org.apache.http.impl.DefaultBHttpServerConnectionFactory;
...
import fr.xephi.authme.libs.org.apache.http.protocol.HttpExpectationVerifier;
...
import fr.xephi.authme.libs.org.apache.http.protocol.HttpRequestHandler;
import fr.xephi.authme.libs.org.apache.http.protocol.HttpRequestHandlerMapper;
import fr.xephi.authme.libs.org.apache.http.protocol.HttpService;
import fr.xephi.authme.libs.org.apache.http.protocol.ResponseConnControl;
import fr.xephi.authme.libs.org.apache.http.protocol.ResponseContent;
import fr.xephi.authme.libs.org.apache.http.protocol.ResponseDate;
import fr.xephi.authme.libs.org.apache.http.protocol.ResponseServer;
import fr.xephi.authme.libs.org.apache.http.protocol.UriHttpRequestHandlerMapper;
   ...
   public HttpServer create() {
      ...
      if (handlerMapperCopy == null) {
         ...
         if (this.handlerMap != null) {
            ...
            while(i$.hasNext()) {
               Entry<String, HttpRequestHandler> entry = (Entry)i$.next();
