...
public class TimeUtil {
   ...
   private static final String TIME_ZONE_MAPPINGS_RESOURCE = "/fr/xephi/authme/libs/com/mysql/cj/util/TimeZoneMapping.properties";
   ...
   private static void loadTimeZoneMappings(ExceptionInterceptor exceptionInterceptor) {
      ...
      try {
         timeZoneMappings.load(TimeUtil.class.getResourceAsStream("/fr/xephi/authme/libs/com/mysql/cj/util/TimeZoneMapping.properties"));
   ...
   static {
      TIME_FORMATTER_WITH_OPTIONAL_MICROS = (new DateTimeFormatterBuilder()).appendPattern("HH:mm:ss").appendFraction(ChronoField.NANO_OF_SECOND, 0, 6, true).toFormatter();
      ...
      DATETIME_FORMATTER_WITH_OPTIONAL_MICROS = (new DateTimeFormatterBuilder()).appendPattern("yyyy-MM-dd HH:mm:ss").appendFraction(ChronoField.NANO_OF_SECOND, 0, 6, true).toFormatter();
