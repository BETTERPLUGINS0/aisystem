...
public abstract class AbstractMessage extends AbstractMessageLite implements Message {
   ...
   protected static int hashFields(int hash, Map<Descriptors.FieldDescriptor, Object> map) {
      ...
      while(var2.hasNext()) {
         Entry<Descriptors.FieldDescriptor, Object> entry = (Entry)var2.next();
   ...
   public abstract static class Builder<BuilderType extends AbstractMessage.Builder<BuilderType>> extends AbstractMessageLite.Builder implements Message.Builder {
      ...
      public BuilderType clear() {
         ...
         while(var1.hasNext()) {
            Entry<Descriptors.FieldDescriptor, Object> entry = (Entry)var1.next();
