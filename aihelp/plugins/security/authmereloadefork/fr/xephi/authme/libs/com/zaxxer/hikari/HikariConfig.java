package fr.xephi.authme.libs.com.zaxxer.hikari;
...
public class HikariConfig implements HikariConfigMXBean {
   ...
   private void loadProperties(String propertyFileName) {
      ...
      try {
         Object is = propFile.isFile() ? new FileInputStream(propFile) : this.getClass().getResourceAsStream(propertyFileName);
   ...
   private String generatePoolName() {
      ...
      try {
         synchronized(System.getProperties()) {
            String next = String.valueOf(Integer.getInteger("fr.xephi.authme.libs.com.zaxxer.hikari.pool_number", 0) + 1);
            System.setProperty("fr.xephi.authme.libs.com.zaxxer.hikari.pool_number", next);
   ...
   static {
      ...
      SOFT_TIMEOUT_FLOOR = Long.getLong("fr.xephi.authme.libs.com.zaxxer.hikari.timeoutMs.floor", 250L);
