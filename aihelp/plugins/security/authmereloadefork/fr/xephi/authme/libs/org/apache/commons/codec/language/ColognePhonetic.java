...
public class ColognePhonetic implements StringEncoder {
   ...
   public String colognePhonetic(String text) {
      if (text == null) {
         ...
         ColognePhonetic.CologneInputBuffer input = new ColognePhonetic.CologneInputBuffer(this.preprocess(text));
         ColognePhonetic.CologneOutputBuffer output = new ColognePhonetic.CologneOutputBuffer(input.length() * 2);
         char lastChar = '-';
