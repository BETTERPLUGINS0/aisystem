...
interface NodeFactory<K, V> {
   ...
   References.WeakKeyReference<Object> RETIRED_WEAK_KEY = new References.WeakKeyReference((Object)null, (ReferenceQueue)null);
   References.WeakKeyReference<Object> DEAD_WEAK_KEY = new References.WeakKeyReference((Object)null, (ReferenceQueue)null);
   ...
   static <K, V> NodeFactory<K, V> newFactory(Caffeine<K, V> builder, boolean isAsync) {
      StringBuilder sb = new StringBuilder("fr.xephi.authme.libs.com.github.benmanes.caffeine.cache.");
      ...
      try {
         ...
         NodeFactory<K, V> factory = (NodeFactory)clazz.getDeclaredConstructor().newInstance();
         return factory;
