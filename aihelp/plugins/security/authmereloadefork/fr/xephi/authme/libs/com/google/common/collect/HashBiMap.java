...
public final class HashBiMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> implements BiMap<K, V>, Serializable {
   ...
   @CheckForNull
   private HashBiMap.BiEntry<K, V> seekByKey(@CheckForNull Object key, int keyHash) {
   ...
   @CheckForNull
   private HashBiMap.BiEntry<K, V> seekByValue(@CheckForNull Object value, int valueHash) {
   ...
   private V put(@ParametricNullness K key, @ParametricNullness V value, boolean force) {
      ...
      if (oldEntryForKey != null && valueHash == oldEntryForKey.valueHash && Objects.equal(value, oldEntryForKey.value)) {
         ...
         if (oldEntryForValue != null) {
            if (!force) {
               String var9 = String.valueOf(value);
   ...
   private K putInverse(@ParametricNullness V value, @ParametricNullness K key, boolean force) {
      ...
      if (oldEntryForValue != null && keyHash == oldEntryForValue.keyHash && Objects.equal(key, oldEntryForValue.key)) {
         ...
         String var9 = String.valueOf(key);
         throw new IllegalArgumentException((new StringBuilder(21 + String.valueOf(var9).length())).append("key already present: ").append(var9).toString());
      } else {
         if (oldEntryForValue != null) {
            this.delete(oldEntryForValue);
         }
   ...
   public void replaceAll(BiFunction<? super K, ? super V, ? extends V> function) {
      ...
      for(HashBiMap.BiEntry entry = oldFirst; entry != null; entry = entry.nextInKeyInsertionOrder) {
   ...
   abstract class Itr<T> implements Iterator<T> {
      ...
      public T next() {
         if (!this.hasNext()) {
            ...
            HashBiMap.BiEntry<K, V> entry = (HashBiMap.BiEntry)java.util.Objects.requireNonNull(this.next);
