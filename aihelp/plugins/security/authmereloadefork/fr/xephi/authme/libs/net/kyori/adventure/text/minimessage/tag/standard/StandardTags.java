...
public final class StandardTags {
   ...
   public static TagResolver decorations(@NotNull final TextDecoration decoration) {
      return (TagResolver)Objects.requireNonNull((TagResolver)DecorationTag.RESOLVERS.get(decoration), "No resolver found for decoration (this should not be possible?)");
   }
