...
public final class UnsignedLongs {
      ...
      if (string.length() == 0) {
         ...
         for(int pos = 0; pos < string.length(); ++pos) {
            ...
            if (pos > maxSafePos && UnsignedLongs.ParseOverflowDetection.overflowInParse(value, digit, radix)) {
               ...
               String var10003 = String.valueOf(string);
               String var10002;
               if (var10003.length() != 0) {
                  var10002 = "Too large for unsigned long: ".concat(var10003);
               } else {
                  String var10004 = new String;
                  var10002 = var10004;
                  var10004.<init>("Too large for unsigned long: ");
               }
   ...
   static enum LexicographicalComparator implements Comparator<long[]> {
      ...
      // $FF: synthetic method
      private static UnsignedLongs.LexicographicalComparator[] $values() {
         return new UnsignedLongs.LexicographicalComparator[]{INSTANCE};
      }
   }
}
