...
import fr.xephi.authme.libs.com.google.common.base.Charsets;
...
import fr.xephi.authme.libs.com.google.common.collect.ImmutableListMultimap;
import fr.xephi.authme.libs.com.google.common.collect.ImmutableMultiset;
import fr.xephi.authme.libs.com.google.common.collect.ImmutableSet;
import fr.xephi.authme.libs.com.google.common.collect.ListMultimap;
...
public final class MediaType {
      ...
      if (local == null) {
         ...
         while(var3.hasNext()) {
            ...
            if (value == null) {
               ...
               throw new IllegalStateException((new StringBuilder(35 + String.valueOf(value).length() + String.valueOf(currentValue).length())).append("Multiple charset values defined: ").append(value).append(", ").append(currentValue).toString());
            }
         }
   ...
   public static MediaType parse(String input) {
      ...
      try {
         ...
         throw new IllegalArgumentException((new StringBuilder(18 + String.valueOf(input).length())).append("Could not parse '").append(input).append("'").toString(), var8);
      }
   }
   ...
   private String computeToString() {
      ...
      if (!this.parameters.isEmpty()) {
         builder.append("; ");
         Multimap<String, String> quotedParameters = Multimaps.transformValues((ListMultimap)this.parameters, (value) -> {
