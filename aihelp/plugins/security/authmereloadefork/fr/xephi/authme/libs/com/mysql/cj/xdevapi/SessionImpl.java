...
public class SessionImpl implements Session {
   ...
   public List<Schema> getSchemas() {
      Function<fr.xephi.authme.libs.com.mysql.cj.result.Row, String> rowToName = (r) -> {
         return (String)r.getValue(0, new StringValueFactory(this.session.getPropertySet()));
      };
      Function<fr.xephi.authme.libs.com.mysql.cj.result.Row, Schema> rowToSchema = rowToName.andThen((n) -> {
