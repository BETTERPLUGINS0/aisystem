...
public class InternalTimestamp extends InternalDate {
   ...
   public static InternalTimestamp from(OffsetDateTime x) {
      ...
      internalTimestamp.setOffset((int)TimeUnit.SECONDS.toMinutes((long)x.getOffset().getTotalSeconds()));
   ...
   public static InternalTimestamp from(Calendar x, int nanos) {
      return new InternalTimestamp(x.get(1), x.get(2) + 1, x.get(5), x.get(11), x.get(12), x.get(13), nanos, -1);
   }
