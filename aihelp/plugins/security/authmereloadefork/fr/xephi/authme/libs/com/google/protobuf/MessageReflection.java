...
class MessageReflection {
   static void writeMessageTo(Message message, Map<Descriptors.FieldDescriptor, Object> fields, CodedOutputStream output, boolean alwaysWriteRequiredFields) throws IOException {
      ...
      while(true) {
         while(var5.hasNext()) {
            Entry<Descriptors.FieldDescriptor, Object> entry = (Entry)var5.next();
   ...
   static int getSerializedSize(Message message, Map<Descriptors.FieldDescriptor, Object> fields) {
      ...
      while(true) {
         while(var4.hasNext()) {
            Entry<Descriptors.FieldDescriptor, Object> entry = (Entry)var4.next();
            Descriptors.FieldDescriptor field = (Descriptors.FieldDescriptor)entry.getKey();
            Object value = entry.getValue();
            if (isMessageSet && field.isExtension() && field.getType() == Descriptors.FieldDescriptor.Type.MESSAGE && !field.isRepeated()) {
      ...
      while(true) {
         while(true) {
            ...
            do {
               ...
               Entry<Descriptors.FieldDescriptor, Object> entry = (Entry)var3.next();
               field = (Descriptors.FieldDescriptor)entry.getKey();
   ...
   interface MergeTarget {
      ...
      void mergeGroup(CodedInputStream var1, ExtensionRegistryLite var2, Descriptors.FieldDescriptor var3, Message var4) throws IOException;

      void mergeMessage(CodedInputStream var1, ExtensionRegistryLite var2, Descriptors.FieldDescriptor var3, Message var4) throws IOException;
