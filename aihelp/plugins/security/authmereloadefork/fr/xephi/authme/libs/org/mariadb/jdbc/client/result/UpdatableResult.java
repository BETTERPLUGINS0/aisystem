...
import fr.xephi.authme.libs.org.mariadb.jdbc.codec.Parameter;
      ...
      if (this.state == 3 || this.state == 4) {
         ...
         try {
            ...
            for(int pos = 0; pos < this.metadataList.length; ++pos) {
               ...
               fr.xephi.authme.libs.org.mariadb.jdbc.client.util.Parameter param = this.parameters.size() > pos ? this.parameters.get(pos) : null;
               if (param != null) {
         ...
         while(true) {
            ...
            if (Arrays.asList(this.primaryCols).contains(colInfo.getColumnName())) {
               if (this.state != 0 && this.parameters.size() > pos && this.parameters.get(pos) != null) {
                  fr.xephi.authme.libs.org.mariadb.jdbc.client.util.Parameter value = this.parameters.get(pos);
               ...
               try {
                  ...
                  for(pos = 0; pos < this.metadataList.length; ++pos) {
                     if (this.parameters.size() > pos) {
                        fr.xephi.authme.libs.org.mariadb.jdbc.client.util.Parameter param = this.parameters.get(pos);
                        if (param != null) {
