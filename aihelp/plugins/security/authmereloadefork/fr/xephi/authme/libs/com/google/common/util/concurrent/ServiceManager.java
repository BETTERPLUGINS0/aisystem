...
import fr.xephi.authme.libs.com.google.common.base.Stopwatch;
import fr.xephi.authme.libs.com.google.common.collect.Collections2;
...
import fr.xephi.authme.libs.com.google.common.collect.ImmutableSetMultimap;
import fr.xephi.authme.libs.com.google.common.collect.Lists;
import fr.xephi.authme.libs.com.google.common.collect.Maps;
import fr.xephi.authme.libs.com.google.common.collect.MultimapBuilder;
import fr.xephi.authme.libs.com.google.common.collect.Multimaps;
...
import fr.xephi.authme.libs.com.google.common.collect.SetMultimap;
   ...
   public ServiceManager startAsync() {
      ...
      while(var1.hasNext()) {
         ...
         try {
            ...
            String var4 = String.valueOf(service);
   ...
   private static final class ServiceListener extends Service.Listener {
      ...
      public void failed(Service.State from, Throwable failure) {
         ...
         if (state != null) {
            ...
            if (log) {
               Logger var10000 = ServiceManager.logger;
               Level var10001 = Level.SEVERE;
               String var5 = String.valueOf(this.service);
               String var6 = String.valueOf(from);
               var10000.log(var10001, (new StringBuilder(34 + String.valueOf(var5).length() + String.valueOf(var6).length())).append("Service ").append(var5).append(" has failed in the ").append(var6).append(" state.").toString(), failure);
            }
   ...
   private static final class ServiceManagerState {
      ...
      void markReady() {
         ...
         try {
            if (this.transitioned) {
               ...
               String var7 = String.valueOf(servicesInBadStates);
               throw new IllegalArgumentException((new StringBuilder(89 + String.valueOf(var7).length())).append("Services started transitioning asynchronously before the ServiceManager was constructed: ").append(var7).toString());
            }
      ...
      void awaitHealthy(long timeout, TimeUnit unit) throws TimeoutException {
         ...
         try {
            if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, timeout, unit)) {
               String var4 = String.valueOf(Multimaps.filterKeys(this.servicesByState, Predicates.in(ImmutableSet.of(Service.State.NEW, Service.State.STARTING))));
               throw new TimeoutException((new StringBuilder(93 + String.valueOf(var4).length())).append("Timeout waiting for the services to become healthy. The following services have not started: ").append(var4).toString());
            }
      ...
      void awaitStopped(long timeout, TimeUnit unit) throws TimeoutException {
         ...
         try {
            if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, timeout, unit)) {
               String var4 = String.valueOf(Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
               throw new TimeoutException((new StringBuilder(83 + String.valueOf(var4).length())).append("Timeout waiting for the services to stop. The following services have not stopped: ").append(var4).toString());
            }
         } finally {
            this.monitor.leave();
         }
      ...
      ImmutableSetMultimap<Service.State, Service> servicesByState() {
         ...
         try {
            ...
            while(var2.hasNext()) {
               Entry<Service.State, Service> entry = (Entry)var2.next();
      ...
      ImmutableMap<Service, Long> startupTimes() {
         ...
         try {
            ...
            while(var2.hasNext()) {
               Entry<Service, Stopwatch> entry = (Entry)var2.next();
         ...
         Collections.sort(loadTimes, Ordering.natural().onResultOf(new Function<Entry<Service, Long>, Long>(this) {
      ...
      void enqueueFailedEvent(final Service service) {
         this.listeners.enqueue(new ListenerCallQueue.Event<ServiceManager.Listener>(this) {
            ...
            public String toString() {
               String var1 = String.valueOf(service);
               return (new StringBuilder(18 + String.valueOf(var1).length())).append("failed({service=").append(var1).append("})").toString();
            }
         });
      }
      ...
      void checkHealthy() {
         if (this.states.count(Service.State.RUNNING) != this.numberOfServices) {
            ...
            IllegalStateException exception = new IllegalStateException((new StringBuilder(79 + String.valueOf(var2).length())).append("Expected to be healthy after starting. The following services are not running: ").append(var2).toString());
