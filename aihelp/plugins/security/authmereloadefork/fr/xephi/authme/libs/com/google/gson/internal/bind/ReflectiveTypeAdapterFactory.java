...
import fr.xephi.authme.libs.com.google.gson.FieldNamingStrategy;
import fr.xephi.authme.libs.com.google.gson.Gson;
import fr.xephi.authme.libs.com.google.gson.JsonIOException;
...
import fr.xephi.authme.libs.com.google.gson.ReflectionAccessFilter;
...
import fr.xephi.authme.libs.com.google.gson.annotations.SerializedName;
import fr.xephi.authme.libs.com.google.gson.internal.$Gson$Types;
...
import fr.xephi.authme.libs.com.google.gson.internal.ObjectConstructor;
import fr.xephi.authme.libs.com.google.gson.internal.Primitives;
import fr.xephi.authme.libs.com.google.gson.internal.ReflectionAccessFilterHelper;
import fr.xephi.authme.libs.com.google.gson.internal.reflect.ReflectionHelper;
         ...
         void write(JsonWriter writer, Object source) throws IOException, IllegalAccessException {
            if (this.serialized) {
               ...
               if (fieldValue != source) {
                  ...
                  TypeAdapter<Object> t = jsonAdapterPresent ? mapped : new TypeAdapterRuntimeTypeWrapper(context, mapped, fieldType.getType());
   ...
   private static final class RecordAdapter<T> extends ReflectiveTypeAdapterFactory.Adapter<T, Object[]> {
      ...
      T finalize(Object[] accumulator) {
         try {
            ...
            throw new RuntimeException("Failed to invoke constructor '" + ReflectionHelper.constructorToString(this.constructor) + "' with args " + Arrays.toString(accumulator), var4);
         } catch (InvocationTargetException var5) {
            throw new RuntimeException("Failed to invoke constructor '" + ReflectionHelper.constructorToString(this.constructor) + "' with args " + Arrays.toString(accumulator), var5.getCause());
         }
      }
   }
   ...
   public abstract static class Adapter<T, A> extends TypeAdapter<T> {
      ...
      public T read(JsonReader in) throws IOException {
         if (in.peek() == JsonToken.NULL) {
            ...
            Object accumulator = this.createAccumulator();
