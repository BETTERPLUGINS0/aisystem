...
public class StatementWrapper extends WrapperBase implements Statement {
   ...
   public boolean isWrapperFor(Class<?> iface) throws SQLException {
      ...
      if (isInstance) {
         ...
         return interfaceClassName.equals("fr.xephi.authme.libs.com.mysql.cj.jdbc.Statement") || interfaceClassName.equals("java.sql.Statement") || interfaceClassName.equals("java.sql.Wrapper");
      }
   }
