...
public final class Iterators {
      ...
      return new UnmodifiableIterator<I>() {
         ...
         public I next() {
            if (!this.hasNext()) {
               ...
               I result = (Iterator)java.util.Objects.requireNonNull(elements[this.index]);
   ...
   static <T> Iterator<T> concatNoDefensiveCopy(Iterator<? extends T>... inputs) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         Iterator<? extends T> input = var1[var3];
   ...
   static <T> UnmodifiableListIterator<T> forArray(T[] array, int offset, int length, int index) {
      ...
      return (UnmodifiableListIterator)(length == 0 ? emptyListIterator() : new Iterators.ArrayItr(array, offset, length, index));
   }
   ...
   private static class MergingIterator<T> extends UnmodifiableIterator<T> {
      ...
      public MergingIterator(Iterable<? extends Iterator<? extends T>> iterators, Comparator<? super T> itemComparator) {
         Comparator<PeekingIterator<T>> heapComparator = (o1, o2) -> {
         ...
         while(var4.hasNext()) {
            Iterator<? extends T> iterator = (Iterator)var4.next();
            if (iterator.hasNext()) {
   ...
   private static enum EmptyModifiableIterator implements Iterator<Object> {
      ...
      // $FF: synthetic method
      private static Iterators.EmptyModifiableIterator[] $values() {
         return new Iterators.EmptyModifiableIterator[]{INSTANCE};
      }
   }
}
