package fr.xephi.authme.libs.com.mysql.cj.conf;
...
import fr.xephi.authme.libs.com.mysql.cj.exceptions.UnsupportedConnectionStringException;
import fr.xephi.authme.libs.com.mysql.cj.exceptions.WrongArgumentException;
import fr.xephi.authme.libs.com.mysql.cj.util.DnsSrv;
...
public abstract class ConnectionUrl implements DatabaseUrlContainer {
   ...
   protected void setupPropertiesTransformer() {
      ...
      if (!StringUtils.isNullOrEmpty(propertiesTransformClassName)) {
         try {
            this.propertiesTransformer = (ConnectionPropertiesTransform)Util.getInstance(ConnectionPropertiesTransform.class, propertiesTransformClassName, (Class[])null, (Object[])null, (ExceptionInterceptor)null);
         } catch (CJException var3) {
            throw (InvalidConnectionAttributeException)ExceptionFactory.createException((Class)InvalidConnectionAttributeException.class, (String)Messages.getString("ConnectionString.9"), (Throwable)var3);
         }
      }
   ...
   public static Properties getPropertiesFromConfigFiles(String configFiles) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         try {
            InputStream configAsStream = ConnectionUrl.class.getResourceAsStream("/fr/xephi/authme/libs/com/mysql/cj/configurations/" + configFile + ".properties");
            Throwable var7 = null;
   ...
   protected void fixProtocolDependencies(Map<String, String> hostProps) {
      ...
      if (!StringUtils.isNullOrEmpty(protocol) && protocol.equalsIgnoreCase("PIPE") && !hostProps.containsKey(PropertyKey.socketFactory.getKeyName())) {
         hostProps.put(PropertyKey.socketFactory.getKeyName(), "fr.xephi.authme.libs.com.mysql.cj.protocol.NamedPipeSocketFactory");
      }
   ...
   public static enum Type {
      FAILOVER_DNS_SRV_CONNECTION("jdbc:mysql+srv:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.FailoverDnsSrvConnectionUrl"),
      LOADBALANCE_DNS_SRV_CONNECTION("jdbc:mysql+srv:loadbalance:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.LoadBalanceDnsSrvConnectionUrl"),
      REPLICATION_DNS_SRV_CONNECTION("jdbc:mysql+srv:replication:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.ReplicationDnsSrvConnectionUrl"),
      XDEVAPI_DNS_SRV_SESSION("mysqlx+srv:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.XDevApiDnsSrvConnectionUrl"),
      SINGLE_CONNECTION("jdbc:mysql:", ConnectionUrl.HostsCardinality.SINGLE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.SingleConnectionUrl", PropertyKey.dnsSrv, FAILOVER_DNS_SRV_CONNECTION),
      FAILOVER_CONNECTION("jdbc:mysql:", ConnectionUrl.HostsCardinality.MULTIPLE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.FailoverConnectionUrl", PropertyKey.dnsSrv, FAILOVER_DNS_SRV_CONNECTION),
      LOADBALANCE_CONNECTION("jdbc:mysql:loadbalance:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.LoadBalanceConnectionUrl", PropertyKey.dnsSrv, LOADBALANCE_DNS_SRV_CONNECTION),
      REPLICATION_CONNECTION("jdbc:mysql:replication:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.ReplicationConnectionUrl", PropertyKey.dnsSrv, REPLICATION_DNS_SRV_CONNECTION),
      XDEVAPI_SESSION("mysqlx:", ConnectionUrl.HostsCardinality.ONE_OR_MORE, "fr.xephi.authme.libs.com.mysql.cj.conf.url.XDevApiConnectionUrl", PropertyKey.xdevapiDnsSrv, XDEVAPI_DNS_SRV_SESSION);
      ...
      private Type(String scheme, ConnectionUrl.HostsCardinality cardinality, String implementingClass) {
         this(scheme, cardinality, implementingClass, (PropertyKey)null, (ConnectionUrl.Type)null);
      }

      private Type(String scheme, ConnectionUrl.HostsCardinality cardinality, String implementingClass, PropertyKey dnsSrvPropertyKey, ConnectionUrl.Type alternateDnsSrvType) {
         this.scheme = scheme;
      ...
      public static boolean isSupported(String scheme) {
         ConnectionUrl.Type[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            ConnectionUrl.Type t = var1[var3];
      ...
      private ConnectionUrl getImplementingInstance(ConnectionUrlParser parser, Properties info) {
         return (ConnectionUrl)Util.getInstance(ConnectionUrl.class, this.implementingClass, new Class[]{ConnectionUrlParser.class, Properties.class}, new Object[]{parser, info}, (ExceptionInterceptor)null);
      }
   }
