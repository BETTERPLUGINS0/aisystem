package fr.xephi.authme.libs.org.postgresql.translation;
...
public class messages_zh_TW extends ResourceBundle {
   ...
   public Enumeration getKeys() {
      return new Enumeration() {
         ...
         {
            for(this.idx = 0; this.idx < 578 && messages_zh_TW.table[this.idx] == null; this.idx += 2) {
            }
         ...
         public Object nextElement() {
            String key = messages_zh_TW.table[this.idx];

            do {
               this.idx += 2;
            } while(this.idx < 578 && messages_zh_TW.table[this.idx] == null);
