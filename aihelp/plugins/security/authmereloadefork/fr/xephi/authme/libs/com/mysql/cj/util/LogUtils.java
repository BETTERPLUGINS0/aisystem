...
public class LogUtils {
   ...
   public static String findCallingClassAndMethod(Throwable t) {
      ...
      int endInternalMethods = Math.max(Math.max(stackTraceAsString.lastIndexOf("fr.xephi.authme.libs.com.mysql.cj"), stackTraceAsString.lastIndexOf("fr.xephi.authme.libs.com.mysql.cj.core")), stackTraceAsString.lastIndexOf("fr.xephi.authme.libs.com.mysql.cj.jdbc"));
