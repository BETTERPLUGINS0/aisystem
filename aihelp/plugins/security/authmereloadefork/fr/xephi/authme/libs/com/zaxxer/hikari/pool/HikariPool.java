package fr.xephi.authme.libs.com.zaxxer.hikari.pool;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.health.HealthCheckRegistry;
import fr.xephi.authme.libs.com.zaxxer.hikari.HikariConfig;
import fr.xephi.authme.libs.com.zaxxer.hikari.HikariPoolMXBean;
...
import fr.xephi.authme.libs.com.zaxxer.hikari.metrics.dropwizard.CodahaleHealthChecker;
import fr.xephi.authme.libs.com.zaxxer.hikari.metrics.dropwizard.CodahaleMetricsTrackerFactory;
import fr.xephi.authme.libs.com.zaxxer.hikari.metrics.micrometer.MicrometerMetricsTrackerFactory;
import fr.xephi.authme.libs.com.zaxxer.hikari.util.ClockSource;
import fr.xephi.authme.libs.com.zaxxer.hikari.util.ConcurrentBag;
import fr.xephi.authme.libs.com.zaxxer.hikari.util.SuspendResumeLock;
import fr.xephi.authme.libs.com.zaxxer.hikari.util.UtilityElf;
...
public final class HikariPool extends PoolBase implements HikariPoolMXBean, ConcurrentBag.IBagStateListener {
   ...
   public HikariPool(HikariConfig config) {
      super(config);
      this.aliveBypassWindowMs = Long.getLong("fr.xephi.authme.libs.com.zaxxer.hikari.aliveBypassWindowMs", TimeUnit.MILLISECONDS.toMillis(500L));
      this.housekeepingPeriodMs = Long.getLong("fr.xephi.authme.libs.com.zaxxer.hikari.housekeeping.periodMs", TimeUnit.SECONDS.toMillis(30L));
      ...
      this.addConnectionExecutor = UtilityElf.createThreadPoolExecutor(addConnectionQueue, this.poolName + " connection adder", threadFactory, new DiscardOldestPolicy());
      ...
      if (Boolean.getBoolean("fr.xephi.authme.libs.com.zaxxer.hikari.blockUntilFilled") && config.getInitializationFailTimeout() > 1L) {
