...
public class Messages {
   private static final String BUNDLE_NAME = "fr.xephi.authme.libs.com.mysql.cj.LocalizedErrorMessages";
   ...
   static {
      ...
      try {
         temp = ResourceBundle.getBundle("fr.xephi.authme.libs.com.mysql.cj.LocalizedErrorMessages", Locale.getDefault(), Messages.class.getClassLoader());
      } catch (Throwable var9) {
         try {
            temp = ResourceBundle.getBundle("fr.xephi.authme.libs.com.mysql.cj.LocalizedErrorMessages");
