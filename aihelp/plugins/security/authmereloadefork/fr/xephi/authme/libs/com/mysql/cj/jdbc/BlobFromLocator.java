...
public class BlobFromLocator implements java.sql.Blob {
   ...
   public InputStream getBinaryStream() throws SQLException {
      try {
         return new BufferedInputStream(new BlobFromLocator.LocatorInputStream(), (Integer)this.creatorResultSet.getSession().getPropertySet().getMemorySizeProperty(PropertyKey.locatorFetchBufferSize).getValue());
   ...
   public InputStream getBinaryStream(long pos, long length) throws SQLException {
      try {
         return new BlobFromLocator.LocatorInputStream(pos, length);
