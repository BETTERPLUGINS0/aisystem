...
import fr.xephi.authme.libs.org.mariadb.jdbc.client.result.rowdecoder.BinaryRowDecoder;
import fr.xephi.authme.libs.org.mariadb.jdbc.client.result.rowdecoder.RowDecoder;
import fr.xephi.authme.libs.org.mariadb.jdbc.client.result.rowdecoder.TextRowDecoder;
...
import fr.xephi.authme.libs.org.mariadb.jdbc.plugin.codec.BigIntegerCodec;
...
public abstract class Result implements ResultSet, Completion {
   ...
   public Result(fr.xephi.authme.libs.org.mariadb.jdbc.Statement stmt, boolean binaryProtocol, long maxRows, ColumnDecoder[] metadataList, Reader reader, Context context, int resultSetType, boolean closeOnCompletion, boolean traceEnable, boolean forceAlias, int fetchSize) {
   ...
   public String getString(int columnIndex) throws SQLException {
      ...
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeString(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength);
   }
   ...
   public BigInteger getBigInteger(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (BigInteger)this.rowDecoder.decode(BigIntegerCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }
   ...
   public BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException {
      ...
      if (this.fieldLength.get() == -1) {
         ...
         BigDecimal d = (BigDecimal)this.rowDecoder.decode(BigDecimalCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   ...
   public byte[] getBytes(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (byte[])this.rowDecoder.decode(ByteArrayCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }

   public Date getDate(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeDate(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength, (Calendar)null);
   }

   public Time getTime(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeTime(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength, (Calendar)null);
   }

   public Timestamp getTimestamp(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeTimestamp(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength, (Calendar)null);
   }

   public InputStream getAsciiStream(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (InputStream)this.rowDecoder.decode(StreamCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }
   ...
   public Object getObject(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.defaultDecode(this.context.getConf(), this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength);
   }
   ...
   public java.io.Reader getCharacterStream(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (java.io.Reader)this.rowDecoder.decode(ReaderCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }
   ...
   public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (BigDecimal)this.rowDecoder.decode(BigDecimalCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }
   ...
   public Blob getBlob(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (Blob)this.rowDecoder.decode(BlobCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }

   public Clob getClob(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (Clob)this.rowDecoder.decode(ClobCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }
   ...
   public Date getDate(int columnIndex, Calendar cal) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeDate(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength, cal);
   }
   ...
   public Time getTime(int columnIndex, Calendar cal) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeTime(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength, cal);
   }
   ...
   public Timestamp getTimestamp(int columnIndex, Calendar cal) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : this.rowDecoder.decodeTimestamp(this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength, cal);
   }
   ...
   public URL getURL(int columnIndex) throws SQLException {
      ...
      if (this.fieldLength.get() == -1) {
         ...
         String s = (String)this.rowDecoder.decode(StringCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
         if (s == null) {
            return null;
         } else {
            try {
   ...
   public NClob getNClob(int columnIndex) throws SQLException {
      this.checkIndex(columnIndex);
      this.fieldLength.set(this.rowDecoder.setPosition(columnIndex - 1, this.fieldIndex, this.maxIndex, this.rowBuf, this.nullBitmap, this.metadataList));
      return this.fieldLength.get() == -1 ? null : (NClob)this.rowDecoder.decode(ClobCodec.INSTANCE, (Calendar)null, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
   }
   ...
   public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
      ...
      if (this.wasNull()) {
         ...
         if (!Object.class.equals(type) && type != null) {
            Codec[] var6 = conf.codecs();
            int var7 = var6.length;

            for(int var8 = 0; var8 < var7; ++var8) {
               Codec<?> codec = var6[var8];
               if (codec.canDecode(column, type)) {
                  return this.rowDecoder.decode(codec, (Calendar)calendar, this.rowBuf, this.fieldLength, this.metadataList, this.fieldIndex);
               }
            }
            ...
            return this.rowDecoder.defaultDecode(conf, this.metadataList, this.fieldIndex, this.rowBuf, this.fieldLength);
         }
      }
   }
