...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
   ...
   public Set<Range<C>> asRanges() {
      ...
      return result == null ? (this.asRanges = new TreeRangeSet.AsRanges(this, this.rangesByLowerBound.values())) : result;
   }

   public Set<Range<C>> asDescendingSetOfRanges() {
      Set<Range<C>> result = this.asDescendingSetOfRanges;
      return result == null ? (this.asDescendingSetOfRanges = new TreeRangeSet.AsRanges(this, this.rangesByLowerBound.descendingMap().values())) : result;
   }
   ...
   final class AsRanges extends ForwardingCollection<Range<C>> implements Set<Range<C>> {
      ...
      AsRanges(TreeRangeSet this$0, Collection delegate) {
