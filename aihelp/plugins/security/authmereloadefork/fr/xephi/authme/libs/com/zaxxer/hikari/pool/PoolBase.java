...
import fr.xephi.authme.libs.com.zaxxer.hikari.SQLExceptionOverride;
...
import fr.xephi.authme.libs.com.zaxxer.hikari.util.DriverDataSource;
import fr.xephi.authme.libs.com.zaxxer.hikari.util.PropertyElf;
      ...
      if (this.config.isRegisterMbeans()) {
         try {
            ...
            if ("true".equals(System.getProperty("hikaricp.jmx.register2.0"))) {
               beanConfigName = new ObjectName("fr.xephi.authme.libs.com.zaxxer.hikari:type=PoolConfig,name=" + this.poolName);
               beanPoolName = new ObjectName("fr.xephi.authme.libs.com.zaxxer.hikari:type=Pool,name=" + this.poolName);
            } else {
               beanConfigName = new ObjectName("fr.xephi.authme.libs.com.zaxxer.hikari:type=PoolConfig (" + this.poolName + ")");
               beanPoolName = new ObjectName("fr.xephi.authme.libs.com.zaxxer.hikari:type=Pool (" + this.poolName + ")");
            }
