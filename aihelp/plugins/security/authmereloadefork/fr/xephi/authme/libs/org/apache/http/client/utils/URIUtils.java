...
public class URIUtils {
   public static final EnumSet<URIUtils.UriFlag> NO_FLAGS = EnumSet.noneOf(URIUtils.UriFlag.class);
   ...
   public static URI rewriteURI(URI uri, HttpHost target, EnumSet<URIUtils.UriFlag> flags) throws URISyntaxException {
