...
public final class DateUtils {
   ...
   public static Date parseDate(String dateValue, String[] dateFormats, Date startDate) throws DateParseException {
      Date d = fr.xephi.authme.libs.org.apache.http.client.utils.DateUtils.parseDate(dateValue, dateFormats, startDate);
      if (d == null) {
   ...
   public static String formatDate(Date date) {
      return fr.xephi.authme.libs.org.apache.http.client.utils.DateUtils.formatDate(date);
   }

   public static String formatDate(Date date, String pattern) {
      return fr.xephi.authme.libs.org.apache.http.client.utils.DateUtils.formatDate(date, pattern);
   }
