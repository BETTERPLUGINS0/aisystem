...
public final class Descriptors {
   ...
   public static final class OneofDescriptor extends Descriptors.GenericDescriptor {
      ...
      // $FF: synthetic method
      OneofDescriptor(DescriptorProtos.OneofDescriptorProto x0, Descriptors.FileDescriptor x1, Descriptors.Descriptor x2, int x3, Object x4) {
         this(x0, x1, x2, x3);
      }
   }
   ...
   private static final class DescriptorPool {
      ...
      DescriptorPool(Descriptors.FileDescriptor[] dependencies, boolean allowUnknownDependencies) {
         ...
         Descriptors.FileDescriptor[] var3 = dependencies;
         int var4 = dependencies.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            Descriptors.FileDescriptor dependency = var3[var5];
            this.dependencies.add(dependency);
            this.importPublicDependencies(dependency);
         }

         Iterator var8 = this.dependencies.iterator();

         while(var8.hasNext()) {
            Descriptors.FileDescriptor dependency = (Descriptors.FileDescriptor)var8.next();
   ...
   public static final class MethodDescriptor extends Descriptors.GenericDescriptor {
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         Descriptors.GenericDescriptor input = this.getFile().pool.lookupSymbol(this.proto.getInputType(), this, Descriptors.DescriptorPool.SearchFilter.TYPES_ONLY);
         if (!(input instanceof Descriptors.Descriptor)) {
            ...
            Descriptors.GenericDescriptor output = this.getFile().pool.lookupSymbol(this.proto.getOutputType(), this, Descriptors.DescriptorPool.SearchFilter.TYPES_ONLY);
   ...
   public static final class EnumValueDescriptor extends Descriptors.GenericDescriptor implements Internal.EnumLite {
      ...
      // $FF: synthetic method
      EnumValueDescriptor(Descriptors.EnumDescriptor x0, Integer x1, Object x2) {
         this(x0, x1);
      }
   ...
   public static final class EnumDescriptor extends Descriptors.GenericDescriptor implements Internal.EnumLiteMap<Descriptors.EnumValueDescriptor> {
      ...
      private Map<Integer, WeakReference<Descriptors.EnumValueDescriptor>> unknownValues;
      private ReferenceQueue<Descriptors.EnumValueDescriptor> cleanupQueue;
      ...
      public Descriptors.EnumValueDescriptor findValueByNumber(int number) {
         return (Descriptors.EnumValueDescriptor)Descriptors.binarySearch(this.valuesSortedByNumber, this.distinctNumbers, Descriptors.EnumValueDescriptor.NUMBER_GETTER, number);
      }
      ...
      private EnumDescriptor(DescriptorProtos.EnumDescriptorProto proto, Descriptors.FileDescriptor file, Descriptors.Descriptor parent, int index) throws Descriptors.DescriptorValidationException {
         ...
         if (proto.getValueCount() == 0) {
            ...
            int j;
            for(j = 0; j < proto.getValueCount(); ++j) {
               this.values[j] = new Descriptors.EnumValueDescriptor(proto.getValue(j), file, this, j);
            }
      ...
      private static class UnknownEnumValueReference extends WeakReference<Descriptors.EnumValueDescriptor> {
         ...
         // $FF: synthetic method
         UnknownEnumValueReference(int x0, Descriptors.EnumValueDescriptor x1, Object x2) {
            this(x0, x1);
         }
      }
   }

   public static final class FieldDescriptor extends Descriptors.GenericDescriptor implements Comparable<Descriptors.FieldDescriptor>, FieldSet.FieldDescriptorLite<Descriptors.FieldDescriptor> {
   ...
   public static final class Descriptor extends Descriptors.GenericDescriptor {
      ...
      public Descriptors.FieldDescriptor findFieldByNumber(int number) {
         return (Descriptors.FieldDescriptor)Descriptors.binarySearch(this.fieldsSortedByNumber, this.fieldsSortedByNumber.length, Descriptors.FieldDescriptor.NUMBER_GETTER, number);
      }
      ...
      private Descriptor(DescriptorProtos.DescriptorProto proto, Descriptors.FileDescriptor file, Descriptors.Descriptor parent, int index) throws Descriptors.DescriptorValidationException {
         ...
         int syntheticOneofCount;
         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getOneofDeclCount(); ++syntheticOneofCount) {
            this.oneofs[syntheticOneofCount] = new Descriptors.OneofDescriptor(proto.getOneofDecl(syntheticOneofCount), file, this, syntheticOneofCount);
         }
         ...
         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getNestedTypeCount(); ++syntheticOneofCount) {
            this.nestedTypes[syntheticOneofCount] = new Descriptors.Descriptor(proto.getNestedType(syntheticOneofCount), file, this, syntheticOneofCount);
         }
         ...
         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getEnumTypeCount(); ++syntheticOneofCount) {
            this.enumTypes[syntheticOneofCount] = new Descriptors.EnumDescriptor(proto.getEnumType(syntheticOneofCount), file, this, syntheticOneofCount);
         }
         ...
         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getFieldCount(); ++syntheticOneofCount) {
            this.fields[syntheticOneofCount] = new Descriptors.FieldDescriptor(proto.getField(syntheticOneofCount), file, this, syntheticOneofCount, false);
         }
         ...
         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getExtensionCount(); ++syntheticOneofCount) {
            this.extensions[syntheticOneofCount] = new Descriptors.FieldDescriptor(proto.getExtension(syntheticOneofCount), file, this, syntheticOneofCount, true);
         }

         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getOneofDeclCount(); ++syntheticOneofCount) {
            this.oneofs[syntheticOneofCount].fields = new Descriptors.FieldDescriptor[this.oneofs[syntheticOneofCount].getFieldCount()];
            this.oneofs[syntheticOneofCount].fieldCount = 0;
         }

         for(syntheticOneofCount = 0; syntheticOneofCount < proto.getFieldCount(); ++syntheticOneofCount) {
            Descriptors.OneofDescriptor oneofDescriptor = this.fields[syntheticOneofCount].getContainingOneof();
            if (oneofDescriptor != null) {
               oneofDescriptor.fields[oneofDescriptor.fieldCount++] = this.fields[syntheticOneofCount];
            }
         }

         syntheticOneofCount = 0;
         Descriptors.OneofDescriptor[] var10 = this.oneofs;
         int var7 = var10.length;

         for(int var8 = 0; var8 < var7; ++var8) {
            Descriptors.OneofDescriptor oneof = var10[var8];
         ...
         if (proto.getExtensionRangeCount() > 0) {
            ...
            for(Iterator var12 = proto.getExtensionRangeList().iterator(); var12.hasNext(); ++i) {
               DescriptorProtos.DescriptorProto.ExtensionRange range = (DescriptorProtos.DescriptorProto.ExtensionRange)var12.next();
