...
public class Rule {
   ...
   private static String createResourceName(NameType nameType, RuleType rt, String lang) {
      return String.format("fr/xephi/authme/libs/org/apache/commons/codec/language/bm/%s_%s_%s.txt", nameType.getName(), rt.getName(), lang);
   }
   ...
   private static Scanner createScanner(String lang) {
      String resName = String.format("fr/xephi/authme/libs/org/apache/commons/codec/language/bm/%s.txt", lang);
      return new Scanner(Resources.getInputStream(resName), "UTF-8");
   }
