...
public class LogFactoryImpl extends LogFactory {
   private static final String LOGGING_IMPL_LOG4J_LOGGER = "fr.xephi.authme.libs.org.apache.commons.logging.impl.Log4JLogger";
   private static final String LOGGING_IMPL_JDK14_LOGGER = "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk14Logger";
   private static final String LOGGING_IMPL_LUMBERJACK_LOGGER = "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk13LumberjackLogger";
   private static final String LOGGING_IMPL_SIMPLE_LOGGER = "fr.xephi.authme.libs.org.apache.commons.logging.impl.SimpleLog";
   private static final String PKG_IMPL = "fr.xephi.authme.libs.org.apache.commons.logging.impl.";
   private static final int PKG_LEN = "fr.xephi.authme.libs.org.apache.commons.logging.impl.".length();
   public static final String LOG_PROPERTY = "fr.xephi.authme.libs.org.apache.commons.logging.Log";
   protected static final String LOG_PROPERTY_OLD = "fr.xephi.authme.libs.org.apache.commons.logging.log";
   public static final String ALLOW_FLAWED_CONTEXT_PROPERTY = "fr.xephi.authme.libs.org.apache.commons.logging.Log.allowFlawedContext";
   public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY = "fr.xephi.authme.libs.org.apache.commons.logging.Log.allowFlawedDiscovery";
   public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY = "fr.xephi.authme.libs.org.apache.commons.logging.Log.allowFlawedHierarchy";
   private static final String[] classesToDiscover = new String[]{"fr.xephi.authme.libs.org.apache.commons.logging.impl.Log4JLogger", "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk14Logger", "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk13LumberjackLogger", "fr.xephi.authme.libs.org.apache.commons.logging.impl.SimpleLog"};
   ...
   public LogFactoryImpl() {
      ...
      this.logMethod = null;
      this.logMethodSignature = new Class[]{class$org$apache$commons$logging$LogFactory == null ? (class$org$apache$commons$logging$LogFactory = class$("fr.xephi.authme.libs.org.apache.commons.logging.LogFactory")) : class$org$apache$commons$logging$LogFactory};
   ...
   protected boolean isJdk13LumberjackAvailable() {
      return this.isLogLibraryAvailable("Jdk13Lumberjack", "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk13LumberjackLogger");
   }

   /** @deprecated */
   protected boolean isJdk14Available() {
      return this.isLogLibraryAvailable("Jdk14", "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk14Logger");
   }

   /** @deprecated */
   protected boolean isLog4JAvailable() {
      return this.isLogLibraryAvailable("Log4J", "fr.xephi.authme.libs.org.apache.commons.logging.impl.Log4JLogger");
   }
   ...
   private void initConfiguration() {
      this.allowFlawedContext = this.getBooleanConfiguration("fr.xephi.authme.libs.org.apache.commons.logging.Log.allowFlawedContext", true);
      this.allowFlawedDiscovery = this.getBooleanConfiguration("fr.xephi.authme.libs.org.apache.commons.logging.Log.allowFlawedDiscovery", true);
      this.allowFlawedHierarchy = this.getBooleanConfiguration("fr.xephi.authme.libs.org.apache.commons.logging.Log.allowFlawedHierarchy", true);
   }
   ...
   private Log discoverLogImplementation(String logCategory) throws LogConfigurationException {
      ...
      if (specifiedLogClassName != null) {
         ...
         if (result == null) {
            ...
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "fr.xephi.authme.libs.org.apache.commons.logging.impl.Log4JLogger");
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk14Logger");
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk13LumberjackLogger");
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "fr.xephi.authme.libs.org.apache.commons.logging.impl.SimpleLog");
   ...
   private String findUserSpecifiedLogClassName() {
      ...
      String specifiedClass = (String)this.getAttribute("fr.xephi.authme.libs.org.apache.commons.logging.Log");
      if (specifiedClass == null) {
         if (isDiagnosticsEnabled()) {
            this.logDiagnostic("Trying to get log class from attribute 'org.apache.commons.logging.log'");
         }

         specifiedClass = (String)this.getAttribute("fr.xephi.authme.libs.org.apache.commons.logging.log");
      }
      ...
      if (specifiedClass == null) {
         ...
         try {
            specifiedClass = getSystemProperty("fr.xephi.authme.libs.org.apache.commons.logging.Log", (String)null);
         } catch (SecurityException var4) {
            if (isDiagnosticsEnabled()) {
   ...
   private ClassLoader getBaseClassLoader() throws LogConfigurationException {
      ClassLoader thisClassLoader = getClassLoader(class$org$apache$commons$logging$impl$LogFactoryImpl == null ? (class$org$apache$commons$logging$impl$LogFactoryImpl = class$("fr.xephi.authme.libs.org.apache.commons.logging.impl.LogFactoryImpl")) : class$org$apache$commons$logging$impl$LogFactoryImpl);
      if (!this.useTCCL) {
   ...
   private void handleFlawedHierarchy(ClassLoader badClassLoader, Class badClass) throws LogConfigurationException {
      ...
      String logInterfaceName = (class$org$apache$commons$logging$Log == null ? (class$org$apache$commons$logging$Log = class$("fr.xephi.authme.libs.org.apache.commons.logging.Log")) : class$org$apache$commons$logging$Log).getName();
      ...
      if (implementsLog) {
         if (isDiagnosticsEnabled()) {
            try {
               ClassLoader logInterfaceClassLoader = getClassLoader(class$org$apache$commons$logging$Log == null ? (class$org$apache$commons$logging$Log = class$("fr.xephi.authme.libs.org.apache.commons.logging.Log")) : class$org$apache$commons$logging$Log);
         ...
         if (!this.allowFlawedHierarchy) {
            ...
            msg.append((class$org$apache$commons$logging$Log == null ? (class$org$apache$commons$logging$Log = class$("fr.xephi.authme.libs.org.apache.commons.logging.Log")) : class$org$apache$commons$logging$Log).getName());
            msg.append("' visible.");
            if (isDiagnosticsEnabled()) {
