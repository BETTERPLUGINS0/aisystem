...
import fr.xephi.authme.libs.org.apache.commons.logging.impl.NoOpLog;
...
public class LogSource {
   ...
   static {
      ...
      try {
         jdk14IsAvailable = null != Class.forName("java.util.logging.Logger") && null != Class.forName("fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk14Logger");
      ...
      try {
         name = System.getProperty("fr.xephi.authme.libs.org.apache.commons.logging.log");
         if (name == null) {
            name = System.getProperty("fr.xephi.authme.libs.org.apache.commons.logging.Log");
         }
      ...
      if (name != null) {
         try {
            ...
            try {
               setLogImplementation("fr.xephi.authme.libs.org.apache.commons.logging.impl.NoOpLog");
         ...
         try {
            if (log4jIsAvailable) {
               setLogImplementation("fr.xephi.authme.libs.org.apache.commons.logging.impl.Log4JLogger");
            } else if (jdk14IsAvailable) {
               setLogImplementation("fr.xephi.authme.libs.org.apache.commons.logging.impl.Jdk14Logger");
            } else {
               setLogImplementation("fr.xephi.authme.libs.org.apache.commons.logging.impl.NoOpLog");
            }
