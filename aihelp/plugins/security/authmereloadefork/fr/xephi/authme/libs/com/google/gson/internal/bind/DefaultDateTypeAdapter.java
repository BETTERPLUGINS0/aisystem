...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
   ...
   // $FF: synthetic method
   DefaultDateTypeAdapter(DefaultDateTypeAdapter.DateType x0, String x1, Object x2) {
      this(x0, x1);
   }

   // $FF: synthetic method
   DefaultDateTypeAdapter(DefaultDateTypeAdapter.DateType x0, int x1, Object x2) {
      this(x0, x1);
   }

   // $FF: synthetic method
   DefaultDateTypeAdapter(DefaultDateTypeAdapter.DateType x0, int x1, int x2, Object x3) {
      this(x0, x1, x2);
   }
