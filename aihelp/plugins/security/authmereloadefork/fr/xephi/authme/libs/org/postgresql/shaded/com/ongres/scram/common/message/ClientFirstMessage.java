...
public class ClientFirstMessage implements StringWritable {
   ...
   public ClientFirstMessage(String user, String nonce) {
      this(gs2Header(Gs2CbindFlag.CLIENT_NOT, (String)null, (String)null), user, nonce);
   }
   ...
   public static ClientFirstMessage parseFrom(String clientFirstMessage) throws ScramParseException, IllegalArgumentException {
      ...
      try {
         ...
         throw new ScramParseException("Illegal series of attributes in client-first-message", var5);
      }
