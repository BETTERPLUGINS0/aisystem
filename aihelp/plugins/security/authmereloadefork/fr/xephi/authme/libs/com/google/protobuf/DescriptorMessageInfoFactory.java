...
final class DescriptorMessageInfoFactory implements MessageInfoFactory {
   ...
   static class IsInitializedCheckAnalyzer {
      ...
      private DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node dfs(Descriptors.Descriptor descriptor) {
         DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node result = new DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node(descriptor, this.index++);
         ...
         while(var3.hasNext()) {
            ...
            if (field.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE) {
               DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node child = (DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node)this.nodeCache.get(field.getMessageType());
               if (child == null) {
         ...
         if (result.index == result.lowLink) {
            ...
            do {
               node = (DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node)this.stack.pop();
      ...
      private void analyze(DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.StronglyConnectedComponent component) {
         ...
         while(var3.hasNext()) {
            ...
            while(var5.hasNext()) {
               ...
               if (field.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                  DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node node = (DescriptorMessageInfoFactory.IsInitializedCheckAnalyzer.Node)this.nodeCache.get(field.getMessageType());
