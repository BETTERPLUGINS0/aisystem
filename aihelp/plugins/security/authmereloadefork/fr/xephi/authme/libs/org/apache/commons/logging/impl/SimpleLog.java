...
public class SimpleLog implements Log, Serializable {
   ...
   protected static final String systemPrefix = "fr.xephi.authme.libs.org.apache.commons.logging.simplelog.";
   ...
   public SimpleLog(String name) {
      this.logName = name;
      this.setLevel(3);
      String lvl = getStringProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.log." + this.logName);

      for(int i = String.valueOf(name).lastIndexOf("."); null == lvl && i > -1; i = String.valueOf(name).lastIndexOf(".")) {
         name = name.substring(0, i);
         lvl = getStringProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.log." + name);
      }

      if (null == lvl) {
         lvl = getStringProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.defaultlog");
      }
   ...
   static {
      ...
      showLogName = getBooleanProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.showlogname", showLogName);
      showShortName = getBooleanProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.showShortLogname", showShortName);
      showDateTime = getBooleanProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.showdatetime", showDateTime);
      if (showDateTime) {
         dateTimeFormat = getStringProperty("fr.xephi.authme.libs.org.apache.commons.logging.simplelog.dateTimeFormat", dateTimeFormat);
