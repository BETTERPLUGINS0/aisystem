...
public class Jdk14Logger implements Log {
   ...
   private static final int findCallerStackDepth(StackTraceElement[] stackTrace) {
      ...
      for(int i = 0; i < numFrames; ++i) {
         ...
         if (!callerClassName.startsWith("fr.xephi.authme.libs.com.mysql.cj") && !callerClassName.startsWith("fr.xephi.authme.libs.com.mysql.cj.core") && !callerClassName.startsWith("fr.xephi.authme.libs.com.mysql.cj.jdbc")) {
            return i;
         }
      }
