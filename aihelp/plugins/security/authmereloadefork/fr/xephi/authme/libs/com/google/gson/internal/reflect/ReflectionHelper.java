package fr.xephi.authme.libs.com.google.gson.internal.reflect;
...
public class ReflectionHelper {
   ...
   public static void makeAccessible(AccessibleObject object) throws JsonIOException {
      try {
         ...
         throw new JsonIOException("Failed making " + description + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.", var3);
      }
   }
   ...
   public static String tryMakeAccessible(Constructor<?> constructor) {
      try {
         ...
         return "Failed making constructor '" + constructorToString(constructor) + "' accessible; either increase its visibility or write a custom InstanceCreator or TypeAdapter for its declaring type: " + var2.getMessage();
      }
   }
   ...
   private static class RecordNotSupportedHelper extends ReflectionHelper.RecordHelper {
      ...
      // $FF: synthetic method
      RecordNotSupportedHelper(Object x0) {
         this();
      }
   }
   ...
   private static class RecordSupportedHelper extends ReflectionHelper.RecordHelper {
      ...
      // $FF: synthetic method
      RecordSupportedHelper(Object x0) throws NoSuchMethodException {
         this();
      }
   }
