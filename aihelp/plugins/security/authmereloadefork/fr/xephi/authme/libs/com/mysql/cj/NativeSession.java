...
import fr.xephi.authme.libs.com.mysql.cj.protocol.NetworkResources;
...
import fr.xephi.authme.libs.com.mysql.cj.protocol.SocketFactory;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.NativeMessageBuilder;
...
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.NativeServerSession;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.NativeSocketConnection;
import fr.xephi.authme.libs.com.mysql.cj.protocol.a.ResultsetFactory;
...
public class NativeSession extends CoreSession implements Serializable {
   ...
   private void createConfigCacheIfNeeded(Object syncMutex) {
      synchronized(syncMutex) {
         if (this.serverConfigCache == null) {
            ...
            CacheAdapterFactory<String, Map<String, String>> cacheFactory = (CacheAdapterFactory)Util.getInstance(CacheAdapterFactory.class, serverConfigCacheFactory, (Class[])null, (Object[])null, this.getExceptionInterceptor());
   ...
   public void loadServerVariables(Object syncMutex, String version) {
      ...
      try {
         ...
         if (this.versionMeetsMinimum(5, 1, 0)) {
            ...
            NativePacketPayload resultPacket = (NativePacketPayload)this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)queryBuf.toString()), false, 0);
            ...
            NativePacketPayload resultPacket = (NativePacketPayload)this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)(versionComment + "SHOW VARIABLES")), false, 0);
            Resultset rs = ((NativeProtocol)this.protocol).readAllResults(-1, false, resultPacket, false, (ColumnDefinition)null, new ResultsetFactory(Resultset.Type.FORWARD_ONLY, (Resultset.Concurrency)null));
   ...
   public void setSessionVariables() {
      ...
      if (sessionVariables != null) {
         ...
         if (!variablesToSet.isEmpty()) {
            ...
            this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)query.toString()), false, 0);
         }
      }
   ...
   public String getProcessHost() {
      try {
         ...
         if (processHost == null) {
            ...
            NativePacketPayload resultPacket = (NativePacketPayload)this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)"SELECT CONNECTION_ID()"), false, 0);
            Resultset rs = ((NativeProtocol)this.protocol).readAllResults(-1, false, resultPacket, false, (ColumnDefinition)null, new ResultsetFactory(Resultset.Type.FORWARD_ONLY, (Resultset.Concurrency)null));
   ...
   private String findProcessHost(long threadId) {
      try {
         ...
         NativePacketPayload resultPacket = !this.versionMeetsMinimum(5, 6, 0) || ps == null || !"1".contentEquals(ps) && !"ON".contentEquals(ps) ? (NativePacketPayload)this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)"SHOW PROCESSLIST"), false, 0) : (NativePacketPayload)this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)("select PROCESSLIST_ID, PROCESSLIST_USER, PROCESSLIST_HOST from performance_schema.threads where PROCESSLIST_ID=" + threadId)), false, 0);
         Resultset rs = ((NativeProtocol)this.protocol).readAllResults(-1, false, resultPacket, false, (ColumnDefinition)null, new ResultsetFactory(Resultset.Type.FORWARD_ONLY, (Resultset.Concurrency)null));
         ValueFactory<Long> lvf = new LongValueFactory(this.getPropertySet());
   ...
   public String queryServerVariable(String varName) {
      try {
         NativePacketPayload resultPacket = (NativePacketPayload)this.protocol.sendCommand(this.commandBuilder.buildComQuery((NativePacketPayload)null, (String)("SELECT " + varName)), false, 0);
         Resultset rs = ((NativeProtocol)this.protocol).readAllResults(-1, false, resultPacket, false, (ColumnDefinition)null, new ResultsetFactory(Resultset.Type.FORWARD_ONLY, (Resultset.Concurrency)null));
   ...
   public void ping(boolean checkForClosedConnection, int timeoutMillis) {
      ...
      if ((pingMillisLifetime <= 0L || System.currentTimeMillis() - this.connectionCreationTimeMillis <= pingMillisLifetime) && (pingMaxOperations <= 0 || pingMaxOperations > this.getCommandCount())) {
         this.protocol.sendCommand(this.commandBuilder.buildComPing((NativePacketPayload)null), false, timeoutMillis);
      } else {
