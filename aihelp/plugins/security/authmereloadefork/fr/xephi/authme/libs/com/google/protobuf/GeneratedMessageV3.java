...
public abstract class GeneratedMessageV3 extends AbstractMessage implements Serializable {
         ...
         if (this.initialized) {
            ...
            synchronized(this) {
               if (this.initialized) {
                  ...
                  for(int i = 0; i < i; ++i) {
                     this.oneofs[i] = new GeneratedMessageV3.FieldAccessorTable.OneofAccessor(this.descriptor, i, this.camelCaseNames[i + fieldsSize], messageClass, builderClass);
                  }
   ...
   public abstract static class Builder<BuilderType extends GeneratedMessageV3.Builder<BuilderType>> extends AbstractMessage.Builder<BuilderType> {
      ...
      public BuilderType clone() {
         BuilderType builder = (GeneratedMessageV3.Builder)this.getDefaultInstanceForType().newBuilderForType();
