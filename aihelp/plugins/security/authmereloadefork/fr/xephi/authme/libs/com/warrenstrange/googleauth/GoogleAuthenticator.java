...
import fr.xephi.authme.libs.org.apache.commons.codec.binary.Base32;
...
public final class GoogleAuthenticator implements IGoogleAuthenticator {
   public static final String RNG_ALGORITHM = "fr.xephi.authme.libs.com.warrenstrange.googleauth.rng.algorithm";
   public static final String RNG_ALGORITHM_PROVIDER = "fr.xephi.authme.libs.com.warrenstrange.googleauth.rng.algorithmProvider";
   ...
   private String getRandomNumberAlgorithm() {
      return System.getProperty("fr.xephi.authme.libs.com.warrenstrange.googleauth.rng.algorithm", "SHA1PRNG");
   }

   private String getRandomNumberAlgorithmProvider() {
      return System.getProperty("fr.xephi.authme.libs.com.warrenstrange.googleauth.rng.algorithmProvider", "SUN");
   }
