...
import fr.xephi.authme.libs.com.google.common.base.Suppliers;
...
public final class CacheBuilder<K, V> {
   ...
   static enum OneWeigher implements Weigher<Object, Object> {
      ...
      // $FF: synthetic method
      private static CacheBuilder.OneWeigher[] $values() {
         return new CacheBuilder.OneWeigher[]{INSTANCE};
      }
   }
   ...
   static enum NullListener implements RemovalListener<Object, Object> {
      ...
      // $FF: synthetic method
      private static CacheBuilder.NullListener[] $values() {
         return new CacheBuilder.NullListener[]{INSTANCE};
      }
   }
}
