...
interface Reader {
   ...
   <T> void mergeMessageField(T var1, Schema<T> var2, ExtensionRegistryLite var3) throws IOException;

   <T> void mergeGroupField(T var1, Schema<T> var2, ExtensionRegistryLite var3) throws IOException;
