...
public abstract class BaseCallableStatement extends ServerPreparedStatement implements CallableStatement {
   ...
   public BaseCallableStatement(String sql, Connection con, ReentrantLock lock, String databaseName, String procedureName, boolean canUseServerTimeout, boolean canUseServerMaxRows, boolean canCachePrepStmts, int resultSetType, int resultSetConcurrency, int defaultFetchSize) throws SQLException {
      super(sql, con, lock, canUseServerTimeout, canUseServerMaxRows, canCachePrepStmts, 1, resultSetType, resultSetConcurrency, defaultFetchSize);
   ...
   public CallableParameterMetaData getParameterMetaData() throws SQLException {
      PreparedStatement prep = new ClientPreparedStatement("SELECT * from information_schema.PARAMETERS WHERE SPECIFIC_NAME = ? AND SPECIFIC_SCHEMA = ? ORDER BY ORDINAL_POSITION", this.con, this.lock, false, false, 2, 1003, 1007, 0);
