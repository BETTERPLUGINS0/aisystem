...
public interface Protocol<M extends Message> {
   ...
   Supplier<ValueEncoder> getValueEncoderSupplier(Object var1);

   public interface ProtocolEventHandler {
      void addListener(Protocol.ProtocolEventListener var1);

      void removeListener(Protocol.ProtocolEventListener var1);

      void invokeListeners(Protocol.ProtocolEventListener.EventType var1, Throwable var2);
   }

   public interface ProtocolEventListener {
      void handleEvent(Protocol.ProtocolEventListener.EventType var1, Object var2, Throwable var3);
