...
public class CharsetMapping {
   ...
   protected static List<String> getStaticMysqlCharsetAliasesByName(String mysqlCharsetName) {
      MysqlCharset cs;
      return (cs = (MysqlCharset)CHARSET_NAME_TO_CHARSET.get(mysqlCharsetName)) != null ? cs.aliases : null;
   }
   ...
   static {
      ...
      for(int i = 0; i < charset.length; ++i) {
         ...
         Iterator var6 = charset[i].aliases.iterator();

         String encUC;
         while(var6.hasNext()) {
            encUC = (String)var6.next();
            charsetNameToMysqlCharsetMap.put(encUC, charset[i]);
         }

         var6 = charset[i].javaEncodingsUc.iterator();
      ...
      for(int i = 1; i < 1024; ++i) {
         ...
         if (coll != null) {
            ...
            String[] var12 = coll.collationNames;
            var13 = var12.length;

            for(int var14 = 0; var14 < var13; ++var14) {
               String collationName = var12[var14];
      ...
      MysqlCharset[] var23 = charset;
      int var25 = charset.length;

      for(var13 = 0; var13 < var25; ++var13) {
         MysqlCharset cs = var23[var13];
         Integer idx;
         if (!cs.aliases.isEmpty() && (idx = (Integer)charsetNameToCollationIndexMap.get(cs.charsetName)) != null) {
            Iterator var27 = cs.aliases.iterator();

            while(var27.hasNext()) {
               String alias = (String)var27.next();
