...
import fr.xephi.authme.libs.com.mysql.cj.jdbc.BlobFromLocator;
...
import fr.xephi.authme.libs.com.mysql.cj.jdbc.MysqlSQLXML;
import fr.xephi.authme.libs.com.mysql.cj.jdbc.StatementImpl;
import fr.xephi.authme.libs.com.mysql.cj.jdbc.exceptions.NotUpdatable;
...
import fr.xephi.authme.libs.com.mysql.cj.result.BinaryStreamValueFactory;
...
import fr.xephi.authme.libs.com.mysql.cj.result.DurationValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.Field;
import fr.xephi.authme.libs.com.mysql.cj.result.FloatValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.IntegerValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.LocalDateTimeValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.LocalDateValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.LocalTimeValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.LongValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.OffsetDateTimeValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.OffsetTimeValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.Row;
import fr.xephi.authme.libs.com.mysql.cj.result.ShortValueFactory;
...
import fr.xephi.authme.libs.com.mysql.cj.result.UtilCalendarValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.ValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.result.ZonedDateTimeValueFactory;
import fr.xephi.authme.libs.com.mysql.cj.util.LogUtils;
...
public class ResultSetImpl extends NativeResultset implements ResultSetInternalMethods, WarningListener {
   ...
   public Blob getBlob(int columnIndex) throws SQLException {
      try {
         ...
         if (this.thisRow.getNull(columnIndex - 1)) {
            ...
            return (Blob)(!(Boolean)this.emulateLocators.getValue() ? new fr.xephi.authme.libs.com.mysql.cj.jdbc.Blob(this.thisRow.getBytes(columnIndex - 1), this.getExceptionInterceptor()) : new BlobFromLocator(this, columnIndex, this.getExceptionInterceptor()));
         }
      } catch (CJException var3) {
         throw SQLExceptionsMapping.translateException(var3, this.getExceptionInterceptor());
      }
   ...
   public Clob getClob(int columnIndex) throws SQLException {
      try {
         ...
         return asString == null ? null : new fr.xephi.authme.libs.com.mysql.cj.jdbc.Clob(asString, this.getExceptionInterceptor());
      } catch (CJException var4) {
         throw SQLExceptionsMapping.translateException(var4, this.getExceptionInterceptor());
      }
   }
   ...
   public NClob getNClob(int columnIndex) throws SQLException {
      try {
         ...
         if (fieldEncoding != null && fieldEncoding.equals("UTF-8")) {
            ...
            return asString == null ? null : new fr.xephi.authme.libs.com.mysql.cj.jdbc.NClob(asString, this.getExceptionInterceptor());
         } else {
                           ...
                           if (!type.equals(Long.class) && !type.equals(Long.TYPE)) {
                              if (!type.equals(Float.class) && !type.equals(Float.TYPE)) {
                                 if (!type.equals(Double.class) && !type.equals(Double.TYPE)) {
                                    ...
                                    } else if (type.equals(fr.xephi.authme.libs.com.mysql.cj.jdbc.Clob.class)) {
                                       return this.getClob(columnIndex);
                                    } else if (type.equals(fr.xephi.authme.libs.com.mysql.cj.jdbc.Blob.class)) {
