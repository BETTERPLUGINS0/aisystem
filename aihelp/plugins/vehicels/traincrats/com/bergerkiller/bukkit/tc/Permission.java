...
public enum Permission implements IPermissionEnum {
   ...
   COMMAND_SAVEDTRAIN_SPAWNLIMIT("train.command.savedtrain.spawnlimit", PermissionDefault.OP, "Whether the player can set a global spawn limit for a saved train"),
   ...
   private Permission(String node, PermissionDefault permdefault, String desc) {
      this._root = node;
   ...
   public boolean has(CommandSender sender) {
      return CommonPlugin.hasInstance() ? super.has(sender) : sender.hasPermission(this.getName());
   }
   ...
   public com.bergerkiller.bukkit.common.dep.cloud.permission.Permission cloudPermission() {
      return this._cloud;
   }

   // $FF: synthetic method
   private static Permission[] $values() {
      return new Permission[]{COMMAND_GLOBALPROPERTIES, COMMAND_PROPERTIES, COMMAND_TARGET_NEAR, COMMAND_USE_SELECTORS, COMMAND_UNLIMITED_SELECTORS, PROPERTY_APPLYDEFAULTS, PROPERTY_NAME, PROPERTY_OWNERS, PROPERTY_MAXSPEED, PROPERTY_SLOWDOWN, PROPERTY_COLLISION, PROPERTY_PLAYERENTER, PROPERTY_PLAYEREXIT, PROPERTY_KEEPCHUNKSLOADED, PROPERTY_GRAVITY, PROPERTY_FRICTION, PROPERTY_BANKING, PROPERTY_DESTINATION, PROPERTY_ROUTE, PROPERTY_TAGS, PROPERTY_ONLYOWNERSCANENTER, PROPERTY_PICKUPITEMS, PROPERTY_SOUNDENABLED, PROPERTY_INVINCIBLE, PROPERTY_ALLOWPLAYERTAKE, PROPERTY_SPAWNITEMDROPS, PROPERTY_REQUIREPOWEREDCART, PROPERTY_DISPLAYNAME, PROPERTY_ALLOWMOBMANUALMOVEMENT, PROPERTY_ALLOWPLAYERMANUALMOVEMENT, PROPERTY_BREAKBLOCKS_NORMAL, PROPERTY_BREAKBLOCKS_ADMIN, PROPERTY_REALTIME, PROPERTY_TICKETS, PROPERTY_VIEW_DISTANCE, PROPERTY_TRACKING_RANGE, PROPERTY_ENTER_MESSAGE, PROPERTY_EXIT_OFFSET, PROPERTY_WAIT, COMMAND_EDIT, COMMAND_DESTROY, COMMAND_DESTROYALL, COMMAND_FIXBUGGED, COMMAND_UPGRADESAVED, COMMAND_REROUTE, COMMAND_RELOAD, COMMAND_DEFAULT, COMMAND_SAVEALL, COMMAND_MESSAGE, COMMAND_PATHINFO, COMMAND_TELEPORT, COMMAND_CHANGEBLOCK, COMMAND_CHANGETICK, COMMAND_ISSUE, COMMAND_GIVE_EDITOR, COMMAND_STORAGE_CHEST_USE, COMMAND_STORAGE_CHEST_CREATE, COMMAND_SAVE_TRAIN, COMMAND_SAVE_ROUTE, COMMAND_SAVEDTRAIN_LIST, COMMAND_SAVEDTRAIN_REVERSE, COMMAND_SAVEDTRAIN_SPAWNLIMIT, COMMAND_SAVEDTRAIN_RENAME, COMMAND_SAVEDTRAIN_COPY, COMMAND_SAVEDTRAIN_DELETE, COMMAND_SAVEDTRAIN_CLAIM, COMMAND_SAVEDTRAIN_GLOBAL, COMMAND_SAVEDTRAIN_IMPORT, COMMAND_SAVEDTRAIN_EXPORT, COMMAND_ENTER, COMMAND_EJECT, COMMAND_LAUNCH, COMMAND_ANIMATE, COMMAND_EFFECT, COMMAND_LOCATE, COMMAND_FLIP, COMMAND_MODEL_CONFIG_LIST, COMMAND_MODEL_CONFIG_RENAME, COMMAND_MODEL_CONFIG_COPY, COMMAND_MODEL_CONFIG_DELETE, COMMAND_MODEL_CONFIG_CLAIM, COMMAND_MODEL_CONFIG_GLOBAL, COMMAND_MODEL_CONFIG_IMPORT, COMMAND_MODEL_CONFIG_EXPORT, COMMAND_MODEL_SEARCH, SPAWNER_AUTOMATIC, SPAWNER_REGULAR, SPAWNER_POWERED, SPAWNER_STORAGE, SPAWNER_TNT, SPAWNER_HOPPER, SPAWNER_COMMAND, SPAWNER_SPAWNER, SPAWNER_INVENTORY_ITEMS, BUILD_REMOTE_CONTROL, BUILD_STATION, BUILD_SPAWNER, BUILD_TRIGGER, BUILD_DESTINATION, BUILD_SWITCHER, BUILD_DESTRUCTOR, BUILD_DETECTOR, BUILD_EJECTOR, BUILD_EJECTOR_ABSOLUTE, BUILD_PROPERTY, BUILD_COLLECTOR, BUILD_DEPOSITOR, BUILD_ELEVATOR, BUILD_TELEPORTER, BUILD_BLOCKER, BUILD_WAIT, BUILD_CRAFTER, BUILD_TICKET, BUILD_ANNOUNCER, BUILD_EFFECT, BUILD_SOUND, BUILD_BLOCKCHANGER, BUILD_JUMPER, BUILD_LAUNCHER, BUILD_ENTER, BUILD_SKIPPER, BUILD_MUTEX, BUILD_FLIPPER, BUILD_ANIMATOR, BUILD_TITLE, GENERAL_PLACE_MINECART, GENERAL_PLACE_TRAINCART, GENERAL_PROPERTIES_ADMIN, BREAK_MINECART_SELF, BREAK_MINECART_ANY, TICKET_MANAGE, DEBUG_COMMAND_DEBUG, USE_SCHEMATIC_ATTACHMENTS};
   }
}
