...
public final class XBlock {
    ...
    public static boolean setType(@NotNull Block block, @Nullable XMaterial xMaterial, boolean bl) {
        ...
        if ((xMaterial2 = ITEM_TO_BLOCK.get(xMaterial)) != null) {
            xMaterial = xMaterial2;
        }
        if ((material = xMaterial.get()) == null) {
            return false;
        }
        ...
        if (handling == LegacyMaterial.Handling.COLORABLE) {
            ...
            boolean bl3 = false;
            switch (1.$SwitchMap$com$cryptomorin$xseries$XBlock$LegacyMaterial[((Enum)object).ordinal()]) {
                case 1: 
                case 2: {
    ...
    public static boolean setType(@NotNull Block block, @Nullable XMaterial xMaterial) {
