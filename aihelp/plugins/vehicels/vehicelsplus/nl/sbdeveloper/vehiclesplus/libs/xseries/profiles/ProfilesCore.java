...
public final class ProfilesCore {
    ...
    static {
        ...
        try {
            ...
            object2 = minecraftClassHandle.method("public MinecraftSessionService getSessionService();").named("aq", "ay", "getMinecraftSessionService", "az", "ao", "am", "aD", "ar").reflect().invoke(object4);
