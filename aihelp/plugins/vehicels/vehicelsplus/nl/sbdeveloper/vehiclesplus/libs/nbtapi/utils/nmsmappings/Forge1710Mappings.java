...
public class Forge1710Mappings {
    ...
    public static String toString(Object object) {
        ...
        try {
            return (String)crucible_toString.invoke(object, new Object[0]);
        } catch (Exception exception) {
            throw new NbtApiException("Error while calling the method 'crucible_toString', from Forge1710Mappings. Passed Class: " + Forge1710Mappings.class, exception);
        }
    }
