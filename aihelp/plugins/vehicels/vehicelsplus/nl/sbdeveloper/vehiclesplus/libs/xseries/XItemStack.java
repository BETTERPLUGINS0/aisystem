...
public final class XItemStack {
    ...
    private static final Object REGISTRY_BANNER_PATTERN;
    private static final PatternType DEFAULT_PATTERN_TYPE;
    ...
    @NotNull
    private static PatternType getPatternType(@Nullable String string) {
        return XItemStack.getRegistryOrEnum(PatternType.class, REGISTRY_BANNER_PATTERN, string, DEFAULT_PATTERN_TYPE);
    }
    ...
    public static ItemStack edit(@NotNull ItemStack itemStack, @NotNull ConfigurationSection configurationSection, @NotNull Function<String, String> function, @Nullable Consumer<Exception> consumer) {
        ...
        if (!Strings.isNullOrEmpty(string)) {
            ...
            if (!object7.isSupported()) {
                object6 = new UnAcceptableMaterialCondition((XMaterial)object7, UnAcceptableMaterialCondition.Reason.UNSUPPORTED);
                if (consumer == null) {
                    throw object6;
                }
                consumer.accept((Exception)object6);
            ...
            if (XTag.INVENTORY_NOT_DISPLAYABLE.isTagged((XMaterial)object7)) {
                object6 = new UnAcceptableMaterialCondition((XMaterial)object7, UnAcceptableMaterialCondition.Reason.NOT_DISPLAYABLE);
                if (consumer == null) {
                    throw object6;
                }
                consumer.accept((Exception)object6);
            ...
            ((XMaterial)object7).setType(itemStack);
        }
        if ((n2 = configurationSection.getInt("amount")) > 1) {
            itemStack.setAmount(n2);
        }
        object7 = (object6 = itemStack.getItemMeta()) == null ? Bukkit.getItemFactory().getItemMeta(XMaterial.STONE.get()) : object6;
        if (XMaterial.supports(13)) {
            int n3;
        ...
        if (object7 instanceof SkullMeta) {
            ...
            if (object5 != null) {
                ...
                while (object422.hasNext()) {
                    ...
                    object322 = XItemStack.getPatternType(string3);
            ...
            if (object5 instanceof CreatureSpawner) {
                ...
                if (string4 != null) {
                    for (String string5 : string4.getKeys(false)) {
                        PatternType patternType = XItemStack.getPatternType(string5);
                        ...
                        object422.addPattern(new Pattern(dyeColor, patternType));
                    }
                    object422.update(true);
                    blockStateMeta.setBlockState((BlockState)object422);
                }
            ...
            if (!XMaterial.supports(13)) {
                if (XMaterial.supports(11)) {
                    String string8;
                    if (object7 instanceof SpawnEggMeta && !Strings.isNullOrEmpty(string8 = configurationSection.getString("creature"))) {
        ...
        if (XMaterial.supports(14) && (n = configurationSection.getInt("custom-model-data")) != 0) {
            object7.setCustomModelData(Integer.valueOf(n));
        }
        if (configurationSection.isSet("lore")) {
            ...
            if (!object422.isEmpty()) {
                ...
                while (object8.hasNext()) {
                    ...
                    for (String string3 : XItemStack.splitNewLine((String)object322)) {
                        if (string3.isEmpty()) {
                            arrayList.add(" ");
                            continue;
                        }
        ...
        if ((configurationSection2 = configurationSection.getConfigurationSection("enchants")) != null) {
            ...
            while (object422.hasNext()) {
                ...
                object322 = XEnchantment.matchXEnchantment(string11);
                ((Optional)object322).ifPresent(arg_0 -> XItemStack.lambda$edit$2((ItemMeta)object7, configurationSection2, string11, arg_0));
            }
        } else if (configurationSection.getBoolean("glow")) {
            object7.addEnchant(XEnchantment.UNBREAKING.getEnchant(), 1, false);
            XItemFlag.HIDE_ENCHANTS.set((ItemMeta)object7);
        }
        ...
        if (!(list = configurationSection.getStringList("flags")).isEmpty()) {
            ...
            while (object322.hasNext()) {
                ...
                if ((string12 = string12.toUpperCase(Locale.ENGLISH)).equals("ALL")) {
                    XItemFlag.hideEverything((ItemMeta)object7);
                    break;
                }
                XItemFlag.of(string12).ifPresent(arg_0 -> XItemStack.lambda$edit$4((ItemMeta)object7, arg_0));
            }
        } else {
        ...
        if (XMaterial.supports(13) && (object322 = configurationSection.getConfigurationSection("attributes")) != null) {
            for (String string4 : object322.getKeys(false)) {
                ...
                if (!optional.isPresent() || (object = object322.getConfigurationSection(string4)) == null) continue;
                EquipmentSlot equipmentSlot = object.getString("slot") != null ? Enums.getIfPresent(EquipmentSlot.class, object.getString("slot")).or(EquipmentSlot.HAND) : null;
                string2 = object.getString("name");
                if (string2 == null) {
                    string2 = UUID.randomUUID().toString().toLowerCase(Locale.ENGLISH);
                }
                optional.get();
                AttributeModifier attributeModifier = XAttribute.createModifier(string2, object.getDouble("amount"), Enums.getIfPresent(AttributeModifier.Operation.class, object.getString("operation")).or(AttributeModifier.Operation.ADD_NUMBER), equipmentSlot);
                object7.addAttributeModifier((Attribute)optional.get().get(), attributeModifier);
            }
        }
    ...
    public static int firstPartial(@NotNull Inventory inventory, @Nullable ItemStack itemStack, int n) {
        return XItemStack.firstPartial(inventory, itemStack, n, null);
    }

    public static int firstPartial(@NotNull Inventory inventory, @Nullable ItemStack itemStack, int n, @Nullable Predicate<Integer> predicate) {
        if (itemStack != null) {
    ...
    public static int firstEmpty(@NotNull Inventory inventory, int n) {
        return XItemStack.firstEmpty(inventory, n, null);
    }

    public static int firstEmpty(@NotNull Inventory inventory, int n, @Nullable Predicate<Integer> predicate) {
        ItemStack[] itemStackArray = XItemStack.getStorageContents(inventory);
        int n2 = itemStackArray.length;
        if (n < 0 || n >= n2) {
            throw new IndexOutOfBoundsException("Begin Index: " + n + ", Inventory storage content size: " + n2);
    ...
    public static int firstPartialOrEmpty(@NotNull Inventory inventory, @Nullable ItemStack itemStack, int n) {
        if (itemStack != null) {
            ItemStack[] itemStackArray = XItemStack.getStorageContents(inventory);
            int n2 = itemStackArray.length;
            if (n < 0 || n >= n2) {
    ...
    static {
        ...
        REGISTRY_BANNER_PATTERN = XItemStack.supportsRegistry("BANNER_PATTERN");
        DEFAULT_PATTERN_TYPE = XItemStack.getPatternType("BASE");
        boolean bl = false;
        boolean bl2 = false;
        try {
