...
public final class XTag<T extends Enum<T>> {
    ...
    @SafeVarargs
    private XTag(@NotNull Class<T> clazz, @NotNull XTag<T> ... xTagArray) {
    ...
    @SafeVarargs
    private final XTag<T> inheritFrom(@NotNull XTag<T> ... xTagArray) {
    ...
    static {
        ...
        super.inheritFrom(COAL_ORES, IRON_ORES, COPPER_ORES, REDSTONE_ORES, LAPIS_ORES, GOLD_ORES, DIAMOND_ORES, EMERALD_ORES);
