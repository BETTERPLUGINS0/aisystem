 ...
 */
package nl.sbdeveloper.vehiclesplus.libs.xseries.profiles.objects.transformer;
    ...
    private static final class TransformationSequence {
        ...
        private final class TransformedProfileCache {
            ...
            private void transform() {
                ...
                this.cacheProfile = this.transformer.transform(TransformationSequence.this.profileable, TransformationSequence.this.markRestAsCopy ? TransformationSequence.this.profile : PlayerProfiles.clone(TransformationSequence.this.profile));
                TransformationSequence.this.profile = this.cacheProfile;
