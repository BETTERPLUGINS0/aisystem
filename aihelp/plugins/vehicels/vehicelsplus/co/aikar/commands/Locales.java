...
public class Locales {
    ...
    public boolean addMessageBundle(ClassLoader classLoader, String string, Locale locale) {
        SetMultimap setMultimap = this.loadedBundles.getOrDefault(classLoader, HashMultimap.create());
        if (!setMultimap.containsEntry(string, locale) && this.localeManager.addMessageBundle(classLoader, string, locale)) {
            setMultimap.put(string, locale);
