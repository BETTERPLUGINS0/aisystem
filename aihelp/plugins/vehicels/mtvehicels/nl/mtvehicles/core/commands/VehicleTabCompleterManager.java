...
public class VehicleTabCompleterManager
        ...
        if (strings.length > 1) {
            ...
            if (subCommand.equals("edit")) {
                if (strings.length == 2) {
                    ...
                    ArrayList<String> suggestions = new ArrayList<String>(playerNames);
                    suggestions.addAll(VehicleEdit.getEditCommands());
                    return this.getApplicableTabCompleters(strings[1], suggestions);
                }
                if (strings.length == 3 && Bukkit.getPlayer((String)strings[1]) != null) {
                ...
                if (strings.length == 3) {
                    if (Bukkit.getPlayer((String)strings[1]) != null) {
