...
@Name(value="Condition - Is vehicle friction blocked")
@Description(value={"Check if the vehicle friction of an MTV Vehicle is blocked"})
@Examples(value={"if mtv vehicle friction of vehicle {_car} is blocked:", "if vehicle friction of license plate \"MT-12-34\" is not blocked:"})
@Since(value={"2.5.6"})
public class CondIsFrictionBlocked
extends Condition {
