...
@Name(value="Condition - Is vehicle braking blocked")
@Description(value={"Check if the vehicle braking of an MTV Vehicle is blocked"})
@Examples(value={"if mtv vehicle breaking of vehicle {_car} is blocked:", "if vehicle breaking of license plate \"MT-12-34\" is not blocked:"})
@Since(value={"2.5.6"})
public class CondIsBrakingBlocked
extends Condition {
