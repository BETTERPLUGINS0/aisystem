...
public class Vehicle {
    ...
    public String toString() {
        ...
        return this.getName() + " with license plate " + this.getLicensePlate();
    }
    ...
    public int getSeatsAmount() {
        List seats = (List)this.getVehicleData().get("seats");
        return seats.size();
    }
    ...
    public Double getCurrentSpeed() {
        if (VehicleData.speed.get(this.getLicensePlate()) == null) {
            return null;
        }
        return VehicleData.speed.get(this.licensePlate) * 20.0;
    }

    @Nullable
    public Double getCurrentFuel() {
        if (!((Boolean)ConfigModule.defaultConfig.get(DefaultConfig.Option.FUEL_ENABLED)).booleanValue()) {
            return null;
        }
        if (!((Boolean)ConfigModule.vehicleDataConfig.get(this.getLicensePlate(), VehicleDataConfig.Option.FUEL_ENABLED)).booleanValue()) {
            return null;
        }
        return VehicleData.fuel.get(this.licensePlate);
    }
    ...
    public String getOwnerName() {
        return Bukkit.getOfflinePlayer((UUID)this.getOwnerUUID()).getName();
    }
    ...
    public void saveSeats() {
        ...
        for (int i = 1; i <= seats.size(); ++i) {
            ...
            if (i == 1) {
                VehicleData.mainx.put("MTVEHICLES_MAINSEAT_" + this.licensePlate, seat.get("x"));
                VehicleData.mainy.put("MTVEHICLES_MAINSEAT_" + this.licensePlate, seat.get("y"));
                VehicleData.mainz.put("MTVEHICLES_MAINSEAT_" + this.licensePlate, seat.get("z"));
                continue;
            }
            if (i <= 1) continue;
            VehicleData.seatx.put("MTVEHICLES_SEAT" + i + "_" + this.licensePlate, seat.get("x"));
            VehicleData.seaty.put("MTVEHICLES_SEAT" + i + "_" + this.licensePlate, seat.get("y"));
            VehicleData.seatz.put("MTVEHICLES_SEAT" + i + "_" + this.licensePlate, seat.get("z"));
        }
    }
    ...
    public static enum Seat {
        ...
        public boolean isPassenger() {
            return this.equals((Object)PASSENGER);
        }
    }
}
