...
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.CompiledClass;
import nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Reflection;
    ...
    private static void processClasses(CompiledClass[] entries, int n) throws Exception {
        ...
        for (i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null || entries[i].classobject != null) {
                String metaobj = entries[i].metaobject == null ? "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.Metaobject" : entries[i].metaobject;
                String classobj = entries[i].classobject == null ? "nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.reflect.ClassMetaobject" : entries[i].classobject;
