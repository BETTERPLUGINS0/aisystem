...
public class ItemFactory {
    ...
    public ItemFactory setLore(List<String> lore) {
        ...
        for (String str : lore) {
            formatted.add(ChatColor.translateAlternateColorCodes((char)'&', (String)str));
        }
    ...
    public ItemFactory setLore(String ... lore) {
        ...
        for (int b = 0; b < i; b = (int)((byte)(b + 1))) {
            ...
            loreList.add(ChatColor.translateAlternateColorCodes((char)'&', (String)loreLine));
        }
        ItemMeta im = this.item.getItemMeta();
        assert (im != null);
        im.setLore(loreList);
    ...
    public ItemFactory addLoreLine(String line, int pos) {
        ...
        lore.set(pos, ChatColor.translateAlternateColorCodes((char)'&', (String)line));
        im.setLore(lore);
        this.item.setItemMeta(im);
        return this;
    }
