...
implements Translator {
    ...
    private CtClass produceProxyClass(CtClass orgclass, Class<?> orgRtClass) throws CannotCompileException, NotFoundException {
        ...
        CtField f = new CtField(this.classPool.get("nl.mtvehicles.core.infrastructure.libs.worldguardwrapper.shaded.javassist.tools.rmi.ObjectImporter"), fieldImporter, proxy);
        f.setModifiers(2);
