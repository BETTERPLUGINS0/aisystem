...
@Name(value="Delete an MTV vehicle")
@Description(value={"Delete an MTV from the database (VehicleData.yml)"})
@Examples(value={"delete mtv vehicle {_car}"})
public class EffDeleteVehicle
extends Effect {
    ...
    static {
        Skript.registerEffect(EffDeleteVehicle.class, (String[])new String[]{"(delete|clear) [mtv] vehicle %mtvehicle%"});
    }
}
