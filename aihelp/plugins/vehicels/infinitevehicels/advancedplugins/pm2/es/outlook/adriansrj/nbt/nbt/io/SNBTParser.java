...
import es.outlook.adriansrj.nbt.nbt.tag.ArrayTag;
...
public final class SNBTParser implements MaxDepthIO {
   ...
   public SNBTParser(String var1) {
      this.ptr = new StringPointer(var1);
   }

   public Tag<?> parse(int var1, boolean var2) {
      Tag var3 = this.parseAnything(var1);
      if (!var2) {
   ...
   public Tag<?> parse(int var1) {
      return this.parse(var1, false);
   }

   public Tag<?> parse() {
      return this.parse(512, false);
   }
   ...
   private Tag<?> parseAnything(int var1) {
      this.ptr.skipWhitespace();
   ...
   private Tag<?> parseStringOrLiteral() {
      ...
      if (this.ptr.currentChar() == '"') {
         ...
         if (var1.isEmpty()) {
         ...
         } else if (BYTE_LITERAL_PATTERN.matcher(var1).matches()) {
            try {
               return new ByteTag(Byte.parseByte(var1.substring(0, var1.length() - 1)));
            } catch (NumberFormatException var3) {
               throw this.ptr.parseException("byte not in range: \"" + var1.substring(0, var1.length() - 1) + "\"");
            }
            ...
            try {
               ...
               throw this.ptr.parseException("short not in range: \"" + var1.substring(0, var1.length() - 1) + "\"");
            }
         } else if (LONG_LITERAL_PATTERN.matcher(var1).matches()) {
            try {
               return new LongTag(Long.parseLong(var1.substring(0, var1.length() - 1)));
            } catch (NumberFormatException var5) {
               throw this.ptr.parseException("long not in range: \"" + var1.substring(0, var1.length() - 1) + "\"");
            }
         } else if (INT_LITERAL_PATTERN.matcher(var1).matches()) {
            try {
               return new IntTag(Integer.parseInt(var1));
            } catch (NumberFormatException var6) {
               throw this.ptr.parseException("int not in range: \"" + var1.substring(0, var1.length() - 1) + "\"");
            }
   ...
   private CompoundTag parseCompoundTag(int var1) {
      this.ptr.expectChar('{');
   ...
   private ListTag<?> parseListTag(int var1) {
      this.ptr.expectChar('[');
      this.ptr.skipWhitespace();
