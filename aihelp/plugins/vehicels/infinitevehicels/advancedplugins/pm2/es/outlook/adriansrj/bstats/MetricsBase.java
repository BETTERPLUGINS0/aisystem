package es.outlook.adriansrj.bstats;

import es.outlook.adriansrj.bstats.charts.CustomChart;
...
public class MetricsBase {
   ...
   public MetricsBase(String var1, String var2, int var3, boolean var4, Consumer<JsonObjectBuilder> var5, Consumer<JsonObjectBuilder> var6, Consumer<Runnable> var7, Supplier<Boolean> var8, BiConsumer<String, Throwable> var9, Consumer<String> var10, boolean var11, boolean var12, boolean var13) {
      ScheduledThreadPoolExecutor var14 = new ScheduledThreadPoolExecutor(1, (var0) -> {
         return new Thread(var0, "bStats-Metrics");
      });
      var14.setExecuteExistingDelayedTasksAfterShutdownPolicy(false);
      this.scheduler = var14;
      this.platform = var1;
   ...
   private void submitData() {
      ...
      var1.appendField("metricsVersion", "3.0.2");
