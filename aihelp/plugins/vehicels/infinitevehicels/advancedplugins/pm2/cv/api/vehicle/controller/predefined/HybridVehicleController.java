...
public class HybridVehicleController extends VehicleController {
   ...
   public HybridVehicleController(@NotNull Vehicle var1, @Nullable VehicleControllerProperties var2) {
      super(var1, var2);
   }

   public void loadProperties() {
      this.maxPositiveAcceleration = this.properties.getDoubleProperty("max-positive-acceleration", 0.4D);
   ...
   public void tick() {
      ...
      this.tickTurning();
      if (this.currentSpeed != 0.0D && this.worksOn(var1 != null ? var1 : this.vehicle.getCurrentSurface(SURFACE_SCAN_IGNORE))) {
   ...
   protected boolean worksOn(@NotNull Map<EnumSurface, Double> var1) {
      return var1.containsKey(EnumSurface.SOLID) || var1.containsKey(EnumSurface.DUSTY) || var1.containsKey(EnumSurface.SNOWY) || var1.containsKey(EnumSurface.SLIPPERY) || var1.containsKey(EnumSurface.WATER) || var1.containsKey(EnumSurface.LAVA);
   }
