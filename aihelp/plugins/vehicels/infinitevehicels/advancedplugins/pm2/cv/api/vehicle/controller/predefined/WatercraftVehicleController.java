...
public class WatercraftVehicleController extends VehicleController {
   ...
   public WatercraftVehicleController(@NotNull Vehicle var1, @Nullable VehicleControllerProperties var2) {
      super(var1, var2);
   }

   public void loadProperties() {
      this.maxPositiveAcceleration = this.properties.getDoubleProperty("max-positive-acceleration", 0.17D);
      this.maxNegativeAcceleration = this.properties.getDoubleProperty("max-negative-acceleration", 0.1D);
      this.positiveAccelerationOnWater = this.properties.getDoubleProperty("positive-acceleration-on-water", 0.025D);
      this.positiveAccelerationOnLava = this.properties.getDoubleProperty("positive-acceleration-on-lava", 0.025D);
      this.negativeAccelerationOnWater = this.properties.getDoubleProperty("negative-acceleration-on-water", 0.025D);
      this.negativeAccelerationOnLava = this.properties.getDoubleProperty("negative-acceleration-on-lava", 0.025D);
   ...
   public void tick() {
      ...
      if ((this.forward || this.backward) && this.hasFuel()) {
         ...
         if (var2 != 0.0D && this.vehicle.containsAnyWithin(EnumSurface.LAVA, EnumSurface.SOLID)) {
            var2 = 0.0D;
         }
      ...
      this.tickTurning();
      if (this.currentSpeed != 0.0D && this.isOnLiquid(var1 != null ? var1 : this.vehicle.getCurrentSurface(SURFACE_SCAN_IGNORE))) {
   ...
   protected boolean isOnLiquid(@NotNull Map<EnumSurface, Double> var1) {
      return var1.containsKey(EnumSurface.WATER) || var1.containsKey(EnumSurface.LAVA);
   }
