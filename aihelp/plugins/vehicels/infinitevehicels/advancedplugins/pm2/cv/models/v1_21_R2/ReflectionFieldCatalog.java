...
public enum ReflectionFieldCatalog implements ReflectionUtils.ReflectionEnum {
   ...
   ENTITY_SIZE_DATA(Entity.class, "bb", "dimensions"),
   ENTITY_VIEW_HEIGHT(Entity.class, "bc", "eyeHeight"),
   BUKKIT_WRAPPER(Entity.class, "bukkitEntity", "bukkitEntity"),
   JUMP_COOLDOWN(EntityLiving.class, "cf", "noJumpDelay"),
   JUMP_STATUS(EntityLiving.class, "bn", "jumping"),
   VISUAL_CONTROLLER(EntityInsentient.class, "bP", "lookControl"),
   MOVEMENT_CONTROLLER(EntityInsentient.class, "bQ", "moveControl"),
   PATHFINDING_SYSTEM(EntityInsentient.class, "bS", "navigation"),
   BEHAVIOR_MANAGER(EntityInsentient.class, "bT", "goalSelector"),
   ROTATION_CONTROLLER(EntityInsentient.class, "cb", "bodyRotationControl"),
   ...
   public static ReflectionFieldCatalog findByMappedName(String mappedName) {
   ...
   public static List<ReflectionFieldCatalog> getFieldsForClass(Class<?> clazz) {
   ...
   @Generated
   private ReflectionFieldCatalog(final Class<?> target, final String obfuscated, final String mapped) {
      this.target = var3;
