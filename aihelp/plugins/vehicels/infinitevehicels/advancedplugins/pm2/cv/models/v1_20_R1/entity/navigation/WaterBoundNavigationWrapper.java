package advancedplugins.pm2.cv.models.v1_20_R1.entity.navigation;
...
public class WaterBoundNavigationWrapper extends NavigationGuardian {
   ...
   private double getNodeDistanceSquared(Vec3D pos) {
      double var2 = var1.c - this.a.dn();
      double var4 = var1.d - this.a.dp();
      double var6 = var1.e - this.a.dt();
   ...
   protected void k() {
      ...
      double var3 = Math.abs(this.a.dn() - var2.c);
      double var5 = Math.abs(this.a.dp() - var2.d);
      double var7 = Math.abs(this.a.dt() - var2.e);
