package advancedplugins.pm2.cv.models.v1_20_R6.entity.hitbox;
...
public class HitboxEntityImpl extends EntityLiving implements HitboxEntity {
   ...
   public CraftEntity getBukkitEntity() {
      ...
      if (var1 == null) {
         synchronized(this) {
            CraftLivingEntity var3 = new CraftLivingEntity(this.dP().getCraftServer(), this);
   ...
   protected int o(int air) {
      return var1;
   }

   public void a(RemovalReason reason) {
      super.a(var1);
      ModelAPI.setRenderCanceled(this.al(), false);
   ...
   public Location getLocation() {
      return CraftLocation.toBukkit(this.dn(), this.dP().getWorld(), this.getBukkitYaw(), this.dH());
   }
