...
import advancedplugins.pm2.cv.models.v1_21_R7.network.utils.TripleConsumer;
...
public class LocomotionManager extends ControllerMove implements MoveController {
   ...
   public LocomotionManager(EntityInsentient var1, ControllerMove var2) {
      super(var1);
   ...
   public void a() {
      this.groundContact = this.d.aS();
      IModelContainer var1 = ModelAPI.getModeledEntity(this.d.cT());
      if (var1 == null) {
   ...
   public void globalMove(float var1, float var2, float var3, float var4) {
      ...
      this.d.I((float)var6.g);
      this.d.H((float)var6.h);
      this.d.G((float)var6.i);
   }

   private Vec3D rotateByEntityYaw(Vec3D var1) {
      return var1.b(-this.d.dX() * 0.017453292F);
   }

   private void applyEntityVelocity(Vector var1) {
      Vec3D var2 = this.rotateByEntityYaw(new Vec3D(var1.getX(), var1.getY(), var1.getZ()));
      this.d.I((float)var2.g);
      this.d.H((float)var2.h);
      this.d.G((float)var2.i);
   }

   private Vector extractEntityVelocity() {
      float var1 = Float.isNaN(this.d.bM) ? 0.0F : this.d.bM;
      float var2 = Float.isNaN(this.d.bN) ? 0.0F : this.d.bN;
      float var3 = Float.isNaN(this.d.bO) ? 0.0F : this.d.bO;
      return (new Vector(var1, var2, var3)).rotateAroundY((double)(this.d.dX() * 0.017453292F));
   }
   ...
   private void processRootMotion(RootMotionDelta var1) {
      ...
      if (!var2.isZero() || !var1.onGround()) {
         ...
         if (!MathUtils.isSimilar((float)var2.getY(), 0.0F) || !var1.onGround()) {
            this.d.k(this.d.dI().d(1.0D, 0.0D, 1.0D));
         }
   ...
   public void setVelocity(double var1, double var3, double var5) {
      this.d.m(var1, var3, var5);
   }

   public void addVelocity(double var1, double var3, double var5) {
      this.d.k(this.d.dI().b(var1, var3, var5));
   }
   ...
   public float getSpeed() {
      return (float)this.d.i(GenericAttributes.w);
   }

   public Vector getVelocity() {
      return CraftVector.toBukkit(this.d.dI());
   }
