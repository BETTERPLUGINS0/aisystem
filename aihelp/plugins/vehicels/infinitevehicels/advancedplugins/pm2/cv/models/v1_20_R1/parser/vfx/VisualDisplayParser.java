package advancedplugins.pm2.cv.models.v1_20_R1.parser.vfx;
...
public class VisualDisplayParser implements VisualRendererParser<VisualDisplayRenderer> {
   ...
   private PacketPlayOutSpawnEntity vfxSpawn(VisualDisplayRenderer.RendererVisualModel vfx) {
      ...
      return new PacketPlayOutSpawnEntity(var1.getModelId(), var1.getModelUuid(), (double)var2.x, (double)var2.y, (double)var2.z, 0.0F, 0.0F, EntityTypes.ae, 0, Vec3D.b, 0.0D);
   }
   ...
   private PacketPlayOutMount mount(VisualDisplayRenderer.RendererVisualModel vfx) {
      ...
      var2.d(var1.getPivotId());
      var2.d(1);
      var2.d(var1.getModelId());
