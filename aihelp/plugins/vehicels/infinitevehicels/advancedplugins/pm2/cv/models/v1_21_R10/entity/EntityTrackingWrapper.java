...
public class EntityTrackingWrapper implements TrackedEntity {
   ...
   private final Supplier<net.minecraft.server.level.ChunkMap.TrackedEntity> trackingDataProvider;
   ...
   @NotNull
   private net.minecraft.server.level.ChunkMap.TrackedEntity cachedTracker;

   public EntityTrackingWrapper(Entity var1, Supplier<net.minecraft.server.level.ChunkMap.TrackedEntity> var2, @NotNull net.minecraft.server.level.ChunkMap.TrackedEntity var3) {
   ...
   private Set<UUID> collectVisiblePlayers(Predicate<Player> var1) {
      ...
      Iterator var3 = this.getCurrentTracker().seenBy.iterator();
   ...
   public void sendPairingData(Player var1) {
      if (var1 != null) {
         ...
         this.getCurrentTracker().serverEntity.sendPairingData(var2, (var1x) -> {
   ...
   public void broadcastRemove() {
      this.getCurrentTracker().broadcastRemoved();
   }
   ...
   @NotNull
   private net.minecraft.server.level.ChunkMap.TrackedEntity getCurrentTracker() {
      net.minecraft.server.level.ChunkMap.TrackedEntity var1 = (net.minecraft.server.level.ChunkMap.TrackedEntity)this.trackingDataProvider.get();
   ...
   private void synchronizeTrackerData(net.minecraft.server.level.ChunkMap.TrackedEntity var1) {
   ...
   @Generated
   public Supplier<net.minecraft.server.level.ChunkMap.TrackedEntity> getTrackingDataProvider() {
   ...
   @NotNull
   @Generated
   public net.minecraft.server.level.ChunkMap.TrackedEntity getCachedTracker() {
      return this.cachedTracker;
   }
   ...
   @Generated
   public void setCachedTracker(@NotNull net.minecraft.server.level.ChunkMap.TrackedEntity var1) {
      this.cachedTracker = var1;
   }
}
