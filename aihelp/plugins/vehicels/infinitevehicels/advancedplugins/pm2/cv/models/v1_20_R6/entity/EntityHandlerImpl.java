package advancedplugins.pm2.cv.models.v1_20_R6.entity;
...
import advancedplugins.pm2.cv.models.v1_20_R6.NMSFields;
import advancedplugins.pm2.cv.models.v1_20_R6.NMSMethods;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.controller.BodyRotationControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.controller.LookControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.controller.MoveControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.hitbox.HitboxEntityImpl;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.navigation.AmphibiousNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.navigation.FlyingNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.navigation.GroundNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.navigation.WallClimberNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.entity.navigation.WaterBoundNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R6.network.patch.PatchedServerGamePacketListener;
import advancedplugins.pm2.cv.models.v1_20_R6.network.utils.NetworkUtils;
import advancedplugins.pm2.cv.models.v1_20_R6.network.utils.Packets;
...
public class EntityHandlerImpl implements EntityHandler {
   ...
   public void setHitbox(Entity entity, @NotNull Hitbox hitbox) {
      ...
      EntitySize var6 = EntitySize.c(var3, var4);
   ...
   public double getStepHeight(Entity entity) {
      return (double)EntityUtils.nms(var1).dJ();
   }
   ...
   public void movePassenger(Entity entity, double x, double y, double z) {
      ...
      if (this.dummyArmorStand == null) {
         this.dummyArmorStand = new EntityArmorStand(EntityTypes.d, var8.dP());
   ...
   public void setForcedInvisible(Player player, boolean flag) {
      if (this.isForcedInvisible(var1) != var2) {
         ...
         for(int var5 = 0; var5 < 8; ++var5) {
            var4 = MathUtils.setBit(var4, var5, var3.j(var5));
         }
   ...
   public MoveController wrapMoveController(Entity entity, Supplier<MoveController> def) {
      ...
      if (var3 instanceof EntityInsentient) {
         EntityInsentient var4 = (EntityInsentient)var3;
         MoveControlWrapper var5 = new MoveControlWrapper(var4, var4.H());
   ...
   public LookController wrapLookController(Entity entity, Supplier<LookController> def) {
      ...
      if (var3 instanceof EntityInsentient) {
         EntityInsentient var4 = (EntityInsentient)var3;
         LookControlWrapper var5 = new LookControlWrapper(var4, var4.G());
   ...
   public void wrapNavigation(Entity entity) {
      ...
      if (var2 instanceof EntityInsentient) {
         ...
         try {
            ...
            NavigationAbstract var5 = var3.K();
            Object var6;
            if (var5 instanceof NavigationSpider) {
               ...
               if (!(var5 instanceof AmphibiousPathNavigation)) {
                  String var13 = String.valueOf(var3.ak());
   ...
   public HitboxEntity createHitbox(Location location, IJoint joint, SubHitbox subHitbox) {
      ...
      ModelAPI.setRenderCanceled(var5.al(), true);
   ...
   public void forceUseItem(Player player, EquipmentSlot hand) {
      ...
      PatchedServerGamePacketListener.handleUseItem(var7, var6, (var4x) -> {
         if (var4.v() != EnumAnimation.a && var4x == EnumInteractionResult.c) {
            ...
            if (var6 instanceof InstrumentItem) {
               ...
               var8.ifPresent((var2x) -> {
                  ...
                  RandomSource var6 = (RandomSource)ReflectionUtils.get(var5.dP(), NMSFields.LEVEL_threadSafeRandom);
   ...
   public float getYRot(Entity entity) {
      return EntityUtils.nms(var1).dF();
   }
   ...
   public boolean isWalking(Entity entity) {
      ...
      if (var2.ai < 1) {
         ...
         double var3 = var2.du() - var2.ad;
         double var5 = var2.dA() - var2.af;
   ...
   public boolean isRemoved(Entity entity) {
      return EntityUtils.nms(var1).dK();
   }
