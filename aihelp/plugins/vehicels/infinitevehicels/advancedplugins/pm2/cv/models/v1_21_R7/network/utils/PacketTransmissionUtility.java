...
import advancedplugins.pm2.cv.models.v1_21_R7.network.ChannelManagerImpl;
...
public class PacketTransmissionUtility {
   ...
   public static RegistryFriendlyByteBuf allocateBuffer() {
      return new RegistryFriendlyByteBuf(Unpooled.buffer(), MinecraftServer.getServer().bg());
   }
   ...
   public static <T extends Packet<PacketListenerPlayOut>> T instantiatePacket(Class<T> var0, RegistryFriendlyByteBuf var1) {
   ...
   public static PacketDataSerializer decodeIncomingPacket(Packet<? super PacketListenerPlayIn> var0, EntityPlayer var1) {
      RegistryFriendlyByteBuf var2 = allocateBuffer();
      GameProtocols.b.a(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().bg()), var1.g).c().encode(var2, var0);
      var2.l();
      return var2;
   }

   public static PacketDataSerializer decodeOutgoingPacket(Packet<? super PacketListenerPlayOut> var0) {
      RegistryFriendlyByteBuf var1 = allocateBuffer();
   ...
   public static PacketBundleProvider.PacketFactory generateAnchorSpawn(int var0, UUID var1, Vector3f var2) {
      return (var3) -> {
         ...
         return new PacketPlayOutSpawnEntity(var0, var1, (double)var2.x, (double)var2.y - var4, (double)var2.z, 0.0F, 0.0F, EntityTypes.f, 0, Vec3D.c, 0.0D);
      };
   }
   ...
   private static EntityRelationship createPositionedRelation(int var0, double var1, double var3, double var5) {
      ...
      var7.n(var1, var3, var5);
      return var7;
   }

   private static ClientboundEntityPositionSyncPacket createPositionSync(EntityRelationship var0) {
      return new ClientboundEntityPositionSyncPacket(var0.az(), PositionMoveRotation.a(var0), var0.aS());
   }

   public static PacketBundleProvider.PacketFactory wrapWithLevelOfDetail(IModelContainer var0, BiFunction<UUID, AnimationLODHandler.LODTracker, Packet<PacketListenerPlayOut>> var1) {
      return (var2) -> {
   ...
   public static void transmitToPlayer(UUID var0, @Nullable Packet<? super PacketListenerPlayOut> var1) {
      if (var1 != null) {
   ...
   public static void broadcastToPlayers(Set<UUID> var0, @Nullable Packet<? super PacketListenerPlayOut> var1) {
      if (var1 != null) {
         ChannelManagerImpl var2 = ChannelManagerImpl.instance;
         if (var2.isBatching()) {
            var0.forEach((var2x) -> {
   ...
   public static void broadcastConditionally(Set<UUID> var0, @Nullable Packet<? super PacketListenerPlayOut> var1, Predicate<Player> var2) {
      if (var1 != null) {
   ...
   private static void dispatchProtectedPacket(UUID var0, Packet<? super PacketListenerPlayOut> var1) {
   ...
   public static void transmitDirectly(UUID var0, @Nullable Packet<? super PacketListenerPlayOut> var1) {
      if (var1 != null) {
         ModelAPI.getNetworkHandler().getPipeline(var0).ifPresent((var1x) -> {
            var1x.writeAndFlush(var1);
         });
   ...
   public static void transmitDirectlyToAll(Set<UUID> var0, @Nullable Packet<? super PacketListenerPlayOut> var1) {
      if (var1 != null) {
         var0.forEach((var1x) -> {
   ...
   public static void transmitDirectlyConditional(Set<UUID> var0, @Nullable Packet<? super PacketListenerPlayOut> var1, Predicate<Player> var2) {
      if (var1 != null) {
   ...
   private static void sendCompiledBundle(UUID var0, Collection<Packet<? super PacketListenerPlayOut>> var1) {
   ...
   static {
      CLIENT_PROTOCOL_INFO = GameProtocols.c.a(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().bg()));
