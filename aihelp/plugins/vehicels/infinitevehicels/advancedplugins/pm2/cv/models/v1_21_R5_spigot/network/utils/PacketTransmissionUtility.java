package advancedplugins.pm2.cv.models.v1_21_R5_spigot.network.utils;
...
import advancedplugins.pm2.cv.models.v1_21_R5_spigot.network.ChannelManagerImpl;
...
public class PacketTransmissionUtility {
   ...
   public static PacketDataSerializer decodeIncomingPacket(Packet<? super PacketListenerPlayIn> var0, EntityPlayer var1) {
      ...
      GameProtocols.b.a(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().ba()), var1.g).c().encode(var2, var0);
      var2.l();
      return var2;
   }
   ...
   public static PacketBundleProvider.PacketFactory generateAnchorSpawn(int var0, UUID var1, Vector3f var2) {
      return (var3) -> {
         ...
         return new PacketPlayOutSpawnEntity(var0, var1, (double)var2.x, (double)var2.y - var4, (double)var2.z, 0.0F, 0.0F, EntityTypes.e, 0, Vec3D.c, 0.0D);
      };
   }
   ...
   private static ClientboundEntityPositionSyncPacket createPositionSync(EntityRelationship var0) {
      return new ClientboundEntityPositionSyncPacket(var0.ar(), PositionMoveRotation.a(var0), var0.aK());
   }
   ...
   static {
      CLIENT_PROTOCOL_INFO = GameProtocols.c.a(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().ba()));
