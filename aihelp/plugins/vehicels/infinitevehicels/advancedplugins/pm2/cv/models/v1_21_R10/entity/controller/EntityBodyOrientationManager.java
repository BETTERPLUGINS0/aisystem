...
public class EntityBodyOrientationManager extends BodyRotationControl implements BodyRotationController {
   private final Mob targetEntity;
   ...
   public EntityBodyOrientationManager(Mob var1) {
      super(var1);
      this.targetEntity = var1;
      this.headRotationUpperBound = (float)var1.getMaxHeadYRot();
      this.bodyRotationUpperBound = (float)var1.getMaxHeadYRot();
   ...
   public void clientTick() {
      if (!this.getTargetEntity().isDeadOrDying()) {
   ...
   private void synchronizeBodyToMovement() {
      this.targetEntity.yBodyRot = this.targetEntity.getYRot();
      this.adjustHeadOrientation();
      this.previousStableHeadOrientation = this.targetEntity.yHeadRot;
      this.timeSinceStable = 0;
   }

   private void handleStaticOrientation() {
      float var1 = Math.abs(this.targetEntity.yHeadRot - this.previousStableHeadOrientation);
   ...
   public float getYHeadRot() {
      return this.targetEntity.yHeadRot;
   }

   public void setYHeadRot(float var1) {
      this.targetEntity.yHeadRot = var1;
   }

   public float getXHeadRot() {
      return this.targetEntity.getXRot();
   }

   public void setXHeadRot(float var1) {
      this.targetEntity.setXRot(var1);
   }

   public float getYBodyRot() {
      return this.targetEntity.yBodyRot;
   }

   public void setYBodyRot(float var1) {
      this.targetEntity.yBodyRot = var1;
   }
   ...
   public float rotateTowards(float var1, float var2, float var3) {
   ...
   private void adjustBodyOrientation() {
      ...
      this.targetEntity.yBodyRot = MathUtils.rotateIfNecessary(this.targetEntity.yBodyRot, this.targetEntity.yHeadRot, var1, this.bodyRotationUpperBound);
   }
   ...
   private void adjustHeadOrientation() {
      ...
      this.targetEntity.yHeadRot = MathUtils.rotateIfNecessary(this.targetEntity.yHeadRot, this.targetEntity.yBodyRot, var1, this.headRotationUpperBound);
   }
   ...
   private void smoothHeadAlignment() {
      ...
      this.targetEntity.yBodyRot = MathUtils.rotateIfNecessary(this.targetEntity.yBodyRot, this.targetEntity.yHeadRot, var3, var2);
   }
   ...
   private boolean isNotCarryingPassenger() {
      return !(this.targetEntity.getFirstPassenger() instanceof Mob);
   }

   private boolean detectMovement() {
      double var1 = this.targetEntity.getX() - this.targetEntity.xo;
      double var3 = this.targetEntity.getZ() - this.targetEntity.zo;
