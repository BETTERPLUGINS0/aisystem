...
public abstract class EnhancedPathfinder {
   ...
   private double calculateDistanceToNode(Vec3D nodePosition) {
      double var2 = var1.d - this.controlledEntity.dB();
      double var4 = var1.e - this.controlledEntity.dD();
      double var6 = var1.f - this.controlledEntity.dH();
   ...
   private float calculateProximityThreshold() {
      float var1 = this.controlledEntity.dr();
   ...
   private boolean isWithinNodeProximity(Vec3D entityPos, Vec3D nodePos, float threshold) {
      double var4 = Math.abs(this.controlledEntity.dB() - var2.d);
      double var6 = Math.abs(this.controlledEntity.dD() - var2.e);
      double var8 = Math.abs(this.controlledEntity.dH() - var2.f);
