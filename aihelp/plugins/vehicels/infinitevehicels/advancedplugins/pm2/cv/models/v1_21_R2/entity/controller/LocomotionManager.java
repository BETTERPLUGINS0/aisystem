package advancedplugins.pm2.cv.models.v1_21_R2.entity.controller;
...
import advancedplugins.pm2.cv.models.v1_21_R2.network.utils.TripleConsumer;
...
public class LocomotionManager extends ControllerMove implements MoveController {
   ...
   private Vec3D rotateByEntityYaw(Vec3D vector) {
      return var1.b(-this.d.dM() * 0.017453292F);
   }
   ...
   private Vector extractEntityVelocity() {
      float var1 = Float.isNaN(this.d.bo) ? 0.0F : this.d.bo;
      float var2 = Float.isNaN(this.d.bp) ? 0.0F : this.d.bp;
      float var3 = Float.isNaN(this.d.bq) ? 0.0F : this.d.bq;
      return (new Vector(var1, var2, var3)).rotateAroundY((double)(this.d.dM() * 0.017453292F));
   }
   ...
   private void processRootMotion(RootMotionDelta motion) {
      ...
      if (!var2.isZero() || !var1.onGround()) {
         ...
         if (!MathUtils.isSimilar((float)var2.getY(), 0.0F) || !var1.onGround()) {
            this.d.h(this.d.dz().d(1.0D, 0.0D, 1.0D));
         }
   ...
   public void addVelocity(double x, double y, double z) {
      this.d.h(this.d.dz().b(var1, var3, var5));
   }
   ...
   public Vector getVelocity() {
      return CraftVector.toBukkit(this.d.dz());
   }
