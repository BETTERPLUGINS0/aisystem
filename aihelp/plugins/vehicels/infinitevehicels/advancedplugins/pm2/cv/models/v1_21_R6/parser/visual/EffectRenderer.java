package advancedplugins.pm2.cv.models.v1_21_R6.parser.visual;
...
public class EffectRenderer implements VisualRendererParser<VisualDisplayRenderer> {
   ...
   private PacketPlayOutEntityMetadata configureAnchor(VisualDisplayRenderer.RendererVisualModel var1) {
      return new PacketPlayOutEntityMetadata(var1.getPivotId(), EntityUtils.DEFAULT_AREA_EFFECT_CLOUD_DATA);
   }

   private PacketPlayOutSpawnEntity createDisplayEntity(VisualDisplayRenderer.RendererVisualModel var1) {
      Vector3f var2 = (Vector3f)var1.getOrigin().get();
      return new PacketPlayOutSpawnEntity(var1.getModelId(), var1.getModelUuid(), (double)var2.x, (double)var2.y, (double)var2.z, 0.0F, 0.0F, EntityTypes.at, 0, Vec3D.c, 0.0D);
   }

   private PacketPlayOutEntityMetadata configureDisplay(VisualDisplayRenderer.RendererVisualModel var1, boolean var2) {
   ...
   private ArrayList<c<?>> buildDisplayProperties(VisualDisplayRenderer.RendererVisualModel var1, boolean var2) {
   ...
   private void addInitialProperties(ArrayList<c<?>> var1) {
   ...
   private void addConditionalProperties(ArrayList<c<?>> var1, VisualDisplayRenderer.RendererVisualModel var2, boolean var3) {
      ...
      var2.getLeftRotation().ifDirty((var1x) -> {
         ...
         var1.add(new c(13, DataWatcherRegistry.I, var2));
      }, var3);
   ...
   private PacketPlayOutMount establishHierarchy(VisualDisplayRenderer.RendererVisualModel var1) {
