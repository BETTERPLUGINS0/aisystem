package advancedplugins.pm2.cv.models.v1_21_R2.entity.hitbox;
...
import advancedplugins.pm2.cv.models.v1_21_R2.entity.EntityConversionUtil;
...
public class CollisionVolumeEntity extends EntityLiving implements HitboxEntity {
   ...
   @NotNull
   protected AxisAlignedBB makeBoundingBox(Vec3D position) {
   ...
   public CraftEntity getBukkitEntity() {
      ...
      if (var1 == null) {
         synchronized(this) {
            CraftLivingEntity var3 = new CraftLivingEntity(this.dW().getCraftServer(), this);
   ...
   public Location getLocation() {
      return CraftLocation.toBukkit(this.du(), this.dW().getWorld(), this.getBukkitYaw(), this.dO());
   }
   ...
   private static class OrientedBoundingVolume extends advancedplugins.pm2.cv.models.v1_21_R2.entity.hitbox.OrientedBoundingVolume {
