...
public class EntityUtils {
   ...
   public static final List<c<?>> LEASH_SLIME_DATA;
   ...
   static {
      ...
      LEASH_SLIME_DATA = List.of(new c(0, DataWatcherRegistry.a, (byte)32), new c(1, DataWatcherRegistry.b, Integer.MAX_VALUE), new c(16, DataWatcherRegistry.b, 0));
