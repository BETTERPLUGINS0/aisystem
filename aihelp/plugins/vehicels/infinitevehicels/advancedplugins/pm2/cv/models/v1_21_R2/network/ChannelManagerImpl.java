...
import advancedplugins.pm2.cv.models.v1_21_R2.network.utils.PacketAggregator;
...
public class ChannelManagerImpl implements NetworkHandler {
   ...
   public Optional<PipelineWrapper> getPipeline(UUID playerId) {
   ...
   public void injectChannel(Player player) {
      PlayerConnection var2 = ((CraftPlayer)var1).getHandle().f;
   ...
   private void insertHandlersIntoPipeline(ChannelPipeline pipeline, ModelPacketHandler handler) {
   ...
   public void ping(UUID playerId) {
   ...
   public void appendPacket(UUID playerId, Packet<? super PacketListenerPlayOut> packet) {
   ...
   public void appendPackets(UUID playerId, Collection<Packet<? super PacketListenerPlayOut>> packets) {
      PacketAggregator var3 = (PacketAggregator)this.playerAggregators.get(var1);
      if (var3 != null) {
