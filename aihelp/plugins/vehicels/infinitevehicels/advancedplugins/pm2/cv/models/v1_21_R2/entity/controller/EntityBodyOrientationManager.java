...
public class EntityBodyOrientationManager extends EntityAIBodyControl implements BodyRotationController {
   ...
   public EntityBodyOrientationManager(EntityInsentient mob) {
      ...
      this.headRotationUpperBound = (float)var1.aa();
      this.bodyRotationUpperBound = (float)var1.aa();
   ...
   private void synchronizeBodyToMovement() {
      this.targetEntity.aX = this.targetEntity.dM();
   ...
   private boolean isNotCarryingPassenger() {
      return !(this.targetEntity.da() instanceof EntityInsentient);
   }

   private boolean detectMovement() {
      double var1 = this.targetEntity.dB() - this.targetEntity.K;
      double var3 = this.targetEntity.dH() - this.targetEntity.M;
