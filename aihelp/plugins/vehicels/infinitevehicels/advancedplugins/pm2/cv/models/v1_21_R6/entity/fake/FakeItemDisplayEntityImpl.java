package advancedplugins.pm2.cv.models.v1_21_R6.entity.fake;
...
public class FakeItemDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeItemDisplayEntity {
   ...
   public void positionSync(double var1, double var3, double var5, float var7, float var8) {
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.itemDisplay.ar(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.itemDisplay.dC(), (float)this.itemDisplay.dE(), (float)this.itemDisplay.dI());
   }
   ...
   public void packAndSend(Player var1) {
      List var2 = this.itemDisplay.au().c();
      if (var2 != null && !var2.isEmpty()) {
         this.sendPacket(var1, new PacketPlayOutEntityMetadata(this.itemDisplay.ar(), var2));
      }
