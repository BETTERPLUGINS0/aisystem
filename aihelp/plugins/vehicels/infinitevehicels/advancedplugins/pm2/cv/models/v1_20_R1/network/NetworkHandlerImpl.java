...
import advancedplugins.pm2.cv.models.v1_20_R1.network.utils.Bundler;
...
public class NetworkHandlerImpl implements NetworkHandler {
   ...
   public void injectChannel(Player player) {
      ...
      NetworkManager var3 = var2.h;
      ChannelPipeline var4 = var3.m.pipeline();
   ...
   @Generated
   public Map<UUID, PipelineWrapper> getPipelines() {
      return this.pipelines;
   }

   @Generated
   public Map<UUID, Bundler> getBundles() {
      return this.bundles;
   }
