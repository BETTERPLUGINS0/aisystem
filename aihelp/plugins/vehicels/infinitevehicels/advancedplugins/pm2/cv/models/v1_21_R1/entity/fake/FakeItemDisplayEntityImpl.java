...
public class FakeItemDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeItemDisplayEntity {
   ...
   public void positionSync(double x, double y, double z, float yaw, float pitch) {
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.itemDisplay.an(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.itemDisplay.dt(), (float)this.itemDisplay.dv(), (float)this.itemDisplay.dz());
   }
   ...
   public void packAndSend(Player player) {
      ...
      if (var2 != null && !var2.isEmpty()) {
         this.sendPacket(var1, new PacketPlayOutEntityMetadata(this.itemDisplay.an(), var2));
      }
