...
public class ServerInteractionProcessor {
   ...
   public static void handleInteract(InteractionPacketWrapper var0, PacketListenerPlayIn var1) {
   ...
   private static class InteractionHandler {
      ...
      InteractionHandler(InteractionPacketWrapper var1, PlayerConnection var2) {
         this.wrapper = var1;
         this.connection = var2;
         this.player = var2.o();
         this.craftPlayer = this.player.getBukkitEntity();
         this.level = this.player.A();
         this.server = this.level.q().server;
      }
      ...
      private void handleFakeInteraction() {
         this.wrapper.dispatch(new c() {
            ...
            public void a(EnumHand var1, Vec3D var2) {
            }
      ...
      private boolean shouldProcessInteraction(Entity var1) {
         return var1 != this.player || this.player.at();
      }

      private void processEntityInteraction(Entity var1) {
         this.player.J();
         this.player.h(this.wrapper.isUsingSecondaryAction());
         ...
         } else if (this.level.u().a(var1.dF())) {
      ...
      private void handleModelInteraction(IVisualModel var1) {
         ...
         this.wrapper.dispatch(new c(var2, var1) {
            ...
            public void a(EnumHand var1, Vec3D var2) {
               Vector var3 = new Vector(var2.g, var2.h, var2.i);
      ...
      private void handleUnknownEntity() {
         if (ServerInfo.IS_PAPER) {
            this.wrapper.dispatch(new c(this) {
               ...
               private void invokeUnknownEntityEvent(EnumHand var1, @Nullable Vec3D var2) {
               }
            });
         }
      }
      ...
      private void handleKnownEntity(Entity var1) {
         AxisAlignedBB var2 = var1.de();
         double var3 = var2.e(this.player.bR());
         double var5 = this.player.he();
         if (var3 < var5 * var5) {
      ...
      private class EntityInteractionProcessor {
         ...
         void process() {
            InteractionHandler.this.wrapper.dispatch(new c() {
               ...
               public void a(@NotNull EnumHand var1) {
               ...
               public void a(@NotNull EnumHand var1, @NotNull Vec3D var2) {
                  this.executeInteraction(var1, (var1, var2, var3) -> {
                     return var2.a(var1, var0, var3);
                  }, new PlayerInteractAtEntityEvent(this.this$1.this$0.craftPlayer, this.this$1.target.getBukkitEntity(), new Vector(var2.g, var2.h, var2.i), var1 == EnumHand.b ? EquipmentSlot.OFF_HAND : EquipmentSlot.HAND));
               }

               public void a() {
                  if (this.canAttack()) {
                     ItemStack var1 = this.this$1.this$0.player.b(EnumHand.a);
                     if (var1.a(this.this$1.this$0.level.O())) {
               ...
               private boolean canAttack() {
                  return !(this.this$1.target instanceof EntityItem) && !(this.this$1.target instanceof EntityExperienceOrb) && !(this.this$1.target instanceof EntityArrow) && (this.this$1.target != this.this$1.this$0.player || this.this$1.this$0.player.at());
               }

               private void executeInteraction(EnumHand var1, ServerInteractionProcessor.EntityInteractor var2, PlayerInteractEntityEvent var3) {
                  ItemStack var4 = this.this$1.this$0.player.b(var1);
                  if (var4.a(this.this$1.this$0.level.O())) {
                     ItemStack var5 = var4.v();
                     Item var6 = this.this$1.this$0.player.gB().h().h();
                     boolean var7 = var4.h() == Items.wU && this.this$1.target instanceof EntityInsentient;
                     this.this$1.this$0.server.getPluginManager().callEvent(var3);
                     this.handleSpecialCases(var3, var6, var7);
                     if (var3.isCancelled()) {
                        this.this$1.this$0.player.cl.b();
                     } else {
               ...
               private boolean shouldUpdateBucketable(PlayerInteractEntityEvent var1, Item var2) {
                  return this.this$1.target instanceof Bucketable && this.this$1.target instanceof EntityLiving && var2.h() == Items.sl && (var1.isCancelled() || this.this$1.this$0.player.gB().h().h() != var2);
               }

               private boolean shouldUpdateLeash(PlayerInteractEntityEvent var1, Item var2) {
                  return var1.isCancelled() || this.this$1.this$0.player.gB().h().h() != var2;
               }
               ...
               private void updateBucketableEntity() {
                  if (this.this$1.this$0.player.getBukkitEntity().canSee(this.this$1.target.getBukkitEntity())) {
                     EntityTrackerEntry var1 = ((EntityTracker)this.this$1.this$0.level.n().a.J.get(this.this$1.target.az())).b;
                     ArrayList var2 = new ArrayList();
                     EntityPlayer var10001 = this.this$1.this$0.player;
                     Objects.requireNonNull(var2);
                     var1.a(var10001, var2::add);
                     this.this$1.this$0.player.g.b(new ClientboundBundlePacket(var2));
                  }
               ...
               private void updateLeash() {
                  this.this$1.this$0.connection.b(new PacketPlayOutAttachEntity(this.this$1.target, ((EntityInsentient)this.this$1.target).ak_()));
               }

               private void updateEntityData() {
                  List var1 = this.this$1.target.aC().b();
                  if (var1 != null && this.this$1.this$0.player.getBukkitEntity().canSee(this.this$1.target.getBukkitEntity())) {
                     this.this$1.this$0.player.g.b(new PacketPlayOutEntityMetadata(this.this$1.target.az(), var1));
                  }
               ...
               private void updateAllayEquipment() {
                  ...
                  this.this$1.this$0.connection.b(new PacketPlayOutEntityEquipment(this.this$1.target.az(), var2));
                  this.this$1.this$0.player.cl.b();
               }
               ...
               private void handleSuccessfulInteraction(EnumInteractionResult var1, EnumHand var2) {
               ...
               // $FF: synthetic method
               private static Pair lambda$updateAllayEquipment$1(Allay var0, EnumItemSlot var1) {
                  return Pair.of(var1, var0.a(var1));
               }

               // $FF: synthetic method
               private static EnumInteractionResult lambda$onInteraction$0(Vec3D var0, EntityPlayer var1, Entity var2, EnumHand var3) {
                  return var2.a(var1, var0, var3);
               }
            });
         }
   ...
   private static class ItemUseHandler {
      ...
      ItemUseHandler(PacketPlayInBlockPlace var1, PlayerConnection var2, Consumer<EnumInteractionResult> var3) {
         this.packet = var1;
         this.connection = var2;
         this.afterUse = var3;
         this.player = var2.o();
      ...
      void process() {
         PlayerConnectionUtils.a(this.packet, this.connection, this.player.A());
         if (!this.player.fv() && this.checkRateLimit()) {
            this.connection.a(this.packet.e());
            EnumHand var1 = this.packet.b();
            ItemStack var2 = this.player.b(var1);
            this.player.J();
            if (!var2.f() && var2.a(this.player.A().O())) {
      ...
      private void processItemUse(EnumHand var1, ItemStack var2) {
         ...
         if (var4) {
            ...
            if (!var2.f()) {
               EnumInteractionResult var5 = this.player.h.a(this.player, this.player.A(), var2, var1);
      ...
      private MovingObjectPosition calculateHitResult() {
         ...
         return this.player.A().a(new RayTrace(var1.eyePosition, var4, BlockCollisionOption.b, FluidCollisionOption.a, this.player));
      }

      private boolean checkCancellation(MovingObjectPosition var1, EnumHand var2, ItemStack var3) {
      ...
      private boolean isRepeatedInteraction(MovingObjectPositionBlock var1, EnumHand var2, ItemStack var3) {
      ...
      private static class PlayerViewInfo {
         ...
         PlayerViewInfo(EntityPlayer var1) {
            this.eyePosition = new Vec3D(var1.dK(), var1.dM() + (double)var1.df(), var1.dQ());
            this.pitch = var1.dZ();
            this.yaw = var1.dX();
         }

         Vec3D getTargetPosition(double var1) {
