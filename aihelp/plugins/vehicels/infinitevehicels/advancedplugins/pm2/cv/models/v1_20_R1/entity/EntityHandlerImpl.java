package advancedplugins.pm2.cv.models.v1_20_R1.entity;
...
import advancedplugins.pm2.cv.models.v1_20_R1.NMSMethods;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.controller.BodyRotationControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.controller.LookControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.controller.MoveControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.hitbox.HitboxEntityImpl;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.navigation.AmphibiousNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.navigation.FlyingNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.navigation.GroundNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.navigation.WallClimberNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.entity.navigation.WaterBoundNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.network.patch.PatchedServerGamePacketListener;
...
public class EntityHandlerImpl implements EntityHandler {
   public static final AtomicInteger ENTITY_COUNTER;
   ...
   private static boolean isVisible(CraftWorld world, Vec3D startPos, Vec3D endPos) {
      MovingObjectPositionBlock var3 = usePaperClipMethod ? var0.getHandle().a(new OcclusionClipContext(var1, var2)) : var0.getHandle().clip(new OcclusionClipContext(var1, var2), (BlockPosition)null);
   ...
   public void setHitbox(Entity entity, @NotNull Hitbox hitbox) {
      ...
      EntitySize var6 = new EntitySize(var3, var4, true);
   ...
   public double getStepHeight(Entity entity) {
      return (double)EntityUtils.nms(var1).dC();
   }

   public void setPosition(Entity entity, double x, double y, double z) {
      EntityUtils.nms(var1).e(var2, var4, var6);
   }
   ...
   public void movePassenger(Entity entity, double x, double y, double z) {
      ...
      if (this.dummyArmorStand == null) {
         this.dummyArmorStand = new EntityArmorStand(EntityTypes.d, var8.dI());
         this.dummyArmorStand.u(true);
      }

      double var9 = var4 - var8.bx();
      var8.e(var2, var9, var6);
      var8.f(Vec3D.b);
      var8.n();
   ...
   public void setForcedInvisible(Player player, boolean flag) {
      if (this.isForcedInvisible(var1) != var2) {
         ...
         PacketPlayOutEntityMetadata var6 = new PacketPlayOutEntityMetadata(var1.getEntityId(), List.of(new b(0, DataWatcherRegistry.a, var4)));
   ...
   public MoveController wrapMoveController(Entity entity, Supplier<MoveController> def) {
      ...
      if (var3 instanceof EntityInsentient) {
         EntityInsentient var4 = (EntityInsentient)var3;
         MoveControlWrapper var5 = new MoveControlWrapper(var4, var4.G());
   ...
   public LookController wrapLookController(Entity entity, Supplier<LookController> def) {
      ...
      if (var3 instanceof EntityInsentient) {
         EntityInsentient var4 = (EntityInsentient)var3;
         LookControlWrapper var5 = new LookControlWrapper(var4, var4.E());
   ...
   public void wrapNavigation(Entity entity) {
      ...
      if (var2 instanceof EntityInsentient) {
         ...
         try {
            ...
            NavigationAbstract var5 = var3.J();
            Object var6;
            if (var5 instanceof NavigationSpider) {
               ...
               if (!(var5 instanceof AmphibiousPathNavigation)) {
                  String var13 = String.valueOf(var3.ae());
                  LogUtil.warn("Failed to create custom navigation for " + var13 + ": " + String.valueOf(var3.ct()));
   ...
   public HitboxEntity createHitbox(Location location, IJoint joint, SubHitbox subHitbox) {
      ...
      var5.e(var1.getX(), var1.getY(), var1.getZ());
      ModelAPI.setRenderCanceled(var5.af(), true);
   ...
   public void spawnDynamicHitbox(DynamicHitbox hitbox) {
      ...
      final PacketPlayOutSpawnEntity var5 = new PacketPlayOutSpawnEntity(DynamicHitbox.getHitboxId(), DynamicHitbox.getHitboxUUID(), var2.getX(), var2.getY() - 0.5202D, var2.getZ(), 0.0F, 0.0F, EntityTypes.aL, 0, Vec3D.b, 0.0D);
   ...
   public void forceUseItem(Player player, EquipmentSlot hand) {
      ...
      PacketPlayInBlockPlace var7 = new PacketPlayInBlockPlace(var2 == EquipmentSlot.HAND ? EnumHand.a : EnumHand.b, 0);
      var7.timestamp = System.currentTimeMillis();
      PatchedServerGamePacketListener.handleUseItem(var7, var6, (var4x) -> {
         if (var4.s() != EnumAnimation.a && var4x == EnumInteractionResult.b) {
            PacketPlayOutEntityMetadata var5x = new PacketPlayOutEntityMetadata(var1.getEntityId(), List.of(new b(8, DataWatcherRegistry.a, (byte)(var2 == EquipmentSlot.HAND ? 1 : 3))));
            ...
            if (var6 instanceof InstrumentItem) {
               ...
               var8.ifPresent((var2x) -> {
                  ...
                  RandomSource var6 = (RandomSource)ReflectionUtils.get(var5.dI(), NMSFields.LEVEL_threadSafeRandom);
   ...
   public float getYRot(Entity entity) {
      return EntityUtils.nms(var1).dy();
   }
   ...
   public float getXHeadRot(Entity entity) {
      return EntityUtils.nms(var1).dA();
   }
   ...
   public boolean isWalking(Entity entity) {
      ...
      if (var2.ag < 1) {
         ...
         double var3 = var2.dn() - var2.ab;
         double var5 = var2.dt() - var2.ad;
   ...
   public boolean isRemoved(Entity entity) {
      return EntityUtils.nms(var1).dD();
   }
         ...
         if (var13 == EntityHandler.BoxRelToCam.INSIDE && var14 == EntityHandler.BoxRelToCam.INSIDE && var15 == EntityHandler.BoxRelToCam.INSIDE) {
            ...
            if (DebugToggle.isDebugging(DebugToggle.SHOW_CULL_POINTS)) {
               ...
               while(var25.hasNext()) {
                  ...
                  var5.spawnParticle(Particle.REDSTONE, var26.c, var26.d, var26.e, 1, new DustOptions(Color.RED, 0.2F));
               }
            }
