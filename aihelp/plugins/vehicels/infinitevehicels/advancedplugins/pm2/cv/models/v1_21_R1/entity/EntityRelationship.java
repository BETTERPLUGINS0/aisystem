...
public class EntityRelationship extends Entity {
   private EntityRelationship(int entityId) {
      super(EntityTypes.ae, MinecraftServer.getServer().I());
      this.e(var1);
   ...
   protected void attachChildren(List<? extends Entity> children) {
      this.p = ImmutableList.copyOf(var1);
   }

   protected void a(@NotNull a builder) {
   }

   public boolean hurtServer(WorldServer world, DamageSource source, float amount) {
      return false;
   }
