...
public class FakeBlockDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeBlockDisplayEntity {
   ...
   protected int getEntityId() {
      return this.getBlockDisplay().ao();
   }
   ...
   public void positionSync(double x, double y, double z, float yaw, float pitch) {
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.blockDisplay.ao(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public void packAndSend(Player player) {
      ...
      if (var2 != null && !var2.isEmpty()) {
         this.sendPacket(var1, new PacketPlayOutEntityMetadata(this.blockDisplay.ao(), var2));
      }
