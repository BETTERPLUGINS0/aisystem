package advancedplugins.pm2.cv.models.v1_20_R1.network;
...
import advancedplugins.pm2.cv.models.v1_20_R1.network.patch.ServerboundInteractPacketWrapper;
import advancedplugins.pm2.cv.models.v1_20_R1.network.utils.NetworkUtils;
import advancedplugins.pm2.cv.models.v1_20_R1.network.utils.PacketInterceptor;
...
public class InfiniteModelChannelHandler extends ChannelDuplexHandler {
      ...
      if (!(var2 instanceof Packet)) {
         ...
         try {
            ...
            if (var5 instanceof ClientboundBundlePacket) {
               ...
               if (!var4.isEmpty()) {
                  var11 = new ClientboundBundlePacket(new Iterable<Packet<PacketListenerPlayOut>>(this) {
                     @NotNull
   ...
   private PacketPlayOutEntityDestroy handleRemoveEntities(PacketPlayOutEntityDestroy packet) {
      int[] var2 = var1.a().intStream().filter(this::shouldShow).toArray();
      return var2.length == var1.a().size() ? var1 : new PacketPlayOutEntityDestroy(IntArrayList.wrap(var2));
   }
   ...
   private PacketPlayOutEntityMetadata handleEntityData(PacketPlayOutEntityMetadata packet) {
      if (!this.shouldShow(var1.a())) {
         return null;
      } else if (var1.a() != this.player.getEntityId()) {
         return var1;
      } else {
         if (this.entityHandler.isForcedInvisible(this.player)) {
            ...
            while(var4.hasNext()) {
               ...
               if (var5.a() == 0) {
                  ...
                  var2.add(new b(0, DataWatcherRegistry.a, var6));
               } else {
                  var2.add(var5);
               }
            }
            ...
            var3.writeByte(255);
            var1 = new PacketPlayOutEntityMetadata(var1.a(), var2);
         }
   ...
   private PacketPlayInSteerVehicle handlePlayerInput(PacketPlayInSteerVehicle inputPacket) {
      ...
      if (var2 != null) {
         ...
         if (var3 == null) {
            var2.setInput(new MountController.MountInput(var1.a(), var1.c(), var1.d(), var1.e()));
         } else {
            var3.setSide(var1.a());
            var3.setFront(var1.c());
            var3.setJump(var1.d());
            var3.setSneak(var1.e());
         }
      }
