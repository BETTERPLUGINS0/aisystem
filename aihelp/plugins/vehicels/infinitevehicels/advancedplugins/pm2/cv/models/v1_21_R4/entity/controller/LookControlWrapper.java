...
public class LookControlWrapper extends ControllerLook implements LookController {
   ...
   public void a() {
      if (this.modelContainer == null) {
         this.modelContainer = ModelAPI.getModeledEntity(this.a.cG());
      }
   ...
   public void lookAt(double x, double y, double z) {
      double var7 = var1 - this.a.dA();
      double var9 = var3 - this.a.dE();
      double var11 = var5 - this.a.dG();
   ...
   @Generated
   public void setModelContainer(IModelContainer modelContainer) {
