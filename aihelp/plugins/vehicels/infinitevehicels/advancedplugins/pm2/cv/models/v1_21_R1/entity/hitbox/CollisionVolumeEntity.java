...
import advancedplugins.pm2.cv.models.v1_21_R1.entity.EntityConversionUtil;
...
public class CollisionVolumeEntity extends EntityLiving implements HitboxEntity {
   ...
   private void updatePositions() {
      ...
      while(var2.hasNext()) {
         ...
         EntityConversionUtil.toNMS(var3).c(var1);
      }
   ...
   public boolean hurtServer(@NotNull WorldServer world, @NotNull DamageSource source, float amount) {
   ...
   private void propagateDamageToBoundEntities(WorldServer world, DamageSource source, float amount) {
      ...
      while(var4.hasNext()) {
         ...
         EntityConversionUtil.toNMS(var5).a(var2, var3);
      }
   ...
   public EnumInteractionResult a(EntityHuman player, @NotNull EnumHand hand) {
      ...
      return this.collisionBox.getDamageMultiplier() <= 1.0E-5F ? EnumInteractionResult.e : this.processMainEntityInteraction(var1, var2);
   }
   ...
   private static class OrientedBoundingVolume extends advancedplugins.pm2.cv.models.v1_21_R1.entity.hitbox.OrientedBoundingVolume {
