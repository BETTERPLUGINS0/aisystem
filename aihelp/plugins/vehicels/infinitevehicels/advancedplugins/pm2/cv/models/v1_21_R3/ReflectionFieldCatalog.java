...
public enum ReflectionFieldCatalog implements ReflectionUtils.ReflectionEnum {
   ...
   JUMP_COOLDOWN(EntityLiving.class, "ce", "noJumpDelay"),
   JUMP_STATUS(EntityLiving.class, "bm", "jumping"),
   VISUAL_CONTROLLER(EntityInsentient.class, "bO", "lookControl"),
   MOVEMENT_CONTROLLER(EntityInsentient.class, "bP", "moveControl"),
   PATHFINDING_SYSTEM(EntityInsentient.class, "bR", "navigation"),
   BEHAVIOR_MANAGER(EntityInsentient.class, "bS", "goalSelector"),
   ROTATION_CONTROLLER(EntityInsentient.class, "ca", "bodyRotationControl"),
