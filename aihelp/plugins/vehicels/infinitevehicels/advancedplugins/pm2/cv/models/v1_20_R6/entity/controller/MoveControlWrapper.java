...
public class MoveControlWrapper extends ControllerMove implements MoveController {
         ...
         if (var5 != null) {
            ...
            if (!var6.isZero() || !var5.onGround()) {
               ...
               if (!MathUtils.isSimilar((float)var6.getY(), 0.0F) || !var5.onGround()) {
                  this.d.h(this.d.ds().d(1.0D, 0.0D, 1.0D));
               }
   ...
   public void globalMove(float x, float y, float z, float speedModifier) {
      float var5 = this.getSpeed();
      this.d.y(var5 * var4);
      Vec3D var6 = (new Vec3D((double)var1, (double)var2, (double)var3)).b(-this.d.dF() * 0.017453292F);
      this.d.E((float)var6.c);
      this.d.D((float)var6.d);
      this.d.C((float)var6.e);
   }

   private void fromVector(Vector vector) {
      Vec3D var2 = (new Vec3D(var1.getX(), var1.getY(), var1.getZ())).b(-this.d.dF() * 0.017453292F);
      this.d.E((float)var2.c);
      this.d.D((float)var2.d);
      this.d.C((float)var2.e);
   }

   private Vector toVector() {
      return (new Vector(Float.isNaN(this.d.bo) ? 0.0F : this.d.bo, Float.isNaN(this.d.bp) ? 0.0F : this.d.bp, Float.isNaN(this.d.bq) ? 0.0F : this.d.bq)).rotateAroundY((double)(this.d.dF() * 0.017453292F));
   }
   ...
   public void addVelocity(double x, double y, double z) {
      this.d.h(this.d.ds().b(var1, var3, var5));
   }
   ...
   public float getSpeed() {
      return (float)this.d.g(GenericAttributes.r);
   }

   public Vector getVelocity() {
      return CraftVector.toBukkit(this.d.ds());
   }
