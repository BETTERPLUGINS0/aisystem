package advancedplugins.pm2.cv.models.v1_20_R4.network.utils;
...
public class NetworkUtils {
   ...
   public static Packets.PacketSupplier createPivotSpawn(int id, UUID uuid, Vector3f pos) {
      return (var3) -> {
         return ModelAPI.getPlayerProtocolVersion(var3) >= 764 ? new PacketPlayOutSpawnEntity(var0, var1, (double)var2.x, (double)var2.y - 0.5D, (double)var2.z, 0.0F, 0.0F, EntityTypes.c, 0, Vec3D.b, 0.0D) : new PacketPlayOutSpawnEntity(var0, var1, (double)var2.x, (double)var2.y - 0.375D, (double)var2.z, 0.0F, 0.0F, EntityTypes.c, 0, Vec3D.b, 0.0D);
      };
   }

   public static Packets.PacketSupplier createPivotTeleport(int id, Vector3f pos) {
      EntityContainer var2 = EntityContainer.of(var0);
      var2.p((double)var1.x, (double)var1.y - 0.375D, (double)var1.z);
      PacketPlayOutEntityTeleport var3 = new PacketPlayOutEntityTeleport(var2);
      var2 = EntityContainer.of(var0);
      var2.e(var0);
      var2.p((double)var1.x, (double)var1.y - 0.5D, (double)var1.z);
