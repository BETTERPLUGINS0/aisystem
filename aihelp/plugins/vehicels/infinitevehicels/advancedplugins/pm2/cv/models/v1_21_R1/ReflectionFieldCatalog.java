...
public enum ReflectionFieldCatalog implements ReflectionUtils.ReflectionEnum {
   ...
   ENTITY_SIZE_DATA(Entity.class, "bd", "dimensions"),
   ENTITY_VIEW_HEIGHT(Entity.class, "be", "eyeHeight"),
   BUKKIT_WRAPPER(Entity.class, "bukkitEntity", "bukkitEntity"),
   JUMP_COOLDOWN(EntityLiving.class, "ch", "noJumpDelay"),
   JUMP_STATUS(EntityLiving.class, "bn", "jumping"),
   VISUAL_CONTROLLER(EntityInsentient.class, "bS", "lookControl"),
   MOVEMENT_CONTROLLER(EntityInsentient.class, "bT", "moveControl"),
   PATHFINDING_SYSTEM(EntityInsentient.class, "bV", "navigation"),
   BEHAVIOR_MANAGER(EntityInsentient.class, "bW", "goalSelector"),
   ROTATION_CONTROLLER(EntityInsentient.class, "cd", "bodyRotationControl"),
