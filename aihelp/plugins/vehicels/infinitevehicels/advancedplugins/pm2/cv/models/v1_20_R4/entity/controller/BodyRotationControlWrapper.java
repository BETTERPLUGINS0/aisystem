...
public class BodyRotationControlWrapper extends EntityAIBodyControl implements BodyRotationController {
   ...
   private void rotateBodyIfNecessary() {
      this.mob.aU = MathUtils.rotateIfNecessary(this.mob.aU, this.mob.aW, this.isBodyClampUneven ? this.minBodyAngle : -this.maxBodyAngle, this.maxBodyAngle);
   }

   private void rotateHeadIfNecessary() {
      this.mob.aW = MathUtils.rotateIfNecessary(this.mob.aW, this.mob.aU, this.isHeadClampUneven ? this.minHeadAngle : -this.maxHeadAngle, this.maxHeadAngle);
   }
   ...
   private void rotateHeadTowardsFront() {
      ...
      this.mob.aU = MathUtils.rotateIfNecessary(this.mob.aU, this.mob.aW, var4, var3);
   }
   ...
   private boolean isMoving() {
      double var1 = this.mob.dr() - this.mob.K;
      double var3 = this.mob.dx() - this.mob.M;
