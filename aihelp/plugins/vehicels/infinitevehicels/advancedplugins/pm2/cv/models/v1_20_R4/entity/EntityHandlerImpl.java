...
import advancedplugins.pm2.cv.models.v1_20_R4.NMSMethods;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.controller.BodyRotationControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.controller.LookControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.controller.MoveControlWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.hitbox.HitboxEntityImpl;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.navigation.AmphibiousNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.navigation.FlyingNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.navigation.GroundNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.navigation.WallClimberNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.entity.navigation.WaterBoundNavigationWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.network.patch.PatchedServerGamePacketListener;
...
public class EntityHandlerImpl implements EntityHandler {
   ...
   public double getStepHeight(Entity entity) {
      return (double)EntityUtils.nms(var1).dG();
   }
   ...
   public void movePassenger(Entity entity, double x, double y, double z) {
      ...
      if (this.dummyArmorStand == null) {
         this.dummyArmorStand = new EntityArmorStand(EntityTypes.d, var8.dM());
         this.dummyArmorStand.u(true);
      }

      double var9 = var4 - var8.m(this.dummyArmorStand).d;
         ...
         try {
            ...
            if (var5 instanceof NavigationSpider) {
               ...
               if (!(var5 instanceof AmphibiousPathNavigation)) {
                  String var13 = String.valueOf(var3.ai());
                  LogUtil.warn("Failed to create custom navigation for " + var13 + ": " + String.valueOf(var3.cw()));
   ...
   public HitboxEntity createHitbox(Location location, IJoint joint, SubHitbox subHitbox) {
      ...
      ModelAPI.setRenderCanceled(var5.aj(), true);
   ...
   public void spawnDynamicHitbox(DynamicHitbox hitbox) {
      ...
      final PacketPlayOutSpawnEntity var5 = new PacketPlayOutSpawnEntity(DynamicHitbox.getHitboxId(), DynamicHitbox.getHitboxUUID(), var2.getX(), var2.getY() - 0.5202D, var2.getZ(), 0.0F, 0.0F, EntityTypes.aM, 0, Vec3D.b, 0.0D);
         ...
         if (var4.s() != EnumAnimation.a && var4x == EnumInteractionResult.b) {
            ...
            if (var6 instanceof InstrumentItem) {
               ...
               var8.ifPresent((var2x) -> {
                  ...
                  RandomSource var6 = (RandomSource)ReflectionUtils.get(var5.dM(), NMSFields.LEVEL_threadSafeRandom);
   ...
   public float getYRot(Entity entity) {
      return EntityUtils.nms(var1).dC();
   }
   ...
   public boolean isWalking(Entity entity) {
      ...
      if (var2.ah < 1) {
         ...
         double var3 = var2.dr() - var2.ac;
         double var5 = var2.dx() - var2.ae;
   ...
   public boolean isRemoved(Entity entity) {
      return EntityUtils.nms(var1).dH();
   }
