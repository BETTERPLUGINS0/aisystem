package advancedplugins.pm2.cv.models.v1_20_R4.entity.hitbox;
...
public class HitboxEntityImpl extends EntityLiving implements HitboxEntity {
   ...
   public CraftEntity getBukkitEntity() {
      ...
      if (var1 == null) {
         synchronized(this) {
            CraftLivingEntity var3 = new CraftLivingEntity(this.dM().getCraftServer(), this);
   ...
   public void a(RemovalReason reason) {
      super.a(var1);
      ModelAPI.setRenderCanceled(this.aj(), false);
