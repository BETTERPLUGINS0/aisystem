...
public class GroundNavigationWrapper extends Navigation {
   ...
   private double getNodeDistanceSquared(Vec3D pos) {
      double var2 = var1.c - this.a.dt();
      double var4 = var1.d - this.a.dv();
      double var6 = var1.e - this.a.dz();
   ...
   protected void k() {
      ...
      double var3 = Math.abs(this.a.dt() - var2.c);
      double var5 = Math.abs(this.a.dv() - var2.d);
      double var7 = Math.abs(this.a.dz() - var2.e);
