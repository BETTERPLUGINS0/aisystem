...
public interface EntityHandler {
   ...
   HitboxEntity createHitbox(Location var1, IJoint var2, SubHitbox var3);
   ...
   void move(Entity var1, double var2, double var4, double var6);
   ...
   float getHealth(Entity var1);

   float getMaxHealth(Entity var1);
   ...
   boolean shouldCull(Player var1, Location var2, Entity var3, BoundingBox var4);
   ...
   public static enum Point {
      ...
      @Generated
      private Point(final float param3, final float param4, final float param5) {
         this.x = var3;
         this.y = var4;
         this.z = var5;
      }
   ...
   public static enum BoxRelToCam {
      ...
      public static EntityHandler.BoxRelToCam from(int var0, int var1, int var2) {
   ...
   public static enum InteractionResult {
      ...
      private static EntityHandler.InteractionResult[] $values() {
         return new EntityHandler.InteractionResult[]{SUCCESS, SUCCESS_NO_ITEM_USED, CONSUME, CONSUME_PARTIAL, PASS, FAIL};
      }
