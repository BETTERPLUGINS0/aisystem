...
public class EntityBodyOrientationManager extends EntityAIBodyControl implements BodyRotationController {
   ...
   public EntityBodyOrientationManager(EntityInsentient mob) {
      ...
      this.headRotationUpperBound = (float)var1.ae();
      this.bodyRotationUpperBound = (float)var1.ae();
   ...
   private void synchronizeBodyToMovement() {
      this.targetEntity.aY = this.targetEntity.dE();
      this.adjustHeadOrientation();
      this.previousStableHeadOrientation = this.targetEntity.ba;
      this.timeSinceStable = 0;
   }

   private void handleStaticOrientation() {
      float var1 = Math.abs(this.targetEntity.ba - this.previousStableHeadOrientation);
   ...
   public float getYHeadRot() {
      return this.targetEntity.ba;
   }

   public void setYHeadRot(float rot) {
      this.targetEntity.ba = var1;
   }

   public float getXHeadRot() {
      return this.targetEntity.dG();
   }

   public void setXHeadRot(float rot) {
      this.targetEntity.u(var1);
   }

   public float getYBodyRot() {
      return this.targetEntity.aY;
   }

   public void setYBodyRot(float rot) {
      this.targetEntity.aY = var1;
   }
   ...
   private void adjustBodyOrientation() {
      ...
      this.targetEntity.aY = MathUtils.rotateIfNecessary(this.targetEntity.aY, this.targetEntity.ba, var1, this.bodyRotationUpperBound);
   }
   ...
   private void adjustHeadOrientation() {
      ...
      this.targetEntity.ba = MathUtils.rotateIfNecessary(this.targetEntity.ba, this.targetEntity.aY, var1, this.headRotationUpperBound);
   }
   ...
   private void smoothHeadAlignment() {
      ...
      this.targetEntity.aY = MathUtils.rotateIfNecessary(this.targetEntity.aY, this.targetEntity.ba, var3, var2);
   }
   ...
   private boolean isNotCarryingPassenger() {
      return !(this.targetEntity.cT() instanceof EntityInsentient);
   }

   private boolean detectMovement() {
      double var1 = this.targetEntity.dt() - this.targetEntity.L;
      double var3 = this.targetEntity.dz() - this.targetEntity.N;
