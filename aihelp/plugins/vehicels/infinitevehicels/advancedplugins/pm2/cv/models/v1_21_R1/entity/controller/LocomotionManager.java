...
import advancedplugins.pm2.cv.models.v1_21_R1.network.utils.TripleConsumer;
...
public class LocomotionManager extends ControllerMove implements MoveController {
   ...
   private Vec3D rotateByEntityYaw(Vec3D vector) {
      return var1.b(-this.d.dE() * 0.017453292F);
   }
   ...
   private Vector extractEntityVelocity() {
      ...
      return (new Vector(var1, var2, var3)).rotateAroundY((double)(this.d.dE() * 0.017453292F));
   }
