package advancedplugins.pm2.cv.models.v1_21_R5_spigot.entity.hitbox;
...
import advancedplugins.pm2.cv.models.v1_21_R5_spigot.entity.EntityConversionUtil;
...
public class CollisionVolumeEntity extends EntityLiving implements HitboxEntity {
   ...
   public CraftEntity getBukkitEntity() {
      ...
      if (var1 == null) {
         synchronized(this) {
            CraftLivingEntity var3 = new CraftLivingEntity(this.ai().getCraftServer(), this);
   ...
   public Location getLocation() {
      return CraftLocation.toBukkit(this.dv(), this.ai().getWorld(), this.getBukkitYaw(), this.dR());
   }
   ...
   private static class OrientedBoundingVolume extends advancedplugins.pm2.cv.models.v1_21_R5_spigot.entity.hitbox.OrientedBoundingVolume {
