...
public class FakeBlockDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeBlockDisplayEntity {
   ...
   protected int getEntityId() {
      return this.getBlockDisplay().an();
   }
   ...
   public void positionSync(double x, double y, double z, float yaw, float pitch) {
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.blockDisplay.an(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.blockDisplay.dt(), (float)this.blockDisplay.dv(), (float)this.blockDisplay.dz());
   }
   ...
   public void packAndSend(Player player) {
      List var2 = this.blockDisplay.ar().c();
      if (var2 != null && !var2.isEmpty()) {
         this.sendPacket(var1, new PacketPlayOutEntityMetadata(this.blockDisplay.an(), var2));
      }
