...
public class PacketAggregator {
   ...
   private final List<List<Packet<? super PacketListenerPlayOut>>> packetGroups = new ArrayList();

   public void addPacket(Packet<? super PacketListenerPlayOut> packet) {
   ...
   public void addPackets(Collection<Packet<? super PacketListenerPlayOut>> packets) {
      this.ensureGroupExists();
      List var2 = this.getCurrentGroup();
   ...
   private List<Packet<? super PacketListenerPlayOut>> getCurrentGroup() {
      return (List)this.packetGroups.get(this.packetGroups.size() - 1);
   }

   private List<Packet<? super PacketListenerPlayOut>> createNewGroup() {
   ...
   public void flush(Consumer<Object> transmitter) {
