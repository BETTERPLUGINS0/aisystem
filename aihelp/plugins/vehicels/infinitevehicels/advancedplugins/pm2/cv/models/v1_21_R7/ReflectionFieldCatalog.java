...
public enum ReflectionFieldCatalog implements ReflectionUtils.ReflectionEnum {
   ...
   JUMP_COOLDOWN(EntityLiving.class, "cu", "noJumpDelay"),
   JUMP_STATUS(EntityLiving.class, "bL", "jumping"),
   VISUAL_CONTROLLER(EntityInsentient.class, "cm", "lookControl"),
   MOVEMENT_CONTROLLER(EntityInsentient.class, "cn", "moveControl"),
   PATHFINDING_SYSTEM(EntityInsentient.class, "cp", "navigation"),
   BEHAVIOR_MANAGER(EntityInsentient.class, "cq", "goalSelector"),
   ROTATION_CONTROLLER(EntityInsentient.class, "cy", "bodyRotationControl"),
   ...
   SAFE_RANDOM_SOURCE(World.class, "C", "threadSafeRandom");
