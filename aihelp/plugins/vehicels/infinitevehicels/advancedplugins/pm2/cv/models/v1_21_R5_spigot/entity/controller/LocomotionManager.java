package advancedplugins.pm2.cv.models.v1_21_R5_spigot.entity.controller;
...
import advancedplugins.pm2.cv.models.v1_21_R5_spigot.network.utils.TripleConsumer;
...
public class LocomotionManager extends ControllerMove implements MoveController {
   ...
   public void a() {
      this.groundContact = this.d.aK();
      IModelContainer var1 = ModelAPI.getModeledEntity(this.d.cK());
      if (var1 == null) {
   ...
   private Vec3D rotateByEntityYaw(Vec3D var1) {
      return var1.b(-this.d.dP() * 0.017453292F);
   }
   ...
   private Vector extractEntityVelocity() {
      float var1 = Float.isNaN(this.d.bC) ? 0.0F : this.d.bC;
      float var2 = Float.isNaN(this.d.bD) ? 0.0F : this.d.bD;
      float var3 = Float.isNaN(this.d.bE) ? 0.0F : this.d.bE;
      return (new Vector(var1, var2, var3)).rotateAroundY((double)(this.d.dP() * 0.017453292F));
   }
   ...
   private void processRootMotion(RootMotionDelta var1) {
      ...
      if (!var2.isZero() || !var1.onGround()) {
         ...
         if (!MathUtils.isSimilar((float)var2.getY(), 0.0F) || !var1.onGround()) {
            this.d.i(this.d.dA().d(1.0D, 0.0D, 1.0D));
         }
   ...
   public void addVelocity(double var1, double var3, double var5) {
      this.d.i(this.d.dA().b(var1, var3, var5));
   }
   ...
   public Vector getVelocity() {
      return CraftVector.toBukkit(this.d.dA());
   }
