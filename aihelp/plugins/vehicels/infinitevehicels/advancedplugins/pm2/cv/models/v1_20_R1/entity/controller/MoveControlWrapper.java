...
public class MoveControlWrapper extends ControllerMove implements MoveController {
         ...
         if (var5 != null) {
            ...
            if (!var6.isZero() || !var5.onGround()) {
               ...
               if (!MathUtils.isSimilar((float)var6.getY(), 0.0F) || !var5.onGround()) {
                  this.d.f(this.d.dl().d(1.0D, 0.0D, 1.0D));
               }
   ...
   public void globalMove(float x, float y, float z, float speedModifier) {
      float var5 = this.getSpeed();
      this.d.w(var5 * var4);
      Vec3D var6 = (new Vec3D((double)var1, (double)var2, (double)var3)).b(-this.d.dy() * 0.017453292F);
      this.d.B((float)var6.c);
      this.d.A((float)var6.d);
      this.d.z((float)var6.e);
   }

   private void fromVector(Vector vector) {
      Vec3D var2 = (new Vec3D(var1.getX(), var1.getY(), var1.getZ())).b(-this.d.dy() * 0.017453292F);
      this.d.B((float)var2.c);
      this.d.A((float)var2.d);
      this.d.z((float)var2.e);
   }

   private Vector toVector() {
      return (new Vector(Float.isNaN(this.d.bl) ? 0.0F : this.d.bl, Float.isNaN(this.d.bm) ? 0.0F : this.d.bm, Float.isNaN(this.d.bn) ? 0.0F : this.d.bn)).rotateAroundY((double)(this.d.dy() * 0.017453292F));
   }
   ...
   public void addVelocity(double x, double y, double z) {
      this.d.f(this.d.dl().b(var1, var3, var5));
   }
