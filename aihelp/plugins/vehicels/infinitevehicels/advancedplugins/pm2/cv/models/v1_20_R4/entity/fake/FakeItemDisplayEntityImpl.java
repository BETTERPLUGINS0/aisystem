...
public class FakeItemDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeItemDisplayEntity {
   ...
   public void positionSync(double x, double y, double z, float yaw, float pitch) {
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.itemDisplay.aj(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.itemDisplay.dr(), (float)this.itemDisplay.dt(), (float)this.itemDisplay.dx());
   }
