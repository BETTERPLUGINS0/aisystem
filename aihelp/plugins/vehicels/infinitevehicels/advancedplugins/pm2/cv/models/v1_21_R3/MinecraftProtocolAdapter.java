package advancedplugins.pm2.cv.models.v1_21_R3;
...
import advancedplugins.pm2.cv.models.v1_21_R3.entity.EntityManagementSystem;
import advancedplugins.pm2.cv.models.v1_21_R3.entity.fake.FakeDisplayEntityManagerImpl;
import advancedplugins.pm2.cv.models.v1_21_R3.network.ChannelManagerImpl;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.behavior.ConnectionLinkHandler;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.behavior.InteractionZoneManager;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.behavior.JointedDisplayCoordinator;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.behavior.RideableEntityProcessor;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.behavior.TextLabelController;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.model.ModelEntitySynchronizer;
import advancedplugins.pm2.cv.models.v1_21_R3.parser.visual.EffectRenderer;
...
public class MinecraftProtocolAdapter implements NMSHandler {
   ...
   private void updateItemColor(ItemMeta metadata, Color color) {
      CustomModelDataComponent var3 = var1.getCustomModelDataComponent();
      var3.setColors(List.of(var2));
      var1.setCustomModelDataComponent(var3);
   }
