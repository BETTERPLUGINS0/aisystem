...
import advancedplugins.pm2.cv.models.v1_21_R1.network.utils.EntityActivityChecker;
...
public class GazeDirectionHandler extends ControllerLook implements LookController {
   ...
   private void initializeModelIfNeeded() {
      if (this.entityModel == null) {
         this.entityModel = ModelAPI.getModeledEntity(this.a.cz());
      }
   ...
   public void lookAt(double x, double y, double z) {
      Vec3D var7 = new Vec3D(this.a.dt(), this.a.dx(), this.a.dz());
   ...
   private GazeDirectionHandler.OrientationAngles calculateOrientationAngles(Vec3D from, Vec3D to) {
      double var3 = var2.c - var1.c;
      double var5 = var2.d - var1.d;
      double var7 = var2.e - var1.e;
