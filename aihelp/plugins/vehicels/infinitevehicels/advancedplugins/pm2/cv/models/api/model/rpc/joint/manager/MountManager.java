...
public interface MountManager {
   ...
   @Nullable
   <T extends Mount & JointAction> T getDriverJoint();

   <T extends Mount & JointAction> void setDriverJoint(@Nullable T var1);

   <T extends Mount & JointAction> void registerSeat(T var1);

   <T extends Mount & JointAction> Map<String, T> getSeats();

   <T extends Mount & JointAction> Optional<T> getSeat(String var1);

   <T extends Mount & JointAction> Optional<T> getMount(Entity var1);
