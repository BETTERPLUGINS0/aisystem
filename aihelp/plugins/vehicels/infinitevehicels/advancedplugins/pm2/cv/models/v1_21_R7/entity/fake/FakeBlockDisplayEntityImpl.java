...
public class FakeBlockDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeBlockDisplayEntity {
   ...
   protected int getEntityId() {
      return this.getBlockDisplay().az();
   }
   ...
   public void positionSync(double var1, double var3, double var5, float var7, float var8) {
      ...
      this.blockDisplay.a(var7, true, var8, true);
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.blockDisplay.az(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.blockDisplay.dK(), (float)this.blockDisplay.dM(), (float)this.blockDisplay.dQ());
   }
   ...
   public void packAndSend(Player var1) {
      List var2 = this.blockDisplay.aC().c();
      if (var2 != null && !var2.isEmpty()) {
         this.sendPacket(var1, new PacketPlayOutEntityMetadata(this.blockDisplay.az(), var2));
      }
