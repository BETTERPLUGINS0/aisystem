...
public abstract class FakeDisplayEntityImpl implements FakeDisplayEntity {
   ...
   public void spawnInternal(Player forPlayer) {
      PacketPlayOutSpawnEntity var2 = new PacketPlayOutSpawnEntity(this.getEntityId(), this.uuid, this.initialSpawnLocation.getX(), this.initialSpawnLocation.getY(), this.initialSpawnLocation.getZ(), this.initialSpawnLocation.getYaw(), this.initialSpawnLocation.getPitch(), this.getEntityType(), 0, Vec3D.b, 0.0D);
