...
public class FakeBlockDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeBlockDisplayEntity {
   ...
   public FakeBlockDisplayEntityImpl(@NotNull Location initialSpawnLocation) {
      ...
      this.blockDisplay.e(var1.getX(), var1.getY(), var1.getZ());
   }
   ...
   public void positionSync(double x, double y, double z, float yaw, float pitch) {
      this.blockDisplay.e(var1, var3, var5);
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.blockDisplay.af(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.blockDisplay.dn(), (float)this.blockDisplay.dp(), (float)this.blockDisplay.dt());
   }
