package advancedplugins.pm2.cv.models.v1_21_R2.network.utils;
...
public class PacketTransmissionUtility {
   ...
   public static PacketDataSerializer decodeIncomingPacket(Packet<? super PacketListenerPlayIn> packet, EntityPlayer player) {
      ...
      GameProtocols.a.a(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().ba())).c().encode(var2, var0);
      var2.l();
      return var2;
   }
   ...
   public static PacketBundleProvider.PacketFactory generateAnchorSpawn(int entityId, UUID entityUuid, Vector3f position) {
      return (var3) -> {
         ...
         return new PacketPlayOutSpawnEntity(var0, var1, (double)var2.x, (double)var2.y - var4, (double)var2.z, 0.0F, 0.0F, EntityTypes.d, 0, Vec3D.c, 0.0D);
      };
   }
   ...
   private static ClientboundEntityPositionSyncPacket createPositionSync(EntityRelationship relation) {
      return new ClientboundEntityPositionSyncPacket(var0.ar(), PositionMoveRotation.a(var0), var0.aJ());
   }
   ...
   static {
      CLIENT_PROTOCOL_INFO = GameProtocols.b.a(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().ba()));
