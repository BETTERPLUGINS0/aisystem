...
public class ServerInteractionProcessor {
   ...
   private static class InteractionHandler {
      ...
      private boolean shouldProcessInteraction(Entity entity) {
         return var1 != this.player || this.player.Z_();
      }
      ...
      private void processEntityInteraction(Entity targetEntity) {
         ...
         } else if (this.level.F_().a(var1.dv())) {
            ...
            InteractionHandler.this.wrapper.dispatch(new c() {
               ...
               public void a() {
                  if (this.canAttack()) {
                     ...
                     if (var1.a(this.this$1.this$0.level.K())) {
               ...
               private boolean canAttack() {
                  return !(this.this$1.target instanceof EntityItem) && !(this.this$1.target instanceof EntityExperienceOrb) && !(this.this$1.target instanceof EntityArrow) && (this.this$1.target != this.this$1.this$0.player || this.this$1.this$0.player.Z_());
               }
               ...
               private void executeInteraction(EnumHand hand, ServerInteractionProcessor.EntityInteractor interactor, PlayerInteractEntityEvent event) {
                  ...
                  if (var4.a(this.this$1.this$0.level.K())) {
                     ItemStack var5 = var4.v();
                     Item var6 = this.this$1.this$0.player.gi().f().h();
                     boolean var7 = var4.h() == Items.vK && this.this$1.target instanceof EntityInsentient;
               ...
               private boolean shouldUpdateBucketable(PlayerInteractEntityEvent event, Item beforeItem) {
                  return this.this$1.target instanceof Bucketable && this.this$1.target instanceof EntityLiving && var2.j() == Items.rg && (var1.isCancelled() || this.this$1.this$0.player.gi().f().h() != var2);
               }
               ...
               private void updateLeash() {
                  this.this$1.this$0.connection.b(new PacketPlayOutAttachEntity(this.this$1.target, ((EntityInsentient)this.this$1.target).D()));
               }
   ...
   private static class ItemUseHandler {
      ...
      void process() {
         ...
         if (!this.player.fi() && this.checkRateLimit()) {
            ...
            this.player.H();
            if (!var2.f() && var2.a(this.player.dV().K())) {
      ...
      private void processItemUse(EnumHand hand, ItemStack item) {
         ...
         if (var4) {
            ...
            if (!var2.f()) {
               EnumInteractionResult var5 = this.player.h.a(this.player, this.player.dV(), var2, var1);
      ...
      private MovingObjectPosition calculateHitResult() {
         ...
         return this.player.dV().a(new RayTrace(var1.eyePosition, var4, BlockCollisionOption.b, FluidCollisionOption.a, this.player));
      }
      ...
      private static class PlayerViewInfo {
         ...
         PlayerViewInfo(EntityPlayer player) {
            this.eyePosition = new Vec3D(var1.dA(), var1.dC() + (double)var1.cS(), var1.dG());
            this.pitch = var1.dN();
            this.yaw = var1.dL();
         }
