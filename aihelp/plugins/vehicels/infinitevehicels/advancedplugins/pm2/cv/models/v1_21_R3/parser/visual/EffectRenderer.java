package advancedplugins.pm2.cv.models.v1_21_R3.parser.visual;
...
public class EffectRenderer implements VisualRendererParser<VisualDisplayRenderer> {
   ...
   private PacketPlayOutSpawnEntity createDisplayEntity(VisualDisplayRenderer.RendererVisualModel effect) {
      ...
      return new PacketPlayOutSpawnEntity(var1.getModelId(), var1.getModelUuid(), (double)var2.x, (double)var2.y, (double)var2.z, 0.0F, 0.0F, EntityTypes.ar, 0, Vec3D.c, 0.0D);
   }
