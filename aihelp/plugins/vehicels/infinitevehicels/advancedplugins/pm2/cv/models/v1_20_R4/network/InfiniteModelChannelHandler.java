package advancedplugins.pm2.cv.models.v1_20_R4.network;
...
import advancedplugins.pm2.cv.models.v1_20_R4.network.patch.ServerboundInteractPacketWrapper;
import advancedplugins.pm2.cv.models.v1_20_R4.network.utils.NetworkUtils;
import advancedplugins.pm2.cv.models.v1_20_R4.network.utils.PacketInterceptor;
...
public class InfiniteModelChannelHandler extends ChannelDuplexHandler {
   ...
   private List<Packet<? super PacketListenerPlayOut>> handleAddEntityPost(PacketPlayOutSpawnEntity packet) {
      return this.handleMount(var1.d());
   }
   ...
   private PacketPlayInSteerVehicle handlePlayerInput(PacketPlayInSteerVehicle inputPacket) {
      ...
      if (var2 != null) {
         ...
         if (var3 == null) {
            var2.setInput(new MountController.MountInput(var1.a(), var1.d(), var1.e(), var1.f()));
         } else {
            var3.setSide(var1.a());
            var3.setFront(var1.d());
            var3.setJump(var1.e());
            var3.setSneak(var1.f());
         }
      }
