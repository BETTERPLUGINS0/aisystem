package advancedplugins.pm2.cv.models.v1_20_R4.entity.navigation;
...
public class AmphibiousNavigationWrapper extends AmphibiousPathNavigation {
   ...
   private double getNodeDistanceSquared(Vec3D pos) {
      double var2 = var1.c - this.a.dr();
      double var4 = var1.d - this.a.dt();
      double var6 = var1.e - this.a.dx();
   ...
   protected void k() {
      ...
      double var3 = Math.abs(this.a.dr() - var2.c);
      double var5 = Math.abs(this.a.dt() - var2.d);
      double var7 = Math.abs(this.a.dx() - var2.e);
