...
public enum NMSFields implements ReflectionUtils.ReflectionEnum {
   ...
   LIVING_ENTITY_noJumpDelay(EntityLiving.class, "ch", "noJumpDelay"),
   LIVING_ENTITY_jumping(EntityLiving.class, "bn", "jumping"),
   MOB_lookControl(EntityInsentient.class, "bS", "lookControl"),
   MOB_moveControl(EntityInsentient.class, "bT", "moveControl"),
   MOB_navigation(EntityInsentient.class, "bV", "navigation"),
   MOB_goalSelector(EntityInsentient.class, "bW", "goalSelector"),
   MOB_bodyRotationControl(EntityInsentient.class, "cd", "bodyRotationControl"),
