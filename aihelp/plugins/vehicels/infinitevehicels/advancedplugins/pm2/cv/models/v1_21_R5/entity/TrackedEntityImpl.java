...
public class TrackedEntityImpl implements TrackedEntity {
   ...
   private final Supplier<net.minecraft.server.level.ChunkMap.TrackedEntity> trackedEntitySupplier;
   ...
   @NotNull
   private net.minecraft.server.level.ChunkMap.TrackedEntity lastTrackedEntity;

   public TrackedEntityImpl(Entity var1, Supplier<net.minecraft.server.level.ChunkMap.TrackedEntity> var2, @NotNull net.minecraft.server.level.ChunkMap.TrackedEntity var3) {
   ...
   public Set<UUID> getTrackedPlayer() {
      ...
      Iterator var2 = this.getTrackedEntity().seenBy.iterator();

      while(var2.hasNext()) {
         ServerPlayerConnection var3 = (ServerPlayerConnection)var2.next();
         Player var4 = Bukkit.getPlayer(var3.getPlayer().getUUID());
   ...
   public Set<UUID> getTrackedPlayer(Predicate<Player> var1) {
      ...
      Iterator var3 = this.getTrackedEntity().seenBy.iterator();

      while(var3.hasNext()) {
         ServerPlayerConnection var4 = (ServerPlayerConnection)var3.next();
         Player var5 = Bukkit.getPlayer(var4.getPlayer().getUUID());
         if (this.playerPredicate == null) {
            this.playerPredicate = (var0) -> {
               return true;
            };
         }
   ...
   public void sendPairingData(Player var1) {
      if (var1 != null) {
         ServerPlayer var2 = ((CraftPlayer)var1).getHandle();
         this.getTrackedEntity().serverEntity.sendPairingData(var2, (var1x) -> {
   ...
   @NotNull
   private net.minecraft.server.level.ChunkMap.TrackedEntity getTrackedEntity() {
      net.minecraft.server.level.ChunkMap.TrackedEntity var1 = (net.minecraft.server.level.ChunkMap.TrackedEntity)this.trackedEntitySupplier.get();
   ...
   private void syncInstance(net.minecraft.server.level.ChunkMap.TrackedEntity var1) {
   ...
   @Generated
   public Supplier<net.minecraft.server.level.ChunkMap.TrackedEntity> getTrackedEntitySupplier() {
   ...
   @NotNull
   @Generated
   public net.minecraft.server.level.ChunkMap.TrackedEntity getLastTrackedEntity() {
      return this.lastTrackedEntity;
   }
   ...
   @Generated
   public void setLastTrackedEntity(@NotNull net.minecraft.server.level.ChunkMap.TrackedEntity var1) {
      this.lastTrackedEntity = var1;
   }
}
