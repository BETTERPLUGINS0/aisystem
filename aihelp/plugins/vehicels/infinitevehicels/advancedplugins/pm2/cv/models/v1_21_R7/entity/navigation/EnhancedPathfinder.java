...
public abstract class EnhancedPathfinder {
   ...
   private double calculateDistanceToNode(Vec3D var1) {
      double var2 = var1.g - this.controlledEntity.dK();
      double var4 = var1.h - this.controlledEntity.dM();
      double var6 = var1.i - this.controlledEntity.dQ();
   ...
   private float calculateProximityThreshold() {
      float var1 = this.controlledEntity.dA();
      return var1 > 0.75F ? var1 / 2.0F : 0.75F - var1 / 2.0F;
   }

   private boolean isWithinNodeProximity(Vec3D var1, Vec3D var2, float var3) {
      double var4 = Math.abs(this.controlledEntity.dK() - var2.g);
      double var6 = Math.abs(this.controlledEntity.dM() - var2.h);
      double var8 = Math.abs(this.controlledEntity.dQ() - var2.i);
