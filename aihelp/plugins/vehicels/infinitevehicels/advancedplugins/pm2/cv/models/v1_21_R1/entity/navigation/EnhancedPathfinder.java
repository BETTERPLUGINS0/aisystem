...
public abstract class EnhancedPathfinder {
   ...
   private double calculateDistanceToNode(Vec3D nodePosition) {
      double var2 = var1.c - this.controlledEntity.dt();
      double var4 = var1.d - this.controlledEntity.dv();
      double var6 = var1.e - this.controlledEntity.dz();
   ...
   private float calculateProximityThreshold() {
      float var1 = this.controlledEntity.dj();
   ...
   private boolean isWithinNodeProximity(Vec3D entityPos, Vec3D nodePos, float threshold) {
      double var4 = Math.abs(this.controlledEntity.dt() - var2.c);
      double var6 = Math.abs(this.controlledEntity.dv() - var2.d);
      double var8 = Math.abs(this.controlledEntity.dz() - var2.e);
