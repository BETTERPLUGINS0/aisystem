...
import advancedplugins.pm2.cv.models.v1_21_R10.network.utils.PacketAggregator;
...
public class ChannelManagerImpl implements NetworkHandler {
   ...
   public void injectChannel(Player var1) {
      ...
      Connection var3 = (Connection)ReflectionUtils.get(var2, ReflectionFieldCatalog.NETWORK_CONNECTION);
      if (var3 != null) {
         ChannelPipeline var4 = var3.channel.pipeline();
   ...
   private void insertHandlersIntoPipeline(ChannelPipeline var1, ModelPacketHandler var2) {
      ...
      while(var4.hasNext()) {
         ...
         if (var5.getValue() instanceof Connection) {
