...
public class OBB extends AxisAlignedBB {
   ...
   public OBB(double minX, double minY, double minZ, double maxX, double maxY, double maxZ, Quaternionf rotation, float yaw) {
      ...
      this.rotation = var13;
      this.yaw = var14;
      this.bukkitOBB = new OrientedBoundingBox(this.f().k(), new Vector3f((float)this.b(), (float)this.c(), (float)this.d()), var13, var14);
   }
   ...
   public Optional<Vec3D> b(Vec3D from, Vec3D to) {
      ...
      Vec3D var6 = (new Vec3D(var1.d(var4).k().rotateY(-var5).rotate(var3))).e(var4);
      Vec3D var7 = (new Vec3D(var2.d(var4).k().rotateY(-var5).rotate(var3))).e(var4);
      Optional var8 = super.b(var6, var7);
      if (var8.isEmpty()) {
         return var8;
      } else {
         Vec3D var9 = (new Vec3D(((Vec3D)var8.get()).d(var4).k().rotate(this.rotation).rotateY(var5))).e(var4);
