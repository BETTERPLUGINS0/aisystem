...
public enum ReflectionMethodCatalog implements ReflectionUtils.MethodEnum {
   CALCULATE_EFFECTIVE_RANGE(TrackedEntity.class, "b", "getEffectiveRange", new Class[0]),
   VALIDATE_PACKET_LIMIT(ServerGamePacketListenerImpl.class, "checkLimit", "checkLimit", new Class[]{Long.TYPE}),
   RETRIEVE_INSTRUMENT_DATA(InstrumentItem.class, "a", "getInstrument", new Class[]{ItemStack.class, Provider.class});
