...
public class TerrainNavigatorOptimized extends Navigation {
   ...
   public TerrainNavigatorOptimized(EntityInsentient var1, Navigation var2) {
      super(var1, var1.ai());
   ...
   private class RouteProcessor {
      ...
      RouteProcessor(EntityInsentient param2) {
         this.navigator = var2;
      }

      void calibrateStartingPoint(PathEntity var1) {
         int var2 = var1.f();
      ...
      private double computeNodeDistance(Vec3D var1) {
         double var2 = var1.d - this.navigator.dC();
         double var4 = var1.e - this.navigator.dE();
         double var6 = var1.f - this.navigator.dI();
         return var2 * var2 + var4 * var4 + var6 * var6;
      }

      private float determineReachRadius() {
         float var1 = this.navigator.ds();
         return var1 > 0.75F ? var1 / 2.0F : 0.75F - var1 / 2.0F;
      }

      private boolean isAtDestination(Vec3D var1, Vec3D var2, float var3) {
         double var4 = Math.abs(this.navigator.dC() - var2.d);
         double var6 = Math.abs(this.navigator.dE() - var2.e);
         double var8 = Math.abs(this.navigator.dI() - var2.f);
         return var4 < (double)var3 && var8 < (double)var3 && var6 < 1.0D;
      }

      private boolean canProgressToFollowing(Vec3D var1) {
      ...
      private boolean shouldTransitionToNext(Vec3D var1, PathEntity var2) {
         if (var2.f() + 1 >= var2.e()) {
            return false;
         } else {
