package advancedplugins.pm2.cv.models.v1_21_R5_spigot.network.patch;
...
import advancedplugins.pm2.cv.models.v1_21_R5_spigot.ReflectionMethodCatalog;
...
public class ServerInteractionProcessor {
   ...
   private static class InteractionHandler {
      ...
      private boolean shouldProcessInteraction(Entity var1) {
         return var1 != this.player || this.player.am();
      }
      ...
      private void processEntityInteraction(Entity var1) {
         ...
         } else if (this.level.F_().a(var1.dx())) {
      ...
      private void handleKnownEntity(Entity var1) {
         AxisAlignedBB var2 = var1.cV();
         double var3 = var2.e(this.player.bI());
         double var5 = this.player.gW();
         if (var3 < var5 * var5) {
            ...
            InteractionHandler.this.wrapper.dispatch(new c() {
               ...
               public void a() {
                  if (this.canAttack()) {
                     ...
                     if (var1.a(this.this$1.this$0.level.L())) {
               ...
               private boolean canAttack() {
                  return !(this.this$1.target instanceof EntityItem) && !(this.this$1.target instanceof EntityExperienceOrb) && !(this.this$1.target instanceof EntityArrow) && (this.this$1.target != this.this$1.this$0.player || this.this$1.this$0.player.am());
               }
               ...
               private void executeInteraction(EnumHand var1, ServerInteractionProcessor.EntityInteractor var2, PlayerInteractEntityEvent var3) {
                  ...
                  if (var4.a(this.this$1.this$0.level.L())) {
                     ItemStack var5 = var4.v();
                     Item var6 = this.this$1.this$0.player.gs().g().h();
                     boolean var7 = var4.h() == Items.wn && this.this$1.target instanceof EntityInsentient;
                     this.this$1.this$0.server.getPluginManager().callEvent(var3);
                     this.handleSpecialCases(var3, var6, var7);
                     if (var3.isCancelled()) {
                        this.this$1.this$0.player.cn.b();
                     } else {
               ...
               private boolean shouldUpdateBucketable(PlayerInteractEntityEvent var1, Item var2) {
                  return this.this$1.target instanceof Bucketable && this.this$1.target instanceof EntityLiving && var2.h() == Items.rG && (var1.isCancelled() || this.this$1.this$0.player.gs().g().h() != var2);
               }

               private boolean shouldUpdateLeash(PlayerInteractEntityEvent var1, Item var2) {
                  return var1.isCancelled() || this.this$1.this$0.player.gs().g().h() != var2;
               }
               ...
               private void updateBucketableEntity() {
                  if (this.this$1.this$0.player.getBukkitEntity().canSee(this.this$1.target.getBukkitEntity())) {
                     EntityTrackerEntry var1 = ((EntityTracker)this.this$1.this$0.level.n().a.L.get(this.this$1.target.ar())).b;
               ...
               private void updateLeash() {
                  this.this$1.this$0.connection.b(new PacketPlayOutAttachEntity(this.this$1.target, ((EntityInsentient)this.this$1.target).aj_()));
               }
               ...
               private void updateEntityData() {
                  ...
                  if (var1 != null && this.this$1.this$0.player.getBukkitEntity().canSee(this.this$1.target.getBukkitEntity())) {
                     this.this$1.this$0.player.g.b(new PacketPlayOutEntityMetadata(this.this$1.target.ar(), var1));
                  }
   ...
   private static class ItemUseHandler {
      ...
      private void processItemUse(EnumHand var1, ItemStack var2) {
         ...
         if (var4) {
            ...
            if (!var2.f()) {
               EnumInteractionResult var5 = this.player.h.a(this.player, this.player.y(), var2, var1);
      ...
      private MovingObjectPosition calculateHitResult() {
         ...
         return this.player.y().a(new RayTrace(var1.eyePosition, var4, BlockCollisionOption.b, FluidCollisionOption.a, this.player));
      }
      ...
      private static class PlayerViewInfo {
         ...
         PlayerViewInfo(EntityPlayer var1) {
            this.eyePosition = new Vec3D(var1.dC(), var1.dE() + (double)var1.cW(), var1.dI());
            this.pitch = var1.dR();
            this.yaw = var1.dP();
         }
