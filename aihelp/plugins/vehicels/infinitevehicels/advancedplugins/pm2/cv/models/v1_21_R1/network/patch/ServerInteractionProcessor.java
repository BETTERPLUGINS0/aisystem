...
public class ServerInteractionProcessor {
   ...
   private static class InteractionHandler {
      ...
      InteractionHandler(InteractionPacketWrapper wrapper, PlayerConnection connection) {
         ...
         this.server = this.level.o().server;
      }
      ...
      private boolean shouldProcessInteraction(Entity entity) {
         return var1 != this.player || this.player.R_();
      }
      ...
      private void processEntityInteraction(Entity targetEntity) {
         ...
         } else if (this.level.C_().a(var1.do())) {
      ...
      private void handleKnownEntity(Entity entity) {
         AxisAlignedBB var2 = var1.cK();
         double var3 = var2.e(this.player.by());
         double var5 = this.player.gz();
         if (var3 < var5 * var5) {
         ...
         void process() {
            InteractionHandler.this.wrapper.dispatch(new c() {
               ...
               public void a(@NotNull EnumHand hand, @NotNull Vec3D pos) {
                  ...
                  }, new PlayerInteractAtEntityEvent(this.this$1.this$0.craftPlayer, this.this$1.target.getBukkitEntity(), new Vector(var2.c, var2.d, var2.e), var1 == EnumHand.b ? EquipmentSlot.OFF_HAND : EquipmentSlot.HAND));
               }
               ...
               private boolean canAttack() {
                  return !(this.this$1.target instanceof EntityItem) && !(this.this$1.target instanceof EntityExperienceOrb) && !(this.this$1.target instanceof EntityArrow) && (this.this$1.target != this.this$1.this$0.player || this.this$1.this$0.player.R_());
               }
               ...
               private void executeInteraction(EnumHand hand, ServerInteractionProcessor.EntityInteractor interactor, PlayerInteractEntityEvent event) {
                  ...
                  if (var4.a(this.this$1.this$0.level.J())) {
                     ItemStack var5 = var4.s();
                     Item var6 = this.this$1.this$0.player.fY().f().g();
                     boolean var7 = var4.g() == Items.uK && this.this$1.target instanceof EntityInsentient;
               ...
               private boolean shouldUpdateBucketable(PlayerInteractEntityEvent event, Item beforeItem) {
                  return this.this$1.target instanceof Bucketable && this.this$1.target instanceof EntityLiving && var2.r() == Items.qz && (var1.isCancelled() || this.this$1.this$0.player.fY().f().g() != var2);
               }

               private boolean shouldUpdateLeash(PlayerInteractEntityEvent event, Item beforeItem) {
                  return var1.isCancelled() || this.this$1.this$0.player.fY().f().g() != var2;
               }
               ...
               private void updateBucketableEntity() {
                  if (this.this$1.this$0.player.getBukkitEntity().canSee(this.this$1.target.getBukkitEntity())) {
                     EntityTrackerEntry var1 = ((EntityTracker)this.this$1.this$0.level.l().a.K.get(this.this$1.target.an())).b;
                     ArrayList var2 = new ArrayList();
                     EntityPlayer var10001 = this.this$1.this$0.player;
                     Objects.requireNonNull(var2);
                     var1.a(var10001, var2::add);
                     this.this$1.this$0.player.c.b(new ClientboundBundlePacket(var2));
                  }
               ...
               private void updateEntityData() {
                  List var1 = this.this$1.target.ar().b();
                  if (var1 != null && this.this$1.this$0.player.getBukkitEntity().canSee(this.this$1.target.getBukkitEntity())) {
                     this.this$1.this$0.player.c.b(new PacketPlayOutEntityMetadata(this.this$1.target.an(), var1));
                  }
               ...
               private void updateAllayEquipment() {
                  ...
                  this.this$1.this$0.connection.b(new PacketPlayOutEntityEquipment(this.this$1.target.an(), var2));
                  this.this$1.this$0.player.cd.b();
               }
   ...
   private static class ItemUseHandler {
      ...
      private void processItemUse(EnumHand hand, ItemStack item) {
         ...
         if (var4) {
            ...
            if (!var2.e()) {
               EnumInteractionResult var5 = this.player.e.a(this.player, this.player.dO(), var2, var1);
      ...
      private MovingObjectPosition calculateHitResult() {
         ...
         double var2 = this.player.e.b() == EnumGamemode.b ? 5.0D : 4.5D;
         Vec3D var4 = var1.getTargetPosition(var2);
         return this.player.dO().a(new RayTrace(var1.eyePosition, var4, BlockCollisionOption.b, FluidCollisionOption.a, this.player));
      }

      private boolean checkCancellation(MovingObjectPosition hitResult, EnumHand hand, ItemStack item) {
         if (var1 != null && var1.c() == EnumMovingObjectType.b) {
            MovingObjectPositionBlock var6 = (MovingObjectPositionBlock)var1;
            if (this.isRepeatedInteraction(var6, var2, var3)) {
               return this.player.e.interactResult;
            } else {
               PlayerInteractEvent var5 = CraftEventFactory.callPlayerInteractEvent(this.player, Action.RIGHT_CLICK_BLOCK, var6.a(), var6.b(), var3, true, var2, var6.e());
               this.player.e.firedInteract = false;
      ...
      private boolean isRepeatedInteraction(MovingObjectPositionBlock blockHit, EnumHand hand, ItemStack item) {
         return this.player.e.firedInteract && this.player.e.interactPosition.equals(var1.a()) && this.player.e.interactHand == var2 && ItemStack.c(this.player.e.interactItemStack, var3);
      }
      ...
      private static class PlayerViewInfo {
         ...
         PlayerViewInfo(EntityPlayer player) {
            this.eyePosition = new Vec3D(var1.dt(), var1.dv() + (double)var1.cL(), var1.dz());
            this.pitch = var1.dG();
            this.yaw = var1.dE();
         }
