package advancedplugins.pm2.cv.models.v1_21_R7.entity.controller;
...
public class EntityBodyOrientationManager extends EntityAIBodyControl implements BodyRotationController {
   ...
   public EntityBodyOrientationManager(EntityInsentient var1) {
      ...
      this.headRotationUpperBound = (float)var1.ah();
      this.bodyRotationUpperBound = (float)var1.ah();
   ...
   private void synchronizeBodyToMovement() {
      this.targetEntity.bB = this.targetEntity.dX();
      this.adjustHeadOrientation();
      this.previousStableHeadOrientation = this.targetEntity.bD;
      this.timeSinceStable = 0;
   }

   private void handleStaticOrientation() {
      float var1 = Math.abs(this.targetEntity.bD - this.previousStableHeadOrientation);
   ...
   public float getYHeadRot() {
      return this.targetEntity.bD;
   }

   public void setYHeadRot(float var1) {
      this.targetEntity.bD = var1;
   }

   public float getXHeadRot() {
      return this.targetEntity.dZ();
   }
   ...
   public float getYBodyRot() {
      return this.targetEntity.bB;
   }

   public void setYBodyRot(float var1) {
      this.targetEntity.bB = var1;
   }
   ...
   private void adjustBodyOrientation() {
      ...
      this.targetEntity.bB = MathUtils.rotateIfNecessary(this.targetEntity.bB, this.targetEntity.bD, var1, this.bodyRotationUpperBound);
   }
   ...
   private void adjustHeadOrientation() {
      ...
      this.targetEntity.bD = MathUtils.rotateIfNecessary(this.targetEntity.bD, this.targetEntity.bB, var1, this.headRotationUpperBound);
   }
   ...
   private void smoothHeadAlignment() {
      ...
      this.targetEntity.bB = MathUtils.rotateIfNecessary(this.targetEntity.bB, this.targetEntity.bD, var3, var2);
   }
   ...
   private boolean isNotCarryingPassenger() {
      return !(this.targetEntity.dj() instanceof EntityInsentient);
   }

   private boolean detectMovement() {
      double var1 = this.targetEntity.dK() - this.targetEntity.Y;
      double var3 = this.targetEntity.dQ() - this.targetEntity.aa;
