...
public class FakeBlockDisplayEntityImpl extends FakeDisplayEntityImpl implements FakeBlockDisplayEntity {
   ...
   public void positionSync(double x, double y, double z, float yaw, float pitch) {
      ...
      if (var14) {
         ...
         var15 = new PacketPlayOutRelEntityMoveLook(this.blockDisplay.al(), (short)((int)var9), (short)((int)var10), (short)((int)var11), var12, var13, true);
      }
   ...
   public Vector3f getPosition() {
      return new Vector3f((float)this.blockDisplay.du(), (float)this.blockDisplay.dw(), (float)this.blockDisplay.dA());
   }
