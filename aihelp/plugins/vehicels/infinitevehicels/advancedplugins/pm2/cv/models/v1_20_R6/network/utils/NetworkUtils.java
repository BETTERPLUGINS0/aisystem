package advancedplugins.pm2.cv.models.v1_20_R6.network.utils;
...
public class NetworkUtils {
   ...
   static {
      CLIENTBOUND_CODEC = GameProtocols.b.bind(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().bc()));
      SERVERBOUND_CODEC = GameProtocols.a.bind(RegistryFriendlyByteBuf.a(MinecraftServer.getServer().bc()));
   }
}
