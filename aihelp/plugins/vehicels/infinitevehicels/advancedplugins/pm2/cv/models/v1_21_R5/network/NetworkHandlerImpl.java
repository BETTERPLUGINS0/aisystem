...
import advancedplugins.pm2.cv.models.v1_21_R5.network.utils.Bundler;
...
public class NetworkHandlerImpl implements NetworkHandler {
   ...
   public void injectChannel(Player var1) {
      ServerGamePacketListenerImpl var2 = ((CraftPlayer)var1).getHandle().connection;
      Connection var3 = (Connection)ReflectionUtils.get(var2, NMSFields.SERVER_COMMON_PACKET_LISTENER_IMPL_connection);
      ChannelPipeline var4 = ((Connection)Objects.requireNonNull(var3)).channel.pipeline();
      ...
      while(var7.hasNext()) {
         ...
         if (var4.get(var8) instanceof Connection) {
   ...
   public void appendPacket(UUID var1, Packet<? super ClientGamePacketListener> var2) {
   ...
   public void appendPackets(UUID var1, Collection<Packet<? super ClientGamePacketListener>> var2) {
      Bundler var3 = (Bundler)this.bundles.get(var1);
      if (var3 != null) {
         var3.appendPacket(var2);
      }
