package implementation.v1_21_R7.fake;
...
import implementation.v1_21_R7.util.PacketWritingUtil;
...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(new PacketPlayOutSpawnEntity(var2.az(), var2.cT(), var2.dK(), var2.dM(), var2.dQ(), var2.dZ(), var2.dX(), var2.ax(), 0, var2.dI(), (double)var2.cN()));
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cN())));
      PacketPlayOutEntityMetadata var3 = null;
      List var4 = this.handle.aC().c();
      if (var4 != null && var4.size() > 0) {
         var3 = new PacketPlayOutEntityMetadata(this.handle.az(), var4);
      }
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.az()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.az()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.az()}), var3);
      }
   ...
   protected Packet<?> prepareLocationPacket(boolean var1, boolean var2) {
      ...
      if (!var1 && this.lastLocationSent != null && !(this.lastLocationSent.f(var4) > 8.0D)) {
         ...
         var3 = new ClientboundEntityPositionSyncPacket(this.handle.az(), PositionMoveRotation.a(this.handle), this.handle.aS());
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      short var3 = (short)((int)PacketUtil.serializeDeltaLocation(var1.g, var2.g));
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.h, var2.h));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.i, var2.i));
      return new PacketPlayOutRelEntityMove(this.handle.az(), var3, var4, var5, this.handle.bc);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.h, var2.h));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.i, var2.i));
      return new PacketPlayOutRelEntityMoveLook(this.handle.az(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dX()), PacketUtil.serializeRotationAngle(this.handle.dZ()), this.handle.bc);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.az(), PacketUtil.serializeRotationAngle(this.handle.dX()), PacketUtil.serializeRotationAngle(this.handle.dZ()), this.handle.bc);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cN())));
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      ...
      DataWatcher var3 = this.handle.aC();
      Object var4;
      if (var1) {
         var4 = this.handle.aC().c();
      } else {
         var4 = var3.b();
      }
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.az(), (List)var4);
      }
   ...
   private void modifyRot(List<c<?>> var1) {
      ...
      if (var3 instanceof Display) {
         ...
         if (!var8) {
            Vector3f var17 = new Vector3f((Vector3fc)var2.aC().a(var4));
            var17.rotateY(-var16);
            var1.add(new c(var4.a(), var4.b(), var17));
         }

         if (!var9) {
            Quaternionf var18 = new Quaternionf((Quaternionfc)var2.aC().a(var15));
