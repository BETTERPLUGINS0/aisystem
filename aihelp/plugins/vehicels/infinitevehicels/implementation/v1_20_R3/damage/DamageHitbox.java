package implementation.v1_20_R3.damage;
...
public class DamageHitbox extends EntitySlime implements advancedplugins.pm2.cv.damage.DamageHitbox {
   ...
   public DamageHitbox(@NotNull World var1) {
      super(EntityTypes.aM, ((CraftWorld)var1).getHandle());
      ...
      this.d(true);
      ((AttributeModifiable)Objects.requireNonNull(this.a(GenericAttributes.l))).a(Double.MAX_VALUE);
