...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(this.handle.dj());
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cp())));
      PacketPlayOutEntityMetadata var2 = null;
      List var3 = this.handle.an().c();
      if (var3 != null && var3.size() > 0) {
         PacketDataSerializer var4 = new PacketDataSerializer(Unpooled.buffer());
         var4.c(this.handle.aj());
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.aj()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.aj()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.aj()}), var3);
      }
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      ...
      return new PacketPlayOutRelEntityMove(this.handle.aj(), var3, var4, var5, this.handle.aJ);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMoveLook(this.handle.aj(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dC()), PacketUtil.serializeRotationAngle(this.handle.dE()), this.handle.aJ);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.aj(), PacketUtil.serializeRotationAngle(this.handle.dC()), PacketUtil.serializeRotationAngle(this.handle.dE()), this.handle.aJ);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cp())));
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      PacketPlayOutEntityMetadata var2 = null;
      DataWatcher var3 = this.handle.an();
      Object var4;
      if (var1) {
         var4 = this.handle.an().c();
      } else {
         var4 = var3.b();
      }
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.aj(), (List)var4);
      }
   ...
   private void modifyRot(List<b<?>> var1) {
      ...
      if (var3 instanceof Display) {
         ...
         try {
            var15 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_LEFT_ROTATION_ID", "v");
            var4 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_TRANSLATION_ID", "t");
            var5 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_TRANSFORMATION_INTERPOLATION_DURATION_ID", "r");
            var6 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS_ID", "q");
         ...
         if (!var8) {
            Vector3f var16 = new Vector3f((Vector3fc)var2.an().b(var4));
            var16.rotateY(-var7);
            var1.add(new b(var4.a(), var4.b(), var16));
         }

         if (!var9) {
            Quaternionf var17 = new Quaternionf((Quaternionfc)var2.an().b(var15));
