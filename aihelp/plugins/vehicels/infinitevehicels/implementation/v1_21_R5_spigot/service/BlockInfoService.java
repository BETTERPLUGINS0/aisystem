...
public class BlockInfoService implements advancedplugins.pm2.cv.api.service.BlockInfoService {
   ...
   private EnumSurface getSurfaceType(World var1, BlockPosition var2, IBlockData var3, boolean var4) {
      ...
      if (var6 instanceof BlockAir) {
         ...
         if (var6 != Blocks.ed && var6 != Blocks.ef && var6 != Blocks.fV && !(var6 instanceof BlockSnow)) {
            if (!(var6 instanceof BlockIce) && var6 != Blocks.nD && var6 != Blocks.je && var6 != Blocks.tn && var6 != Blocks.tj && !(var6 instanceof BlockWetSponge)) {
   ...
   private boolean isSlipperyWhenRaining(Block var1) {
      return this.isGlass(var1) || var1 == Blocks.j || var1 == Blocks.k || var1 == Blocks.lk || var1 == Blocks.ts || var1 instanceof BlockGrass || var1 instanceof BlockLongGrass || var1 instanceof BlockLeaves;
   }
