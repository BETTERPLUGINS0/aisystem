...
public class FakeDisplayBlockHandle extends FakeDisplayHandle<BlockDisplay> implements advancedplugins.pm2.cv.fake.display.FakeDisplayBlockHandle {
   ...
   protected BlockDisplay createHandleInstance(@NotNull World var1) {
      return (BlockDisplay)EntityTypes.q.a(((CraftWorld)var1).getHandle(), EntitySpawnReason.n);
   }
   ...
   private Packet<?> createTrickyInvisibilityPacket(boolean var1) {
      ...
      try {
         ...
         if (var3 != null) {
            c var10;
            if (var1) {
               var10 = c.a(var3, Blocks.a.m());
            } else {
               var10 = c.a(var3, ((BlockDisplay)this.handle).m());
            }

            return new PacketPlayOutEntityMetadata(((BlockDisplay)this.handle).ar(), Collections.singletonList(var10));
         }
