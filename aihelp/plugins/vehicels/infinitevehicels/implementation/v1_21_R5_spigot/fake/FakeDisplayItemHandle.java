...
public class FakeDisplayItemHandle extends FakeDisplayHandle<ItemDisplay> implements advancedplugins.pm2.cv.fake.display.FakeDisplayItemHandle {
   ...
   protected ItemDisplay createHandleInstance(@NotNull World var1) {
      return (ItemDisplay)EntityTypes.at.a(((CraftWorld)var1).getHandle(), EntitySpawnReason.n);
   }
      ...
      try {
         ...
         if (var3 != null) {
            ...
            if (var1) {
               ...
               var10 = c.a(var3, ((ItemDisplay)this.handle).m());
            }

            return new PacketPlayOutEntityMetadata(((ItemDisplay)this.handle).ar(), Collections.singletonList(var10));
         }
