package implementation.v1_21_R5_spigot.fake;
...
import implementation.v1_21_R5_spigot.util.PacketWritingUtil;
...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(new PacketPlayOutSpawnEntity(var2.ar(), var2.cK(), var2.dC(), var2.dE(), var2.dI(), var2.dR(), var2.dP(), var2.ap(), 0, var2.dA(), (double)var2.cE()));
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cE())));
      PacketPlayOutEntityMetadata var3 = null;
      List var4 = this.handle.au().c();
      if (var4 != null && var4.size() > 0) {
         var3 = new PacketPlayOutEntityMetadata(this.handle.ar(), var4);
      }
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.ar()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.ar()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.ar()}), var3);
      }
   ...
   protected Packet<?> prepareLocationPacket(boolean var1, boolean var2) {
      ...
      if (!var1 && this.lastLocationSent != null && !(this.lastLocationSent.f(var4) > 8.0D)) {
         ...
         var3 = new ClientboundEntityPositionSyncPacket(this.handle.ar(), PositionMoveRotation.a(this.handle), this.handle.aK());
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      ...
      return new PacketPlayOutRelEntityMove(this.handle.ar(), var3, var4, var5, this.handle.bb);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.f, var2.f));
      return new PacketPlayOutRelEntityMoveLook(this.handle.ar(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dP()), PacketUtil.serializeRotationAngle(this.handle.dR()), this.handle.bb);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.ar(), PacketUtil.serializeRotationAngle(this.handle.dP()), PacketUtil.serializeRotationAngle(this.handle.dR()), this.handle.bb);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cE())));
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      ...
      DataWatcher var3 = this.handle.au();
      Object var4;
      if (var1) {
         var4 = this.handle.au().c();
      } else {
         var4 = var3.b();
      }
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.ar(), (List)var4);
      }
   ...
   private void modifyRot(List<c<?>> var1) {
      ...
      if (var3 instanceof Display) {
         ...
         if (!var8) {
            Vector3f var17 = new Vector3f((Vector3fc)var2.au().a(var4));
            var17.rotateY(-var16);
            var1.add(new c(var4.a(), var4.b(), var17));
         }

         if (!var9) {
            Quaternionf var18 = new Quaternionf((Quaternionfc)var2.au().a(var15));
