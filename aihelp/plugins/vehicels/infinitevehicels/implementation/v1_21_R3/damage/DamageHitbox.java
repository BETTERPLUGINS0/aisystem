package implementation.v1_21_R3.damage;
...
public class DamageHitbox extends EntitySlime implements advancedplugins.pm2.cv.damage.DamageHitbox {
   ...
   public DamageHitbox(@NotNull World var1) {
      super(EntityTypes.bg, ((CraftWorld)var1).getHandle());
      ...
      this.e(true);
      ((AttributeModifiable)Objects.requireNonNull(this.g(GenericAttributes.s))).a(Double.MAX_VALUE);
   ...
   public void h() {
      ...
      if (this.orientationDirty) {
         ...
         this.N = this.orientation;
         this.r(this.orientation);
         this.q(this.orientation);
      }

      super.h();
   }

   public AxisAlignedBB makeBoundingBoxCustom(Vec3D var1) {
      return this.makeBoundingBoxCustom(var1.d, var1.e, var1.f);
   }

   public AxisAlignedBB makeBoundingBoxCustom(double var1, double var3, double var5) {
