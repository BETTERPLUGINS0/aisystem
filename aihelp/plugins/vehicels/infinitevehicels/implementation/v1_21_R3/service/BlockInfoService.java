...
public class BlockInfoService implements advancedplugins.pm2.cv.api.service.BlockInfoService {
   ...
   private EnumSurface getSurfaceType(World var1, BlockPosition var2, IBlockData var3, boolean var4) {
      ...
      if (var6 instanceof BlockAir) {
         ...
         if (var6 != Blocks.ea && var6 != Blocks.ec && var6 != Blocks.fR && !(var6 instanceof BlockSnow)) {
            if (!(var6 instanceof BlockIce) && var6 != Blocks.ny && var6 != Blocks.ja && var6 != Blocks.te && var6 != Blocks.tc && !(var6 instanceof BlockWetSponge)) {
               if (var6 != Blocks.J && var6 != Blocks.fP) {
                  if (var6 != Blocks.K && var6 != Blocks.fQ) {
   ...
   private boolean isSlipperyWhenRaining(Block var1) {
      return this.isGlass(var1) || var1 == Blocks.j || var1 == Blocks.k || var1 == Blocks.lg || var1 == Blocks.tj || var1 instanceof BlockGrass || var1 instanceof BlockLongGrass || var1 instanceof BlockLeaves;
   }
