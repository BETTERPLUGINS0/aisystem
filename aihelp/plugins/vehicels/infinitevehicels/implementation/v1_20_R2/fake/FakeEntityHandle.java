package implementation.v1_20_R2.fake;
...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(this.handle.di());
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.co())));
      PacketPlayOutEntityMetadata var2 = null;
      List var3 = this.handle.al().c();
      if (var3 != null && var3.size() > 0) {
         PacketDataSerializer var4 = new PacketDataSerializer(Unpooled.buffer());
         var4.c(this.handle.ah());
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.ah()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.ah()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.ah()}), var3);
      }
   ...
   protected Packet<?> prepareLocationPacket(boolean var1, boolean var2) {
      Vec3D var4 = this.handle.dj();
      if (System.currentTimeMillis() - this.lastTeleportPacketTimestamp >= Constants.FORCE_TELEPORT_PERIOD) {
         var1 = true;
      }

      Object var3;
      if (!var1 && this.lastLocationSent != null && !(this.lastLocationSent.g(var4) > 64.0D)) {
         if (var2) {
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      ...
      return new PacketPlayOutRelEntityMove(this.handle.ah(), var3, var4, var5, this.handle.aJ);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMoveLook(this.handle.ah(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dB()), PacketUtil.serializeRotationAngle(this.handle.dD()), this.handle.aJ);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.ah(), PacketUtil.serializeRotationAngle(this.handle.dB()), PacketUtil.serializeRotationAngle(this.handle.dD()), this.handle.aJ);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.co())));
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      PacketPlayOutEntityMetadata var2 = null;
      DataWatcher var3 = this.handle.al();
      Object var4;
      if (var1) {
         var4 = this.handle.al().c();
      } else {
         var4 = var3.b();
      }
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.ah(), (List)var4);
      }
      ...
      if (var3 instanceof Display) {
         ...
         for(int var11 = 0; var11 < var1.size(); ++var11) {
            ...
            if (var12.a() == var5.a()) {
               ...
               var1.set(var11, new b(var12.a(), var12.b(), var19));
               var9 = true;
            }
         }
         ...
         if (!var8) {
            Vector3f var17 = new Vector3f((Vector3fc)var2.al().b(var4));
            var17.rotateY(-var16);
            var1.add(new b(var4.a(), var4.b(), var17));
         }

         if (!var9) {
            Quaternionf var18 = new Quaternionf((Quaternionfc)var2.al().b(var15));
            var18 = (new Quaternionf()).rotateY(-var16).mul(var18);
            var1.add(new b(var15.a(), var15.b(), var18));
         }
