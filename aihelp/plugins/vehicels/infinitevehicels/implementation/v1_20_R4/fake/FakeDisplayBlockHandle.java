   ...
   private Packet<?> createTrickyInvisibilityPacket(boolean var1) {
      ...
      try {
         ...
         if (var3 != null) {
            c var10;
            if (var1) {
               var10 = c.a(var3, Blocks.a.o());
            } else {
               var10 = c.a(var3, ((BlockDisplay)this.handle).u());
            }

            return new PacketPlayOutEntityMetadata(((BlockDisplay)this.handle).al(), Collections.singletonList(var10));
         }
