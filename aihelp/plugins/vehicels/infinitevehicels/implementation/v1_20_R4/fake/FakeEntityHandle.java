package implementation.v1_20_R4.fake;
...
import implementation.v1_20_R4.util.PacketWritingUtil;
...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(this.handle.dl());
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cs())));
      PacketPlayOutEntityMetadata var2 = null;
      List var3 = this.handle.ap().c();
      if (var3 != null && var3.size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.al(), var3);
      }
      ...
      PacketPlayOutMount var4 = this.passengers.size() > 0 ? this.createPassengersPacket() : null;
      if (var4 != null) {
         var1.add(var4);
      }
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.al()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.al()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.al()}), var3);
      }
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      ...
      return new PacketPlayOutRelEntityMove(this.handle.al(), var3, var4, var5, this.handle.aI);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMoveLook(this.handle.al(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dF()), PacketUtil.serializeRotationAngle(this.handle.dH()), this.handle.aI);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.al(), PacketUtil.serializeRotationAngle(this.handle.dF()), PacketUtil.serializeRotationAngle(this.handle.dH()), this.handle.aI);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cs())));
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      PacketPlayOutEntityMetadata var2 = null;
      DataWatcher var3 = this.handle.ap();
      Object var4;
      if (var1) {
         var4 = this.handle.ap().c();
      } else {
         var4 = var3.b();
      }
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.al(), (List)var4);
      }
   ...
   private void modifyRot(List<c<?>> var1) {
      ...
      if (var3 instanceof Display) {
         ...
         if (!var8) {
            Vector3f var17 = new Vector3f((Vector3fc)var2.ap().a(var4));
            var17.rotateY(-var16);
            var1.add(new c(var4.a(), var4.b(), var17));
         }

         if (!var9) {
            Quaternionf var18 = new Quaternionf((Quaternionfc)var2.ap().a(var15));
