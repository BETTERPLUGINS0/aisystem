package implementation.v1_20_R4.damage;
...
public class DamageHitbox extends EntitySlime implements advancedplugins.pm2.cv.damage.DamageHitbox {
   ...
   public DamageHitbox(@NotNull World var1) {
      ...
      this.e(true);
      ((AttributeModifiable)Objects.requireNonNull(this.f(GenericAttributes.q))).a(Double.MAX_VALUE);
      super.t(Float.MAX_VALUE);
      this.setWidth(0.15F);
