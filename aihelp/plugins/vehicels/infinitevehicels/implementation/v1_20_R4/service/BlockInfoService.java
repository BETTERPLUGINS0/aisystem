package implementation.v1_20_R4.service;
...
public class BlockInfoService implements advancedplugins.pm2.cv.api.service.BlockInfoService {
   ...
   private EnumSurface getSurfaceType(World var1, BlockPosition var2, IBlockData var3, boolean var4) {
      ...
      } else if (var6 != Blocks.I && !(var6 instanceof BlockSlowSand) && var6 != Blocks.J && var6 != Blocks.L && var6 != Blocks.M && var6 != Blocks.dR && !(var6 instanceof BlockConcretePowder)) {
         if (var6 != Blocks.dN && var6 != Blocks.dP && var6 != Blocks.fw && !(var6 instanceof BlockSnow)) {
            if (!(var6 instanceof BlockIce) && var6 != Blocks.mW && var6 != Blocks.iC && var6 != Blocks.sC && var6 != Blocks.sA && !(var6 instanceof BlockWetSponge)) {
   ...
   private boolean isSlipperyWhenRaining(Block var1) {
      return this.isGlass(var1) || var1 == Blocks.j || var1 == Blocks.k || var1 == Blocks.kE || var1 == Blocks.sH || var1 instanceof BlockGrass || var1 instanceof BlockLongGrass || var1 instanceof BlockLeaves;
   }
   ...
   private boolean isGlass(Block var1) {
      if (!(var1 instanceof BlockStainedGlass) && !(var1 instanceof BlockStainedGlassPane) && !(var1 instanceof TintedGlassBlock)) {
         return var1 == Blocks.aQ || var1 == Blocks.eY;
      } else {
         return true;
      }
   }
