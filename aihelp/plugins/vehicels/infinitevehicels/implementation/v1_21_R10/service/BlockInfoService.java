package implementation.v1_21_R10.service;
...
public class BlockInfoService implements advancedplugins.pm2.cv.api.service.BlockInfoService {
   ...
   public EnumSurface getSurfaceTypeAt(World var1, int var2, int var3, int var4, boolean var5) {
      ...
      IBlockData var7 = ((CraftWorld)var1).getHandle().m(var6).a_(var6);
   ...
   private EnumSurface getSurfaceType(World var1, BlockPosition var2, IBlockData var3, boolean var4) {
      ...
      } else if (var6 != Blocks.L && !(var6 instanceof BlockSlowSand) && var6 != Blocks.M && var6 != Blocks.O && var6 != Blocks.P && var6 != Blocks.eu && !(var6 instanceof BlockConcretePowder)) {
         if (var6 != Blocks.ep && var6 != Blocks.er && var6 != Blocks.gl && !(var6 instanceof BlockSnow)) {
            if (!(var6 instanceof BlockIce) && var6 != Blocks.nT && var6 != Blocks.ju && var6 != Blocks.ub && var6 != Blocks.tX && !(var6 instanceof BlockWetSponge)) {
               if (var6 != Blocks.J && var6 != Blocks.gj) {
                  if (var6 != Blocks.K && var6 != Blocks.gk) {
                     if (!(var6 instanceof BlockPressurePlateAbstract) && !(var6 instanceof CarpetBlock)) {
                        VoxelShape var8 = var3.g(var5, var2);
                        return !var8.c() ? EnumSurface.SOLID : EnumSurface.UNKNOWN;
                     } else {
   ...
   private boolean isSlipperyWhenRaining(Block var1) {
      return this.isGlass(var1) || var1 == Blocks.j || var1 == Blocks.k || var1 == Blocks.lA || var1 == Blocks.ug || var1 instanceof BlockGrass || var1 instanceof BlockLongGrass || var1 instanceof BlockLeaves;
   }

   private boolean isGlass(Block var1) {
      if (!(var1 instanceof BlockStainedGlass) && !(var1 instanceof BlockStainedGlassPane) && !(var1 instanceof TintedGlassBlock)) {
         return var1 == Blocks.aX || var1 == Blocks.fG;
      } else {
         return true;
      }
   }
