...
import org.bukkit.craftbukkit.v1_21_R7.entity.CraftDisplay;
...
public abstract class FakeDisplayHandle<D extends Display> extends FakeEntityHandle<D, EnumDisplayProperty> implements advancedplugins.pm2.cv.fake.display.FakeDisplayHandle {
   ...
   public void applyProperty(@NotNull EnumDisplayProperty var1, @NotNull Object var2) {
      switch(var1) {
      case VISIBILITY:
         ((Display)this.handle).l(!(Boolean)var2);
         break;
      case GLOWING:
         ((Display)this.handle).k((Boolean)var2);
         break;
      case GLOWING_COLOR:
      ...
      case TRANSFORM_INTERPOLATION_DURATION:
         ...
         break;
      case VIEW_RANGE:
         ((Display)this.handle).b((Float)var2);
         break;
      case LEFT_ROTATION:
         ((Display)this.handle).a(new Transformation((Vector3fc)null, (Quaternionf)var2, (Vector3fc)null, (Quaternionfc)null));
         break;
      case TRANSFORMATION:
