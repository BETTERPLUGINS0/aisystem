...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(this.handle.S());
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cm())));
      PacketPlayOutEntityMetadata var2 = null;
      List var3 = this.handle.aj().c();
      if (var3 != null && var3.size() > 0) {
         PacketDataSerializer var4 = new PacketDataSerializer(Unpooled.buffer());
         var4.d(this.handle.af());
         this.packData(var3, var4);
         var2 = new PacketPlayOutEntityMetadata(var4);
      }
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.af()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.af()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.af()}), var3);
      }
   ...
   protected Packet<?> prepareLocationPacket(boolean var1, boolean var2) {
      ...
      if (!var1 && this.lastLocationSent != null && !(this.lastLocationSent.f(var4) > 8.0D)) {
         if (var2) {
            ...
            var3 = this.createRelativePosPacket(var4, this.lastLocationSent);
         }
      } else {
         var3 = new PacketPlayOutEntityTeleport(this.handle);
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      short var3 = (short)((int)PacketUtil.serializeDeltaLocation(var1.c, var2.c));
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMove(this.handle.af(), var3, var4, var5, this.handle.aJ);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMoveLook(this.handle.af(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dy()), PacketUtil.serializeRotationAngle(this.handle.dA()), this.handle.aJ);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.af(), PacketUtil.serializeRotationAngle(this.handle.dy()), PacketUtil.serializeRotationAngle(this.handle.dA()), this.handle.aJ);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.cm())));
   }
   ...
   protected PacketPlayOutMount createPassengersPacket() {
      ...
      var1.d(this.getId());
      var1.a(var2.toArray());
      return new PacketPlayOutMount(var1);
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      PacketPlayOutEntityMetadata var2 = null;
      DataWatcher var3 = this.handle.aj();
      Object var4;
      if (var1) {
         var4 = this.handle.aj().c();
      } else {
         var4 = var3.b();
      }
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.af(), (List)var4);
      }

      return var2;
   }

   private void modifyRot(List<b<?>> var1) {
      Entity var3 = this.handle;
      if (var3 instanceof Display) {
         Display var2 = (Display)var3;
         DataWatcherObject var14 = (DataWatcherObject)ReflectionUtil.getStaticField(Display.class, "DATA_LEFT_ROTATION_ID", "t");
         DataWatcherObject var4 = (DataWatcherObject)ReflectionUtil.getStaticField(Display.class, "DATA_TRANSLATION_ID", "r");
         DataWatcherObject var5 = (DataWatcherObject)ReflectionUtil.getStaticField(Display.class, "DATA_INTERPOLATION_DURATION_ID", "q");
         DataWatcherObject var6 = (DataWatcherObject)ReflectionUtil.getStaticField(Display.class, "DATA_INTERPOLATION_START_DELTA_TICKS_ID", "p");
         float var7 = this.handle.getBukkitYaw() * 0.017453292F;
         boolean var8 = false;
         boolean var9 = false;
         boolean var10 = false;
         if (var14 != null && var4 != null && var5 != null && var6 != null) {
            for(int var11 = 0; var11 < var1.size(); ++var11) {
               b var12 = (b)var1.get(var11);
               if (var12.a() == var5.a()) {
                  var10 = true;
               } else if (var12.a() == var4.a()) {
                  Vector3f var13 = new Vector3f((Vector3f)var12.c());
                  var13.rotateY(-var7);
                  var1.set(var11, new b(var12.a(), var12.b(), var13));
                  var8 = true;
               } else if (var12.a() == var14.a()) {
                  Quaternionf var17 = new Quaternionf((Quaternionf)var12.c());
                  var17 = (new Quaternionf()).rotateY(-var7).mul(var17);
                  var1.set(var11, new b(var12.a(), var12.b(), var17));
                  var9 = true;
               }
            }

            if (!var10) {
               var1.add(new b(var5.a(), var5.b(), 3));
               var1.add(new b(var6.a(), var6.b(), 0));
            }

            if (!var8) {
               Vector3f var15 = new Vector3f((Vector3fc)var2.aj().b(var4));
               var15.rotateY(-var7);
               var1.add(new b(var4.a(), var4.b(), var15));
            }

            if (!var9) {
               Quaternionf var16 = new Quaternionf((Quaternionfc)var2.aj().b(var14));
               var16 = (new Quaternionf()).rotateY(-var7).mul(var16);
               var1.add(new b(var14.a(), var14.b(), var16));
            }
   ...
   protected void packData(List<b<?>> var1, PacketDataSerializer var2) {
      Iterator var3 = var1.iterator();
