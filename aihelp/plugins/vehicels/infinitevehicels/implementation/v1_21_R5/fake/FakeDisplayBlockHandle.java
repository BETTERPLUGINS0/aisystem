...
public class FakeDisplayBlockHandle extends FakeDisplayHandle<BlockDisplay> implements advancedplugins.pm2.cv.fake.display.FakeDisplayBlockHandle {
   ...
   protected BlockDisplay createHandleInstance(@NotNull World var1) {
      return (BlockDisplay)EntityType.BLOCK_DISPLAY.create(((CraftWorld)var1).getHandle(), EntitySpawnReason.COMMAND);
   }

   public void applyProperty(@NotNull EnumDisplayProperty var1, @NotNull Object var2) {
      super.applyProperty(var1, var2);
      if (var1 == EnumDisplayProperty.BLOCK_DATA) {
         ((BlockDisplay)this.handle).setBlockState(((CraftBlockData)var2).getState());
      }
      ...
      try {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (EntityDataAccessor.class.isAssignableFrom(var7.getType())) {
               ...
               if (Objects.equals(var8.serializer(), EntityDataSerializers.BLOCK_STATE)) {
                  var3 = var8;
                  break;
               }
            }
         ...
         if (var3 != null) {
            DataValue var10;
            if (var1) {
               var10 = DataValue.create(var3, Blocks.AIR.defaultBlockState());
            } else {
               var10 = DataValue.create(var3, ((BlockDisplay)this.handle).getBlockState());
            }

            return new ClientboundSetEntityDataPacket(((BlockDisplay)this.handle).getId(), Collections.singletonList(var10));
         }
