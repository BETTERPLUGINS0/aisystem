package implementation.v1_21_R5.service;
   ...
   public PacketWrapper read(@NotNull Object var1) {
      if (var1 instanceof ClientboundSetPassengersPacket) {
         ...
         if (var1 instanceof ServerboundInteractPacket) {
            ...
            String var8;
            try {
               ServerboundInteractPacket var9 = (ServerboundInteractPacket)var1;
               Field var10 = var9.getClass().getDeclaredField("action");
               var10.setAccessible(true);
               Object var11 = var10.get(var2);
               Method var12 = var11.getClass().getDeclaredMethod("getType");
               var12.setAccessible(true);
               var8 = String.valueOf(var12.invoke(var11));
            } catch (NoSuchFieldException | InvocationTargetException | NoSuchMethodException | IllegalAccessException var22) {
            ...
            if (var8.equalsIgnoreCase("INTERACT_AT")) {
               Vec3 var38 = (Vec3)this.object(var2, "net.minecraft.network.protocol.game.ServerboundInteractPacket$InteractionAtLocationAction", "action", "location");
               InteractionHand var42 = (InteractionHand)this.object(var2, "net.minecraft.network.protocol.game.ServerboundInteractPacket$InteractionAtLocationAction", "action", "hand");
