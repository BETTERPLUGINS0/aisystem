...
public class BlockInfoService implements advancedplugins.pm2.cv.api.service.BlockInfoService {
   ...
   private EnumSurface getSurfaceType(World var1, BlockPosition var2, IBlockData var3, boolean var4) {
      ...
      } else if (!(var6 instanceof BlockSand) && !(var6 instanceof BlockSlowSand) && var6 != Blocks.J && !(var6 instanceof BlockGravel) && var6 != Blocks.dQ && !(var6 instanceof BlockConcretePowder)) {
         if (var6 != Blocks.dM && var6 != Blocks.dO && var6 != Blocks.fv && !(var6 instanceof BlockSnow)) {
            if (!(var6 instanceof BlockIce) && var6 != Blocks.mS && var6 != Blocks.iB && var6 != Blocks.rw && var6 != Blocks.ru && !(var6 instanceof BlockWetSponge)) {
               if (var6 != Blocks.G && var6 != Blocks.ft) {
                  if (var6 != Blocks.H && var6 != Blocks.fu) {
   ...
   private boolean isSlipperyWhenRaining(Block var1) {
      return var1 instanceof BlockGlass || var1 instanceof TintedGlassBlock || var1 instanceof BlockStainedGlass || var1 == Blocks.eY || var1 == Blocks.j || var1 == Blocks.k || var1 == Blocks.kB || var1 == Blocks.rB || var1 instanceof BlockGrass || var1 instanceof BlockLongGrass || var1 instanceof BlockLeaves;
   }
}
