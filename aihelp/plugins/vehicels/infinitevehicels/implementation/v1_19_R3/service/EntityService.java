...
public class EntityService implements advancedplugins.pm2.cv.api.service.EntityService {
   ...
   public Entity getEntityById(int var1, World var2) {
      ...
      return var4.L.d().a(var1) != null ? ((net.minecraft.world.entity.Entity)Objects.requireNonNull((net.minecraft.world.entity.Entity)var4.L.d().a(var1))).getBukkitEntity() : null;
   }
}
