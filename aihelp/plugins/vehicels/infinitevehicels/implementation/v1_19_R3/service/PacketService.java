...
public class PacketService implements advancedplugins.pm2.cv.service.PacketService {
   ...
   private NetworkManager getNetworkManager(@NotNull PlayerConnection var1) {
      try {
         Field var2 = PlayerConnection.class.getDeclaredField("h");
   ...
   public ChannelPipeline getChannelPipeline(@NotNull Player var1) {
      return this.getNetworkManager(((CraftPlayer)var1).getHandle().b).m.pipeline();
   }
   ...
   public void sendPacket(@NotNull Player var1, @NotNull Object var2, boolean var3) {
      if (var3) {
         ...
         try {
            int var6 = EnumProtocol.b.a(EnumProtocolDirection.b, var4);
         ...
         this.getNetworkManager(((CraftPlayer)var1).getHandle().b).a((Packet)var2);
      }
      ...
      if (var1 instanceof PacketPlayInSteerVehicle) {
         ...
         if (var1 instanceof PacketPlayInUseEntity) {
            ...
            if (var1 instanceof PacketPlayInBlockPlace) {
               ...
               return new UseItemPacketWrapper(var20.a() == EnumHand.a ? UseItemPacketWrapper.Hand.MAIN_HAND : UseItemPacketWrapper.Hand.OFF_HAND, var20.c());
            }
            ...
            if (var1 instanceof PacketPlayInBlockDig) {
               ...
               return new PlayerActionPacketWrapper(var18.u(), var18.v(), var18.w(), var24, var26, var15.e());
            }
         }

         if (var1 instanceof PacketPlayOutEntityTeleport) {
            PacketPlayOutEntityTeleport var13 = (PacketPlayOutEntityTeleport)var1;
            return new TeleportEntityPacketWrapper(var13.a(), var13.c(), var13.d(), var13.e(), var13.f(), var13.g(), var13.h());
         } else {
            ...
            if (var1 instanceof PacketPlayOutRelEntityMove) {
               ...
               var12.a(var14);
               var4 = var14.m();
               return new UpdateEntityPositionPacketWrapper(var4, var12.a(), var12.c(), var12.d(), var12.i());
            } else if (var1 instanceof PacketPlayOutEntityLook) {
               PacketPlayOutEntityLook var11 = (PacketPlayOutEntityLook)var1;
               var14 = new PacketDataSerializer(Unpooled.buffer());
               var11.a(var14);
               var4 = var14.m();
               return new UpdateEntityRotationPacketWrapper(var4, var11.e(), var11.f(), var11.i());
               ...
               var10.a(var14);
               var4 = var14.m();
               return new UpdateEntityPositionRotationPacketWrapper(var4, var10.a(), var10.c(), var10.d(), var10.e(), var10.f(), var10.i());
            } else {
               return null;
            }
         }
   ...
   public Object createInstance(@NotNull PacketWrapper var1) {
      if (var1 instanceof PlayerInputPacketWrapper) {
         ...
         if (var1 instanceof InteractPacketWrapper) {
            ...
            var3.d(var14.entityId);
            switch(var14.action) {
            case INTERACT:
               var3.d(0);
               var3.d(var14.hand == InteractPacketWrapper.Hand.MAIN_HAND ? 0 : 1);
               break;
            case ATTACK:
               var3.d(1);
               break;
            case INTERACT_AT:
               var3.d(2);
               var3.writeFloat(((Double)Objects.requireNonNull(var14.targetX)).floatValue());
               var3.writeFloat(((Double)Objects.requireNonNull(var14.targetY)).floatValue());
               var3.writeFloat(((Double)Objects.requireNonNull(var14.targetZ)).floatValue());
               var3.d(var14.hand == InteractPacketWrapper.Hand.MAIN_HAND ? 0 : 1);
            }

            var3.writeBoolean(var14.sneaking);
            ...
            var3 = new PacketDataSerializer(Unpooled.buffer());
            var3.d(var8.entityId);
            var3.writeDouble(var8.x);
            var3.writeDouble(var8.y);
            var3.writeDouble(var8.z);
            var3.writeByte((byte)((int)((float)var8.yRot * 256.0F / 360.0F)));
            var3.writeByte((byte)((int)((float)var8.xRot * 256.0F / 360.0F)));
            var3.writeBoolean(var8.onGround);
