...
import implementation.v1_19_R3.util.PacketWritingUtil;
...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.ck())));
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      ...
      return new PacketPlayOutRelEntityMove(this.handle.af(), var3, var4, var5, this.handle.N);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMoveLook(this.handle.af(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dw()), PacketUtil.serializeRotationAngle(this.handle.dy()), this.handle.N);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.af(), PacketUtil.serializeRotationAngle(this.handle.dw()), PacketUtil.serializeRotationAngle(this.handle.dy()), this.handle.N);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.ck())));
   }
   ...
   private void modifyRot(List<b<?>> var1) {
      ...
      if (var3 instanceof Display) {
         ...
         try {
            var15 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_LEFT_ROTATION_ID", "u");
            var4 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_TRANSLATION_ID", "s");
            var5 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_INTERPOLATION_DURATION_ID", "r");
            var6 = (DataWatcherObject)ReflectionUtil.getField(Display.class, "DATA_INTERPOLATION_START_DELTA_TICKS_ID", "q");
         ...
         for(int var11 = 0; var11 < var1.size(); ++var11) {
            ...
            if (var12.a() == var5.a()) {
               ...
               Quaternionf var18 = new Quaternionf((Quaternionf)var12.c());
               var18 = (new Quaternionf()).rotateY(-var7).mul(var18);
               var1.set(var11, new b(var12.a(), var12.b(), var18));
               var9 = true;
            }
         }
         ...
         if (!var8) {
            Vector3f var16 = new Vector3f((Vector3fc)var2.aj().a(var4));
            var16.rotateY(-var7);
            var1.add(new b(var4.a(), var4.b(), var16));
         }

         if (!var9) {
            Quaternionf var17 = new Quaternionf((Quaternionfc)var2.aj().a(var15));
            var17 = (new Quaternionf()).rotateY(-var7).mul(var17);
            var1.add(new b(var15.a(), var15.b(), var17));
         }
