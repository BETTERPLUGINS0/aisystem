package implementation.v1_19_R3.locator;
...
public class ArmorStandLocator extends advancedplugins.pm2.cv.locator.ArmorStandLocator {
   ...
   private Set<ChannelPipeline> process(EntityArmorStand var1, boolean var2, double var3, double var5, double var7, @Nullable Float var9, @Nullable Float var10, int var11) {
      advancedplugins.pm2.cv.locator.ArmorStandLocator.Entry var12 = this.getEntry(var1.af());
   ...
   private Packet<?> buildLocationPacket(@NotNull EntityArmorStand var1, double var2, double var4, double var6, @Nullable Float var8, @Nullable Float var9, int var10) {
      advancedplugins.pm2.cv.locator.ArmorStandLocator.Entry var11 = this.getEntry(var1.af());
      Object var12;
      if (!var11.shouldTeleport() && !this.isFlagPresent(var10, 8)) {
         if (var8 != null && var9 != null) {
            var12 = new PacketPlayOutRelEntityMoveLook(var1.af(), (short)((int)PacketUtil.serializeDeltaLocation(var2, var11.getLastXSent())), (short)((int)PacketUtil.serializeDeltaLocation(var4, var11.getLastYSent())), (short)((int)PacketUtil.serializeDeltaLocation(var6, var11.getLastZSent())), PacketUtil.serializeRotationAngle(var8), PacketUtil.serializeRotationAngle(var9), var1.N);
         } else {
            var12 = new PacketPlayOutRelEntityMove(var1.af(), (short)((int)PacketUtil.serializeDeltaLocation(var2, var11.getLastXSent())), (short)((int)PacketUtil.serializeDeltaLocation(var4, var11.getLastYSent())), (short)((int)PacketUtil.serializeDeltaLocation(var6, var11.getLastZSent())), var1.N);
         }
      } else {
         var11.teleported();
         PacketDataSerializer var13 = new PacketDataSerializer(Unpooled.buffer());
         var13.d(var1.af());
         var13.writeDouble(var2);
         var13.writeDouble(var4);
         var13.writeDouble(var6);
         var13.writeByte(PacketUtil.serializeRotationAngle(var1.dw()));
         var13.writeByte(PacketUtil.serializeRotationAngle(var1.dy()));
         var13.writeBoolean(var1.N);
