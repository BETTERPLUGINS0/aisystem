package implementation.v1_21_R4.service;
...
public class BlockInfoService implements advancedplugins.pm2.cv.api.service.BlockInfoService {
   ...
   private EnumSurface getSurfaceType(World var1, BlockPosition var2, IBlockData var3, boolean var4) {
      ...
      } else if (var6 != Blocks.L && !(var6 instanceof BlockSlowSand) && var6 != Blocks.M && var6 != Blocks.O && var6 != Blocks.P && var6 != Blocks.ei && !(var6 instanceof BlockConcretePowder)) {
         if (var6 != Blocks.ed && var6 != Blocks.ef && var6 != Blocks.fV && !(var6 instanceof BlockSnow)) {
            if (!(var6 instanceof BlockIce) && var6 != Blocks.nC && var6 != Blocks.je && var6 != Blocks.tm && var6 != Blocks.ti && !(var6 instanceof BlockWetSponge)) {
               if (var6 != Blocks.J && var6 != Blocks.fT) {
                  if (var6 != Blocks.K && var6 != Blocks.fU) {
   ...
   private boolean isSlipperyWhenRaining(Block var1) {
      return this.isGlass(var1) || var1 == Blocks.j || var1 == Blocks.k || var1 == Blocks.lk || var1 == Blocks.tr || var1 instanceof BlockGrass || var1 instanceof BlockLongGrass || var1 instanceof BlockLeaves;
   }
   ...
   private boolean isGlass(Block var1) {
      if (!(var1 instanceof BlockStainedGlass) && !(var1 instanceof BlockStainedGlassPane) && !(var1 instanceof TintedGlassBlock)) {
         return var1 == Blocks.aX || var1 == Blocks.fq;
      } else {
         return true;
      }
   }
