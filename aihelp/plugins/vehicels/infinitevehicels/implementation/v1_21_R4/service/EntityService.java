...
public class EntityService implements advancedplugins.pm2.cv.api.service.EntityService {
   public void addPassenger(Entity var1, Entity var2) {
      ...
      if (var4 instanceof CraftPlayer) {
         ...
         var5.j(var8);
         var8.f.a(new PositionMoveRotation(var8.dt(), Vec3D.c, 0.0F, 0.0F), Relative.k);
         var8.f.b(new PacketPlayOutMount(var5));
      }
   ...
   public Entity getEntityById(int var1, World var2) {
      ...
      return var4.O.d().a(var1) != null ? ((net.minecraft.world.entity.Entity)Objects.requireNonNull((net.minecraft.world.entity.Entity)var4.O.d().a(var1))).getBukkitEntity() : null;
   }
}
