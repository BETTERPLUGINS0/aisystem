...
public class FakeDisplayTextHandle extends FakeDisplayHandle<TextDisplay> implements advancedplugins.pm2.cv.fake.display.FakeDisplayTextHandle {
   ...
   protected TextDisplay createHandleInstance(@NotNull World var1) {
      return (TextDisplay)EntityType.TEXT_DISPLAY.create(((CraftWorld)var1).getHandle(), EntitySpawnReason.COMMAND);
   }
   ...
   public void applyProperty(@NotNull EnumDisplayProperty var1, @NotNull Object var2) {
      ...
      switch(var1) {
      case TEXT:
         ((TextDisplay)this.handle).setText(CraftChatMessage.fromString((String)var2, true)[0]);
         break;
      case TEXT_LINE_WIDTH:
         ((TextDisplay)this.handle).getEntityData().set(TextDisplay.DATA_LINE_WIDTH_ID, (Integer)var2);
         break;
      case TEXT_OPACITY:
         ((TextDisplay)this.handle).setTextOpacity((Byte)var2);
         break;
      case TEXT_SHADOWED:
