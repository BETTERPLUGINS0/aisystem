package implementation.v1_21_R1.damage;
...
public class DamageHitbox extends EntitySlime implements advancedplugins.pm2.cv.damage.DamageHitbox {
   ...
   public DamageHitbox(@NotNull World var1) {
      super(EntityTypes.aP, ((CraftWorld)var1).getHandle());
      ...
      this.e(true);
      ((AttributeModifiable)Objects.requireNonNull(this.f(GenericAttributes.s))).a(Double.MAX_VALUE);
      super.v(Float.MAX_VALUE);
      this.setWidth(0.15F);
