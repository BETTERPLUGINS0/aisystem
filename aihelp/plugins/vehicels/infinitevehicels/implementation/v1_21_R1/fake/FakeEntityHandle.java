package implementation.v1_21_R1.fake;
...
public abstract class FakeEntityHandle<T extends Entity, P extends Enum<P>> implements advancedplugins.pm2.cv.fake.FakeEntityHandle<P> {
   ...
   protected List<Packet<?>> createShowPackets() {
      ...
      var1.add(new PacketPlayOutSpawnEntity(var2.an(), var2.cz(), var2.dt(), var2.dv(), var2.dz(), var2.dG(), var2.dE(), var2.am(), 0, var2.dr(), (double)var2.ct()));
      var1.add(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.ct())));
      PacketPlayOutEntityMetadata var3 = null;
      List var4 = this.handle.ar().c();
      if (var4 != null && var4.size() > 0) {
         var3 = new PacketPlayOutEntityMetadata(this.handle.an(), var4);
      }
   ...
   public void hide(@NotNull Collection<? extends Player> var1, boolean var2) {
      PacketPlayOutEntityDestroy var3 = new PacketPlayOutEntityDestroy(new int[]{this.handle.an()});
   ...
   public void hide() {
      PacketPlayOutEntityDestroy var1 = new PacketPlayOutEntityDestroy(new int[]{this.handle.an()});
   ...
   public void writeHidePackets(@NotNull PlayerWrapper var1, boolean var2) {
      ...
      ChannelPipeline var3 = var1.getPipeline();
      if (var3 != null) {
         PacketWritingUtil.compressAndWriteToPipeline(new PacketPlayOutEntityDestroy(new int[]{this.handle.an()}), var3);
      }
   ...
   protected PacketPlayOutRelEntityMove createRelativePosPacket(Vec3D var1, Vec3D var2) {
      ...
      return new PacketPlayOutRelEntityMove(this.handle.an(), var3, var4, var5, this.handle.aG);
   }
   ...
   protected PacketPlayOutRelEntityMoveLook createRelativePosRotPacket(Vec3D var1, Vec3D var2) {
      ...
      short var4 = (short)((int)PacketUtil.serializeDeltaLocation(var1.d, var2.d));
      short var5 = (short)((int)PacketUtil.serializeDeltaLocation(var1.e, var2.e));
      return new PacketPlayOutRelEntityMoveLook(this.handle.an(), var3, var4, var5, PacketUtil.serializeRotationAngle(this.handle.dE()), PacketUtil.serializeRotationAngle(this.handle.dG()), this.handle.aG);
   }
   ...
   protected PacketPlayOutEntity prepareRotationPacket() {
      return new PacketPlayOutEntityLook(this.handle.an(), PacketUtil.serializeRotationAngle(this.handle.dE()), PacketUtil.serializeRotationAngle(this.handle.dG()), this.handle.aG);
   }

   public void sendHeadRotation() {
      this.broadcastPacketToViewers(new PacketPlayOutEntityHeadRotation(this.handle, PacketUtil.serializeRotationAngle(this.handle.ct())));
   }
   ...
   protected PacketPlayOutEntityMetadata prepareMetadataPacket(boolean var1) {
      ...
      if (var4 != null && ((List)var4).size() > 0) {
         var2 = new PacketPlayOutEntityMetadata(this.handle.an(), (List)var4);
      }
