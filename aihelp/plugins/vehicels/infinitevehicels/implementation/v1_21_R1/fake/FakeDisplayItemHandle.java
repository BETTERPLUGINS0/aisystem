...
public class FakeDisplayItemHandle extends FakeDisplayHandle<ItemDisplay> implements advancedplugins.pm2.cv.fake.display.FakeDisplayItemHandle {
   ...
   protected ItemDisplay createHandleInstance(@NotNull World var1) {
      return (ItemDisplay)EntityTypes.ah.a(((CraftWorld)var1).getHandle());
   }
   ...
   private ItemDisplayContext toDisplayContext(EnumItemDisplaySlot var1) {
      ...
      switch(var1) {
      case NONE:
         var10000 = ItemDisplayContext.a;
         break;
      case THIRD_PERSON_LEFT_HAND:
         var10000 = ItemDisplayContext.b;
         break;
      case THIRD_PERSON_RIGHT_HAND:
         var10000 = ItemDisplayContext.c;
         break;
      case FIRST_PERSON_LEFT_HAND:
         var10000 = ItemDisplayContext.d;
         break;
      case FIRST_PERSON_RIGHT_HAND:
         var10000 = ItemDisplayContext.e;
         break;
      case HEAD:
         var10000 = ItemDisplayContext.f;
         break;
      case GUI:
         var10000 = ItemDisplayContext.g;
         break;
      case GROUND:
         var10000 = ItemDisplayContext.h;
         break;
      case FIXED:
         var10000 = ItemDisplayContext.i;
         break;
      default:
   ...
   private Packet<?> createTrickyInvisibilityPacket(boolean var1) {
      ...
      try {
         ...
         if (var3 != null) {
            c var10;
            if (var1) {
               var10 = c.a(var3, net.minecraft.world.item.ItemStack.l);
            } else {
               var10 = c.a(var3, ((ItemDisplay)this.handle).t());
            }

            return new PacketPlayOutEntityMetadata(((ItemDisplay)this.handle).an(), Collections.singletonList(var10));
         }
