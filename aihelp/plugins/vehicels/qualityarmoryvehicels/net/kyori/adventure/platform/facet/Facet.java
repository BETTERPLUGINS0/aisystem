...
public interface Facet<V> {
    @SafeVarargs
    @NotNull
    public static <V, F extends Facet<? extends V>> Collection<F> of(@NotNull Supplier<F> ... suppliers) {
    ...
    FakeEntity<V, P> {
        ...
        @Override
        default public void bossBarProgressChanged(@NotNull net.kyori.adventure.bossbar.BossBar bar, float oldProgress, float newProgress) {
            this.health(newProgress);
        }

        @Override
        default public void bossBarNameChanged(@NotNull net.kyori.adventure.bossbar.BossBar bar, @NotNull Component oldName, @NotNull Component newName) {
            this.name(newName);
        }
    ...
    Closeable {
        ...
        default public void bossBarInitialized(@NotNull net.kyori.adventure.bossbar.BossBar bar) {
    ...
    extends Facet<V> {
        public M createForSelf(V var1, @NotNull net.kyori.adventure.sound.Sound var2);

        public M createForEmitter(@NotNull net.kyori.adventure.sound.Sound var1,  @NotNull Sound.Emitter var2);
    ...
    extends Position<V, P> {
        public void playSound(@NotNull V var1, @NotNull net.kyori.adventure.sound.Sound var2, @NotNull P var3);
