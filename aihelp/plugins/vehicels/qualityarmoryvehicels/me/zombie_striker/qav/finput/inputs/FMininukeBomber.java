                ...
                public void run() {
                    ...
                    while ((double)n < Math.abs(this.val$dir.getY())) {
                        ...
                        if (bl || bl2 || this.distance < 0) {
                            ...
                            try {
                                this.val$player.getWorld().playSound(this.val$s, "warheadexplode", 10.0f, 1.5f);
                                ...
                                this.val$player.getWorld().playSound(this.val$s, Sound.valueOf((String)"EXPLODE"), 8.0f, 0.7f);
                            }
                            this.cancel();
                            return;
                        }
