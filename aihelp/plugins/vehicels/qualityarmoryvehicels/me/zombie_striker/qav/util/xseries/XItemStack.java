...
import me.zombie_striker.qav.util.xseries.XItemFlag;
import me.zombie_striker.qav.util.xseries.XMaterial;
import me.zombie_striker.qav.util.xseries.XPatternType;
import me.zombie_striker.qav.util.xseries.XPotion;
import me.zombie_striker.qav.util.xseries.XTag;
...
public final class XItemStack {
    ...
    private static <T> T getRegistryOrEnum(Class<T> clazz, Object object, String string, Object object2) {
        ...
        T t = object != null ? XItemStack.cast(((Registry)object).get(XItemStack.fromConfig(string))) : XItemStack.cast(Enums.getIfPresent((Class)XItemStack.cast(clazz), string.toUpperCase(Locale.ENGLISH)).orNull());
        if (t == null) {
            return (T)object2;
        }
        return t;
    ...
    public static void serialize(@NotNull ItemStack itemStack, @NotNull ConfigurationSection configurationSection, @NotNull Function<String, String> function) {
        ...
        while (object4.hasNext()) {
            ...
            String object22 = "enchants." + XEnchantment.of((Enchantment)object3.getKey()).name();
        ...
        if (!itemMeta.getItemFlags().isEmpty()) {
            ...
            while (iterator.hasNext()) {
                object2 = (ItemFlag)iterator.next();
        ...
        if (itemMeta instanceof BlockStateMeta) {
            ...
            for (Map.Entry entry : object4.getStoredEnchants().entrySet()) {
                object2 = "stored-enchants." + XEnchantment.of((Enchantment)entry.getKey()).name();
                configurationSection.set((String)object2, entry.getValue());
            }
        } else if (itemMeta instanceof SkullMeta) {
            object4 = XSkull.of(itemMeta).getProfileValue();
            if (object4 != null) {
    ...
    public static ItemStack edit(@NotNull ItemStack itemStack, @NotNull ConfigurationSection configurationSection, @NotNull Function<String, String> function, @Nullable Consumer<Exception> consumer) {
        ...
        if (!Strings.isNullOrEmpty(string)) {
            object7 = XMaterial.matchXMaterial(string);
            if (((Optional)object7).isPresent()) {
                object6 = (XMaterial)((Optional)object7).get();
            } else {
                materialCondition = new UnknownMaterialCondition(string);
                if (consumer == null) {
                    throw materialCondition;
                }
                consumer.accept(materialCondition);
                if (materialCondition.hasSolution()) {
                    object6 = ((UnknownMaterialCondition)materialCondition).solution;
                } else {
                    throw materialCondition;
                }
            }
            if (!object6.isSupported()) {
                materialCondition = new UnAcceptableMaterialCondition((XMaterial)object6, UnAcceptableMaterialCondition.Reason.UNSUPPORTED);
                if (consumer == null) {
                    throw materialCondition;
                }
                consumer.accept(materialCondition);
                if (materialCondition.hasSolution()) {
                    object6 = ((UnAcceptableMaterialCondition)materialCondition).solution;
                } else {
                    throw materialCondition;
                }
            }
            if (XTag.INVENTORY_NOT_DISPLAYABLE.isTagged((XMaterial)object6)) {
                materialCondition = new UnAcceptableMaterialCondition((XMaterial)object6, UnAcceptableMaterialCondition.Reason.NOT_DISPLAYABLE);
                if (consumer == null) {
                    throw materialCondition;
                }
                consumer.accept(materialCondition);
            ...
            ((XMaterial)object6).setType(itemStack);
        } else {
            object7 = configurationSection.getString("skull");
            if (object7 != null) {
                XMaterial.PLAYER_HEAD.setType(itemStack);
            }
        }
        int n2 = configurationSection.getInt("amount");
        if (n2 > 1) {
            itemStack.setAmount(n2);
        }
        object6 = (materialCondition = itemStack.getItemMeta()) == null ? Bukkit.getItemFactory().getItemMeta(XMaterial.STONE.get()) : materialCondition;
        if (XMaterial.supports(13)) {
            int n3;
            if (object6 instanceof Damageable && (n3 = configurationSection.getInt("damage")) > 0) {
                ((Damageable)object6).setDamage(n3);
            }
        } else {
        ...
        if (object6 instanceof SkullMeta) {
            String string2 = configurationSection.getString("skull");
            if (string2 != null) {
                if (string2.isEmpty()) {
                    XSkull.of((ItemMeta)object6).profile(Profileable.detect(string2)).removeProfile();
                } else {
                    XSkull.of((ItemMeta)object6).profile(Profileable.detect(string2)).lenient().apply();
                }
            }
        } else if (object6 instanceof BannerMeta) {
            BannerMeta bannerMeta = (BannerMeta)object6;
            ...
            if (object5 != null) {
                ...
                while (object422.hasNext()) {
                    ...
                    object322 = XPatternType.of(string3);
                    if (!((Optional)object322).isPresent() || !((Optional)object322).get().isSupported()) continue;
                    DyeColor dyeColor = Enums.getIfPresent(DyeColor.class, object5.getString(string3).toUpperCase(Locale.ENGLISH)).or(DyeColor.WHITE);
                    bannerMeta.addPattern(new Pattern(dyeColor, (PatternType)((XPatternType)((Optional)object322).get()).get()));
                }
            }
        } else if (object6 instanceof LeatherArmorMeta) {
            LeatherArmorMeta leatherArmorMeta = (LeatherArmorMeta)object6;
            object5 = configurationSection.getString("color");
            if (object5 != null) {
                leatherArmorMeta.setColor(XItemStack.parseColor((String)object5));
            }
        } else if (object6 instanceof PotionMeta) {
            if (XMaterial.supports(9)) {
                PotionMeta potionMeta = (PotionMeta)object6;
                ...
                if (!Strings.isNullOrEmpty((String)object5)) {
                    try {
                        object422 = PotionType.valueOf((String)object5);
                    } catch (IllegalArgumentException illegalArgumentException) {
                        object422 = PotionType.HEALING;
                    }
                    potionMeta.setBasePotionType((PotionType)object422);
                }
        ...
        } else if (object6 instanceof BlockStateMeta) {
            String string4;
            BlockStateMeta blockStateMeta = (BlockStateMeta)object6;
            ...
            if (object5 instanceof CreatureSpawner) {
                ...
                if (!Strings.isNullOrEmpty(string4)) {
                    object422.setSpawnedType(Enums.getIfPresent(EntityType.class, string4.toUpperCase(Locale.ENGLISH)).orNull());
                ...
                if (string4 != null) {
                    for (String string5 : string4.getKeys(false)) {
                        Optional<XPatternType> optional = XPatternType.of(string5);
                        if (!optional.isPresent() || !optional.get().isSupported()) continue;
                        DyeColor dyeColor = Enums.getIfPresent(DyeColor.class, string4.getString(string5).toUpperCase(Locale.ENGLISH)).or(DyeColor.WHITE);
                        object422.addPattern(new Pattern(dyeColor, (PatternType)optional.get().get()));
                    }
                    object422.update(true);
                    blockStateMeta.setBlockState((BlockState)object422);
                }
            }
        } else if (object6 instanceof FireworkMeta) {
            FireworkMeta fireworkMeta = (FireworkMeta)object6;
            ...
            if (object5 != null) {
                ...
                for (Object object322 : object5.getKeys(false)) {
                    ConfigurationSection configurationSection3 = configurationSection.getConfigurationSection("firework." + object322);
                    object422.flicker(configurationSection3.getBoolean("flicker"));
                    object422.trail(configurationSection3.getBoolean("trail"));
                    object422.with(Enums.getIfPresent(FireworkEffect.Type.class, configurationSection3.getString("type").toUpperCase(Locale.ENGLISH)).or(FireworkEffect.Type.STAR));
        ...
        } else if (object6 instanceof BookMeta) {
            BookMeta bookMeta = (BookMeta)object6;
            ...
            if (object5 != null) {
                ...
                if (XMaterial.supports(9) && (object422 = object5.getString("generation")) != null) {
                    BookMeta.Generation generation = Enums.getIfPresent(BookMeta.Generation.class, (String)object422).orNull();
                    bookMeta.setGeneration(generation);
                }
            }
        } else if (object6 instanceof MapMeta) {
            MapMeta mapMeta = (MapMeta)object6;
            ...
            if (object5 != null) {
                ...
                if (XMaterial.supports(14) && (object422 = object5.getConfigurationSection("view")) != null && (world = Bukkit.getWorld((String)object422.getString("world"))) != null) {
                    ...
                    object322.setScale(Enums.getIfPresent(MapView.Scale.class, object422.getString("scale")).or(MapView.Scale.NORMAL));
            ...
            if (XMaterial.supports(20) && object6 instanceof ArmorMeta) {
                ArmorMeta armorMeta = (ArmorMeta)object6;
            ...
            if (XMaterial.supports(17) && object6 instanceof AxolotlBucketMeta) {
                AxolotlBucketMeta axolotlBucketMeta = (AxolotlBucketMeta)object6;
                object5 = configurationSection.getString("color");
                if (object5 != null) {
                    object422 = Enums.getIfPresent(Axolotl.Variant.class, ((String)object5).toUpperCase(Locale.ENGLISH)).or(Axolotl.Variant.BLUE);
                    axolotlBucketMeta.setVariant((Axolotl.Variant)object422);
                }
            }
            if (XMaterial.supports(16) && object6 instanceof CompassMeta) {
                CompassMeta compassMeta = (CompassMeta)object6;
            ...
            if (XMaterial.supports(15) && object6 instanceof SuspiciousStewMeta) {
                SuspiciousStewMeta suspiciousStewMeta = (SuspiciousStewMeta)object6;
            ...
            if (XMaterial.supports(14)) {
                if (object6 instanceof CrossbowMeta) {
                    CrossbowMeta crossbowMeta = (CrossbowMeta)object6;
                    object5 = configurationSection.getConfigurationSection("projectiles");
                    if (object5 != null) {
                        object422 = object5.getKeys(false).iterator();
                        while (object422.hasNext()) {
                            String string7 = (String)object422.next();
                            object322 = XItemStack.deserialize(configurationSection.getConfigurationSection("projectiles." + string7));
                            crossbowMeta.addChargedProjectile((ItemStack)object322);
                        }
                    }
                } else if (object6 instanceof TropicalFishBucketMeta) {
                    TropicalFishBucketMeta tropicalFishBucketMeta = (TropicalFishBucketMeta)object6;
                    object5 = Enums.getIfPresent(DyeColor.class, configurationSection.getString("color")).or(DyeColor.WHITE);
                    object422 = Enums.getIfPresent(DyeColor.class, configurationSection.getString("pattern-color")).or(DyeColor.WHITE);
                    TropicalFish.Pattern pattern = Enums.getIfPresent(TropicalFish.Pattern.class, configurationSection.getString("pattern")).or(TropicalFish.Pattern.BETTY);
            ...
            if (!XMaterial.supports(13)) {
                if (XMaterial.supports(11)) {
                    String string8;
                    if (object6 instanceof SpawnEggMeta && !Strings.isNullOrEmpty(string8 = configurationSection.getString("creature"))) {
                        object5 = (SpawnEggMeta)object6;
                        object422 = Enums.getIfPresent(EntityType.class, string8.toUpperCase(Locale.ENGLISH));
                        if (((com.google.common.base.Optional)object422).isPresent()) {
                            object5.setSpawnedType((EntityType)((com.google.common.base.Optional)object422).get());
                        }
                    }
                } else {
                    ...
                    if (materialData instanceof SpawnEgg && !Strings.isNullOrEmpty((String)(object5 = configurationSection.getString("creature")))) {
                        ...
                        com.google.common.base.Optional<EntityType> optional = Enums.getIfPresent(EntityType.class, ((String)object5).toUpperCase(Locale.ENGLISH));
                        if (optional.isPresent()) {
                            object422.setSpawnedType(optional.get());
                        }
        ...
        String string9 = configurationSection.getString("name");
        if (!Strings.isNullOrEmpty(string9)) {
            object5 = function.apply(string9);
            object6.setDisplayName((String)object5);
        } else if (string9 != null && string9.isEmpty()) {
            object6.setDisplayName(" ");
        }
        if (XMaterial.supports(11) && configurationSection.isSet("unbreakable")) {
            object6.setUnbreakable(configurationSection.getBoolean("unbreakable"));
        }
        if (XMaterial.supports(14) && (n = configurationSection.getInt("custom-model-data")) != 0) {
            object6.setCustomModelData(Integer.valueOf(n));
        }
        if (configurationSection.isSet("lore")) {
            ...
            if (!object422.isEmpty()) {
                ...
                object8 = object422.iterator();
                while (object8.hasNext()) {
                    object322 = (String)object8.next();
                    if (((String)object322).isEmpty()) {
                        arrayList.add(" ");
                        continue;
                    }
                    for (String string3 : XItemStack.splitNewLine(object322)) {
                        if (string3.isEmpty()) {
                            arrayList.add(" ");
                            continue;
                        }
                        arrayList.add(function.apply(string3));
                    }
                }
            } else {
                object8 = configurationSection.getString("lore");
                arrayList = new ArrayList(10);
                if (!Strings.isNullOrEmpty((String)object8)) {
                    for (String string10 : XItemStack.splitNewLine((String)object8)) {
                        if (string10.isEmpty()) {
                            arrayList.add(" ");
                            continue;
                        }
                        arrayList.add(function.apply(string10));
                    }
                }
            }
            object6.setLore(arrayList);
        }
        if ((configurationSection2 = configurationSection.getConfigurationSection("enchants")) != null) {
            ...
            while (object422.hasNext()) {
                String string11 = (String)object422.next();
                object322 = XEnchantment.of(string11);
                ((Optional)object322).ifPresent(arg_0 -> XItemStack.lambda$edit$2((ItemMeta)object6, configurationSection2, string11, arg_0));
            }
        } else if (configurationSection.getBoolean("glow")) {
            object6.addEnchant(XEnchantment.UNBREAKING.getEnchant(), 1, false);
            XItemFlag.HIDE_ENCHANTS.set((ItemMeta)object6);
        }
        if ((object422 = configurationSection.getConfigurationSection("stored-enchants")) != null) {
            for (Object object322 : object422.getKeys(false)) {
                Optional<XEnchantment> optional = XEnchantment.of((String)object322);
                EnchantmentStorageMeta enchantmentStorageMeta = (EnchantmentStorageMeta)object6;
        ...
        if (!(list = configurationSection.getStringList("flags")).isEmpty()) {
            ...
            while (object322.hasNext()) {
                String string12 = (String)object322.next();
                if ((string12 = string12.toUpperCase(Locale.ENGLISH)).equals("ALL")) {
                    XItemFlag.hideEverything((ItemMeta)object6);
                    break;
                }
                XItemFlag.of(string12).ifPresent(arg_0 -> XItemStack.lambda$edit$4((ItemMeta)object6, arg_0));
            }
        } else {
        ...
        if (XMaterial.supports(13) && (object322 = configurationSection.getConfigurationSection("attributes")) != null) {
            for (String string4 : object322.getKeys(false)) {
                String string2;
                Optional<XAttribute> optional = XAttribute.of(string4);
                if (!optional.isPresent() || !optional.get().isSupported() || (object = object322.getConfigurationSection(string4)) == null) continue;
                Iterator iterator = object.getString("slot") != null ? Enums.getIfPresent(EquipmentSlot.class, object.getString("slot")).or(EquipmentSlot.HAND) : null;
                string2 = object.getString("name");
                if (string2 == null) {
                    string2 = UUID.randomUUID().toString().toLowerCase(Locale.ENGLISH);
                }
                AttributeModifier attributeModifier = XAttribute.createModifier(string2, object.getDouble("amount"), Enums.getIfPresent(AttributeModifier.Operation.class, object.getString("operation")).or(AttributeModifier.Operation.ADD_NUMBER), iterator);
                object6.addAttributeModifier((Attribute)optional.get().get(), attributeModifier);
            }
        }
        if (!object6.getItemFlags().isEmpty() && XReflection.supports(1, 20, 6) && !object6.hasAttributeModifiers()) {
            object6.addAttributeModifier((Attribute)XAttribute.ATTACK_DAMAGE.get(), XAttribute.createModifier("xseries:itemflagdummy", 0.0, AttributeModifier.Operation.MULTIPLY_SCALAR_1, null));
        }
        itemStack.setItemMeta((ItemMeta)object6);
        return itemStack;
    }
    ...
    public static List<ItemStack> giveOrDrop(@NotNull Player player, @Nullable ItemStack ... itemStackArray) {
        return XItemStack.giveOrDrop(player, true, itemStackArray);
    }

    @NotNull
    @Contract(mutates="param1")
    public static List<ItemStack> giveOrDrop(@NotNull Player player, boolean bl, @Nullable ItemStack ... itemStackArray) {
    ...
    @Contract(mutates="param1")
    public static List<ItemStack> addItems(@NotNull Inventory inventory, boolean bl, @NotNull ItemStack ... itemStackArray) {
        return XItemStack.addItems(inventory, bl, null, itemStackArray);
    }

    @NotNull
    @Contract(mutates="param1")
    public static List<ItemStack> addItems(@NotNull Inventory inventory, boolean bl, @Nullable Predicate<Integer> predicate, @NotNull ItemStack ... itemStackArray) {
        ...
        int n = XItemStack.getStorageContents(inventory).length;
        int n2 = 0;
    ...
    @NotNull
    @Contract(pure=true)
    public static @Range(from=-1L, to=0x7FFFFFFFL) int firstPartial(@NotNull Inventory inventory, @Nullable ItemStack itemStack, int n) {
        return XItemStack.firstPartial(inventory, itemStack, n, null);
    }

    @NotNull
    @Contract(pure=true)
    public static @Range(from=-1L, to=0x7FFFFFFFL) int firstPartial(@NotNull Inventory inventory, @Nullable ItemStack itemStack, int n, @Nullable Predicate<Integer> predicate) {
        if (itemStack != null) {
            ItemStack[] itemStackArray = XItemStack.getStorageContents(inventory);
    ...
    @Contract(pure=true)
    public static @Range(from=-1L, to=0x7FFFFFFFL) int firstEmpty(@NotNull Inventory inventory, int n) {
        return XItemStack.firstEmpty(inventory, n, null);
    }

    @Contract(pure=true)
    public static @Range(from=-1L, to=0x7FFFFFFFL) int firstEmpty(@NotNull Inventory inventory, int n, @Nullable Predicate<Integer> predicate) {
        ItemStack[] itemStackArray = XItemStack.getStorageContents(inventory);
        int n2 = itemStackArray.length;
        if (n < 0 || n >= n2) {
            throw new IndexOutOfBoundsException("Begin Index: " + n + ", Inventory storage content size: " + n2);
    ...
    @Contract(pure=true)
    public static @Range(from=-1L, to=0x7FFFFFFFL) int firstPartialOrEmpty(@NotNull Inventory inventory, @Nullable ItemStack itemStack, int n) {
        if (itemStack != null) {
            ItemStack[] itemStackArray = XItemStack.getStorageContents(inventory);
            int n2 = itemStackArray.length;
            if (n < 0 || n >= n2) {
    ...
    public static boolean notEmpty(@Nullable ItemStack itemStack) {
        return !XItemStack.isEmpty(itemStack);
    }
    ...
    private static /* synthetic */ void lambda$edit$4(ItemMeta itemMeta, XItemFlag xItemFlag) {
        xItemFlag.set(itemMeta);
    }
    ...
    static {
        ...
        SUPPORTS_Inventory_getStorageContents = bl2;
        bl = false;
        try {
