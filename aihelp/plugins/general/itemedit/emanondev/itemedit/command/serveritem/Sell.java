...
public class Sell extends SubCmd {
   ...
   public void onCommand(@NotNull CommandSender sender, @NotNull String alias, String[] args) {
      try {
         ...
         if (given == 0) {
            if (!silent) {
               this.sendLanguageString("not-enough-space", (String)null, target, new String[]{"%id%", args[1].toLowerCase(), "%nick%", ItemEdit.get().getServerStorage().getNick(args[1]), "%amount%", String.valueOf(amount)});
            }
