...
public class NautilusShop extends SKLivingShopObject<Tameable> {
   ...
   public NautilusShop(BaseEntityShopObjectCreationContext context, BaseEntityShopObjectType<NautilusShop> shopObjectType, AbstractShopkeeper shopkeeper, @Nullable ShopCreationData creationData) {
      super(context, shopObjectType, shopkeeper, creationData);
      PropertyValue var10001 = new PropertyValue(SADDLE);
      NautilusShop var10002 = (NautilusShop)Unsafe.initialized(this);
      ...
      var10002 = (NautilusShop)Unsafe.initialized(this);
      Objects.requireNonNull(var10002);
   ...
   private Button getSaddleEditorButton() {
      return new ShopkeeperActionButton() {
         ...
         public ItemStack getIcon(EditorView editorView) {
            return NautilusShop.this.getSaddleEditorItem();
         }

         protected boolean runAction(EditorView editorView, InventoryClickEvent clickEvent) {
            NautilusShop.this.cycleSaddle();
            return true;
         }
      };
   }
   ...
   private Button getArmorEditorButton() {
      return new ShopkeeperActionButton() {
         @Nullable
         public ItemStack getIcon(EditorView editorView) {
            return NautilusShop.this.getArmorEditorItem();
         }

         protected boolean runAction(EditorView editorView, InventoryClickEvent clickEvent) {
            boolean backwards = clickEvent.isRightClick();
            NautilusShop.this.cycleArmor(backwards);
            return true;
         }
      };
   }
