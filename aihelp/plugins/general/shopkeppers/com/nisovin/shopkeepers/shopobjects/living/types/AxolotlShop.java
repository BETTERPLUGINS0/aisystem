...
public class AxolotlShop extends BabyableShop<Axolotl> {
   ...
   public AxolotlShop(BaseEntityShopObjectCreationContext context, BaseEntityShopObjectType<AxolotlShop> shopObjectType, AbstractShopkeeper shopkeeper, @Nullable ShopCreationData creationData) {
      super(context, shopObjectType, shopkeeper, creationData);
      PropertyValue var10001 = new PropertyValue(VARIANT);
      AxolotlShop var10002 = (AxolotlShop)Unsafe.initialized(this);
   ...
   private void applyVariant() {
      Axolotl entity = (Axolotl)this.getEntity();
      if (entity != null) {
   ...
   private Button getVariantEditorButton() {
      return new ShopkeeperActionButton() {
         ...
         protected boolean runAction(EditorView editorView, InventoryClickEvent clickEvent) {
            ...
            AxolotlShop.this.cycleVariant(backwards);
            return true;
         }
      };
   }
   ...
   static {
      VARIANT = (new BasicProperty()).dataKeyAccessor("axolotlVariant", EnumSerializers.lenient(Variant.class)).defaultValue(Variant.LUCY).build();
   }
}
