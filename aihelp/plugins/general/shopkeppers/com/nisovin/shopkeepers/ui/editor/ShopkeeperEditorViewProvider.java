...
public abstract class ShopkeeperEditorViewProvider extends AbstractEditorViewProvider implements ShopkeeperViewProvider {
   protected ShopkeeperEditorViewProvider(AbstractUIType uiType, AbstractShopkeeper shopkeeper, TradingRecipesAdapter tradingRecipesAdapter) {
   ...
   protected void setupButtons() {
      super.setupButtons();
      ShopkeeperEditorLayout layout = (ShopkeeperEditorLayout)this.getLayout();
