...
public class PlayerByUUIDArgument extends ObjectByIdArgument<UUID, Player> {
   ...
   public PlayerByUUIDArgument(String name, ArgumentFilter<? super Player> filter, int minimumCompletionInput) {
   ...
   protected ObjectIdArgument<UUID> createIdArgument(String name, ObjectByIdArgument.IdArgumentArgs args) {
      return new PlayerUUIDArgument(name, ArgumentFilter.acceptAny(), args.minimumCompletionInput) {
         protected Iterable<? extends UUID> getCompletionSuggestions(CommandInput input, CommandContextView context, String idPrefix) {
            return PlayerByUUIDArgument.this.getCompletionSuggestions(input, context, this.minimumCompletionInput, idPrefix);
         }
      };
   }
