...
public class WrapperPlayServerNamedSoundEffect extends AbstractPacket {
   ...
   public double getEffectPositionX() {
      return (double)(Integer)this.handle.getIntegers().read(0) / 8.0D;
   }

   public void setEffectPositionX(double value) {
      this.handle.getIntegers().write(0, (int)(value * 8.0D));
   }

   public double getEffectPositionY() {
      return (double)(Integer)this.handle.getIntegers().read(1) / 8.0D;
   }

   public void setEffectPositionY(double value) {
      this.handle.getIntegers().write(1, (int)(value * 8.0D));
   }

   public double getEffectPositionZ() {
      return (double)(Integer)this.handle.getIntegers().read(2) / 8.0D;
   }

   public void setEffectPositionZ(double value) {
      this.handle.getIntegers().write(2, (int)(value * 8.0D));
   }
   ...
   public float getPitch() {
      return (float)(Integer)this.handle.getIntegers().read(3) / 63.0F;
   }

   public void setPitch(float value) {
      this.handle.getIntegers().write(3, (int)(value * 63.0F));
   }
   ...
   public static class NamedSoundEffects {
      ...
      public static String[] values() {
         if (values == null) {
            ...
            Field[] var1 = WrapperPlayServerNamedSoundEffect.NamedSoundEffects.class.getFields();
            ...
            for(int var3 = 0; var3 < var2; ++var3) {
               ...
               try {
                  result.add((String)field.get((Object)null));
               } catch (Exception var6) {
                  throw new RuntimeException("Cannot read field.", var6);
               }
            }
