...
public class Chat_DroxPerms extends Chat {
   ...
   public Chat_DroxPerms(Plugin plugin, Permission perms) {
      ...
      if (this.API == null) {
         ...
         if (p != null) {
            this.API = p.getAPI();
            this.log.info(String.format("[%s][Chat] %s hooked.", plugin.getDescription().getName(), "DroxPerms"));
         }
      }

      Bukkit.getServer().getPluginManager().registerEvents(new Chat_DroxPerms.PermissionServerListener(), plugin);
   }
      ...
      public void onPluginEnable(PluginEnableEvent event) {
         if (Chat_DroxPerms.this.API == null) {
            ...
            if (permPlugin.getDescription().getName().equals("DroxPerms")) {
               ...
               Chat_DroxPerms.this.log.info(String.format("[%s][Chat] %s hooked.", Chat_DroxPerms.this.plugin.getDescription().getName(), "DroxPerms"));
            }
         }
