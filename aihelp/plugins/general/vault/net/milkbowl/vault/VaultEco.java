...
public class VaultEco implements Method {
   ...
   public MethodAccount getAccount(String name) {
      return !this.hasAccount(name) ? null : new VaultEco.VaultAccount(name, this.economy);
   }

   public MethodBankAccount getBankAccount(String bank, String name) {
      return !this.hasBankAccount(bank, name) ? null : new VaultEco.VaultBankAccount(bank, this.economy);
   }
   ...
   public class VaultBankAccount implements MethodBankAccount {
      ...
      public boolean set(double amount) {
         if (!this.economy.bankWithdraw(this.bank, this.balance()).transactionSuccess()) {
            ...
            return amount == 0.0D ? true : this.economy.bankDeposit(this.bank, amount).transactionSuccess();
         }
      }
   ...
   public class VaultAccount implements MethodAccount {
      ...
      public boolean set(double amount) {
         if (!this.economy.withdrawPlayer(this.name, this.balance()).transactionSuccess()) {
            ...
            return amount == 0.0D ? true : this.economy.depositPlayer(this.name, amount).transactionSuccess();
         }
      }
