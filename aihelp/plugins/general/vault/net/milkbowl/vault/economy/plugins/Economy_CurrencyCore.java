...
public class Economy_CurrencyCore extends AbstractEconomy {
   ...
   public Economy_CurrencyCore(Plugin plugin) {
      ...
      Bukkit.getServer().getPluginManager().registerEvents(new Economy_CurrencyCore.EconomyServerListener(this), plugin);
      if (this.currency == null) {
         ...
         if (currencyPlugin != null && currencyPlugin.getClass().getName().equals("is.currency.Currency")) {
            ...
            this.log.info(String.format("[Economy] %s hooked.", "CurrencyCore"));
         }
      }
   ...
   public double getBalance(String playerName) {
      ...
      return account == null ? 0.0D : account.getBalance();
   }
   ...
   public EconomyResponse createBank(String name, String player) {
      if (this.currency.getAccountManager().hasAccount(name)) {
         return new EconomyResponse(0.0D, this.currency.getAccountManager().getAccount(name).getBalance(), EconomyResponse.ResponseType.FAILURE, "That account already exists.");
      } else {
   ...
   public EconomyResponse bankHas(String name, double amount) {
      ...
      if (account == null) {
         ...
         return !account.hasBalance(amount) ? new EconomyResponse(0.0D, account.getBalance(), EconomyResponse.ResponseType.FAILURE, "That account does not have enough!") : new EconomyResponse(0.0D, account.getBalance(), EconomyResponse.ResponseType.SUCCESS, "");
      }
   }
   ...
   public class EconomyServerListener implements Listener {
      ...
      public void onPluginEnable(PluginEnableEvent event) {
         if (this.economy.currency == null) {
            ...
            if (currencyPlugin.getDescription().getName().equals("CurrencyCore") && currencyPlugin.getClass().getName().equals("is.currency.Currency")) {
               ...
               Economy_CurrencyCore.this.log.info(String.format("[Economy] %s hooked.", this.economy.getName()));
            }
         }
      ...
      public void onPluginDisable(PluginDisableEvent event) {
         if (this.economy.currency != null && event.getPlugin().getDescription().getName().equals("CurrencyCore")) {
            ...
            Economy_CurrencyCore.this.log.info(String.format("[Economy] %s unhooked.", this.economy.getName()));
         }
