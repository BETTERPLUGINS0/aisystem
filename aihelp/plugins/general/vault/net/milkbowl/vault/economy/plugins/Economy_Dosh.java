...
public class Economy_Dosh extends AbstractEconomy {
   Plugin plugin;
   Dosh doshPlugin;
   Economy_Dosh.DoshAPIHandler apiHandle;
   ...
   public Economy_Dosh(Plugin _plugin) {
      ...
      if (this.plugin.getServer().getPluginManager().isPluginEnabled("Dosh")) {
         ...
         this.apiHandle = new Economy_Dosh.DoshAPIHandler();
      }
   }
   ...
   public boolean has(String playerName, double amount) {
      return this.getBalance(playerName) - amount > 0.0D;
   }
   ...
   public EconomyResponse createBank(String name, String player) {
      return new EconomyResponse(0.0D, 0.0D, EconomyResponse.ResponseType.NOT_IMPLEMENTED, "We do not use banks!");
   }
