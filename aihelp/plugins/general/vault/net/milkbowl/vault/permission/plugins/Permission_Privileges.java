...
public class Permission_Privileges extends Permission {
   ...
   public Permission_Privileges(Plugin plugin) {
      this.plugin = plugin;
      Bukkit.getServer().getPluginManager().registerEvents(new Permission_Privileges.PermissionServerListener(this), plugin);
      if (this.privs == null) {
   ...
   public String[] getGroups() {
      ...
      Iterator var2 = this.privs.getGroupManager().getGroups().iterator();
