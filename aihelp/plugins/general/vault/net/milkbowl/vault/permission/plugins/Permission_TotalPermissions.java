...
public class Permission_TotalPermissions extends Permission {
   ...
   public boolean playerAdd(String world, String player, String permission) {
      try {
         ...
         this.plugin.getLogger().log(Level.SEVERE, String.format("[%s] An error occured while saving perms", this.totalperms.getDescription().getName()), var5);
         return false;
      }
   }
   ...
   public String[] getPlayerGroups(String world, String player) {
      ...
      return (String[])((List)groups).toArray(new String[((List)groups).size()]);
   }
