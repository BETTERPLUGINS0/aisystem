...
public class DelayedAction extends Action {
   ...
   public void execute(final Player player, final String text) {
   ...
   public List<String> tabComplete(CommandSender sender, List<String> params) {
      switch(params.size()) {
      case 1:
         return CompleteUtility.complete((String)params.get(0), Arrays.asList("20", "100", "200"));
      case 2:
   ...
   public List<String> getInfo() {
      ...
      list.add("&b" + this.getID() + " &e<delay ticks> <action>");
