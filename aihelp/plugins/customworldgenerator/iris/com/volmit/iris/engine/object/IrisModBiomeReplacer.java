...
public class IrisModBiomeReplacer {
   ...
   @Generated
   public IrisModBiomeReplacer() {
   }

   @Generated
   public IrisModBiomeReplacer(final KList<String> find, final String replace) {
      this.find = var1;
      this.replace = var2;
   }
   ...
   @Generated
   public IrisModBiomeReplacer setFind(final KList<String> find) {
      this.find = var1;
      return this;
   }

   @Generated
   public IrisModBiomeReplacer setReplace(final String replace) {
      this.replace = var1;
      return this;
   }
   ...
   public boolean equals(final Object o) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof IrisModBiomeReplacer)) {
         return false;
      } else {
         IrisModBiomeReplacer var2 = (IrisModBiomeReplacer)var1;
   ...
   protected boolean canEqual(final Object other) {
      return var1 instanceof IrisModBiomeReplacer;
   }
   ...
   public String toString() {
      ...
      return "IrisModBiomeReplacer(find=" + var10000 + ", replace=" + this.getReplace() + ")";
   }
}
