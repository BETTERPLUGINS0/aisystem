...
public class IrisObjectLoot implements IObjectLoot {
   ...
   public boolean matchesFilter(IrisData manager, BlockData data) {
      Iterator var3 = this.getFilter(var1).iterator();
   ...
   @Generated
   public IrisObjectLoot() {
   }

   @Generated
   public IrisObjectLoot(final KList<IrisBlockData> filter, final boolean exact, final String name, final int weight) {
      this.filter = var1;
      this.exact = var2;
      this.name = var3;
      this.weight = var4;
   ...
   @Generated
   public IrisObjectLoot setFilter(final KList<IrisBlockData> filter) {
      this.filter = var1;
      return this;
   }

   @Generated
   public IrisObjectLoot setExact(final boolean exact) {
      this.exact = var1;
      return this;
   }

   @Generated
   public IrisObjectLoot setName(final String name) {
      this.name = var1;
      return this;
   }

   @Generated
   public IrisObjectLoot setWeight(final int weight) {
      this.weight = var1;
      return this;
   }
   ...
   public boolean equals(final Object o) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof IrisObjectLoot)) {
         return false;
      } else {
         IrisObjectLoot var2 = (IrisObjectLoot)var1;
   ...
   protected boolean canEqual(final Object other) {
      return var1 instanceof IrisObjectLoot;
   }
   ...
   public String toString() {
      ...
      return "IrisObjectLoot(filterCache=" + var10000 + ", filter=" + String.valueOf(this.getFilter()) + ", exact=" + this.isExact() + ", name=" + this.getName() + ", weight=" + this.getWeight() + ")";
   }
}
