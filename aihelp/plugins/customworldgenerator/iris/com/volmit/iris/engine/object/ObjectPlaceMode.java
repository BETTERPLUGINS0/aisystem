...
public enum ObjectPlaceMode {
   ...
   // $FF: synthetic method
   private static ObjectPlaceMode[] $values() {
      return new ObjectPlaceMode[]{CENTER_HEIGHT, MAX_HEIGHT, FAST_MAX_HEIGHT, MIN_HEIGHT, FAST_MIN_HEIGHT, STILT, FAST_STILT, MIN_STILT, FAST_MIN_STILT, CENTER_STILT, PAINT};
   }
}
