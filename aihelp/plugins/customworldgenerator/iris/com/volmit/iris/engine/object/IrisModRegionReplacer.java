...
public class IrisModRegionReplacer {
   ...
   @Generated
   public IrisModRegionReplacer() {
   }

   @Generated
   public IrisModRegionReplacer(final KList<String> find, final String replace) {
      this.find = var1;
      this.replace = var2;
   }
   ...
   @Generated
   public IrisModRegionReplacer setFind(final KList<String> find) {
      this.find = var1;
      return this;
   }

   @Generated
   public IrisModRegionReplacer setReplace(final String replace) {
      this.replace = var1;
      return this;
   }
   ...
   public boolean equals(final Object o) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof IrisModRegionReplacer)) {
         return false;
      } else {
         IrisModRegionReplacer var2 = (IrisModRegionReplacer)var1;
   ...
   protected boolean canEqual(final Object other) {
      return var1 instanceof IrisModRegionReplacer;
   }
   ...
   public String toString() {
      ...
      return "IrisModRegionReplacer(find=" + var10000 + ", replace=" + this.getReplace() + ")";
   }
}
