...
public class CustomBiomeSource extends WorldChunkManager {
   ...
   protected Stream<Holder<BiomeBase>> b() {
      return getAllBiomes((IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.ap).orElse((Object)null), (IRegistry)((CraftWorld)this.engine.getWorld().realWorld()).getHandle().G_().c(Registries.ap).orElse((Object)null), this.engine).stream();
   }
