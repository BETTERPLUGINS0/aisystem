...
public class IrisChunkGenerator extends CustomChunkGenerator {
   ...
   public IrisChunkGenerator(ChunkGenerator delegate, long seed, Engine engine, World world) {
      ...
      IRegistry var22 = (IRegistry)((CraftWorld)var5).getHandle().G_().c(Registries.az).orElseThrow();
      var10 = var7.iterator();
      ...
      while(var10.hasNext()) {
         ...
         try {
            ...
            if (var12 != null) {
               ...
               if (!var13) {
                  ((KSet)this.structures.computeIfAbsent(ResourceKey.a(Registries.az, var14), (var0) -> {
                     return new KSet(new String[0]);
                  })).add(var23.getLoadKey());
               } else {
                  TagKey var15 = TagKey.a(Registries.az, var14);
   ...
   public void a(IRegistryCustom registryAccess, ChunkGeneratorStructureState structureState, StructureManager structureManager, IChunkAccess access, StructureTemplateManager templateManager) {
      if (var3.a()) {
         ...
         IRegistry var8 = var1.d(Registries.az);
         this.populator.populateStructures(var6.e, var6.f, (var9, var10) -> {
            MinecraftKey var11 = MinecraftKey.a(var9);
            if (var11 == null) {
               return false;
            } else {
               Structure var12 = (Structure)var8.b(var11).orElse((Object)null);
               if (var12 == null) {
                  return false;
               } else {
                  HolderSet var13 = var12.a();
                  StructureStart var14 = var12.a(var1, this, this.b, var2.c(), var5, var2.d(), var6, fetchReferences(var3, var4, var7, var12), var4, (var2x) -> {
                     return var10 || var13.a(var2x);
                  });
                  if (!var14.b()) {
                     return false;
                  } else {
                     StructureBoundingBox var15 = var14.a();
                     AsyncStructureSpawnEvent var16 = new AsyncStructureSpawnEvent(var3.a.getMinecraftWorld().getWorld(), CraftStructure.minecraftToBukkit(var12, var1), new BoundingBox((double)var15.g(), (double)var15.h(), (double)var15.i(), (double)var15.j(), (double)var15.k(), (double)var15.l()), var6.e, var6.f);
                     Bukkit.getPluginManager().callEvent(var16);
                     if (!var16.isCancelled()) {
                        var3.a(var7, var12, var14, var4);
                     }
   ...
   public WeightedRandomList<c> a(Holder<BiomeBase> holder, StructureManager structuremanager, EnumCreatureType enumcreaturetype, BlockPosition blockposition) {
   ...
   public void addVanillaDecorations(GeneratorAccessSeed level, IChunkAccess chunkAccess, StructureManager structureManager) {
      if (var3.a()) {
         SectionPosition var4 = SectionPosition.a(var2.f(), var1.al());
         BlockPosition var5 = var4.j();
         SeededRandom var6 = new SeededRandom(new XoroshiroRandomSource(RandomSupport.a()));
         long var7 = var6.a(var1.A(), var5.u(), var5.w());
         IRegistry var9 = var1.G_().d(Registries.az);
         ...
         for(var15 = 0; var15 < var10.size(); ++var15) {
            ...
            Supplier var23 = () -> {
               Optional var10000 = var9.c(var22).map(Object::toString);
   ...
   public int a(int i, int j, Type heightmap_type, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
      return var4.H_() + this.engine.getHeight(var1, var2, !var3.e().test(Blocks.G.n())) + 1;
   }
   ...
   public BlockColumn a(int i, int j, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
      ...
      IBlockData[] var7 = new IBlockData[var3.I_()];

      for(int var8 = 0; var8 < var7.length; ++var8) {
         if (var8 <= var5) {
            var7[var8] = Blocks.b.n();
         } else if (var8 <= var6) {
            var7[var8] = Blocks.G.n();
         } else {
            var7[var8] = Blocks.a.n();
         }
      }

      return new BlockColumn(var3.H_(), var7);
   }
