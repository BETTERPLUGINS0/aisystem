...
public class IrisChunkGenerator extends CustomChunkGenerator {
   ...
   public IrisChunkGenerator(ChunkGenerator delegate, long seed, Engine engine, World world) {
      ...
      IRegistry var22 = (IRegistry)((CraftWorld)var5).getHandle().H_().c(Registries.aJ).orElseThrow();
      var10 = var7.iterator();
      ...
      while(var10.hasNext()) {
         ...
         try {
            ...
            if (var12 != null) {
               ...
               MinecraftKey var14 = new MinecraftKey(var12);
               if (!var13) {
                  ((KSet)this.structures.computeIfAbsent(ResourceKey.a(Registries.aJ, var14), (var0) -> {
                     return new KSet(new String[0]);
                  })).add(var23.getLoadKey());
               } else {
                  TagKey var15 = TagKey.a(Registries.aJ, var14);
                  Named var16 = (Named)var22.b(var15).orElse((Object)null);
                  if (var16 == null) {
   ...
   public Pair<BlockPosition, Holder<Structure>> a(WorldServer level, HolderSet<Structure> holders, BlockPosition pos, int radius, boolean findUnexplored) {
      if (var2.b() == 0) {
         return null;
      } else if (var2.d().orElse((Object)null) == StructureTags.a) {
   ...
   public void a(IRegistryCustom registryAccess, ChunkGeneratorStructureState structureState, StructureManager structureManager, IChunkAccess access, StructureTemplateManager templateManager) {
      if (var3.a()) {
         ChunkCoordIntPair var6 = var4.f();
         SectionPosition var7 = SectionPosition.a(var4);
         IRegistry var8 = var1.d(Registries.aJ);
         this.populator.populateStructures(var6.e, var6.f, (var9, var10) -> {
            MinecraftKey var11 = MinecraftKey.a(var9);
            if (var11 == null) {
               return false;
            } else {
               c var12 = (c)var8.c(var11).orElse((Object)null);
               if (var12 == null) {
                  return false;
               } else {
                  Structure var13 = (Structure)var12.a();
                  HolderSet var14 = var13.a();
                  StructureStart var15 = var13.a(var1, this, this.b, var2.c(), var5, var2.d(), var6, fetchReferences(var3, var4, var7, var13), var4, (var2x) -> {
                     return var10 || var14.a(var2x);
                  });
                  if (!var15.b()) {
                     return false;
                  } else {
                     StructureBoundingBox var16 = var15.a();
                     AsyncStructureSpawnEvent var17 = new AsyncStructureSpawnEvent(var3.a.getMinecraftWorld().getWorld(), CraftStructure.minecraftToBukkit(var13), new BoundingBox((double)var16.h(), (double)var16.i(), (double)var16.j(), (double)var16.k(), (double)var16.l(), (double)var16.m()), var6.e, var6.f);
                     Bukkit.getPluginManager().callEvent(var17);
                     if (!var17.isCancelled()) {
                        var3.a(var7, var13, var15, var4);
                     }
   ...
   public void a(RegionLimitedWorldAccess regionlimitedworldaccess, long seed, RandomState randomstate, BiomeManager biomemanager, StructureManager structuremanager, IChunkAccess ichunkaccess, Features worldgenstage_features) {
      this.delegate.a(var1, var2, var4, var5, var6, var7, var8);
   }
   ...
   public CompletableFuture<IChunkAccess> a(Executor executor, Blender blender, RandomState randomstate, StructureManager structuremanager, IChunkAccess ichunkaccess) {
      return this.delegate.a(var1, var2, var3, var4, var5);
   }

   public WeightedRandomList<net.minecraft.world.level.biome.BiomeSettingsMobs.c> a(Holder<BiomeBase> holder, StructureManager structuremanager, EnumCreatureType enumcreaturetype, BlockPosition blockposition) {
   ...
   public void addVanillaDecorations(GeneratorAccessSeed level, IChunkAccess chunkAccess, StructureManager structureManager) {
      if (var3.a()) {
         SectionPosition var4 = SectionPosition.a(var2.f(), var1.ao());
         BlockPosition var5 = var4.j();
         SeededRandom var6 = new SeededRandom(new XoroshiroRandomSource(RandomSupport.a()));
         long var7 = var6.a(var1.C(), var5.u(), var5.w());
         IRegistry var9 = var1.H_().d(Registries.aJ);
   ...
   private static StructureBoundingBox getWritableArea(IChunkAccess ichunkaccess) {
      ...
      int var2 = var1.d();
      int var3 = var1.e();
      LevelHeightAccessor var4 = var0.z();
      int var5 = var4.I_() + 1;
      int var6 = var4.am() - 1;
   ...
   public int a(int i, int j, Type heightmap_type, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
      return var4.I_() + this.engine.getHeight(var1, var2, !var3.e().test(Blocks.G.o())) + 1;
   }
   ...
   public BlockColumn a(int i, int j, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
      ...
      IBlockData[] var7 = new IBlockData[var3.J_()];

      for(int var8 = 0; var8 < var7.length; ++var8) {
         if (var8 <= var5) {
            var7[var8] = Blocks.b.o();
         } else if (var8 <= var6) {
            var7[var8] = Blocks.G.o();
         } else {
            var7[var8] = Blocks.a.o();
         }
      }

      return new BlockColumn(var3.I_(), var7);
   }
