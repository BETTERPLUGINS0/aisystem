...
public class NMSBinding implements INMSBinding {
   ...
   private Object convertFromTag(NBTBase tag, int depth, int maxDepth) {
      if (var1 != null && var2 <= var3) {
         ...
         case 2:
            ...
            break;
         default:
            var10000 = (String)var1.r_().orElse((Object)null);
         }
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().a(Registries.aN).orElse((Object)null);
   }
   ...
   public Object getTrueBiomeBase(Location location) {
      return ((CraftWorld)var1.getWorld()).getHandle().v(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().L_().a(Registries.aN).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().L_().a(Registries.aN).orElse((Object)null);
   ...
   public void inject(long seed, Engine engine, World world) {
      PlayerChunkMap var5 = ((CraftWorld)var4).getHandle().n().a;
      Field var6 = getField(var5.getClass(), WorldGenContext.class);
      var6.setAccessible(true);
      WorldGenContext var7 = (WorldGenContext)var6.get(var5);
      ResourceKey var8 = (ResourceKey)var5.t.ak().e().orElse((Object)null);
   ...
   public Color getBiomeColor(Location location, BiomeColor type) {
      ...
      Holder var4 = var3.v(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
      ...
      if (var5 == null) {
         ...
         int var6 = var10000;
         if (var6 == 0) {
            if (BiomeColor.FOLIAGE == var2 && var5.i().e().isEmpty()) {
               return null;
            }

            if (BiomeColor.GRASS == var2 && var5.i().g().isEmpty()) {
               return null;
            }
         }
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.b(ResourceKey.a(Registries.aN, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().a(Registries.bm).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().f(Registries.aX);
   ...
   public void placeStructures(org.bukkit.Chunk chunk) {
      ...
      var3.n().g().a(var3, var4, var3.b());
   }

   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().f(Registries.bl);
      IRegistry var2 = this.registry().f(Registries.ax);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.f(Registries.aX).b(ResourceKey.a(Registries.aX, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.f(Registries.aN).b(Biomes.a), List.of());
      ...
      static void enter(@Argument(0) MinecraftServer server, @Argument(3) WorldDataServer levelData, @Argument(value = 5,readOnly = false) WorldDimension levelStem, @Argument(11) Environment env, @Argument(12) ChunkGenerator gen) {
         if (var4 != null && var4.getClass().getPackageName().startsWith("com.volmit.iris")) {
            try {
               ...
               var2 = (WorldDimension)var5.getClass().getDeclaredMethod("levelStem", IRegistryCustom.class, ChunkGenerator.class).invoke(var5, var0.bg(), var4);
