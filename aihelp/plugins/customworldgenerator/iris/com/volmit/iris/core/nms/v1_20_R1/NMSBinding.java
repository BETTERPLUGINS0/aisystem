...
public class NMSBinding implements INMSBinding {
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().c(Registries.ap).orElse((Object)null);
   }

   private IRegistry<Block> getBlockRegistry() {
      return (IRegistry)this.registry().c(Registries.e).orElse((Object)null);
   }
   ...
   public Object getTrueBiomeBase(Location location) {
      return ((CraftWorld)var1.getWorld()).getHandle().s(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return CraftBlock.biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().B_().c(Registries.ap).orElse((Object)null), var2);
   }
   ...
   public Object getBiomeBase(Object registry, Biome biome) {
      ...
      if (var3 != null) {
         ...
         Holder var4 = CraftBlock.biomeToBiomeBase((IRegistry)var1, var2);
         if (var4 == null) {
            return CraftBlock.biomeToBiomeBase((IRegistry)var1, Biome.PLAINS);
         } else {
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().B_().c(Registries.ap).orElse((Object)null);
   ...
   public void inject(long seed, Engine engine, World world) {
      PlayerChunkMap var5 = ((CraftWorld)var4).getHandle().k().a;
      ResourceKey var6 = (ResourceKey)var5.q.ab().e().orElse((Object)null);
   ...
   public Color getBiomeColor(Location location, BiomeColor type) {
      ...
      Holder var4 = var3.s(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().c(Registries.az).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().d(Registries.au);
   ...
   public KMap<Material, List<BlockProperty>> getBlockProperties() {
      ...
      Block var3;
      IBlockData var4;
      for(Iterator var2 = this.registry().d(Registries.e).iterator(); var2.hasNext(); var1.put(CraftMagicNumbers.getMaterial(var3), var3.l().d().stream().map((var2x) -> {
   ...
   public void placeStructures(org.bukkit.Chunk chunk) {
      ...
      var3.k().g().a(var3, var4, var3.a());
   }

   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().d(Registries.aB);
      IRegistry var2 = this.registry().d(Registries.ag);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.b(Registries.au).b(ResourceKey.a(Registries.au, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.d(Registries.ap).f(Biomes.a), List.of());
      ...
      static void enter(@Argument(0) MinecraftServer server, @Argument(3) WorldDataServer levelData, @Argument(value = 5,readOnly = false) WorldDimension levelStem, @Argument(12) Environment env, @Argument(13) ChunkGenerator gen) {
         if (var4 != null && var4.getClass().getPackageName().startsWith("com.volmit.iris")) {
            try {
               ...
               var2 = (WorldDimension)var5.getClass().getDeclaredMethod("levelStem", IRegistryCustom.class, ChunkGenerator.class).invoke(var5, var0.aV(), var4);
