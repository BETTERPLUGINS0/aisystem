...
public class CustomBiomeSource extends WorldChunkManager {
   ...
   public CustomBiomeSource(long seed, Engine engine, World world) {
      this.engine = var3;
      this.seed = var1;
      this.biomeCustomRegistry = (IRegistry)this.registry().c(Registries.ap).orElse((Object)null);
      this.biomeRegistry = (IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.ap).orElse((Object)null);
         ...
         while(var4.hasNext()) {
            ...
            if (var5.isCustom()) {
               ...
               while(var6.hasNext()) {
                  ...
                  String var10006 = var2.getDimension().getLoadKey();
                  var3.add((Holder)var0.b((ResourceKey)var0.c((BiomeBase)var0.a(new MinecraftKey(var10006 + ":" + var7.getId()))).get()).get());
               }
            } else {
               var3.add(CraftBlock.biomeToBiomeBase(var1, var5.getVanillaDerivative()));
            }
         }
   ...
   protected Stream<Holder<BiomeBase>> b() {
      return getAllBiomes((IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.ap).orElse((Object)null), (IRegistry)((CraftWorld)this.engine.getWorld().realWorld()).getHandle().B_().c(Registries.ap).orElse((Object)null), this.engine).stream();
   }
   ...
   private KMap<String, Holder<BiomeBase>> fillCustomBiomes(IRegistry<BiomeBase> customRegistry, Engine engine) {
      ...
      while(true) {
         ...
         while(var6.hasNext()) {
            IrisBiomeCustom var7 = (IrisBiomeCustom)var6.next();
            String var10002 = var2.getDimension().getLoadKey();
            MinecraftKey var8 = new MinecraftKey(var10002 + ":" + var7.getId());
            BiomeBase var9 = (BiomeBase)var1.a(var8);
            Optional var10 = var1.c(var9);
            if (var10.isEmpty()) {
   ...
   public Holder<BiomeBase> getNoiseBiome(int x, int y, int z, Sampler sampler) {
      ...
      if (var6.isCustom()) {
         ...
         return CraftBlock.biomeToBiomeBase(this.biomeRegistry, var7);
      }
   }
}
