...
public class NMSBinding implements INMSBinding {
   ...
   public KMap<String, Object> serializeTile(Location location) {
      ...
      if (var2 == null) {
         ...
         NBTTagCompound var3 = var2.d(this.registry());
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().a(Registries.aG).orElse((Object)null);
   }
   ...
   public Object getTrueBiomeBase(Location location) {
      return ((CraftWorld)var1.getWorld()).getHandle().u(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().J_().a(Registries.aG).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().J_().a(Registries.aG).orElse((Object)null);
   ...
   public void inject(long seed, Engine engine, World world) {
      PlayerChunkMap var5 = ((CraftWorld)var4).getHandle().m().a;
   ...
   public Color getBiomeColor(Location location, BiomeColor type) {
      ...
      Holder var4 = var3.u(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.b(ResourceKey.a(Registries.aG, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().a(Registries.be).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().f(Registries.aP);
   ...
   public void placeStructures(org.bukkit.Chunk chunk) {
      ...
      var3.m().g().a(var3, var4, var3.b());
   }

   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().f(Registries.bd);
      IRegistry var2 = this.registry().f(Registries.at);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.f(Registries.aP).b(ResourceKey.a(Registries.aP, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.f(Registries.aG).b(Biomes.a), List.of());
