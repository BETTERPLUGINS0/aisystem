...
public class NMSBinding implements INMSBinding {
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().a(Registries.aI).orElse((Object)null);
   }

   private IRegistry<Block> getBlockRegistry() {
      return (IRegistry)this.registry().a(Registries.f).orElse((Object)null);
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().K_().a(Registries.aI).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().K_().a(Registries.aI).orElse((Object)null);
   ...
   public ItemStack applyCustomNbt(ItemStack itemStack, KMap<String, Object> customNbt) {
      if (var2 != null && !var2.isEmpty()) {
         ...
         try {
            ...
            var4.a(((CustomData)var3.a(DataComponents.b, CustomData.a)).d());
   ...
   public void inject(long seed, Engine engine, World world) {
      ...
      ResourceKey var8 = (ResourceKey)var5.t.ag().e().orElse((Object)null);
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.b(ResourceKey.a(Registries.aI, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().a(Registries.aU).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().e(Registries.aN);
   ...
   public KMap<Material, List<BlockProperty>> getBlockProperties() {
      ...
      Block var3;
      IBlockData var4;
      for(Iterator var2 = this.registry().e(Registries.f).iterator(); var2.hasNext(); var1.put(CraftMagicNumbers.getMaterial(var3), var3.l().d().stream().map((var2x) -> {
   ...
   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().e(Registries.aW);
      IRegistry var2 = this.registry().e(Registries.ao);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.e(Registries.aN).b(ResourceKey.a(Registries.aN, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.e(Registries.aI).b(Biomes.a), List.of());
