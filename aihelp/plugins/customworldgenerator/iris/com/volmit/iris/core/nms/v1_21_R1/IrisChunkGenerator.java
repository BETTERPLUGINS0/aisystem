...
public class IrisChunkGenerator extends CustomChunkGenerator {
   ...
   public IrisChunkGenerator(ChunkGenerator delegate, long seed, Engine engine, World world) {
      ...
      IRegistry var22 = (IRegistry)((CraftWorld)var5).getHandle().H_().c(Registries.aR).orElseThrow();
      var10 = var7.iterator();
      ...
      while(var10.hasNext()) {
         ...
         try {
            ...
            if (var12 != null) {
               ...
               if (!var13) {
                  ((KSet)this.structures.computeIfAbsent(ResourceKey.a(Registries.aR, var14), (var0) -> {
                     return new KSet(new String[0]);
                  })).add(var23.getLoadKey());
               } else {
                  TagKey var15 = TagKey.a(Registries.aR, var14);
   ...
   public void a(IRegistryCustom registryAccess, ChunkGeneratorStructureState structureState, StructureManager structureManager, IChunkAccess access, StructureTemplateManager templateManager) {
      if (var3.a()) {
         ...
         IRegistry var8 = var1.d(Registries.aR);
         this.populator.populateStructures(var6.e, var6.f, (var9, var10) -> {
            MinecraftKey var11 = MinecraftKey.c(var9);
            if (var11 == null) {
               return false;
            } else {
   ...
   public void addVanillaDecorations(GeneratorAccessSeed level, IChunkAccess chunkAccess, StructureManager structureManager) {
      if (var3.a()) {
         ...
         IRegistry var9 = var1.H_().d(Registries.aR);
         List var10 = var9.t().sorted(Comparator.comparingInt((var0) -> {
