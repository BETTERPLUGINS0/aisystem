...
public class IrisChunkGenerator extends CustomChunkGenerator {
   ...
   public IrisChunkGenerator(ChunkGenerator delegate, long seed, Engine engine, World world) {
      ...
      IRegistry var22 = (IRegistry)((CraftWorld)var5).getHandle().K_().a(Registries.aU).orElseThrow();
      var10 = var7.iterator();
      ...
      while(var10.hasNext()) {
         ...
         try {
            ...
            if (var12 != null) {
               ...
               if (!var13) {
                  ((KSet)this.structures.computeIfAbsent(ResourceKey.a(Registries.aU, var14), (var0) -> {
                     return new KSet(new String[0]);
                  })).add(var23.getLoadKey());
               } else {
                  TagKey var15 = TagKey.a(Registries.aU, var14);
   ...
   public void a(IRegistryCustom registryAccess, ChunkGeneratorStructureState structureState, StructureManager structureManager, IChunkAccess access, StructureTemplateManager templateManager) {
      if (var3.a()) {
         ...
         IRegistry var8 = var1.e(Registries.aU);
         this.populator.populateStructures(var6.h, var6.i, (var9, var10) -> {
            ...
            if (var11 == null) {
               ...
               if (var12 == null) {
                  ...
                  if (!var15.b()) {
                     ...
                     AsyncStructureSpawnEvent var17 = new AsyncStructureSpawnEvent(var3.a.getMinecraftWorld().getWorld(), CraftStructure.minecraftToBukkit(var13), new BoundingBox((double)var16.h(), (double)var16.i(), (double)var16.j(), (double)var16.k(), (double)var16.l(), (double)var16.m()), var6.h, var6.i);
   ...
   public void addVanillaDecorations(GeneratorAccessSeed level, IChunkAccess chunkAccess, StructureManager structureManager) {
      if (var3.a()) {
         ...
         long var7 = var6.a(var1.D(), var5.u(), var5.w());
         IRegistry var9 = var1.K_().e(Registries.aU);
