...
public class IrisChunkGenerator extends CustomChunkGenerator {
   ...
   public IrisChunkGenerator(ChunkGenerator delegate, long seed, Engine engine, World world) {
      ...
      IRegistry var22 = (IRegistry)((CraftWorld)var5).getHandle().I_().c(Registries.aD).orElseThrow();
      var10 = var7.iterator();
      ...
      while(var10.hasNext()) {
         ...
         try {
            ...
            if (var12 != null) {
               ...
               if (!var13) {
                  ((KSet)this.structures.computeIfAbsent(ResourceKey.a(Registries.aD, var14), (var0) -> {
                     return new KSet(new String[0]);
                  })).add(var23.getLoadKey());
               } else {
                  TagKey var15 = TagKey.a(Registries.aD, var14);
   ...
   public void a(IRegistryCustom registryAccess, ChunkGeneratorStructureState structureState, StructureManager structureManager, IChunkAccess access, StructureTemplateManager templateManager) {
      if (var3.a()) {
         ...
         IRegistry var8 = var1.d(Registries.aD);
            ...
            if (var11 == null) {
               ...
               if (var12 == null) {
                  ...
                  if (!var14.b()) {
                     ...
                     AsyncStructureSpawnEvent var16 = new AsyncStructureSpawnEvent(var3.a.getMinecraftWorld().getWorld(), CraftStructure.minecraftToBukkit(var12), new BoundingBox((double)var15.h(), (double)var15.i(), (double)var15.j(), (double)var15.k(), (double)var15.l(), (double)var15.m()), var6.e, var6.f);
   ...
   public void addVanillaDecorations(GeneratorAccessSeed level, IChunkAccess chunkAccess, StructureManager structureManager) {
      if (var3.a()) {
         SectionPosition var4 = SectionPosition.a(var2.f(), var1.an());
         ...
         IRegistry var9 = var1.I_().d(Registries.aD);
   ...
   public int a(int i, int j, Type heightmap_type, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
      return var4.J_() + this.engine.getHeight(var1, var2, !var3.e().test(Blocks.G.o())) + 1;
   }
   ...
   public BlockColumn a(int i, int j, LevelHeightAccessor levelheightaccessor, RandomState randomstate) {
      ...
      IBlockData[] var7 = new IBlockData[var3.K_()];
      ...
      return new BlockColumn(var3.J_(), var7);
   }
