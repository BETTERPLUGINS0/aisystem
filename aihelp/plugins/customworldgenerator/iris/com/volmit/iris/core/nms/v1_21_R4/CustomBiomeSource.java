...
public class CustomBiomeSource extends WorldChunkManager {
   ...
   public CustomBiomeSource(long seed, Engine engine, World world) {
      this.engine = var3;
      this.seed = var1;
      this.biomeCustomRegistry = (IRegistry)this.registry().a(Registries.aG).orElse((Object)null);
      this.biomeRegistry = (IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).a(Registries.aG).orElse((Object)null);
   ...
   protected Stream<Holder<BiomeBase>> b() {
      return getAllBiomes((IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).a(Registries.aG).orElse((Object)null), (IRegistry)((CraftWorld)this.engine.getWorld().realWorld()).getHandle().J_().a(Registries.aG).orElse((Object)null), this.engine).stream();
   }
