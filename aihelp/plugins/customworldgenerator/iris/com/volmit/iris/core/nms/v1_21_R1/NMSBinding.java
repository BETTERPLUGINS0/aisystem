...
public class NMSBinding implements INMSBinding {
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().c(Registries.aF).orElse((Object)null);
   }
   ...
   public Object getCustomBiomeBaseHolderFor(String mckey) {
      return this.getCustomBiomeRegistry().c(this.getTrueBiomeBaseId(this.getCustomBiomeRegistry().a(MinecraftKey.a(var1)))).get();
   }

   public int getBiomeBaseIdForKey(String key) {
      return this.getCustomBiomeRegistry().a((BiomeBase)this.getCustomBiomeRegistry().a(MinecraftKey.a(var1)));
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().H_().c(Registries.aF).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().H_().c(Registries.aF).orElse((Object)null);
   ...
   public int countCustomBiomes() {
      ...
      this.getCustomBiomeRegistry().f().forEach((var1x) -> {
   ...
   public void inject(long seed, Engine engine, World world) {
      ...
      ResourceKey var8 = (ResourceKey)var5.s.ae().e().orElse((Object)null);
      if (var8 != null && !var8.a().b().equals("iris")) {
         Iris.error("Loaded world %s with invalid dimension type! (%s)", var4.getName(), var8.a().toString());
      }

      WorldGenContext var9 = new WorldGenContext(var7.a(), new IrisChunkGenerator(var7.b(), var1, var3, var4), var7.c(), var7.d(), var7.e());
      var6.set(var5, var9);
   }
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.g(ResourceKey.a(Registries.aF, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().c(Registries.aR).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
         Stream var10000 = var2.f().stream().map(MinecraftKey::toString);
         Objects.requireNonNull(var1);
         var10000.forEach(var1::add);
         var10000 = var2.j().map(Pair::getFirst).map(TagKey::b).map(MinecraftKey::toString).map((var0) -> {
            return "#" + var0;
         });
         Objects.requireNonNull(var1);
         var10000.forEach(var1::add);
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().d(Registries.aK);
   ...
   public KMap<Material, List<BlockProperty>> getBlockProperties() {
      ...
      Block var3;
      IBlockData var4;
      for(Iterator var2 = this.registry().d(Registries.f).iterator(); var2.hasNext(); var1.put(CraftMagicNumbers.getMaterial(var3), var3.l().d().stream().map((var2x) -> {
   ...
   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().d(Registries.aT);
      IRegistry var2 = this.registry().d(Registries.ao);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.b(Registries.aK).b(ResourceKey.a(Registries.aK, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.d(Registries.aF).g(Biomes.a), List.of());
