...
public class NMSBinding implements INMSBinding {
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().c(Registries.az).orElse((Object)null);
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().H_().c(Registries.az).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().H_().c(Registries.az).orElse((Object)null);
   ...
   public void inject(long seed, Engine engine, World world) {
      ...
      ResourceKey var6 = (ResourceKey)var5.q.ae().e().orElse((Object)null);
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.g(ResourceKey.a(Registries.az, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().c(Registries.aJ).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().d(Registries.aE);
   ...
   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().d(Registries.aL);
      IRegistry var2 = this.registry().d(Registries.aj);
      Stream var10000 = var1.e().stream();
      Objects.requireNonNull(var1);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.b(Registries.aE).b(ResourceKey.a(Registries.aE, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.d(Registries.az).g(Biomes.a), List.of());
