...
public class NMSBinding implements INMSBinding {
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().a(Registries.aK).orElse((Object)null);
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().K_().a(Registries.aK).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().K_().a(Registries.aK).orElse((Object)null);
   ...
   public ItemStack applyCustomNbt(ItemStack itemStack, KMap<String, Object> customNbt) {
      if (var2 != null && !var2.isEmpty()) {
         ...
         try {
            ...
            var4.a(((CustomData)var3.a(DataComponents.b, CustomData.a)).e());
   ...
   public void inject(long seed, Engine engine, World world) {
      ...
      ResourceKey var8 = (ResourceKey)var5.t.ai().e().orElse((Object)null);
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.b(ResourceKey.a(Registries.aK, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public int getSpawnChunkCount(World world) {
      Integer var2 = (Integer)Optional.ofNullable((Integer)var1.getGameRuleValue(GameRule.SPAWN_CHUNK_RADIUS)).orElseGet(() -> {
         return (Integer)var1.getGameRuleDefault(GameRule.SPAWN_CHUNK_RADIUS);
      });
      if (var2 == null) {
         throw new IllegalStateException("GameRule.SPAWN_CHUNK_RADIUS is null!");
      } else {
         return (int)Math.pow((double)(2 * var2 + 1), 2.0D);
      }
   }

   public KList<String> getStructureKeys() {
      KList var1 = new KList();
      IRegistry var2 = (IRegistry)this.registry().a(Registries.bj).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().f(Registries.aU);
   ...
   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().f(Registries.bi);
      IRegistry var2 = this.registry().f(Registries.aw);
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         c var5 = var1.f(Registries.aU).b(ResourceKey.a(Registries.aU, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.f(Registries.aK).b(Biomes.a), List.of());
      ...
      static void enter(@Argument(0) MinecraftServer server, @Argument(3) WorldDataServer levelData, @Argument(value = 5,readOnly = false) WorldDimension levelStem, @Argument(12) Environment env, @Argument(13) ChunkGenerator gen) {
         if (var4 != null && var4.getClass().getPackageName().startsWith("com.volmit.iris")) {
            try {
               ...
               var2 = (WorldDimension)var5.getClass().getDeclaredMethod("levelStem", IRegistryCustom.class, ChunkGenerator.class).invoke(var5, var0.ba(), var4);
