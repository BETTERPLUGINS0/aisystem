...
public class NMSBinding implements INMSBinding {
   ...
   public boolean hasTile(Location l) {
      return ((CraftWorld)var1.getWorld()).getHandle().c_(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ())) != null;
   }

   public KMap<String, Object> serializeTile(Location location) {
      TileEntity var2 = ((CraftWorld)var1.getWorld()).getHandle().c_(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
      if (var2 == null) {
         return null;
      } else {
         NBTTagCompound var3 = var2.c(this.registry());
   ...
   private Object convertFromTag(NBTBase tag, int depth, int maxDepth) {
      if (var1 != null && var2 <= var3) {
         ...
         case 0:
            NBTList var6 = (NBTList)var1;
            KList var14 = new KList();
            Iterator var16 = var6.iterator();

            while(var16.hasNext()) {
               Object var17 = var16.next();
               if (var17 instanceof NBTBase) {
                  NBTBase var13 = (NBTBase)var17;
                  var14.add((Object)this.convertFromTag(var13, var2 + 1, var3));
               } else {
                  var14.add((Object)var17);
               }
            }
            ...
            break;
         case 1:
            NBTTagCompound var7 = (NBTTagCompound)var1;
            KMap var15 = new KMap();
            Iterator var9 = var7.e().iterator();

            while(var9.hasNext()) {
               String var10 = (String)var9.next();
               NBTBase var11 = var7.a(var10);
               if (var11 != null) {
                  Object var12 = this.convertFromTag(var11, var2 + 1, var3);
                  if (var12 != null) {
            ...
            break;
         case 2:
            NBTNumber var8 = (NBTNumber)var1;
            var10000 = var8.m();
            break;
         default:
            var10000 = (String)var1.p_().orElse((Object)null);
         }
   ...
   private NBTBase convertToTag(Object object, int depth, int maxDepth) {
      if (var1 != null && var2 <= var3) {
         ...
         byte var5 = 0;
         Object var10000;
         switch(((Class)var1).typeSwitch<invokedynamic>(var1, var5)) {
         case 0:
            Map var6 = (Map)var1;
            NBTTagCompound var15 = new NBTTagCompound();
            Iterator var17 = var6.entrySet().iterator();

            while(var17.hasNext()) {
               Entry var19 = (Entry)var17.next();
               var15.a(var19.getKey().toString(), this.convertToTag(var19.getValue(), var2 + 1, var3));
            }
         ...
         case 1:
            ...
            while(var18.hasNext()) {
               ...
               var16.add(this.convertToTag(var20, var2 + 1, var3));
            }
         ...
         case 2:
            Byte var8 = (Byte)var1;
            var10000 = NBTTagByte.a(var8);
            break;
         case 3:
            Short var9 = (Short)var1;
            var10000 = NBTTagShort.a(var9);
            break;
         case 4:
            Integer var10 = (Integer)var1;
            var10000 = NBTTagInt.a(var10);
            break;
         case 5:
            Long var11 = (Long)var1;
            var10000 = NBTTagLong.a(var11);
            break;
         case 6:
            Float var12 = (Float)var1;
            var10000 = NBTTagFloat.a(var12);
            break;
         case 7:
            Double var13 = (Double)var1;
            var10000 = NBTTagDouble.a(var13);
            break;
         case 8:
            String var14 = (String)var1;
            var10000 = NBTTagString.a(var14);
            break;
         default:
            var10000 = NBTTagEnd.b;
         }

         return (NBTBase)var10000;
      } else {
         return NBTTagEnd.b;
      }
   }
   ...
   private IRegistry<BiomeBase> getCustomBiomeRegistry() {
      return (IRegistry)this.registry().a(Registries.aS).orElse((Object)null);
   }

   private IRegistry<Block> getBlockRegistry() {
      return (IRegistry)this.registry().a(Registries.i).orElse((Object)null);
   }
   ...
   public Object getTrueBiomeBase(Location location) {
      return ((CraftWorld)var1.getWorld()).getHandle().z(new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ()));
   }
   ...
   public Object getCustomBiomeBaseFor(String mckey) {
      return this.getCustomBiomeRegistry().a(MinecraftKey.a(var1));
   }

   public Object getCustomBiomeBaseHolderFor(String mckey) {
      return this.getCustomBiomeRegistry().c(this.getTrueBiomeBaseId(this.getCustomBiomeRegistry().c(MinecraftKey.a(var1)))).orElse((Object)null);
   }

   public int getBiomeBaseIdForKey(String key) {
      return this.getCustomBiomeRegistry().a((BiomeBase)this.getCustomBiomeRegistry().c(MinecraftKey.a(var1)).map(Holder::a).orElse((Object)null));
   }
   ...
   public Object getBiomeBase(World world, Biome biome) {
      return biomeToBiomeBase((IRegistry)((CraftWorld)var1).getHandle().J_().a(Registries.aS).orElse((Object)null), var2);
   }
   ...
   public int getBiomeId(Biome biome) {
      ...
      IRegistry var4 = (IRegistry)((CraftWorld)var3).getHandle().J_().a(Registries.aS).orElse((Object)null);
   ...
   public int countCustomBiomes() {
      ...
      this.getCustomBiomeRegistry().i().forEach((var1x) -> {
   ...
   public ItemStack applyCustomNbt(ItemStack itemStack, KMap<String, Object> customNbt) {
      if (var2 != null && !var2.isEmpty()) {
         ...
         try {
            ...
            var4.a(((CustomData)var3.a(DataComponents.b, CustomData.a)).b());
            var3.b(DataComponents.b, CustomData.a(var4));
   ...
   public void inject(long seed, Engine engine, World world) {
      PlayerChunkMap var5 = ((CraftWorld)var4).getHandle().p().a;
      Field var6 = getField(var5.getClass(), WorldGenContext.class);
      var6.setAccessible(true);
      WorldGenContext var7 = (WorldGenContext)var6.get(var5);
      ResourceKey var8 = (ResourceKey)var5.r.ap().e().orElse((Object)null);
      if (var8 != null && !var8.a().b().equals("iris")) {
         Iris.error("Loaded world %s with invalid dimension type! (%s)", var4.getName(), var8.a().toString());
      }

      WorldGenContext var9 = new WorldGenContext(var7.a(), new IrisChunkGenerator(var7.b(), var1, var3, var4), var7.c(), var7.d(), var7.e(), var7.f());
      var6.set(var5, var9);
   }
         ...
         if (Modifier.isStatic(var6.getModifiers()) && var6.getType().equals(EntityTypes.class)) {
            try {
               ...
               if (var7.g().equals("entity.minecraft." + var1.name().toLowerCase())) {
                  ...
                  var8.add(var7.m());
                  var7.n();
                  Vector3d var9 = new Vector3d((double)var7.l(), (double)var7.m(), (double)var7.l());
                  return var9;
               }
   ...
   public Color getBiomeColor(Location location, BiomeColor type) {
      ...
      BlockPosition var4 = new BlockPosition(var1.getBlockX(), var1.getBlockY(), var1.getBlockZ());
      Holder var5 = var3.z(var4);
      BiomeBase var6 = (BiomeBase)var5.a();
      if (var6 == null) {
         Optional var10002 = var5.e();
         throw new IllegalArgumentException("Invalid biome: " + String.valueOf(var10002.orElse((Object)null)));
      } else {
         EnvironmentAttributeSystem var7 = var3.c();
         int var10000;
         switch(var2) {
         case FOG:
            var10000 = (Integer)var7.a(EnvironmentAttributes.a, var4);
            break;
         case WATER:
            var10000 = var6.i();
            break;
         case WATER_FOG:
            var10000 = (Integer)var7.a(EnvironmentAttributes.f, var4);
            break;
         case SKY:
            var10000 = (Integer)var7.a(EnvironmentAttributes.i, var4);
            break;
         case FOLIAGE:
            var10000 = var6.d();
            break;
         case GRASS:
            var10000 = var6.a((double)var1.getBlockX(), (double)var1.getBlockZ());
            break;
         default:
         ...
         int var8 = var10000;
         if (var8 == 0) {
            if (BiomeColor.FOLIAGE == var2 && var6.h().b().isEmpty()) {
               return null;
            }

            if (BiomeColor.GRASS == var2 && var6.h().d().isEmpty()) {
               return null;
            }
         }

         return new Color(var8, true);
      }
   }
   ...
   public static Holder<BiomeBase> biomeToBiomeBase(IRegistry<BiomeBase> registry, Biome biome) {
      return var0.b(ResourceKey.a(Registries.aS, CraftNamespacedKey.toMinecraft(var1.getKey())));
   }
   ...
   public KList<String> getStructureKeys() {
      ...
      IRegistry var2 = (IRegistry)this.registry().a(Registries.bs).orElse((Object)null);
      if (var2 == null) {
         return var1;
      } else {
         Stream var10000 = var2.i().stream().map(MinecraftKey::toString);
         Objects.requireNonNull(var1);
         var10000.forEach(var1::add);
         var10000 = var2.l().map(Named::h).map(TagKey::b).map(MinecraftKey::toString).map((var0) -> {
            return "#" + var0;
         });
         Objects.requireNonNull(var1);
         var10000.forEach(var1::add);
   ...
   public boolean missingDimensionTypes(String... keys) {
      IRegistry var2 = this.registry().f(Registries.bd);
      Stream var10000 = Arrays.stream(var1).map((var0) -> {
         return MinecraftKey.a("iris", var0);
      });
      Objects.requireNonNull(var2);
      return !var10000.allMatch(var2::d);
   }
   ...
   public boolean injectBukkit() {
      if (this.injected.getAndSet(true)) {
         ...
         try {
            ...
            var1.redefine(WorldServer.class).visit(Advice.to(NMSBinding.ServerLevelAdvice.class).on(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments(new Class[]{MinecraftServer.class, Executor.class, ConversionSession.class, WorldDataServer.class, ResourceKey.class, WorldDimension.class, Boolean.TYPE, Long.TYPE, List.class, Boolean.TYPE, RandomSequences.class, Environment.class, ChunkGenerator.class, BiomeProvider.class})))).make().load(WorldServer.class.getClassLoader(), Agent.installed());
            Iterator var2 = List.of(IChunkAccess.class, ProtoChunk.class).iterator();

            while(var2.hasNext()) {
               Class var3 = (Class)var2.next();
               var1.redefine(var3).visit(Advice.to(NMSBinding.ChunkAccessAdvice.class).on(ElementMatchers.isMethod().and(ElementMatchers.takesArguments(new Class[]{ShortList.class, Integer.TYPE})))).make().load(var3.getClassLoader(), Agent.installed());
            }
   ...
   public KMap<Material, List<BlockProperty>> getBlockProperties() {
      ...
      Block var3;
      IBlockData var4;
      for(Iterator var2 = this.registry().f(Registries.i).iterator(); var2.hasNext(); var1.put(CraftMagicNumbers.getMaterial(var3), var3.l().d().stream().map((var2x) -> {
         return this.createProperty(var2x, var4);
      }).toList())) {
         var3 = (Block)var2.next();
         var4 = var3.m();
         if (var4 == null) {
            var4 = (IBlockData)var3.l().b();
         }
      }
   ...
   private <T extends Comparable<T>> BlockProperty createProperty(IBlockState<T> property, IBlockData state) {
      ...
      List var10005 = var1.a();
      Objects.requireNonNull(var1);
      return new BlockProperty(var10002, var10003, var10004, var10005, var1::b);
   }
   ...
   public void placeStructures(org.bukkit.Chunk chunk) {
      ...
      var3.p().g().a(var3, var4, var3.b());
   }

   public KMap<Identifier, StructurePlacement> collectStructures() {
      IRegistry var1 = this.registry().f(Registries.br);
      IRegistry var2 = this.registry().f(Registries.aA);
      Stream var10000 = var1.i().stream();
      Objects.requireNonNull(var1);
      return (KMap)var10000.map(var1::c).filter(Optional::isPresent).map(Optional::get).map((var1x) -> {
         ...
         return new Pair(new Identifier(var4.b(), var4.a()), ((StructurePlacement.StructurePlacementBuilder)var5).salt(var3.f).frequency(var3.e).structures(var2x.a().stream().map((var0) -> {
   ...
   public WorldDimension levelStem(IRegistryCustom access, ChunkGenerator raw) {
      if (var2 instanceof PlatformChunkGenerator) {
         ...
         MinecraftKey var4 = MinecraftKey.a("iris", var3.getTarget().getDimension().getDimensionTypeKey());
         c var5 = var1.f(Registries.bd).b(ResourceKey.a(Registries.bd, var4));
   ...
   private net.minecraft.world.level.chunk.ChunkGenerator chunkGenerator(IRegistryCustom access) {
      GeneratorSettingsFlat var2 = new GeneratorSettingsFlat(Optional.empty(), var1.f(Registries.aS).b(Biomes.a), List.of());
   ...
   private static class ServerLevelAdvice {
      @OnMethodEnter
      static void enter(@Argument(0) MinecraftServer server, @Argument(3) WorldDataServer levelData, @Argument(value = 5,readOnly = false) WorldDimension levelStem, @Argument(11) Environment env, @Argument(12) ChunkGenerator gen) {
         if (var4 != null && var4.getClass().getPackageName().startsWith("com.volmit.iris")) {
            try {
               ...
               var2 = (WorldDimension)var5.getClass().getDeclaredMethod("levelStem", IRegistryCustom.class, ChunkGenerator.class).invoke(var5, var0.bc(), var4);
