...
public class CustomBiomeSource extends WorldChunkManager {
   ...
   public CustomBiomeSource(long seed, Engine engine, World world) {
      this.engine = var3;
      this.seed = var1;
      this.biomeCustomRegistry = (IRegistry)this.registry().c(Registries.aF).orElse((Object)null);
      this.biomeRegistry = (IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.aF).orElse((Object)null);
         ...
         while(var4.hasNext()) {
            ...
            if (var5.isCustom()) {
               ...
               while(var6.hasNext()) {
                  ...
                  var3.add((Holder)var0.b((ResourceKey)var0.d((BiomeBase)var0.a(MinecraftKey.a(var2.getDimension().getLoadKey(), var7.getId()))).get()).get());
               }
            } else {
   ...
   protected Stream<Holder<BiomeBase>> b() {
      return getAllBiomes((IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.aF).orElse((Object)null), (IRegistry)((CraftWorld)this.engine.getWorld().realWorld()).getHandle().H_().c(Registries.aF).orElse((Object)null), this.engine).stream();
   }
