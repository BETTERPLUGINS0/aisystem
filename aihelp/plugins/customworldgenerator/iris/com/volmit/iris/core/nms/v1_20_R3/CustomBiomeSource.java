...
public class CustomBiomeSource extends WorldChunkManager {
   ...
   public CustomBiomeSource(long seed, Engine engine, World world) {
      this.engine = var3;
      this.seed = var1;
      this.biomeCustomRegistry = (IRegistry)this.registry().c(Registries.at).orElse((Object)null);
      this.biomeRegistry = (IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.at).orElse((Object)null);
   ...
   protected Stream<Holder<BiomeBase>> b() {
      return getAllBiomes((IRegistry)((IRegistryCustom)getFor(Dimension.class, ((CraftServer)Bukkit.getServer()).getHandle().b())).c(Registries.at).orElse((Object)null), (IRegistry)((CraftWorld)this.engine.getWorld().realWorld()).getHandle().I_().c(Registries.at).orElse((Object)null), this.engine).stream();
   }
