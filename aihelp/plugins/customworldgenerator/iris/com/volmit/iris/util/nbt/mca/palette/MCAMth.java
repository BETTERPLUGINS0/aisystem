...
public class MCAMth {
   ...
   public static float fastInvCubeRoot(float var0) {
      ...
      var2 = 0.6666667F * var2 + 0.33333334F * var2 * var2 * var0;
      var2 = 0.6666667F * var2 + 0.33333334F * var2 * var2 * var0;
      return var2;
   }

   public static int hsvToRgb(float var0, float var1, float var2) {
      int var9 = (int)(var0 * 6.0F) % 6;
      float var10 = var0 * 6.0F - (float)var9;
      float var11 = var2 * (1.0F - var1);
      float var12 = var2 * (1.0F - var10 * var1);
      float var13 = var2 * (1.0F - (1.0F - var10) * var1);
      int var6;
      int var7;
      int var8;
      switch(var9) {
      case 0:
         var6 = clamp((int)((int)(var2 * 255.0F)), (int)0, (int)255);
         var7 = clamp((int)((int)(var13 * 255.0F)), (int)0, (int)255);
         var8 = clamp((int)((int)(var11 * 255.0F)), (int)0, (int)255);
         return var6 << 16 | var7 << 8 | var8;
      case 1:
         var6 = clamp((int)((int)(var12 * 255.0F)), (int)0, (int)255);
         var7 = clamp((int)((int)(var2 * 255.0F)), (int)0, (int)255);
         var8 = clamp((int)((int)(var11 * 255.0F)), (int)0, (int)255);
         return var6 << 16 | var7 << 8 | var8;
      case 2:
         var6 = clamp((int)((int)(var11 * 255.0F)), (int)0, (int)255);
         var7 = clamp((int)((int)(var2 * 255.0F)), (int)0, (int)255);
         var8 = clamp((int)((int)(var13 * 255.0F)), (int)0, (int)255);
         return var6 << 16 | var7 << 8 | var8;
      case 3:
         var6 = clamp((int)((int)(var11 * 255.0F)), (int)0, (int)255);
         var7 = clamp((int)((int)(var12 * 255.0F)), (int)0, (int)255);
         var8 = clamp((int)((int)(var2 * 255.0F)), (int)0, (int)255);
         return var6 << 16 | var7 << 8 | var8;
      case 4:
         var6 = clamp((int)((int)(var13 * 255.0F)), (int)0, (int)255);
         var7 = clamp((int)((int)(var11 * 255.0F)), (int)0, (int)255);
         var8 = clamp((int)((int)(var2 * 255.0F)), (int)0, (int)255);
         return var6 << 16 | var7 << 8 | var8;
      case 5:
         var6 = clamp((int)((int)(var2 * 255.0F)), (int)0, (int)255);
         var7 = clamp((int)((int)(var11 * 255.0F)), (int)0, (int)255);
         var8 = clamp((int)((int)(var12 * 255.0F)), (int)0, (int)255);
         return var6 << 16 | var7 << 8 | var8;
      default:
