...
public enum InterpolationMethod {
   ...
   // $FF: synthetic method
   private static InterpolationMethod[] $values() {
      return new InterpolationMethod[]{NONE, BILINEAR, STARCAST_3, STARCAST_6, STARCAST_9, STARCAST_12, BILINEAR_STARCAST_3, BILINEAR_STARCAST_6, BILINEAR_STARCAST_9, BILINEAR_STARCAST_12, HERMITE_STARCAST_3, HERMITE_STARCAST_6, HERMITE_STARCAST_9, HERMITE_STARCAST_12, BILINEAR_BEZIER, BILINEAR_PARAMETRIC_2, BILINEAR_PARAMETRIC_4, BILINEAR_PARAMETRIC_1_5, BICUBIC, HERMITE, CATMULL_ROM_SPLINE, HERMITE_TENSE, HERMITE_LOOSE, HERMITE_LOOSE_HALF_POSITIVE_BIAS, HERMITE_LOOSE_HALF_NEGATIVE_BIAS, HERMITE_LOOSE_FULL_POSITIVE_BIAS, HERMITE_LOOSE_FULL_NEGATIVE_BIAS};
   }
}
