...
public class MinningStream<T> extends BasicStream<T> {
   ...
   public T get(double x, double z) {
      return this.fromDouble(Math.min((Double)this.add.apply(var1, 0.0D, var3), this.getTypedSource().getDouble(var1, var3)));
   }

   public T get(double x, double y, double z) {
      return this.fromDouble(Math.min((Double)this.add.apply(var1, var3, var5), this.getTypedSource().getDouble(var1, var3, var5)));
   }
}
