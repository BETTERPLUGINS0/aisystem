...
public class SimplexNoise implements NoiseGenerator, OctaveNoise {
   ...
   public double noise(double x) {
      if (this.octaves <= 1) {
         return this.f(this.n.GetSimplex(var1, 0.0D));
      } else {
         double var3 = 1.0D;
         double var5 = 0.0D;
         double var7 = 0.0D;
         ...
         for(int var9 = 0; var9 < this.octaves; ++var9) {
            var7 += this.n.GetSimplex(var1 * (var3 == 1.0D ? var3++ : (var3 *= 2.0D)), 0.0D) * var3;
            var5 += var3;
         }
   ...
   public double noise(double x, double z) {
      if (this.octaves <= 1) {
         return this.f(this.n.GetSimplex(var1, var3));
      } else {
         double var5 = 1.0D;
         double var7 = 0.0D;
         double var9 = 0.0D;
         ...
         for(int var11 = 0; var11 < this.octaves; ++var11) {
            ...
            var9 += this.n.GetSimplex(var1 * var5, var3 * var5) * var5;
            var7 += var5;
         }
   ...
   public double noise(double x, double y, double z) {
      if (this.octaves <= 1) {
         return this.f(this.n.GetSimplex(var1, var3, var5));
      } else {
         double var7 = 1.0D;
         double var9 = 0.0D;
         double var11 = 0.0D;
         ...
         for(int var13 = 0; var13 < this.octaves; ++var13) {
            ...
            var11 += this.n.GetSimplex(var1 * var7, var3 * var7, var5 * var7) * var7;
            var9 += var7;
         }
