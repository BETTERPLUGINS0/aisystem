...
public class NMSPlatform extends PlatformImpl {
   ...
   public void register(TypeRegistry registry) {
      ...
      registry.registerLoader(PlatformBiome.class, (type, o, loader, depthTracker) -> {
         ...
         if (identifier == null) {
            throw new LoadException("Invalid identifier: " + String.valueOf(o), depthTracker);
         } else {
            return identifier;
         }
      }).registerLoader(Precipitation.class, (type, o, loader, depthTracker) -> {
         return Precipitation.valueOf(((String)o).toUpperCase(Locale.ROOT));
      }).registerLoader(GrassColorModifier.class, (type, o, loader, depthTracker) -> {
         return GrassColorModifier.valueOf(((String)o).toUpperCase(Locale.ROOT));
      }).registerLoader(GrassColorModifier.class, (type, o, loader, depthTracker) -> {
         return TemperatureModifier.valueOf(((String)o).toUpperCase(Locale.ROOT));
      }).registerLoader(MobCategory.class, (type, o, loader, depthTracker) -> {
         return MobCategory.valueOf((String)o);
      }).registerLoader(AmbientParticleSettings.class, BiomeParticleConfigTemplate::new).registerLoader(SoundEvent.class, SoundEventTemplate::new).registerLoader(AmbientMoodSettings.class, BiomeMoodSoundTemplate::new).registerLoader(AmbientAdditionsSettings.class, BiomeAdditionsSoundTemplate::new).registerLoader(Music.class, MusicSoundTemplate::new).registerLoader(EntityType.class, EntityTypeTemplate::new).registerLoader(SpawnCostConfig.class, SpawnCostConfig::new).registerLoader(SpawnEntryConfig.class, SpawnEntryConfig::new).registerLoader(SpawnTypeConfig.class, SpawnTypeConfig::new).registerLoader(MobSpawnSettings.class, SpawnSettingsTemplate::new).registerLoader(VillagerType.class, VillagerTypeTemplate::new);
   }

   protected InternalAddon load() {
      InternalAddon internalAddon = super.load();
      ((FunctionalEventHandler)this.getEventManager().getHandler(FunctionalEventHandler.class)).register(internalAddon, PlatformInitializationEvent.class).priority(1).then((event) -> {
