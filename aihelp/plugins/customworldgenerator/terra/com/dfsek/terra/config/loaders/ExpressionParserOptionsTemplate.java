...
public class ExpressionParserOptionsTemplate implements ObjectTemplate<ParseOptions> {
   ...
   @Default
   private boolean useLetExpressions;

   public ExpressionParserOptionsTemplate() {
      this.useLetExpressions = DEFAULT_PARSE_OPTIONS.useLetExpressions();
   }

   public ParseOptions get() {
      return new ParseOptions(this.useLetExpressions);
   }
}
