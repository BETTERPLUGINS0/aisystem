...
public class PlainsVillageTemplePopulator extends PlainsVillageAbstractRoomPopulator {
   ...
   public void populate(@NotNull PopulatorDataAbstract data, @NotNull CubeRoom room) {
      ...
      PlainsVillageTempleJigsawBuilder builder = new PlainsVillageTempleJigsawBuilder(this.plainsVillagePopulator, room.getWidthX() - 3, room.getWidthZ() - 3, data, room.getX(), height + 1, room.getZ());
