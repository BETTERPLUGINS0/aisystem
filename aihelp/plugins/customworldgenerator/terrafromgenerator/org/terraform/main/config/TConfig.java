...
public class TConfig extends YamlFileInterface {
   ...
   public float HEIGHT_MAP_LAND_HEIGHT_AMPLIFIER = 1.0F;
   ...
   public double CLIMATE_HUMIDVEGETATION_MINMOIST = 0.0D;
   ...
   public double CLIMATE_DRYVEGETATION_MAXMOIST = 0.0D;
   @YamlKey("climate.hot-barren.minimum-temperature")
   public double CLIMATE_HOTBARREN_MINTEMP = 1.0D;
   ...
   public float BIOME_MOUNTAINOUS_BESIDE_MOUNT_PEAK_MIN = 2.0F;
   ...
   public float BIOME_OCEANIC_THRESHOLD = 22.0F;
   ...
   public double BIOME_CAVE_CRYSTALLINECLUSTER_MAXPERTUB = 0.3700000047683716D;
   ...
   public float BIOME_DEEP_OCEANIC_THRESHOLD = 27.0F;
   ...
   public float BIOME_CLAY_DEPOSIT_SIZE = 3.0F;
   ...
   public double BIOME_PALE_FOREST_CREAKING_CHANCE = 0.085D;
   ...
   public double STRUCTURES_CATACOMBS_SIZEROLLCHANCE = 0.4D;
