...
public class PopulatorDataICA extends PopulatorDataICABiomeWriterAbstract {
   ...
   public void lootTableChest(int x, int y, int z, TerraLootTable table) {
      ...
      if (te instanceof TileEntityLootable) {
         TileEntityLootable.a(this.ica, RandomSource.a(this.tw.getHashedRand((long)x, y, z).nextLong()), pos, (MinecraftKey)LootTableTranslator.translationMap.get(table));
      } else if (te instanceof BrushableBlockEntity) {
         ((BrushableBlockEntity)te).a((MinecraftKey)LootTableTranslator.translationMap.get(table), this.tw.getHashedRand((long)x, y, z).nextLong());
      }
   ...
   public void registerNaturalSpawns(@NotNull NaturalSpawnType type, int x0, int y0, int z0, int x1, int y1, int z1) {
      ...
      final StructurePiece customBoundPiece = new h(RandomSource.a(), x0, z0, EnumDirection.a);
      ...
      } catch (IllegalArgumentException | IllegalAccessException | NoSuchFieldException var15) {
   ...
   public void spawnMinecartWithChest(int x, int y, int z, TerraLootTable table, @NotNull Random random) {
      ...
      entityminecartchest.a((MinecraftKey)LootTableTranslator.translationMap.get(table), random.nextLong());
