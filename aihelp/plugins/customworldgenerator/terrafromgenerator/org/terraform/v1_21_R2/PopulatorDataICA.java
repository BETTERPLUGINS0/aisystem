...
public class PopulatorDataICA extends PopulatorDataICABiomeWriterAbstract {
   ...
   public void registerNaturalSpawns(@NotNull NaturalSpawnType type, int x0, int y0, int z0, int x1, int y1, int z1) {
      ...
      IRegistry<Structure> featureRegistry = (IRegistry)MinecraftServer.getServer().ba().a(Registries.aU).orElseThrow();
   ...
   public void spawnMinecartWithChest(int x, int y, int z, TerraLootTable table, @NotNull Random random) {
      EntityMinecartChest entityminecartchest = (EntityMinecartChest)EntityTypes.y.a(this.ws.getMinecraftWorld(), EntitySpawnReason.b);
      if (entityminecartchest != null) {
         entityminecartchest.a((double)((float)x + 0.5F), (double)((float)y + 0.5F), (double)((float)z + 0.5F));
