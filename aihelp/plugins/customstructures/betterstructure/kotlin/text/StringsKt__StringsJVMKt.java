...
extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(@NotNull String $this$replace, char oldChar, char newChar, boolean ignoreCase) {
        ...
        for (int i = 0; i < $this$forEach$iv.length(); ++i) {
            ...
            boolean bl2 = false;
            $this$replace_u24lambda_u241.append(CharsKt.equals(c2, oldChar, ignoreCase) ? newChar : c2);
        }
    ...
    public static /* synthetic */ String replace$default(String string, char c2, char c3, boolean bl, int n, Object object) {
        if ((n & 4) != 0) {
            bl = false;
        }
    ...
    public static /* synthetic */ String replaceFirst$default(String string, char c2, char c3, boolean bl, int n, Object object) {
        if ((n & 4) != 0) {
            bl = false;
        }
        ...
        block0 : switch (n) {
            ...
            default: {
                switch ($this$repeat.length()) {
                    ...
                    case 1: {
                        char c2;
                        char c3 = c2 = $this$repeat.charAt(0);
                        boolean bl4 = false;
                        int n2 = 0;
