...
public final class UStringsKt {
    ...
    public static final UInt toUIntOrNull(@NotNull String $this$toUIntOrNull, int radix) {
        ...
        for (int i = start; i < length; ++i) {
            ...
            if (Integer.compareUnsigned(result = UInt.constructor-impl(result + UInt.constructor-impl(digit)), beforeAdding) >= 0) continue;
            return null;
        }
    ...
    public static final ULong toULongOrNull(@NotNull String $this$toULongOrNull, int radix) {
        ...
        for (int i = start; i < length; ++i) {
            ...
            if (Long.compareUnsigned(result = ULong.constructor-impl(result + ULong.constructor-impl((long)n & 0xFFFFFFFFL)), beforeAdding) >= 0) continue;
            return null;
        }
