        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index < length) {
                ...
                for (i$iv$iv = index; i$iv$iv < $this$skipWhile$iv$iv22.length(); ++i$iv$iv) {
                    ...
                    boolean bl = false;
                    if (!(new CharRange('0', '9').contains(it) || StringsKt.contains$default((CharSequence)nonDigitSymbols, it, false, 2, null))) break;
                }
            ...
            if (StringsKt.regionMatches(value, index, infinityString, 0, Math.max(length - index, infinityString.length()), true)) {
                ...
                while (index < length) {
                    ...
                    for (i$iv$iv2 = index; i$iv$iv2 < $this$skipWhile$iv$iv422.length(); ++i$iv$iv2) {
                        ...
                        boolean bl3 = false;
                        if (!(new CharRange('0', '9').contains(it2) || it2 == '.')) break;
                    }
                    ...
                    for (i$iv$iv = index; i$iv$iv < $this$skipWhile$iv$iv.length(); ++i$iv$iv) {
                        ...
                        boolean bl4 = false;
                        if (!new CharRange('a', 'z').contains(it3)) break;
                    }
                    int n = i$iv$iv;
            ...
            block6: {
                ...
                if ($this$all$iv instanceof Collection && ((Collection)$this$all$iv).isEmpty()) {
                    ...
                    while (iterator2.hasNext()) {
                        ...
                        boolean bl2 = false;
                        if (new CharRange('0', '9').contains(value.charAt(it))) continue;
                        bl = false;
                        break block6;
                    }
                    bl = true;
