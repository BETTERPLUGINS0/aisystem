...
extends MathKt__MathHKt {
    ...
    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final double min(double a, double b2) {
        return Math.min(a, b2);
    }

    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final double max(double a, double b2) {
    ...
    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final float min(float a, float b2) {
        return Math.min(a, b2);
    }

    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final float max(float a, float b2) {
        return Math.max(a, b2);
    }
    ...
    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final int min(int a, int b2) {
        return Math.min(a, b2);
    }

    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final int max(int a, int b2) {
        return Math.max(a, b2);
    }
    ...
    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final long min(long a, long b2) {
        return Math.min(a, b2);
    }

    @SinceKotlin(version="1.2")
    @InlineOnly
    private static final long max(long a, long b2) {
        return Math.max(a, b2);
    }
