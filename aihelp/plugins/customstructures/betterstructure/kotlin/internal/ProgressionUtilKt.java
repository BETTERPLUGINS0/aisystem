...
public final class ProgressionUtilKt {
    private static final int mod(int a, int b2) {
        int mod = a % b2;
        return mod >= 0 ? mod : mod + b2;
    }

    private static final long mod(long a, long b2) {
        long mod = a % b2;
        return mod >= 0L ? mod : mod + b2;
    }

    private static final int differenceModulo(int a, int b2, int c2) {
        return ProgressionUtilKt.mod(ProgressionUtilKt.mod(a, c2) - ProgressionUtilKt.mod(b2, c2), c2);
    }

    private static final long differenceModulo(long a, long b2, long c2) {
        return ProgressionUtilKt.mod(ProgressionUtilKt.mod(a, c2) - ProgressionUtilKt.mod(b2, c2), c2);
    }
