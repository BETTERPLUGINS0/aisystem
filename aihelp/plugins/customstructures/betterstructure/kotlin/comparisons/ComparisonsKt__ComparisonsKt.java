...
class ComparisonsKt__ComparisonsKt {
    public static final <T> int compareValuesBy(T a, T b2, @NotNull Function1<? super T, ? extends Comparable<?>> ... selectors) {
        boolean bl;
        ...
        return ComparisonsKt__ComparisonsKt.compareValuesByImpl$ComparisonsKt__ComparisonsKt(a, b2, selectors);
    }

    private static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(T a, T b2, Function1<? super T, ? extends Comparable<?>>[] selectors) {
    ...
    @InlineOnly
    private static final <T> int compareValuesBy(T a, T b2, Function1<? super T, ? extends Comparable<?>> selector) {
        Intrinsics.checkNotNullParameter(selector, "selector");
        return ComparisonsKt.compareValues(selector.invoke(a), selector.invoke(b2));
    }

    @InlineOnly
    private static final <T, K> int compareValuesBy(T a, T b2, Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return comparator.compare(selector.invoke(a), selector.invoke(b2));
    }

    public static final <T extends Comparable<?>> int compareValues(@Nullable T a, @Nullable T b2) {
        if (a == b2) {
            return 0;
        }
        if (a == null) {
    ...
    private static final <T> Comparator<T> compareBy(Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator(selector){
            ...
            public final int compare(T a, T b2) {
                ...
                return ComparisonsKt.compareValues(function1.invoke(a), function1.invoke(b2));
            }
        };
    }
    ...
    private static final <T, K> Comparator<T> compareBy(Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator(comparator, selector){
            ...
            public final int compare(T a, T b2) {
                ...
                return comparator.compare(function1.invoke(a), function1.invoke(b2));
            }
        };
    }
    ...
    private static final <T> Comparator<T> compareByDescending(Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator(selector){
            ...
            public final int compare(T a, T b2) {
                Function1<T, Comparable<?>> function1 = this.$selector;
                return ComparisonsKt.compareValues(function1.invoke(b2), function1.invoke(a));
            }
        };
    }
    ...
    private static final <T, K> Comparator<T> compareByDescending(Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator(comparator, selector){
            ...
            public final int compare(T a, T b2) {
                Comparator<K> comparator = this.$comparator;
                Function1<T, K> function1 = this.$selector;
                return comparator.compare(function1.invoke(b2), function1.invoke(a));
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenBy(Comparator<T> $this$thenBy, Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator($this$thenBy, selector){
            ...
            public final int compare(T a, T b2) {
                int n;
                int previousCompare = this.$this_thenBy.compare(a, b2);
                if (previousCompare != 0) {
                    n = previousCompare;
                } else {
                    Function1<T, Comparable<?>> function1 = this.$selector;
                    n = ComparisonsKt.compareValues(function1.invoke(a), function1.invoke(b2));
                }
                return n;
            }
        };
        ...
        return new Comparator($this$thenBy, comparator, selector){
            ...
            public final int compare(T a, T b2) {
                ...
                if (previousCompare != 0) {
                    ...
                    Comparator<K> comparator = this.$comparator;
                    Function1<T, K> function1 = this.$selector;
                    n = comparator.compare(function1.invoke(a), function1.invoke(b2));
                }
                return n;
            }
        };
    ...
    private static final <T> Comparator<T> thenByDescending(Comparator<T> $this$thenByDescending, Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator($this$thenByDescending, selector){
            ...
            public final int compare(T a, T b2) {
                int n;
                int previousCompare = this.$this_thenByDescending.compare(a, b2);
                if (previousCompare != 0) {
                    n = previousCompare;
                } else {
                    Function1<T, Comparable<?>> function1 = this.$selector;
                    n = ComparisonsKt.compareValues(function1.invoke(b2), function1.invoke(a));
                }
                return n;
            }
        };
        ...
        return new Comparator($this$thenByDescending, comparator, selector){
            ...
            public final int compare(T a, T b2) {
                ...
                if (previousCompare != 0) {
                    ...
                    Comparator<K> comparator = this.$comparator;
                    Function1<T, K> function1 = this.$selector;
                    n = comparator.compare(function1.invoke(b2), function1.invoke(a));
                }
                return n;
            }
        };
    ...
    private static final <T> Comparator<T> thenComparator(Comparator<T> $this$thenComparator, Function2<? super T, ? super T, Integer> comparison) {
        ...
        return new Comparator($this$thenComparator, comparison){
            ...
            public final int compare(T a, T b2) {
                int previousCompare = this.$this_thenComparator.compare(a, b2);
                return previousCompare != 0 ? previousCompare : ((Number)this.$comparison.invoke(a, b2)).intValue();
            }
        };
    }
    ...
    private static final int compareBy$lambda$0$ComparisonsKt__ComparisonsKt(Function1[] $selectors, Object a, Object b2) {
        Intrinsics.checkNotNullParameter($selectors, "$selectors");
        return ComparisonsKt__ComparisonsKt.compareValuesByImpl$ComparisonsKt__ComparisonsKt(a, b2, $selectors);
    }

    private static final int then$lambda$1$ComparisonsKt__ComparisonsKt(Comparator $this_then, Comparator $comparator, Object a, Object b2) {
        Intrinsics.checkNotNullParameter($this_then, "$this_then");
        Intrinsics.checkNotNullParameter($comparator, "$comparator");
        int previousCompare = $this_then.compare(a, b2);
        return previousCompare != 0 ? previousCompare : $comparator.compare(a, b2);
    }

    private static final int thenDescending$lambda$2$ComparisonsKt__ComparisonsKt(Comparator $this_thenDescending, Comparator $comparator, Object a, Object b2) {
        Intrinsics.checkNotNullParameter($this_thenDescending, "$this_thenDescending");
        Intrinsics.checkNotNullParameter($comparator, "$comparator");
        int previousCompare = $this_thenDescending.compare(a, b2);
        return previousCompare != 0 ? previousCompare : $comparator.compare(b2, a);
    }

    private static final int nullsFirst$lambda$3$ComparisonsKt__ComparisonsKt(Comparator $comparator, Object a, Object b2) {
        Intrinsics.checkNotNullParameter($comparator, "$comparator");
        return a == b2 ? 0 : (a == null ? -1 : (b2 == null ? 1 : $comparator.compare(a, b2)));
    }

    private static final int nullsLast$lambda$4$ComparisonsKt__ComparisonsKt(Comparator $comparator, Object a, Object b2) {
        Intrinsics.checkNotNullParameter($comparator, "$comparator");
        return a == b2 ? 0 : (a == null ? 1 : (b2 == null ? -1 : $comparator.compare(a, b2)));
    }
}
