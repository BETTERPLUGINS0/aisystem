...
extends ComparisonsKt___ComparisonsJvmKt {
    ...
    public static final <T> T maxOf(T a, T b2, T c2, @NotNull Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return ComparisonsKt.maxOf(a, ComparisonsKt.maxOf(b2, c2, comparator), comparator);
    }

    @SinceKotlin(version="1.1")
    public static final <T> T maxOf(T a, T b2, @NotNull Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return comparator.compare(a, b2) >= 0 ? a : b2;
    }
    ...
    @SinceKotlin(version="1.1")
    public static final <T> T minOf(T a, T b2, T c2, @NotNull Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return ComparisonsKt.minOf(a, ComparisonsKt.minOf(b2, c2, comparator), comparator);
    }

    @SinceKotlin(version="1.1")
    public static final <T> T minOf(T a, T b2, @NotNull Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return comparator.compare(a, b2) <= 0 ? a : b2;
    }
