...
public interface Scanner {
    ...
    default public List<Map.Entry<String, String>> entries(Collection<String> keys2, String value) {
        return keys2.stream().map(key -> this.entry((String)key, value)).collect(Collectors.toList());
    }
    ...
    default public List<Map.Entry<String, String>> entries(String key, Collection<String> values2) {
        return values2.stream().map(value -> this.entry(key, (String)value)).collect(Collectors.toList());
    }
}
