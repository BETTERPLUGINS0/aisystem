...
public class UndergroundGeneratorGlobalConfig
extends GeneratorConfigFields {
    public UndergroundGeneratorGlobalConfig() {
        super("generator_underground_global", true, Arrays.asList(GeneratorConfigFields.StructureType.UNDERGROUND_DEEP, GeneratorConfigFields.StructureType.UNDERGROUND_SHALLOW));
