...
public class GeneratorUndergroundNetherDeep
extends GeneratorConfigFields {
    public GeneratorUndergroundNetherDeep() {
        super("generator_underground_nether_deep", true, Arrays.asList(GeneratorConfigFields.StructureType.UNDERGROUND_DEEP));
