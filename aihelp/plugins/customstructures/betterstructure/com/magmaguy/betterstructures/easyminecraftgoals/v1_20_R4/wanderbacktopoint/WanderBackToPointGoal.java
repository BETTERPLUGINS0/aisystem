...
implements AbstractWanderBackToPoint {
    ...
    public void c() {
        this.pathfinderMob.K().a(this.path, (double)this.speed);
    }
    ...
    public void d() {
        if (this.pathfinderMob != null) {
            this.pathfinderMob.K().n();
            this.path = null;
        }
        if (this.hardObjective && (this.pathfinderMob == null || this.pathfinderMob.gm())) {
    ...
    public boolean a() {
        ...
        if (this.pathfinderMob != null) {
            this.path = this.pathfinderMob.K().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
            if (this.path == null) {
                return false;
            }
        }
