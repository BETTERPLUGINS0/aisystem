...
implements PacketEntityInterface {
    ...
    public void displayTo(Player player) {
        ...
        this.sendPacketToPlayer(player, new Packet[]{new PacketPlayOutSpawnEntity(this.EntityID, this.entity.cG(), this.entity.dA(), this.entity.dC(), this.entity.dG(), this.entity.dN(), this.entity.dL(), this.entity.an(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0), this.createEntityDataPacket()});
    }
    ...
    public Packet<?> generateMovePacket(Location location) {
        ...
        this.entity.w(location.getYaw());
        this.entity.x(location.getPitch());
