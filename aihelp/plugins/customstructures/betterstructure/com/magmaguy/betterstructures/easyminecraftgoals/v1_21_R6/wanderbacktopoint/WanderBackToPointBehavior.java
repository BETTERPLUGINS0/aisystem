 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R6.wanderbacktopoint;
...
implements AbstractWanderBackToPoint {
    ...
    protected boolean a(WorldServer var0, EntityLiving nmsLivingEntity) {
        if (!this.hardObjective && this.mob.e() instanceof EntityHuman) {
            this.updateCooldown();
            return false;
        }
        ...
        this.path = ((EntityCreature)nmsLivingEntity).S().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
    ...
    protected void d(WorldServer var0, EntityLiving var1, long var2) {
        this.mob.S().n();
        this.mob.S().a(this.path, (double)this.speed);
        this.mob.eq().a(Activity.a);
        if (this.hardObjective) {
            new BukkitRunnable(){

                public void run() {
                    if (!WanderBackToPointBehavior.this.livingEntity.isValid() || WanderBackToPointBehavior.this.mob.S().l() || WanderBackToPointBehavior.this.path == null || !WanderBackToPointBehavior.this.path.j()) {
                        this.cancel();
                    ...
                    WanderBackToPointBehavior.this.mob.S().a(WanderBackToPointBehavior.this.path, (double)WanderBackToPointBehavior.this.speed);
                }
    ...
    public void register() {
        ...
        this.mob.eq().a(Activity.a, this.priority, ImmutableList.of(this));
    }
