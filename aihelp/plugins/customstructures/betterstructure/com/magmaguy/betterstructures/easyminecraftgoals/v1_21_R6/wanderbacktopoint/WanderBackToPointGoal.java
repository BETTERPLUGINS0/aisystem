...
implements AbstractWanderBackToPoint {
    ...
    public void d() {
        this.pathfinderMob.S().a(this.path, (double)this.speed);
    }
    ...
    public void e() {
        if (this.pathfinderMob != null) {
            this.pathfinderMob.S().n();
            this.path = null;
        }
        if (this.hardObjective && (this.pathfinderMob == null || this.pathfinderMob.gE())) {
    ...
    public boolean b() {
        ...
        if (this.pathfinderMob != null) {
            this.path = this.pathfinderMob.S().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
            if (this.path == null) {
                return false;
            }
        }
    ...
    public void register() {
        ...
        this.mob.cq.a(this.priority, (PathfinderGoal)this);
    }

    @Override
    public void unregister() {
        this.mob.cq.a((PathfinderGoal)this);
    }
}
