...
implements AbstractWanderBackToPoint {
    ...
    public void d() {
        this.pathfinderMob.P().a(this.path, (double)this.speed);
    }
    ...
    public void e() {
        if (this.pathfinderMob != null) {
            this.pathfinderMob.P().m();
            this.path = null;
        }
        if (this.hardObjective && (this.pathfinderMob == null || this.pathfinderMob.go())) {
    ...
    public boolean b() {
        ...
        if (this.pathfinderMob != null) {
            this.path = this.pathfinderMob.P().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
            if (this.path == null) {
                return false;
            }
        }
    ...
    public void register() {
        ...
        this.mob.bS.a(this.priority, (PathfinderGoal)this);
    }

    @Override
    public void unregister() {
        this.mob.bS.a((PathfinderGoal)this);
    }
}
