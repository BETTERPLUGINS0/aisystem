 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R6.move;
...
public class Move {
    ...
    public static void universalMove(EntityInsentient mob, double speedModifier, Location destination) {
        ...
        Vec3D movementInTick = new Vec3D(destination.getX(), destination.getY(), destination.getZ()).d(mob.dD());
        ...
        Move.rotateHead((Entity)mob, destination.toVector(), new Vector(mob.dD().g, mob.dD().h, mob.dD().i));
    }
