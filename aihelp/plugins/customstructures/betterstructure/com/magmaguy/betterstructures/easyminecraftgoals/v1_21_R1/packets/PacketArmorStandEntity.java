...
PacketTextEntity {
    ...
    public void displayTo(Player player) {
        ...
        if (this.nmsLeatherHorseArmor != null) {
            this.sendPacket(player, new Packet[]{new PacketPlayOutEntityEquipment(((EntityArmorStand)this.entity).an(), List.of((Object)Pair.of((Object)EnumItemSlot.f, (Object)this.nmsLeatherHorseArmor)))});
        }
    }
