 ...
 *  org.bukkit.Location
 *  org.bukkit.World
 *  org.bukkit.craftbukkit.v1_21_R3.CraftWorld
 *  org.bukkit.craftbukkit.v1_21_R3.entity.CraftPlayer
 *  org.bukkit.entity.Entity
 *  org.bukkit.entity.Player
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R3.packets;
...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)this.entity.dV().getWorld(), this.entity.dA(), this.entity.dC(), this.entity.dG(), this.entity.dL(), this.entity.dN());
    }
    ...
    public void displayTo(Player player) {
        ...
        this.sendPacketToPlayer(player, new Packet[]{new PacketPlayOutSpawnEntity(this.EntityID, this.entity.cG(), this.entity.dA(), this.entity.dC(), this.entity.dG(), this.entity.dN(), this.entity.dL(), this.entity.aq(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0), this.createEntityDataPacket()});
    }
    ...
    protected Packet<?> generateTeleportPacket() {
        return new PacketPlayOutEntityTeleport(this.EntityID, new PositionMoveRotation(this.entity.dt(), new Vec3D(0.0, 0.0, 0.0), this.entity.dL(), this.entity.dN()), new HashSet(), true);
    }
