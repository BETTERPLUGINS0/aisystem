...
PacketTextEntity {
    ...
    public void initializeModel(Location location, String modelID) {
        ...
        this.nmsLeatherHorseArmor = CraftBukkitBridge.asNMSCopy(this.leatherHorseArmor);
    ...
    public void displayTo(Player player) {
        ...
        if (this.nmsLeatherHorseArmor != null) {
            this.sendPacket(player, new Packet[]{new PacketPlayOutEntityEquipment(((EntityArmorStand)this.entity).aA(), List.of((Object)Pair.of((Object)EnumItemSlot.f, (Object)this.nmsLeatherHorseArmor)))});
        }
    }
