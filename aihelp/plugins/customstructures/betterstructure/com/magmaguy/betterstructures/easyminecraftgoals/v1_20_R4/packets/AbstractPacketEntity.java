...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)this.entity.dP().getWorld(), this.entity.du(), this.entity.dw(), this.entity.dA(), this.entity.dF(), this.entity.dH());
    }

    @Override
    public UUID getUniqueId() {
        return this.entity.cz();
    }

    protected Packet<?> createEntityDataPacket() {
        List dataValues = this.entity.ap().c();
        if (dataValues == null) {
            return null;
        }
        return new PacketPlayOutEntityMetadata(this.entity.al(), dataValues);
    }

    public Packet<?> generateRemovePacket() {
        return new PacketPlayOutEntityDestroy(new int[]{this.entity.al()});
    }
    ...
    public List<Packet<?>> generateDisplayToPackets(Player player) {
        ...
        packets.add((Packet<?>)new PacketPlayOutSpawnEntity(this.entity.al(), this.entity.cz(), this.entity.du(), this.entity.dw(), this.entity.dA(), this.entity.dH(), this.entity.dF(), this.entity.ak(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0));
    ...
    public Packet generateMovePacket(Location location) {
        ...
        return new PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook(this.entity.al(), (short)(deltaX * 4096.0), (short)(deltaY * 4096.0), (short)(deltaZ * 4096.0), (byte)(newPos.getYaw() * 256.0f / 360.0f), (byte)(newPos.getPitch() * 256.0f / 360.0f), true);
    }
