 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R1.move;
...
public class Move {
    ...
    public static void universalMove(EntityInsentient mob, double speedModifier, Location destination) {
        double speed = mob.g(GenericAttributes.v) * 0.75;
        Vec3D movementInTick = new Vec3D(destination.getX(), destination.getY(), destination.getZ()).d(mob.dm());
        ...
        Move.rotateHead((Entity)mob, destination.toVector(), new Vector(mob.dm().c, mob.dm().d, mob.dm().e));
    }
