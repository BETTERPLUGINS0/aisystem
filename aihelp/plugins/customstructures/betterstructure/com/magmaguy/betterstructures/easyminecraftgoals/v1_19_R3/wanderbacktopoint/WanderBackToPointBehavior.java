...
implements AbstractWanderBackToPoint {
    ...
    protected boolean a(WorldServer var0, EntityLiving nmsLivingEntity) {
        ...
        this.path = ((EntityCreature)nmsLivingEntity).G().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
    ...
    public void register() {
        ...
        this.mob.dH().a(Activity.a, this.priority, ImmutableList.of(this));
    }
