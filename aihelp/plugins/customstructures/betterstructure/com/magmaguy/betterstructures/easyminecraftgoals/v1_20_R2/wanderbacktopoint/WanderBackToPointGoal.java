...
implements AbstractWanderBackToPoint {
    ...
    public void d() {
        if (this.pathfinderMob != null) {
            this.pathfinderMob.L().n();
            this.path = null;
        }
        if (this.hardObjective && (this.pathfinderMob == null || this.pathfinderMob.fZ())) {
    ...
    public void register() {
        ...
        this.mob.bO.a(this.priority, (PathfinderGoal)this);
    }

    @Override
    public void unregister() {
        this.mob.bO.a((PathfinderGoal)this);
    }
}
