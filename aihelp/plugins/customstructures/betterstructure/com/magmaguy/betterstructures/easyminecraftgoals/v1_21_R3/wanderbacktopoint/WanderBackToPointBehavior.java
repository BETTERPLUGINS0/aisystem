 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R3.wanderbacktopoint;
...
implements AbstractWanderBackToPoint {
    ...
    protected boolean a(WorldServer var0, EntityLiving nmsLivingEntity) {
        ...
        this.path = ((EntityCreature)nmsLivingEntity).P().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
    ...
    protected void d(WorldServer var0, EntityLiving var1, long var2) {
        this.mob.P().m();
        this.mob.P().a(this.path, (double)this.speed);
        this.mob.eb().a(Activity.a);
        if (this.hardObjective) {
            new BukkitRunnable(){

                public void run() {
                    if (!WanderBackToPointBehavior.this.livingEntity.isValid() || WanderBackToPointBehavior.this.mob.P().k() || WanderBackToPointBehavior.this.path == null || !WanderBackToPointBehavior.this.path.j()) {
                        this.cancel();
                    ...
                    WanderBackToPointBehavior.this.mob.P().a(WanderBackToPointBehavior.this.path, (double)WanderBackToPointBehavior.this.speed);
                }
    ...
    public void register() {
        ...
        this.mob.eb().a(Activity.a, this.priority, ImmutableList.of(this));
    }
