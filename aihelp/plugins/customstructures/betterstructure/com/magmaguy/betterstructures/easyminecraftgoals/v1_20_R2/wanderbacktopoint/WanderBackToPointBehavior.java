 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_20_R2.wanderbacktopoint;
...
implements AbstractWanderBackToPoint {
    ...
    protected boolean a(WorldServer var0, EntityLiving nmsLivingEntity) {
        if (!this.hardObjective && this.mob.q() instanceof EntityHuman) {
            this.updateCooldown();
            return false;
        }
    ...
    protected void d(WorldServer var0, EntityLiving var1, long var2) {
        ...
        this.mob.dN().a(Activity.a);
        if (this.hardObjective) {
            new BukkitRunnable(){

                public void run() {
                    if (!WanderBackToPointBehavior.this.livingEntity.isValid() || WanderBackToPointBehavior.this.mob.L().l() || WanderBackToPointBehavior.this.path == null || !WanderBackToPointBehavior.this.path.j()) {
                        this.cancel();
    ...
    public void register() {
        ...
        this.mob.dN().a(Activity.a, this.priority, ImmutableList.of(this));
    }
