 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_19_R3.packets;
...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)((net.minecraft.world.entity.Entity)this.entity).H.getWorld(), this.entity.dl(), this.entity.dn(), this.entity.dr(), this.entity.dw(), this.entity.dy());
    }
    ...
    public List<Packet<?>> generateDisplayToPackets(Player player) {
        ...
        packets.add((Packet<?>)new PacketPlayOutSpawnEntity(this.entity.af(), this.entity.cs(), this.entity.dl(), this.entity.dn(), this.entity.dr(), this.entity.dy(), this.entity.dw(), this.entity.ae(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0));
