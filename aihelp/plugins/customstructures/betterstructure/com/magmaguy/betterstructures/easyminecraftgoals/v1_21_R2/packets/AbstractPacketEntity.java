 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R2.packets;
...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)this.entity.dW().getWorld(), this.entity.dB(), this.entity.dD(), this.entity.dH(), this.entity.dM(), this.entity.dO());
    }
    ...
    public void displayTo(Player player) {
        ...
        this.sendPacketToPlayer(player, new Packet[]{new PacketPlayOutSpawnEntity(this.EntityID, this.entity.cG(), this.entity.dB(), this.entity.dD(), this.entity.dH(), this.entity.dO(), this.entity.dM(), this.entity.aq(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0), this.createEntityDataPacket()});
    }
    ...
    protected Packet<?> generateTeleportPacket() {
        return new PacketPlayOutEntityTeleport(this.EntityID, new PositionMoveRotation(this.entity.du(), new Vec3D(0.0, 0.0, 0.0), this.entity.dM(), this.entity.dO()), new HashSet(), true);
    }
