...
import com.magmaguy.betterstructures.easyminecraftgoals.v1_19_R3.packets.AbstractPacketEntity;
...
PacketTextEntity {
    ...
    protected EntityArmorStand createEntity(Location location) {
        return new EntityArmorStand(EntityTypes.d, this.getNMSLevel(location));
    }
    ...
    public void displayTo(Player player) {
        ...
        if (this.nmsLeatherHorseArmor != null) {
            this.sendPacket(player, new Packet[]{new PacketPlayOutEntityEquipment(((EntityArmorStand)this.entity).af(), List.of((Object)Pair.of((Object)EnumItemSlot.f, (Object)this.nmsLeatherHorseArmor)))});
        }
    }
