 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_20_R3.move;
...
public class Move {
    ...
    public static void universalMove(EntityInsentient mob, double speedModifier, Location destination) {
        double speed = mob.b(GenericAttributes.m) * 0.75;
        Vec3D movementInTick = new Vec3D(destination.getX(), destination.getY(), destination.getZ()).d(mob.dk());
        ...
        Move.rotateHead((Entity)mob, destination.toVector(), new Vector(mob.dk().c, mob.dk().d, mob.dk().e));
    }
