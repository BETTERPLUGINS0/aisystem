...
implements AbstractWanderBackToPoint {
    ...
    public void d() {
        this.pathfinderMob.L().a(this.path, (double)this.speed);
    }
    ...
    public void e() {
        if (this.pathfinderMob != null) {
            this.pathfinderMob.L().o();
            this.path = null;
        }
        if (this.hardObjective && (this.pathfinderMob == null || this.pathfinderMob.gk())) {
    ...
    public boolean b() {
        ...
        if (this.pathfinderMob != null) {
            this.path = this.pathfinderMob.L().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
            if (this.path == null) {
                return false;
            }
        }
    ...
    public void register() {
        ...
        this.mob.bT.a(this.priority, (PathfinderGoal)this);
    }

    @Override
    public void unregister() {
        this.mob.bT.a((PathfinderGoal)this);
    }
}
