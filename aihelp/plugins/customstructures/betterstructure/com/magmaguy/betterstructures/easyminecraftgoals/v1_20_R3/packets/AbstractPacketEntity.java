...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)this.entity.dM().getWorld(), this.entity.dr(), this.entity.dt(), this.entity.dx(), this.entity.dC(), this.entity.dE());
    }

    @Override
    public UUID getUniqueId() {
        return this.entity.cw();
    }

    protected Packet<?> createEntityDataPacket() {
        List dataValues = this.entity.an().c();
        if (dataValues == null) {
            return null;
        }
        return new PacketPlayOutEntityMetadata(this.entity.aj(), dataValues);
    }

    public Packet<?> generateRemovePacket() {
        return new PacketPlayOutEntityDestroy(new int[]{this.entity.aj()});
    }
    ...
    public List<Packet<?>> generateDisplayToPackets(Player player) {
        ...
        packets.add((Packet<?>)new PacketPlayOutSpawnEntity(this.entity.aj(), this.entity.cw(), this.entity.dr(), this.entity.dt(), this.entity.dx(), this.entity.dE(), this.entity.dC(), this.entity.ai(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0));
    ...
    public void teleport(Location location) {
        this.entity.c(location.getX(), location.getY(), location.getZ());
    ...
    public Packet generateMovePacket(Location location) {
        ...
        return new PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook(this.entity.aj(), (short)(deltaX * 4096.0), (short)(deltaY * 4096.0), (short)(deltaZ * 4096.0), (byte)(newPos.getYaw() * 256.0f / 360.0f), (byte)(newPos.getPitch() * 256.0f / 360.0f), true);
    }
