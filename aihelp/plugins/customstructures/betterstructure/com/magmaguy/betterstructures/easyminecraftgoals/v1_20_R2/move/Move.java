 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_20_R2.move;
...
public class Move {
    ...
    public static void universalMove(EntityInsentient mob, double speedModifier, Location destination) {
        ...
        Vec3D movementInTick = new Vec3D(destination.getX(), destination.getY(), destination.getZ()).d(mob.dj());
        ...
        Move.rotateHead((Entity)mob, destination.toVector(), new Vector(mob.dj().c, mob.dj().d, mob.dj().e));
    }
