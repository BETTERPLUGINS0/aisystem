...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)this.entity.an().getWorld(), this.entity.dK(), this.entity.dM(), this.entity.dQ(), this.entity.dX(), this.entity.dZ());
    }
    ...
    protected Packet<?> createEntityDataPacket() {
        List dataValues = this.entity.aC().c();
        if (dataValues == null) {
            return null;
        }
    ...
    public void displayTo(Player player) {
        ...
        this.sendPacketToPlayer(player, new Packet[]{new PacketPlayOutSpawnEntity(this.EntityID, this.entity.cT(), this.entity.dK(), this.entity.dM(), this.entity.dQ(), this.entity.dZ(), this.entity.dX(), this.entity.ax(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0), this.createEntityDataPacket()});
    }
    ...
    protected Packet<?> generateTeleportPacket() {
        return new PacketPlayOutEntityTeleport(this.EntityID, new PositionMoveRotation(this.entity.dD(), new Vec3D(0.0, 0.0, 0.0), this.entity.dX(), this.entity.dZ()), new HashSet(), true);
    }
