 ...
 *  org.bukkit.Location
 *  org.bukkit.World
 *  org.bukkit.craftbukkit.v1_21_R1.CraftWorld
 *  org.bukkit.craftbukkit.v1_21_R1.entity.CraftPlayer
 *  org.bukkit.entity.Entity
 *  org.bukkit.entity.Player
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R1.packets;
...
implements PacketEntityInterface {
    ...
    public Location getLocation() {
        return new Location((org.bukkit.World)this.entity.dO().getWorld(), this.entity.dt(), this.entity.dv(), this.entity.dz(), this.entity.dE(), this.entity.dG());
    }
    ...
    protected Packet<?> createEntityDataPacket() {
        List dataValues = this.entity.ar().c();
        if (dataValues == null) {
            return null;
        }
    ...
    public void displayTo(Player player) {
        ...
        this.sendPacketToPlayer(player, new Packet[]{new PacketPlayOutSpawnEntity(this.EntityID, this.entity.cz(), this.entity.dt(), this.entity.dv(), this.entity.dz(), this.entity.dG(), this.entity.dE(), this.entity.am(), 0, new Vec3D(0.0, 0.0, 0.0), 0.0), this.createEntityDataPacket()});
    }
    ...
    public Packet<?> generateMovePacket(Location location) {
        ...
        this.entity.t(location.getYaw());
        this.entity.u(location.getPitch());
