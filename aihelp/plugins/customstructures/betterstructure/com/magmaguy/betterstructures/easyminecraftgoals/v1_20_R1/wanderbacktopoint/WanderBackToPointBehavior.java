 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_20_R1.wanderbacktopoint;
...
implements AbstractWanderBackToPoint {
    ...
    protected boolean a(WorldServer var0, EntityLiving nmsLivingEntity) {
        ...
        this.path = ((EntityCreature)nmsLivingEntity).J().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
    ...
    public void register() {
        ...
        this.mob.dK().a(Activity.a, this.priority, ImmutableList.of(this));
    }
