...
import com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R1.packets.AbstractPacketEntity;
...
implements PacketModelEntity {
    ...
    protected Display.ItemDisplay createEntity(Location location) {
        return new Display.ItemDisplay(EntityTypes.ah, this.getNMSLevel(location));
    }
