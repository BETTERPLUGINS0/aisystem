 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_20_R4.wanderbacktopoint;
...
implements AbstractWanderBackToPoint {
    ...
    protected boolean a(WorldServer var0, EntityLiving nmsLivingEntity) {
        if (!this.hardObjective && this.mob.p() instanceof EntityHuman) {
            this.updateCooldown();
            return false;
        }
        ...
        this.path = ((EntityCreature)nmsLivingEntity).K().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
    ...
    protected void d(WorldServer var0, EntityLiving var1, long var2) {
        this.mob.K().n();
        this.mob.K().a(this.path, (double)this.speed);
        this.mob.dS().a(Activity.a);
        if (this.hardObjective) {
            new BukkitRunnable(){

                public void run() {
                    if (!WanderBackToPointBehavior.this.livingEntity.isValid() || WanderBackToPointBehavior.this.mob.K().l() || WanderBackToPointBehavior.this.path == null || !WanderBackToPointBehavior.this.path.j()) {
                        this.cancel();
                    ...
                    WanderBackToPointBehavior.this.mob.K().a(WanderBackToPointBehavior.this.path, (double)WanderBackToPointBehavior.this.speed);
                }
    ...
    public void register() {
        ...
        this.mob.dS().a(Activity.a, this.priority, ImmutableList.of(this));
    }
