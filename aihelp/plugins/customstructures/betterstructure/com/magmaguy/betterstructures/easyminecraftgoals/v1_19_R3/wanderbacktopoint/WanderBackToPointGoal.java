 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_19_R3.wanderbacktopoint;
...
implements AbstractWanderBackToPoint {
    ...
    public void c() {
        this.pathfinderMob.G().a(this.path, (double)this.speed);
    }
    ...
    public void d() {
        if (this.pathfinderMob != null) {
            this.pathfinderMob.G().n();
            this.path = null;
        }
        if (this.hardObjective && (this.pathfinderMob == null || this.pathfinderMob.fP())) {
    ...
    public boolean a() {
        if (!this.hardObjective && this.mob.P_() instanceof EntityHuman) {
            this.updateCooldown();
            return false;
        }
        ...
        if (this.pathfinderMob != null) {
            this.path = this.pathfinderMob.G().a(this.returnLocation.getX(), this.returnLocation.getY(), this.returnLocation.getZ(), this.stopReturnDistance);
            if (this.path == null) {
                return false;
            }
        }
    ...
    public void register() {
        ...
        this.mob.bN.a(this.priority, (PathfinderGoal)this);
    }

    @Override
    public void unregister() {
        this.mob.bN.a((PathfinderGoal)this);
    }
}
