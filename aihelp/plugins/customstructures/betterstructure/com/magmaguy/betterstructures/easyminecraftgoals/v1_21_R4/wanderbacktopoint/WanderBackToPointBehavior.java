 ...
 */
package com.magmaguy.betterstructures.easyminecraftgoals.v1_21_R4.wanderbacktopoint;
    ...
    protected void d(WorldServer var0, EntityLiving var1, long var2) {
        ...
        if (this.hardObjective) {
            new BukkitRunnable(){
                ...
                public void run() {
                    if (!WanderBackToPointBehavior.this.livingEntity.isValid() || WanderBackToPointBehavior.this.mob.N().k() || WanderBackToPointBehavior.this.path == null || !WanderBackToPointBehavior.this.path.j()) {
                        this.cancel();
