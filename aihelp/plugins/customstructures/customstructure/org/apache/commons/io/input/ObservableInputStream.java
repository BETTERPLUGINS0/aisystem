...
public class ObservableInputStream extends ProxyInputStream {
   ...
   protected void noteClosed() throws IOException {
      ...
      while(var1.hasNext()) {
         ObservableInputStream.Observer observer = (ObservableInputStream.Observer)var1.next();
         observer.closed();
      }
   ...
   protected void noteDataByte(int value) throws IOException {
      ...
      while(var2.hasNext()) {
         ObservableInputStream.Observer observer = (ObservableInputStream.Observer)var2.next();
         observer.data(value);
      }
   ...
   protected void noteDataBytes(byte[] buffer, int offset, int length) throws IOException {
      ...
      while(var4.hasNext()) {
         ObservableInputStream.Observer observer = (ObservableInputStream.Observer)var4.next();
